...
If the revision to download from cannot be found.`),G.forEach(t),z.forEach(t),this.h()},h(){b(r,"href","/docs/huggingface_hub/pr_1006/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),b(P,"href","/docs/huggingface_hub/pr_1006/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(m,D){y(m,p,D),e(p,v),y(m,f,D),y(m,c,D),e(c,h),e(h,r),e(r,u),e(h,T),e(h,_),e(_,x),e(h,w),e(c,$),e(c,A),e(A,P),e(P,O),e(A,L)},d(m){m&&t(p),m&&t(f),m&&t(c)}}}function Ju(U){let p,v,f,c,h,r,u,T,_,x,w,$,A,P,O,L,m,D,z,V,R,K,G,E,S,C,Y,te,Z,J,ee,ae,B;return{c(){p=o("p"),v=i("Raises the following errors:"),f=g(),c=o("ul"),h=o("li"),r=o("a"),u=o("code"),T=i("HTTPError"),_=i(`
if the HuggingFace API returned an error`),x=g(),w=o("li"),$=o("a"),A=o("code"),P=i("ValueError"),O=i(`
if some parameter value is invalid`),L=g(),m=o("li"),D=o("a"),z=i("RepositoryNotFoundError"),V=i(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),_=a(O,"CODE",{});var m=s(_);x=l(m,"private"),m.forEach(t),w=l(O," and you do not have access."),O.forEach(t),P.forEach(t),this.h()},h(){b(r,"href","/docs/huggingface_hub/pr_1006/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError")},m($,A){y($,p,A),e(p,v),y($,f,A),y($,c,A),e(c,h),e(h,r),e(r,u),e(h,T),e(h,_),e(_,x),e(h,w)},d($){$&&t(p),$&&t(f),$&&t(c)}}}function Xu(U){let p,v,f,c,h,r,u,T,_,x,w,$,A,P,O,L,m,D,z,V,R,K,G;return{c(){p=o("p"),v=i("Raises the following errors:"),f=g(),c=o("ul"),h=o("li"),r=o("a"),u=o("code"),T=i("HTTPError"),_=i(`
if the HuggingFace API returned an error`),x=g(),w=o("li"),$=o("a"),A=o("code"),P=i("ValueError"),O=i(`
if some parameter value is invalid`),L=g(),m=o("li"),D=o("a"),z=i("RepositoryNotFoundError"),V=i(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),R=o("code"),K=i("private"),G=i(" and you do not have access."),this.h()},l(E){p=a(E,"P",{});var S=s(p);v=l(S,"Raises the following errors:"),S.forEach(t),f=d(E),c=a(E,"UL",{});var C=s(c);h=a(C,"LI",{});var Y=s(h);r=a(Y,"A",{href:!0,rel:!0});var te=s(r);u=a(te,"CODE",{});var Z=s(u);T=l(Z,"HTTPError"),Z.forEach(t),te.forEach(t),_=l(Y,`
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2959",returnDescription:`
<p>the status change event</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/community#huggingface_hub.DiscussionStatusChange"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2818",returnDescription:`
<p>the newly created comment</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/community#huggingface_hub.DiscussionComment"
...
if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1894",returnDescription:`
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1520",returnDescription:`
...
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1280",returnDescription:`
<p>The dataset repository information.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.DatasetInfo"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L3085",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2441",returnDescription:`
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>).`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2475",returnDescription:`
<p>An iterator of <a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/community#huggingface_hub.Discussion"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L3141",returnDescription:`
<p>the hidden comment</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/community#huggingface_hub.DiscussionComment"
>DiscussionComment</a></p>
`}}),Ot=new se({props:{warning:!0,$$slots:{default:[tf]},$$scope:{ctx:U}}}),Lt=new se({props:{$$slots:{default:[of]},$$scope:{ctx:U}}}),Xo=new Q({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
are the properties of the <a href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.ModelInfo">huggingface_hub.hf_api.ModelInfo</a> class.`,name:"sort"},{anchor:"huggingface_hub.HfApi.list_models.direction",description:`<strong>direction</strong> (<code>Literal[-1]</code> or <code>int</code>, <em>optional</em>) &#x2014;
Direction in which to sort. The value <code>-1</code> sorts by descending
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1480",returnDescription:`
...
values are the properties of the <a href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.SpaceInfo">huggingface_hub.hf_api.SpaceInfo</a>\` class.`,name:"sort"},{anchor:"huggingface_hub.HfApi.list_spaces.direction",description:`<strong>direction</strong> (<code>Literal[-1]</code> or <code>int</code>, <em>optional</em>) &#x2014;
Direction in which to sort. The value <code>-1</code> sorts by descending
...
Whether to use the <code>auth_token</code> provided from the
<code>huggingface_hub</code> cli. If not logged in, a valid <code>auth_token</code>
can be passed in as a string.`,name:"use_auth_token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1121",returnDescription:`
<p>a list of <a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.SpaceInfo"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L3033",returnDescription:`
<p>the status change event</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/community#huggingface_hub.DiscussionStatusChange"
...
Whether or not to retrieve metadata for files in the repository
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1206",returnDescription:`
<p>The model repository information.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.ModelInfo"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2893",returnDescription:`
<p>the title change event</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_1006/en/package_reference/community#huggingface_hub.DiscussionTitleChange"
...
Whether or not to retrieve metadata for files in the repository
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1408",returnDescription:`
...
Whether or not to retrieve metadata for files in the repository
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1344",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L1741",returnDescription:`
...
If specified and <code>create_pr</code> is <code>True</code>, the pull request will be created from <code>parent_commit</code>.
Specifying <code>parent_commit</code> ensures the repo has not changed before committing the changes, and can be
especially useful if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2054",returnDescription:`
...
If provided, files matching any of the patterns are not uploaded.`,name:"ignore_patterns"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_1006/src/huggingface_hub/hf_api.py#L2204",returnDescription:`
...
list of (<a href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.RepoFile">huggingface_hub.hf_api.RepoFile</a>) objects that constitute the model.`,name:"siblings"},{anchor:"huggingface_hub.hf_api.ModelInfo.private",description:`<strong>private</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
list of <a href="/docs/huggingface_hub/pr_1006/en/package_reference/hf_api#huggingface_hub.hf_api.RepoFile">huggingface_hub.hf_api.RepoFile</a> objects that constitute the dataset.`,name:"siblings"},{anchor:"huggingface_hub.hf_api.DatasetInfo.private",description:`<strong>private</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
