...
If the revision to download from cannot be found.`),G.forEach(t),z.forEach(t),this.h()},h(){$(r,"href","/docs/huggingface_hub/pr_993/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),$(P,"href","/docs/huggingface_hub/pr_993/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(m,D){y(m,p,D),e(p,b),y(m,f,D),y(m,c,D),e(c,h),e(h,r),e(r,u),e(h,T),e(h,_),e(_,x),e(h,w),e(c,v),e(c,A),e(A,P),e(P,O),e(A,L)},d(m){m&&t(p),m&&t(f),m&&t(c)}}}function Au(U){let p,b,f,c,h,r,u,T,_,x,w,v,A,P,O,L,m,D,z,V,R,K,G,E,S,C,Y,te,Z,J,ee,ae,B;return{c(){p=a("p"),b=i("Raises the following errors:"),f=g(),c=a("ul"),h=a("li"),r=a("a"),u=a("code"),T=i("HTTPError"),_=i(`
if the HuggingFace API returned an error`),x=g(),w=a("li"),v=a("a"),A=a("code"),P=i("ValueError"),O=i(`
if some parameter value is invalid`),L=g(),m=a("li"),D=a("a"),z=i("RepositoryNotFoundError"),V=i(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),_=n(O,"CODE",{});var m=s(_);x=l(m,"private"),m.forEach(t),w=l(O," and you do not have access."),O.forEach(t),P.forEach(t),this.h()},h(){$(r,"href","/docs/huggingface_hub/pr_993/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError")},m(v,A){y(v,p,A),e(p,b),y(v,f,A),y(v,c,A),e(c,h),e(h,r),e(r,u),e(h,T),e(h,_),e(_,x),e(h,w)},d(v){v&&t(p),v&&t(f),v&&t(c)}}}function Du(U){let p,b,f,c,h,r,u,T,_,x,w,v,A,P,O,L,m,D,z,V,R,K,G;return{c(){p=a("p"),b=i("Raises the following errors:"),f=g(),c=a("ul"),h=a("li"),r=a("a"),u=a("code"),T=i("HTTPError"),_=i(`
if the HuggingFace API returned an error`),x=g(),w=a("li"),v=a("a"),A=a("code"),P=i("ValueError"),O=i(`
if some parameter value is invalid`),L=g(),m=a("li"),D=a("a"),z=i("RepositoryNotFoundError"),V=i(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),R=a("code"),K=i("private"),G=i(" and you do not have access."),this.h()},l(E){p=n(E,"P",{});var S=s(p);b=l(S,"Raises the following errors:"),S.forEach(t),f=d(E),c=n(E,"UL",{});var C=s(c);h=n(C,"LI",{});var Y=s(h);r=n(Y,"A",{href:!0,rel:!0});var te=s(r);u=n(te,"CODE",{});var Z=s(u);T=l(Z,"HTTPError"),Z.forEach(t),te.forEach(t),_=l(Y,`
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2969",returnDescription:`
<p>the status change event</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/community#huggingface_hub.DiscussionStatusChange"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2828",returnDescription:`
<p>the newly created comment</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/community#huggingface_hub.DiscussionComment"
...
if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1896",returnDescription:`
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1522",returnDescription:`
...
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1282",returnDescription:`
<p>The dataset repository information.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.DatasetInfo"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L3095",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2451",returnDescription:`
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>).`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2485",returnDescription:`
<p>An iterator of <a
  href="/docs/huggingface_hub/pr_993/en/package_reference/community#huggingface_hub.Discussion"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L3151",returnDescription:`
<p>the hidden comment</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/community#huggingface_hub.DiscussionComment"
>DiscussionComment</a></p>
`}}),Tt=new se({props:{warning:!0,$$slots:{default:[Iu]},$$scope:{ctx:U}}}),Pt=new se({props:{$$slots:{default:[Nu]},$$scope:{ctx:U}}}),Jo=new Q({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
are the properties of the <a href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.ModelInfo">huggingface_hub.hf_api.ModelInfo</a> class.`,name:"sort"},{anchor:"huggingface_hub.HfApi.list_models.direction",description:`<strong>direction</strong> (<code>Literal[-1]</code> or <code>int</code>, <em>optional</em>) &#x2014;
Direction in which to sort. The value <code>-1</code> sorts by descending
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1482",returnDescription:`
...
values are the properties of the <a href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.SpaceInfo">huggingface_hub.hf_api.SpaceInfo</a>\` class.`,name:"sort"},{anchor:"huggingface_hub.HfApi.list_spaces.direction",description:`<strong>direction</strong> (<code>Literal[-1]</code> or <code>int</code>, <em>optional</em>) &#x2014;
Direction in which to sort. The value <code>-1</code> sorts by descending
...
Whether to use the <code>auth_token</code> provided from the
<code>huggingface_hub</code> cli. If not logged in, a valid <code>auth_token</code>
can be passed in as a string.`,name:"use_auth_token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1123",returnDescription:`
<p>a list of <a
  href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.SpaceInfo"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L3043",returnDescription:`
<p>the status change event</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/community#huggingface_hub.DiscussionStatusChange"
...
Whether or not to retrieve metadata for files in the repository
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1208",returnDescription:`
<p>The model repository information.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.ModelInfo"
...
An authentication token (See <a href="https://huggingface.co/settings/token" rel="nofollow">https://huggingface.co/settings/token</a>)`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2903",returnDescription:`
<p>the title change event</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/pr_993/en/package_reference/community#huggingface_hub.DiscussionTitleChange"
...
Whether or not to retrieve metadata for files in the repository
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1410",returnDescription:`
...
Whether or not to retrieve metadata for files in the repository
(size, LFS metadata, etc). Defaults to <code>False</code>.`,name:"files_metadata"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1346",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L1743",returnDescription:`
...
If specified and <code>create_pr</code> is <code>True</code>, the pull request will be created from <code>parent_commit</code>.
Specifying <code>parent_commit</code> ensures the repo has not changed before committing the changes, and can be
especially useful if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2051",returnDescription:`
...
If specified and <code>create_pr</code> is <code>True</code>, the pull request will be created from <code>parent_commit</code>.
Specifying <code>parent_commit</code> ensures the repo has not changed before committing the changes, and can be
especially useful if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/vr_993/src/huggingface_hub/hf_api.py#L2207",returnDescription:`
...
list of (<a href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.RepoFile">huggingface_hub.hf_api.RepoFile</a>) objects that constitute the model.`,name:"siblings"},{anchor:"huggingface_hub.hf_api.ModelInfo.private",description:`<strong>private</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
list of <a href="/docs/huggingface_hub/pr_993/en/package_reference/hf_api#huggingface_hub.hf_api.RepoFile">huggingface_hub.hf_api.RepoFile</a> objects that constitute the dataset.`,name:"siblings"},{anchor:"huggingface_hub.hf_api.DatasetInfo.private",description:`<strong>private</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
