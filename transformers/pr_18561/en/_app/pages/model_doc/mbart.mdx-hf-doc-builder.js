...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),k=i("Example:"),m=p(),y(c.$$.fragment)},l(n){l=s(n,"P",{});var h=r(l);k=d(h,"Example:"),h.forEach(t),m=u(n),v(c.$$.fragment,n)},m(n,h){b(n,l,h),e(l,k),b(n,m,h),T(c,n,h),g=!0},p:P,i(n){g||(w(c.$$.fragment,n),g=!0)},o(n){M(c.$$.fragment,n),g=!1},d(n){n&&t(l),n&&t(m),$(c,n)}}}function ix(x){let l,k,m,c,g,n,h,q,rt,ze,E,Ae,he,it,me,fe,dt,Ue,Q,L,Ie,oe,S,O,lt,le,ce,ct,H,pt,ut,G,Fe,_e,Xe,ne,ge,be,ht,ae,ke,ye,Qe;return{c(){l=a("p"),k=i("TF 2.0 models accepts two formats as inputs:"),m=p(),c=a("ul"),g=a("li"),n=i("having all inputs as keyword arguments (like PyTorch models), or"),h=p(),q=a("li"),rt=i("having all inputs as a list, tuple or dict in the first positional arguments."),ze=p(),E=a("p"),Ae=i("This second option is useful when using "),he=a("code"),it=i("tf.keras.Model.fit"),me=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),fe=a("code"),dt=i("model(inputs)"),Ue=i("."),Q=p(),L=a("p"),Ie=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=p(),S=a("ul"),O=a("li"),lt=i("a single Tensor with "),le=a("code"),ce=i("input_ids"),ct=i(" only and nothing else: "),H=a("code"),pt=i("model(input_ids)"),ut=p(),G=a("li"),Fe=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),_e=a("code"),Xe=i("model([input_ids, attention_mask])"),ne=i(" or "),ge=a("code"),be=i("model([input_ids, attention_mask, token_type_ids])"),ht=p(),ae=a("li"),ke=i(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),Qe=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){l=s(z,"P",{});var j=r(l);k=d(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),m=u(z),c=s(z,"UL",{});var ve=r(c);g=s(ve,"LI",{});var Ne=r(g);n=d(Ne,"having all inputs as keyword arguments (like PyTorch models), or"),Ne.forEach(t),h=u(ve),q=s(ve,"LI",{});var Et=r(q);rt=d(Et,"having all inputs as a list, tuple or dict in the first positional arguments."),Et.forEach(t),ve.forEach(t),ze=u(z),E=s(z,"P",{});var V=r(E);Ae=d(V,"This second option is useful when using "),he=s(V,"CODE",{});var Ct=r(he);it=d(Ct,"tf.keras.Model.fit"),Ct.forEach(t),me=d(V,` method which currently requires having all the
...
first positional argument :`),X.forEach(t),oe=u(z),S=s(z,"UL",{});var se=r(S);O=s(se,"LI",{});var re=r(O);lt=d(re,"a single Tensor with "),le=s(re,"CODE",{});var Pt=r(le);ce=d(Pt,"input_ids"),Pt.forEach(t),ct=d(re," only and nothing else: "),H=s(re,"CODE",{});var St=r(H);pt=d(St,"model(input_ids)"),St.forEach(t),re.forEach(t),ut=u(se),G=s(se,"LI",{});var ie=r(G);Fe=d(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),_e=s(ie,"CODE",{});var Ot=r(_e);Xe=d(Ot,"model([input_ids, attention_mask])"),Ot.forEach(t),ne=d(ie," or "),ge=s(ie,"CODE",{});var At=r(ge);be=d(At,"model([input_ids, attention_mask, token_type_ids])"),At.forEach(t),ie.forEach(t),ht=u(se),ae=s(se,"LI",{});var De=r(ae);ke=d(De,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=s(De,"CODE",{});var It=r(ye);Qe=d(It,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),It.forEach(t),De.forEach(t),se.forEach(t)},m(z,j){b(z,l,j),e(l,k),b(z,m,j),b(z,c,j),e(c,g),e(g,n),e(c,h),e(c,q),e(q,rt),b(z,ze,j),b(z,E,j),e(E,Ae),e(E,he),e(he,it),e(E,me),e(E,fe),e(fe,dt),e(E,Ue),b(z,Q,j),b(z,L,j),e(L,Ie),b(z,oe,j),b(z,S,j),e(S,O),e(O,lt),e(O,le),e(le,ce),e(O,ct),e(O,H),e(H,pt),e(S,ut),e(S,G),e(G,Fe),e(G,_e),e(_e,Xe),e(G,ne),e(G,ge),e(ge,be),e(S,ht),e(S,ae),e(ae,ke),e(ae,ye),e(ye,Qe)},d(z){z&&t(l),z&&t(m),z&&t(c),z&&t(ze),z&&t(E),z&&t(Q),z&&t(L),z&&t(oe),z&&t(S)}}}function dx(x){let l,k,m,c,g;return{c(){l=a("p"),k=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),c=i("Module"),g=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){l=s(n,"P",{});var h=r(l);k=d(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(h,"CODE",{});var q=r(m);c=d(q,"Module"),q.forEach(t),g=d(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/configuration_mbart.py#L34"}}),qo=new C({props:{anchor:"transformers.MBartConfig.example",$$slots:{default:[N$]},$$scope:{ctx:x}}}),qa=new U({}),Ba=new F({props:{name:"class transformers.MBartTokenizer",anchor:"transformers.MBartTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"tokenizer_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"additional_special_tokens",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/tokenization_mbart.py#L53"}}),jo=new C({props:{anchor:"transformers.MBartTokenizer.example",$$slots:{default:[D$]},$$scope:{ctx:x}}}),Ea=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Qa=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/tokenization_mbart_fast.py#L245"}}),Ha=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/tokenization_mbart_fast.py#L260"}}),Va=new U({}),Ja=new F({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart50/tokenization_mbart50.py#L49"}}),Io=new C({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[G$]},$$scope:{ctx:x}}}),es=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart50/tokenization_mbart50.py#L256",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ds=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart50/tokenization_mbart50.py#L343"}}),ls=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart50/tokenization_mbart50.py#L349"}}),cs=new U({}),ps=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_mbart.py#L1174",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18561/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_mbart.py#L1308",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),Ko=new st({props:{$$slots:{default:[X$]},$$scope:{ctx:x}}}),Zo=new C({props:{anchor:"transformers.MBartForConditionalGeneration.forward.example",$$slots:{default:[Q$]},$$scope:{ctx:x}}}),Yo=new C({props:{anchor:"transformers.MBartForConditionalGeneration.forward.example-2",$$slots:{default:[H$]},$$scope:{ctx:x}}}),Cs=new U({}),Ps=new F({props:{name:"class transformers.MBartForQuestionAnswering",anchor:"transformers.MBartForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18561/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_18561/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_mbart.py#L1565"}}),Is=new F({props:{name:"forward",anchor:"transformers.MBartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": Tensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18561/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_18561/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18561/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_mbart.py#L1577",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_mbart.py#L1450",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_mbart.py#L1729",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
`}}),yn=new st({props:{$$slots:{default:[dx]},$$scope:{ctx:x}}}),vn=new C({props:{anchor:"transformers.TFMBartForConditionalGeneration.call.example",$$slots:{default:[lx]},$$scope:{ctx:x}}}),Tn=new C({props:{anchor:"transformers.TFMBartForConditionalGeneration.call.example-2",$$slots:{default:[cx]},$$scope:{ctx:x}}}),rr=new U({}),ir=new F({props:{name:"class transformers.FlaxMBartModel",anchor:"transformers.FlaxMBartModel",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18561/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18561/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.FlaxMBartModel.dtype",description:`<strong>dtype</strong> (<code>jax.numpy.dtype</code>, <em>optional</em>, defaults to <code>jax.numpy.float32</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
<p><a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Rn=new C({props:{anchor:"transformers.FlaxMBartForSequenceClassification.decode.example",$$slots:{default:[wx]},$$scope:{ctx:x}}}),Gr=new U({}),Wr=new F({props:{name:"class transformers.FlaxMBartForQuestionAnswering",anchor:"transformers.FlaxMBartForQuestionAnswering",parameters:[{name:"config",val:": MBartConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMBartForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18561/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/pr_18561/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18561/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
<p><a
  href="/docs/transformers/pr_18561/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Kn=new C({props:{anchor:"transformers.FlaxMBartForQuestionAnswering.decode.example",$$slots:{default:[zx]},$$scope:{ctx:x}}}),{c(){l=a("meta"),k=p(),m=a("h1"),c=a("a"),g=a("span"),y(n.$$.fragment),h=p(),q=a("span"),rt=i("MBart and MBart-50"),ze=p(),E=a("p"),Ae=a("strong"),he=i("DISCLAIMER:"),it=i(" If you see something strange, file a "),me=a("a"),fe=i("Github Issue"),dt=i(` and assign
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),v1=p(),xc=a("p"),T1=i("Finally, this model supports inherent JAX features such as:"),w1=p(),bt=a("ul"),zc=a("li"),Qr=a("a"),M1=i("Just-In-Time (JIT) compilation"),$1=p(),Fc=a("li"),Hr=a("a"),x1=i("Automatic Differentiation"),z1=p(),qc=a("li"),Vr=a("a"),F1=i("Vectorization"),q1=p(),Bc=a("li"),Jr=a("a"),B1=i("Parallelization"),j1=p(),ot=a("div"),y(Kr.$$.fragment),E1=p(),wo=a("p"),C1=i("The "),jc=a("code"),P1=i("FlaxMBartPreTrainedModel"),S1=i(" forward method, overrides the "),Ec=a("code"),O1=i("__call__"),A1=i(" special method."),I1=p(),y(Xn.$$.fragment),N1=p(),y(Qn.$$.fragment),D1=p(),Hn=a("div"),y(Zr.$$.fragment),L1=p(),y(Vn.$$.fragment),G1=p(),Jn=a("div"),y(Yr.$$.fragment),W1=p(),y(Kn.$$.fragment),this.h()},l(o){const _=A$('[data-svelte="svelte-1phssyn"]',document.head);l=s(_,"META",{name:!0,content:!0}),_.forEach(t),k=u(o),m=s(o,"H1",{class:!0});var ei=r(m);c=s(ei,"A",{id:!0,class:!0,href:!0});var Cc=r(c);g=s(Cc,"SPAN",{});var Pc=r(g);v(n.$$.fragment,Pc),Pc.forEach(t),Cc.forEach(t),h=u(ei),q=s(ei,"SPAN",{});var Sc=r(q);rt=d(Sc,"MBart and MBart-50"),Sc.forEach(t),ei.forEach(t),ze=u(o),E=s(o,"P",{});var Zn=r(E);Ae=s(Zn,"STRONG",{});var Oc=r(Ae);he=d(Oc,"DISCLAIMER:"),Oc.forEach(t),it=d(Zn," If you see something strange, file a "),me=s(Zn,"A",{href:!0,rel:!0});var Ac=r(me);fe=d(Ac,"Github Issue"),Ac.forEach(t),dt=d(Zn,` and assign
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Ii.forEach(t),gp=u(o),di=s(o,"P",{});var X1=r(di);om=d(X1,"According to the abstract"),X1.forEach(t),bp=u(o),li=s(o,"P",{});var Q1=r(li);md=s(Q1,"EM",{});var H1=r(md);nm=d(H1,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),H1.forEach(t),Q1.forEach(t),kp=u(o),Lt=s(o,"H3",{class:!0});var su=r(Lt);xo=s(su,"A",{id:!0,class:!0,href:!0});var V1=r(xo);fd=s(V1,"SPAN",{});var J1=r(fd);v(Ta.$$.fragment,J1),J1.forEach(t),V1.forEach(t),am=u(su),_d=s(su,"SPAN",{});var K1=r(_d);sm=d(K1,"Training of MBart-50"),K1.forEach(t),su.forEach(t),yp=u(o),Ve=s(o,"P",{});var ea=r(Ve);rm=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
documentation from `),fi=s(Di,"A",{href:!0});var gT=r(fi);Gm=d(gT,"PretrainedConfig"),gT.forEach(t),Wm=d(Di," for more information."),Di.forEach(t),Rm=u(ta),v(qo.$$.fragment,ta),ta.forEach(t),Fp=u(o),Ut=s(o,"H2",{class:!0});var lu=r(Ut);Bo=s(lu,"A",{id:!0,class:!0,href:!0});var bT=r(Bo);qd=s(bT,"SPAN",{});var kT=r(qd);v(qa.$$.fragment,kT),kT.forEach(t),bT.forEach(t),Um=u(lu),Bd=s(lu,"SPAN",{});var yT=r(Bd);Xm=d(yT,"MBartTokenizer"),yT.forEach(t),lu.forEach(t),qp=u(o),de=s(o,"DIV",{class:!0});var at=r(de);v(Ba.$$.fragment,at),Qm=u(at),jd=s(at,"P",{});var vT=r(jd);Hm=d(vT,"Construct an MBART tokenizer."),vT.forEach(t),Vm=u(at),mt=s(at,"P",{});var oa=r(mt);Jm=d(oa,"Adapted from "),_i=s(oa,"A",{href:!0});var TT=r(_i);Km=d(TT,"RobertaTokenizer"),TT.forEach(t),Zm=d(oa," and "),gi=s(oa,"A",{href:!0});var wT=r(gi);Ym=d(wT,"XLNetTokenizer"),wT.forEach(t),ef=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var MT=r(ja);tf=d(MT,"SentencePiece"),MT.forEach(t),of=d(oa,"."),oa.forEach(t),nf=u(at),Xt=s(at,"P",{});var Li=r(Xt);af=d(Li,"The tokenization method is "),Ed=s(Li,"CODE",{});var $T=r(Ed);sf=d($T,"<tokens> <eos> <language code>"),$T.forEach(t),rf=d(Li," for source language documents, and "),Cd=s(Li,"CODE",{});var xT=r(Cd);df=d(xT,"<language code> <tokens> <eos>"),xT.forEach(t),lf=d(Li," for target language documents."),Li.forEach(t),cf=u(at),v(jo.$$.fragment,at),pf=u(at),Je=s(at,"DIV",{class:!0});var na=r(Je);v(Ea.$$.fragment,na),uf=u(na),Ca=s(na,"P",{});var cu=r(Ca);hf=d(cu,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Pd=s(cu,"CODE",{});var zT=r(Pd);mf=d(zT,"X"),zT.forEach(t),ff=d(cu," represents the sequence:"),cu.forEach(t),_f=u(na),Pa=s(na,"UL",{});var pu=r(Pa);Sa=s(pu,"LI",{});var uu=r(Sa);Sd=s(uu,"CODE",{});var FT=r(Sd);gf=d(FT,"input_ids"),FT.forEach(t),bf=d(uu," (for encoder) "),Od=s(uu,"CODE",{});var qT=r(Od);kf=d(qT,"X [eos, src_lang_code]"),qT.forEach(t),uu.forEach(t),yf=u(pu),Oa=s(pu,"LI",{});var hu=r(Oa);Ad=s(hu,"CODE",{});var BT=r(Ad);vf=d(BT,"decoder_input_ids"),BT.forEach(t),Tf=d(hu,": (for decoder) "),Id=s(hu,"CODE",{});var jT=r(Id);wf=d(jT,"X [eos, tgt_lang_code]"),jT.forEach(t),hu.forEach(t),pu.forEach(t),Mf=u(na),Nd=s(na,"P",{});var ET=r(Nd);$f=d(ET,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),ET.forEach(t),na.forEach(t),at.forEach(t),Bp=u(o),Qt=s(o,"H2",{class:!0});var mu=r(Qt);Eo=s(mu,"A",{id:!0,class:!0,href:!0});var CT=r(Eo);Dd=s(CT,"SPAN",{});var PT=r(Dd);v(Aa.$$.fragment,PT),PT.forEach(t),CT.forEach(t),xf=u(mu),Ld=s(mu,"SPAN",{});var ST=r(Ld);zf=d(ST,"MBartTokenizerFast"),ST.forEach(t),mu.forEach(t),jp=u(o),A=s(o,"DIV",{class:!0});var Z=r(A);v(Ia.$$.fragment,Z),Ff=u(Z),Ht=s(Z,"P",{});var Gi=r(Ht);qf=d(Gi,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Gd=s(Gi,"EM",{});var OT=r(Gd);Bf=d(OT,"tokenizers"),OT.forEach(t),jf=d(Gi,` library). Based on
`),Na=s(Gi,"A",{href:!0,rel:!0});var AT=r(Na);Ef=d(AT,"BPE"),AT.forEach(t),Cf=d(Gi,"."),Gi.forEach(t),Pf=u(Z),Da=s(Z,"P",{});var fu=r(Da);Sf=d(fu,"This tokenizer inherits from "),bi=s(fu,"A",{href:!0});var IT=r(bi);Of=d(IT,"PreTrainedTokenizerFast"),IT.forEach(t),Af=d(fu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),fu.forEach(t),If=u(Z),Vt=s(Z,"P",{});var Wi=r(Vt);Nf=d(Wi,"The tokenization method is "),Wd=s(Wi,"CODE",{});var NT=r(Wd);Df=d(NT,"<tokens> <eos> <language code>"),NT.forEach(t),Lf=d(Wi," for source language documents, and "),Rd=s(Wi,"CODE",{});var DT=r(Rd);Gf=d(DT,"<language code> <tokens> <eos>"),DT.forEach(t),Wf=d(Wi," for target language documents."),Wi.forEach(t),Rf=u(Z),v(Co.$$.fragment,Z),Uf=u(Z),qe=s(Z,"DIV",{class:!0});var Tt=r(qe);v(La.$$.fragment,Tt),Xf=u(Tt),Ud=s(Tt,"P",{});var LT=r(Ud);Qf=d(LT,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),LT.forEach(t),Hf=u(Tt),Ga=s(Tt,"P",{});var _u=r(Ga);Vf=d(_u,"An MBART sequence has the following format, where "),Xd=s(_u,"CODE",{});var GT=r(Xd);Jf=d(GT,"X"),GT.forEach(t),Kf=d(_u," represents the sequence:"),_u.forEach(t),Zf=u(Tt),Wa=s(Tt,"UL",{});var gu=r(Wa);Ra=s(gu,"LI",{});var bu=r(Ra);Qd=s(bu,"CODE",{});var WT=r(Qd);Yf=d(WT,"input_ids"),WT.forEach(t),e_=d(bu," (for encoder) "),Hd=s(bu,"CODE",{});var RT=r(Hd);t_=d(RT,"X [eos, src_lang_code]"),RT.forEach(t),bu.forEach(t),o_=u(gu),Ua=s(gu,"LI",{});var ku=r(Ua);Vd=s(ku,"CODE",{});var UT=r(Vd);n_=d(UT,"decoder_input_ids"),UT.forEach(t),a_=d(ku,": (for decoder) "),Jd=s(ku,"CODE",{});var XT=r(Jd);s_=d(XT,"X [eos, tgt_lang_code]"),XT.forEach(t),ku.forEach(t),gu.forEach(t),r_=u(Tt),Kd=s(Tt,"P",{});var QT=r(Kd);i_=d(QT,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),QT.forEach(t),Tt.forEach(t),d_=u(Z),Po=s(Z,"DIV",{class:!0});var yu=r(Po);v(Xa.$$.fragment,yu),l_=u(yu),Zd=s(yu,"P",{});var HT=r(Zd);c_=d(HT,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),HT.forEach(t),yu.forEach(t),p_=u(Z),So=s(Z,"DIV",{class:!0});var vu=r(So);v(Qa.$$.fragment,vu),u_=u(vu),Yd=s(vu,"P",{});var VT=r(Yd);h_=d(VT,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),VT.forEach(t),vu.forEach(t),m_=u(Z),Oo=s(Z,"DIV",{class:!0});var Tu=r(Oo);v(Ha.$$.fragment,Tu),f_=u(Tu),el=s(Tu,"P",{});var JT=r(el);__=d(JT,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),JT.forEach(t),Tu.forEach(t),Z.forEach(t),Ep=u(o),Jt=s(o,"H2",{class:!0});var wu=r(Jt);Ao=s(wu,"A",{id:!0,class:!0,href:!0});var KT=r(Ao);tl=s(KT,"SPAN",{});var ZT=r(tl);v(Va.$$.fragment,ZT),ZT.forEach(t),KT.forEach(t),g_=u(wu),ol=s(wu,"SPAN",{});var YT=r(ol);b_=d(YT,"MBart50Tokenizer"),YT.forEach(t),wu.forEach(t),Cp=u(o),I=s(o,"DIV",{class:!0});var Y=r(I);v(Ja.$$.fragment,Y),k_=u(Y),Ka=s(Y,"P",{});var Mu=r(Ka);y_=d(Mu,"Construct a MBart50 tokenizer. Based on "),Za=s(Mu,"A",{href:!0,rel:!0});var ew=r(Za);v_=d(ew,"SentencePiece"),ew.forEach(t),T_=d(Mu,"."),Mu.forEach(t),w_=u(Y),Ya=s(Y,"P",{});var $u=r(Ya);M_=d($u,"This tokenizer inherits from "),ki=s($u,"A",{href:!0});var tw=r(ki);$_=d(tw,"PreTrainedTokenizer"),tw.forEach(t),x_=d($u,` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),cl=s(Eu,"CODE",{});var lw=r(cl);V_=d(lw,"prepare_for_model"),lw.forEach(t),J_=d(Eu," method."),Eu.forEach(t),ju.forEach(t),K_=u(Y),Lo=s(Y,"DIV",{class:!0});var Cu=r(Lo);v(ds.$$.fragment,Cu),Z_=u(Cu),pl=s(Cu,"P",{});var cw=r(pl);Y_=d(cw,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),cw.forEach(t),Cu.forEach(t),eg=u(Y),Go=s(Y,"DIV",{class:!0});var Pu=r(Go);v(ls.$$.fragment,Pu),tg=u(Pu),ul=s(Pu,"P",{});var pw=r(ul);og=d(pw,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),pw.forEach(t),Pu.forEach(t),Y.forEach(t),Pp=u(o),Kt=s(o,"H2",{class:!0});var Su=r(Kt);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var uw=r(Wo);hl=s(uw,"SPAN",{});var hw=r(hl);v(cs.$$.fragment,hw),hw.forEach(t),uw.forEach(t),ng=u(Su),ml=s(Su,"SPAN",{});var mw=r(ml);ag=d(mw,"MBart50TokenizerFast"),mw.forEach(t),Su.forEach(t),Sp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(ps.$$.fragment,Se),sg=u(Se),Zt=s(Se,"P",{});var Ri=r(Zt);rg=d(Ri,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),fl=s(Ri,"EM",{});var fw=r(fl);ig=d(fw,"tokenizers"),fw.forEach(t),dg=d(Ri,` library). Based on
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qu.forEach(t),cb=u(ia),Bs=s(ia,"P",{});var Hu=r(Bs);pb=d(Hu,"This model is also a PyTorch "),js=s(Hu,"A",{href:!0,rel:!0});var Iw=r(js);ub=d(Iw,"torch.nn.Module"),Iw.forEach(t),hb=d(Hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hu.forEach(t),mb=u(ia),je=s(ia,"DIV",{class:!0});var Mt=r(je);v(Es.$$.fragment,Mt),fb=u(Mt),oo=s(Mt,"P",{});var Xi=r(oo);_b=d(Xi,"The "),Mi=s(Xi,"A",{href:!0});var Nw=r(Mi);gb=d(Nw,"MBartForConditionalGeneration"),Nw.forEach(t),bb=d(Xi," forward method, overrides the "),Bl=s(Xi,"CODE",{});var Dw=r(Bl);kb=d(Dw,"__call__"),Dw.forEach(t),yb=d(Xi," special method."),Xi.forEach(t),vb=u(Mt),v(Ko.$$.fragment,Mt),Tb=u(Mt),v(Zo.$$.fragment,Mt),wb=u(Mt),v(Yo.$$.fragment,Mt),Mt.forEach(t),ia.forEach(t),Dp=u(o),no=s(o,"H2",{class:!0});var Vu=r(no);en=s(Vu,"A",{id:!0,class:!0,href:!0});var Lw=r(en);jl=s(Lw,"SPAN",{});var Gw=r(jl);v(Cs.$$.fragment,Gw),Gw.forEach(t),Lw.forEach(t),Mb=u(Vu),El=s(Vu,"SPAN",{});var Ww=r(El);$b=d(Ww,"MBartForQuestionAnswering"),Ww.forEach(t),Vu.forEach(t),Lp=u(o),we=s(o,"DIV",{class:!0});var $t=r(we);v(Ps.$$.fragment,$t),xb=u($t),ao=s($t,"P",{});var Qi=r(ao);zb=d(Qi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Cl=s(Qi,"CODE",{});var Rw=r(Cl);Fb=d(Rw,"span start logits"),Rw.forEach(t),qb=d(Qi," and "),Pl=s(Qi,"CODE",{});var Uw=r(Pl);Bb=d(Uw,"span end logits"),Uw.forEach(t),jb=d(Qi,")."),Qi.forEach(t),Eb=u($t),Ss=s($t,"P",{});var Ju=r(Ss);Cb=d(Ju,"This model inherits from "),$i=s(Ju,"A",{href:!0});var Xw=r($i);Pb=d(Xw,"PreTrainedModel"),Xw.forEach(t),Sb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Db=u($t),Ee=s($t,"DIV",{class:!0});var xt=r(Ee);v(Is.$$.fragment,xt),Lb=u(xt),so=s(xt,"P",{});var Hi=r(so);Gb=d(Hi,"The "),xi=s(Hi,"A",{href:!0});var Hw=r(xi);Wb=d(Hw,"MBartForQuestionAnswering"),Hw.forEach(t),Rb=d(Hi," forward method, overrides the "),Sl=s(Hi,"CODE",{});var Vw=r(Sl);Ub=d(Vw,"__call__"),Vw.forEach(t),Xb=d(Hi," special method."),Hi.forEach(t),Qb=u(xt),v(tn.$$.fragment,xt),Hb=u(xt),v(on.$$.fragment,xt),Vb=u(xt),v(nn.$$.fragment,xt),xt.forEach(t),$t.forEach(t),Gp=u(o),ro=s(o,"H2",{class:!0});var Zu=r(ro);an=s(Zu,"A",{id:!0,class:!0,href:!0});var Jw=r(an);Ol=s(Jw,"SPAN",{});var Kw=r(Ol);v(Ns.$$.fragment,Kw),Kw.forEach(t),Jw.forEach(t),Jb=u(Zu),Al=s(Zu,"SPAN",{});var Zw=r(Al);Kb=d(Zw,"MBartForSequenceClassification"),Zw.forEach(t),Zu.forEach(t),Wp=u(o),Me=s(o,"DIV",{class:!0});var zt=r(Me);v(Ds.$$.fragment,zt),Zb=u(zt),Il=s(zt,"P",{});var Yw=r(Il);Yb=d(Yw,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(t),Bk=u(Ft),Ks=s(Ft,"P",{});var rh=r(Ks);jk=d(rh,"This model is also a "),Zs=s(rh,"A",{href:!0,rel:!0});var pM=r(Zs);Ek=d(pM,"tf.keras.Model"),pM.forEach(t),Ck=d(rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rh.forEach(t),Pk=u(Ft),v(fn.$$.fragment,Ft),Sk=u(Ft),Ye=s(Ft,"DIV",{class:!0});var da=r(Ye);v(Ys.$$.fragment,da),Ok=u(da),uo=s(da,"P",{});var Ji=r(uo);Ak=d(Ji,"The "),Bi=s(Ji,"A",{href:!0});var uM=r(Bi);Ik=d(uM,"TFMBartModel"),uM.forEach(t),Nk=d(Ji," forward method, overrides the "),Rl=s(Ji,"CODE",{});var hM=r(Rl);Dk=d(hM,"__call__"),hM.forEach(t),Lk=d(Ji," special method."),Ji.forEach(t),Gk=u(da),v(_n.$$.fragment,da),Wk=u(da),v(gn.$$.fragment,da),da.forEach(t),Ft.forEach(t),Hp=u(o),ho=s(o,"H2",{class:!0});var ih=r(ho);bn=s(ih,"A",{id:!0,class:!0,href:!0});var mM=r(bn);Ul=s(mM,"SPAN",{});var fM=r(Ul);v(er.$$.fragment,fM),fM.forEach(t),mM.forEach(t),Rk=u(ih),Xl=s(ih,"SPAN",{});var _M=r(Xl);Uk=d(_M,"TFMBartForConditionalGeneration"),_M.forEach(t),ih.forEach(t),Vp=u(o),xe=s(o,"DIV",{class:!0});var qt=r(xe);v(tr.$$.fragment,qt),Xk=u(qt),or=s(qt,"P",{});var dh=r(or);Qk=d(dh,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ji=s(dh,"A",{href:!0});var gM=r(ji);Hk=d(gM,"TFPreTrainedModel"),gM.forEach(t),Vk=d(dh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
