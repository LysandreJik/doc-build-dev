import{S as ri,i as ai,s as si,e as s,k as c,w as C,t as r,M as ni,c as n,d as o,m as h,a as i,x as w,h as a,b as l,N as ii,G as e,g as p,y as k,q as $,o as O,B as E,v as li,L as oi}from"../../chunks/vendor-hf-doc-builder.js";import{T as ei}from"../../chunks/Tip-hf-doc-builder.js";import{D as te}from"../../chunks/Docstring-hf-doc-builder.js";import{C as As}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ti}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function di(S){let f,R,u,g,T;return g=new As({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("p"),R=r("Example:"),u=c(),C(g.$$.fragment)},l(m){f=n(m,"P",{});var _=i(f);R=a(_,"Example:"),_.forEach(o),u=h(m),w(g.$$.fragment,m)},m(m,_){p(m,f,_),e(f,R),p(m,u,_),k(g,m,_),T=!0},p:oi,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){O(g.$$.fragment,m),T=!1},d(m){m&&o(f),m&&o(u),E(g,m)}}}function pi(S){let f,R,u,g,T,m,_,D,j,b,L,F,Pt,ke,Qo,Mt,er,po,W,tr,$e,or,rr,Oe,ar,sr,fo,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,hr,Lt,mr,pr,To,H,fr,Ee,ur,gr,ye,_r,vr,bo,nt,Tr,Co,B,Re,br,xe,Cr,wr,kr,I,$r,Pe,Or,Er,Me,yr,Rr,je,xr,Pr,Mr,Le,jr,it,Lr,zr,wo,Z,se,zt,ze,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,$o,v,Sr,qt,Wr,Hr,At,Br,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Ht,sa,na,Oo,ct,Bt,ia,Eo,Fe,yo,ne,la,De,da,ca,Ro,J,ie,Gt,qe,ha,Xt,ma,xo,q,Ae,pa,Y,fa,ht,ua,ga,Ie,_a,va,Ta,K,ba,mt,Ca,wa,pt,ka,$a,Oa,le,Po,Q,de,Ut,Ve,Ea,Zt,ya,Mo,y,Ne,Ra,Jt,xa,Pa,P,ft,Ma,ja,Yt,La,za,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ha,Ba,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,He,os,so,rs,as,he,ss,U,Be,ns,Ge,is,gt,ls,ds,cs,me,hs,pe,Xe,ms,Ue,ps,_t,fs,us,gs,fe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,Lo,A,Ke,ks,N,$s,Tt,Os,Es,lo,ys,Rs,bt,xs,Ps,Ms,Qe,js,et,Ls,zs,Fs,ge,tt,Ds,_e,zo;return m=new xt({}),ke=new xt({}),ze=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_28/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/trocr/processing_trocr.py#L24"}}),We=new te({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/trocr/processing_trocr.py#L46"}}),He=new te({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_28/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
namespace).
kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_28/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/processing_utils.py#L94"}}),me=new ei({props:{$$slots:{default:[hi]},$$scope:{ctx:S}}}),Xe=new te({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/trocr/processing_trocr.py#L79"}}),Ze=new te({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/trocr/processing_trocr.py#L86"}}),Ye=new xt({}),Ke=new te({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_28/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_28/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/trocr/modeling_trocr.py#L787"}}),tt=new te({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/pr_28/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_28/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/trocr/modeling_trocr.py#L818",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_28/en/model_doc/trocr#transformers.TrOCRConfig"
...
tasks.`),go=c(),oe=s("img"),_o=c(),re=s("small"),lr=r("TrOCR architecture. Taken from the "),st=s("a"),dr=r("original paper"),cr=r("."),vo=c(),ae=s("p"),hr=r("Please refer to the "),Lt=s("code"),mr=r("VisionEncoderDecoder"),pr=r(" class on how to use this model."),To=c(),H=s("p"),fr=r("This model was contributed by "),Ee=s("a"),ur=r("nielsr"),gr=r(`. The original code can be found
