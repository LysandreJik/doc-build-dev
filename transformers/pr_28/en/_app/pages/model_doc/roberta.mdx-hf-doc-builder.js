...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L742",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_28/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L909",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L1064",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L1180",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L1279",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L1377",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_roberta.py#L1482",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_28/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_28/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=p(),Zp=n("p"),O$=r("Finally, this model supports inherent JAX features such as:"),N$=p(),Ht=n("ul"),eh=n("li"),Pi=n("a"),I$=r("Just-In-Time (JIT) compilation"),D$=p(),th=n("li"),Li=n("a"),S$=r("Automatic Differentiation"),W$=p(),oh=n("li"),Ai=n("a"),B$=r("Vectorization"),U$=p(),nh=n("li"),Oi=n("a"),H$=r("Parallelization"),Q$=p(),Ct=n("div"),T(Ni.$$.fragment),V$=p(),tn=n("p"),J$=r("The "),sh=n("code"),K$=r("FlaxRobertaPreTrainedModel"),G$=r(" forward method, overrides the "),ah=n("code"),X$=r("__call__"),Y$=r(" special method."),Z$=p(),T(Os.$$.fragment),e2=p(),T(Ns.$$.fragment),zf=p(),on=n("h2"),Is=n("a"),rh=n("span"),T(Ii.$$.fragment),t2=p(),ih=n("span"),o2=r("FlaxRobertaForMaskedLM"),Cf=p(),Ie=n("div"),T(Di.$$.fragment),n2=p(),Si=n("p"),s2=r("RoBERTa Model with a "),lh=n("code"),a2=r("language modeling"),r2=r(" head on top."),i2=p(),Wi=n("p"),l2=r("This model inherits from "),Pd=n("a"),d2=r("FlaxPreTrainedModel"),c2=r(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),u2=p(),dh=n("p"),g2=r("Finally, this model supports inherent JAX features such as:"),_2=p(),Qt=n("ul"),ch=n("li"),Hi=n("a"),b2=r("Just-In-Time (JIT) compilation"),k2=p(),ph=n("li"),Qi=n("a"),v2=r("Automatic Differentiation"),T2=p(),hh=n("li"),Vi=n("a"),y2=r("Vectorization"),w2=p(),mh=n("li"),Ji=n("a"),$2=r("Parallelization"),F2=p(),qt=n("div"),T(Ki.$$.fragment),x2=p(),nn=n("p"),R2=r("The "),fh=n("code"),M2=r("FlaxRobertaPreTrainedModel"),E2=r(" forward method, overrides the "),uh=n("code"),z2=r("__call__"),C2=r(" special method."),q2=p(),T(Ds.$$.fragment),j2=p(),T(Ss.$$.fragment),qf=p(),sn=n("h2"),Ws=n("a"),gh=n("span"),T(Gi.$$.fragment),P2=p(),_h=n("span"),L2=r("FlaxRobertaForSequenceClassification"),jf=p(),De=n("div"),T(Xi.$$.fragment),A2=p(),bh=n("p"),O2=r(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u2=h(bt),dh=s(bt,"P",{});var dM=a(dh);g2=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_2=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b2=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k2=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);v2=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),T2=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Vi=s(fM,"A",{href:!0,rel:!0});var uM=a(Vi);y2=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),w2=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Ji=s(gM,"A",{href:!0,rel:!0});var _M=a(Ji);$2=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F2=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);y(Ki.$$.fragment,pa),x2=h(pa),nn=s(pa,"P",{});var rc=a(nn);R2=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);M2=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E2=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);z2=i(kM,"__call__"),kM.forEach(t),C2=i(rc," special method."),rc.forEach(t),q2=h(pa),y(Ds.$$.fragment,pa),j2=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var TM=a(gh);y(Gi.$$.fragment,TM),TM.forEach(t),vM.forEach(t),P2=h(Vu),_h=s(Vu,"SPAN",{});var yM=a(_h);L2=i(yM,"FlaxRobertaForSequenceClassification"),yM.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A2=h(kt),bh=s(kt,"P",{});var wM=a(bh);O2=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
