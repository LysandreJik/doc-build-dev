...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/configuration_mbart.py#L34"}}),qo=new E({props:{anchor:"transformers.MBartConfig.example",$$slots:{default:[NM]},$$scope:{ctx:x}}}),qa=new U({}),Ba=new F({props:{name:"class transformers.MBartTokenizer",anchor:"transformers.MBartTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"tokenizer_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"additional_special_tokens",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/tokenization_mbart.py#L53"}}),jo=new E({props:{anchor:"transformers.MBartTokenizer.example",$$slots:{default:[DM]},$$scope:{ctx:x}}}),Ca=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Qa=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/tokenization_mbart_fast.py#L245"}}),Va=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/tokenization_mbart_fast.py#L260"}}),Ha=new U({}),Ja=new F({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart50/tokenization_mbart50.py#L49"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[GM]},$$scope:{ctx:x}}}),es=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart50/tokenization_mbart50.py#L256",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ds=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart50/tokenization_mbart50.py#L343"}}),ls=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart50/tokenization_mbart50.py#L349"}}),cs=new U({}),ps=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_mbart.py#L1179",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18444/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_mbart.py#L1313",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_mbart.py#L1582",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_mbart.py#L1455",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_mbart.py#L1734",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18444/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18444/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
adding special tokens. An MBART-50 sequence has the following format, where `),nl=s(xu,"CODE",{});var o4=r(nl);j_=d(o4,"X"),o4.forEach(t),C_=d(xu," represents the sequence:"),xu.forEach(t),E_=u(aa),os=s(aa,"UL",{});var zu=r(os);ns=s(zu,"LI",{});var Fu=r(ns);al=s(Fu,"CODE",{});var n4=r(al);P_=d(n4,"input_ids"),n4.forEach(t),S_=d(Fu," (for encoder) "),sl=s(Fu,"CODE",{});var a4=r(sl);O_=d(a4,"[src_lang_code] X [eos]"),a4.forEach(t),Fu.forEach(t),A_=u(zu),as=s(zu,"LI",{});var qu=r(as);rl=s(qu,"CODE",{});var s4=r(rl);I_=d(s4,"labels"),s4.forEach(t),N_=d(qu,": (for decoder) "),il=s(qu,"CODE",{});var r4=r(il);D_=d(r4,"[tgt_lang_code] X [eos]"),r4.forEach(t),qu.forEach(t),zu.forEach(t),L_=u(aa),dl=s(aa,"P",{});var i4=r(dl);G_=d(i4,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),i4.forEach(t),aa.forEach(t),W_=u(Y),No=s(Y,"DIV",{class:!0});var Bu=r(No);v(ss.$$.fragment,Bu),R_=u(Bu),ll=s(Bu,"P",{});var d4=r(ll);U_=d(d4,"Converts a sequence of tokens (strings for sub-words) in a single string."),d4.forEach(t),Bu.forEach(t),X_=u(Y),Do=s(Y,"DIV",{class:!0});var ju=r(Do);v(rs.$$.fragment,ju),Q_=u(ju),is=s(ju,"P",{});var Cu=r(is);V_=d(Cu,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),cl=s(Cu,"CODE",{});var l4=r(cl);H_=d(l4,"prepare_for_model"),l4.forEach(t),J_=d(Cu," method."),Cu.forEach(t),ju.forEach(t),K_=u(Y),Lo=s(Y,"DIV",{class:!0});var Eu=r(Lo);v(ds.$$.fragment,Eu),Z_=u(Eu),pl=s(Eu,"P",{});var c4=r(pl);Y_=d(c4,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),c4.forEach(t),Eu.forEach(t),eg=u(Y),Go=s(Y,"DIV",{class:!0});var Pu=r(Go);v(ls.$$.fragment,Pu),tg=u(Pu),ul=s(Pu,"P",{});var p4=r(ul);og=d(p4,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),p4.forEach(t),Pu.forEach(t),Y.forEach(t),Pp=u(o),Kt=s(o,"H2",{class:!0});var Su=r(Kt);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var u4=r(Wo);hl=s(u4,"SPAN",{});var h4=r(hl);v(cs.$$.fragment,h4),h4.forEach(t),u4.forEach(t),ng=u(Su),ml=s(Su,"SPAN",{});var m4=r(ml);ag=d(m4,"MBart50TokenizerFast"),m4.forEach(t),Su.forEach(t),Sp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(ps.$$.fragment,Se),sg=u(Se),Zt=s(Se,"P",{});var Ri=r(Zt);rg=d(Ri,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),fl=s(Ri,"EM",{});var f4=r(fl);ig=d(f4,"tokenizers"),f4.forEach(t),dg=d(Ri,` library). Based on
`),us=s(Ri,"A",{href:!0,rel:!0});var _4=r(us);lg=d(_4,"BPE"),_4.forEach(t),cg=d(Ri,"."),Ri.forEach(t),pg=u(Se),hs=s(Se,"P",{});var Ou=r(hs);ug=d(Ou,"This tokenizer inherits from "),yi=s(Ou,"A",{href:!0});var g4=r(yi);hg=d(g4,"PreTrainedTokenizerFast"),g4.forEach(t),mg=d(Ou,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Ou.forEach(t),fg=u(Se),v(Ro.$$.fragment,Se),_g=u(Se),Be=s(Se,"DIV",{class:!0});var wt=r(Be);v(ms.$$.fragment,wt),gg=u(wt),_l=s(wt,"P",{});var b4=r(_l);bg=d(b4,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),b4.forEach(t),kg=u(wt),fs=s(wt,"P",{});var Au=r(fs);yg=d(Au,"An MBART-50 sequence has the following format, where "),gl=s(Au,"CODE",{});var k4=r(gl);vg=d(k4,"X"),k4.forEach(t),Tg=d(Au," represents the sequence:"),Au.forEach(t),wg=u(wt),_s=s(wt,"UL",{});var Iu=r(_s);gs=s(Iu,"LI",{});var Nu=r(gs);bl=s(Nu,"CODE",{});var y4=r(bl);Mg=d(y4,"input_ids"),y4.forEach(t),$g=d(Nu," (for encoder) "),kl=s(Nu,"CODE",{});var v4=r(kl);xg=d(v4,"[src_lang_code] X [eos]"),v4.forEach(t),Nu.forEach(t),zg=u(Iu),bs=s(Iu,"LI",{});var Du=r(bs);yl=s(Du,"CODE",{});var T4=r(yl);Fg=d(T4,"labels"),T4.forEach(t),qg=d(Du,": (for decoder) "),vl=s(Du,"CODE",{});var w4=r(vl);Bg=d(w4,"[tgt_lang_code] X [eos]"),w4.forEach(t),Du.forEach(t),Iu.forEach(t),jg=u(wt),Tl=s(wt,"P",{});var M4=r(Tl);Cg=d(M4,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),M4.forEach(t),wt.forEach(t),Eg=u(Se),Uo=s(Se,"DIV",{class:!0});var Lu=r(Uo);v(ks.$$.fragment,Lu),Pg=u(Lu),wl=s(Lu,"P",{});var $4=r(wl);Sg=d($4,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),$4.forEach(t),Lu.forEach(t),Og=u(Se),Xo=s(Se,"DIV",{class:!0});var Gu=r(Xo);v(ys.$$.fragment,Gu),Ag=u(Gu),Ml=s(Gu,"P",{});var x4=r(Ml);Ig=d(x4,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),x4.forEach(t),Gu.forEach(t),Se.forEach(t),Op=u(o),Yt=s(o,"H2",{class:!0});var Wu=r(Yt);Qo=s(Wu,"A",{id:!0,class:!0,href:!0});var z4=r(Qo);$l=s(z4,"SPAN",{});var F4=r($l);v(vs.$$.fragment,F4),F4.forEach(t),z4.forEach(t),Ng=u(Wu),xl=s(Wu,"SPAN",{});var q4=r(xl);Dg=d(q4,"MBartModel"),q4.forEach(t),Wu.forEach(t),Ap=u(o),Ge=s(o,"DIV",{class:!0});var sa=r(Ge);v(Ts.$$.fragment,sa),Lg=u(sa),ws=s(sa,"P",{});var Ru=r(ws);Gg=d(Ru,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),vi=s(Ru,"A",{href:!0});var B4=r(vi);Wg=d(B4,"PreTrainedModel"),B4.forEach(t),Rg=d(Ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ru.forEach(t),Ug=u(sa),Ms=s(sa,"P",{});var Uu=r(Ms);Xg=d(Uu,"This model is also a PyTorch "),$s=s(Uu,"A",{href:!0,rel:!0});var j4=r($s);Qg=d(j4,"torch.nn.Module"),j4.forEach(t),Vg=d(Uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uu.forEach(t),Hg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);v(xs.$$.fragment,ra),Jg=u(ra),eo=s(ra,"P",{});var Ui=r(eo);Kg=d(Ui,"The "),Ti=s(Ui,"A",{href:!0});var C4=r(Ti);Zg=d(C4,"MBartModel"),C4.forEach(t),Yg=d(Ui," forward method, overrides the "),zl=s(Ui,"CODE",{});var E4=r(zl);eb=d(E4,"__call__"),E4.forEach(t),tb=d(Ui," special method."),Ui.forEach(t),ob=u(ra),v(Vo.$$.fragment,ra),nb=u(ra),v(Ho.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Ip=u(o),to=s(o,"H2",{class:!0});var Xu=r(to);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var P4=r(Jo);Fl=s(P4,"SPAN",{});var S4=r(Fl);v(zs.$$.fragment,S4),S4.forEach(t),P4.forEach(t),ab=u(Xu),ql=s(Xu,"SPAN",{});var O4=r(ql);sb=d(O4,"MBartForConditionalGeneration"),O4.forEach(t),Xu.forEach(t),Np=u(o),We=s(o,"DIV",{class:!0});var ia=r(We);v(Fs.$$.fragment,ia),rb=u(ia),qs=s(ia,"P",{});var Qu=r(qs);ib=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),wi=s(Qu,"A",{href:!0});var A4=r(wi);db=d(A4,"PreTrainedModel"),A4.forEach(t),lb=d(Qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qu.forEach(t),cb=u(ia),Bs=s(ia,"P",{});var Vu=r(Bs);pb=d(Vu,"This model is also a PyTorch "),js=s(Vu,"A",{href:!0,rel:!0});var I4=r(js);ub=d(I4,"torch.nn.Module"),I4.forEach(t),hb=d(Vu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vu.forEach(t),mb=u(ia),je=s(ia,"DIV",{class:!0});var Mt=r(je);v(Cs.$$.fragment,Mt),fb=u(Mt),oo=s(Mt,"P",{});var Xi=r(oo);_b=d(Xi,"The "),Mi=s(Xi,"A",{href:!0});var N4=r(Mi);gb=d(N4,"MBartForConditionalGeneration"),N4.forEach(t),bb=d(Xi," forward method, overrides the "),Bl=s(Xi,"CODE",{});var D4=r(Bl);kb=d(D4,"__call__"),D4.forEach(t),yb=d(Xi," special method."),Xi.forEach(t),vb=u(Mt),v(Ko.$$.fragment,Mt),Tb=u(Mt),v(Zo.$$.fragment,Mt),wb=u(Mt),v(Yo.$$.fragment,Mt),Mt.forEach(t),ia.forEach(t),Dp=u(o),no=s(o,"H2",{class:!0});var Hu=r(no);en=s(Hu,"A",{id:!0,class:!0,href:!0});var L4=r(en);jl=s(L4,"SPAN",{});var G4=r(jl);v(Es.$$.fragment,G4),G4.forEach(t),L4.forEach(t),Mb=u(Hu),Cl=s(Hu,"SPAN",{});var W4=r(Cl);$b=d(W4,"MBartForQuestionAnswering"),W4.forEach(t),Hu.forEach(t),Lp=u(o),we=s(o,"DIV",{class:!0});var $t=r(we);v(Ps.$$.fragment,$t),xb=u($t),ao=s($t,"P",{});var Qi=r(ao);zb=d(Qi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),El=s(Qi,"CODE",{});var R4=r(El);Fb=d(R4,"span start logits"),R4.forEach(t),qb=d(Qi," and "),Pl=s(Qi,"CODE",{});var U4=r(Pl);Bb=d(U4,"span end logits"),U4.forEach(t),jb=d(Qi,")."),Qi.forEach(t),Cb=u($t),Ss=s($t,"P",{});var Ju=r(Ss);Eb=d(Ju,"This model inherits from "),$i=s(Ju,"A",{href:!0});var X4=r($i);Pb=d(X4,"PreTrainedModel"),X4.forEach(t),Sb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),Ob=u($t),Os=s($t,"P",{});var Ku=r(Os);Ab=d(Ku,"This model is also a PyTorch "),As=s(Ku,"A",{href:!0,rel:!0});var Q4=r(As);Ib=d(Q4,"torch.nn.Module"),Q4.forEach(t),Nb=d(Ku,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Db=u($t),Ce=s($t,"DIV",{class:!0});var xt=r(Ce);v(Is.$$.fragment,xt),Lb=u(xt),so=s(xt,"P",{});var Vi=r(so);Gb=d(Vi,"The "),xi=s(Vi,"A",{href:!0});var V4=r(xi);Wb=d(V4,"MBartForQuestionAnswering"),V4.forEach(t),Rb=d(Vi," forward method, overrides the "),Sl=s(Vi,"CODE",{});var H4=r(Sl);Ub=d(H4,"__call__"),H4.forEach(t),Xb=d(Vi," special method."),Vi.forEach(t),Qb=u(xt),v(tn.$$.fragment,xt),Vb=u(xt),v(on.$$.fragment,xt),Hb=u(xt),v(nn.$$.fragment,xt),xt.forEach(t),$t.forEach(t),Gp=u(o),ro=s(o,"H2",{class:!0});var Zu=r(ro);an=s(Zu,"A",{id:!0,class:!0,href:!0});var J4=r(an);Ol=s(J4,"SPAN",{});var K4=r(Ol);v(Ns.$$.fragment,K4),K4.forEach(t),J4.forEach(t),Jb=u(Zu),Al=s(Zu,"SPAN",{});var Z4=r(Al);Kb=d(Z4,"MBartForSequenceClassification"),Z4.forEach(t),Zu.forEach(t),Wp=u(o),Me=s(o,"DIV",{class:!0});var zt=r(Me);v(Ds.$$.fragment,zt),Zb=u(zt),Il=s(zt,"P",{});var Y4=r(Il);Yb=d(Y4,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Y4.forEach(t),ek=u(zt),Ls=s(zt,"P",{});var Yu=r(Ls);tk=d(Yu,"This model inherits from "),zi=s(Yu,"A",{href:!0});var ew=r(zi);ok=d(ew,"PreTrainedModel"),ew.forEach(t),nk=d(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
