...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18444/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q$=p(),kh=n("p"),V$=r("Finally, this model supports inherent JAX features such as:"),J$=p(),Vt=n("ul"),vh=n("li"),tl=n("a"),K$=r("Just-In-Time (JIT) compilation"),G$=p(),Th=n("li"),ol=n("a"),X$=r("Automatic Differentiation"),Y$=p(),yh=n("li"),nl=n("a"),Z$=r("Vectorization"),e4=p(),wh=n("li"),sl=n("a"),t4=r("Parallelization"),o4=p(),jt=n("div"),T(al.$$.fragment),n4=p(),an=n("p"),s4=r("The "),$h=n("code"),a4=r("FlaxRobertaPreTrainedModel"),r4=r(" forward method, overrides the "),Fh=n("code"),i4=r("__call__"),l4=r(" special method."),d4=p(),T(Bs.$$.fragment),c4=p(),T(Us.$$.fragment),Pf=p(),rn=n("h2"),Hs=n("a"),xh=n("span"),T(rl.$$.fragment),p4=p(),Rh=n("span"),h4=r("FlaxRobertaForMultipleChoice"),Lf=p(),Se=n("div"),T(il.$$.fragment),m4=p(),Mh=n("p"),f4=r(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k4=p(),dl=n("p"),v4=r("This model is also a Flax Linen "),cl=n("a"),T4=r("flax.linen.Module"),y4=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),w4=p(),Eh=n("p"),$4=r("Finally, this model supports inherent JAX features such as:"),F4=p(),Jt=n("ul"),zh=n("li"),pl=n("a"),x4=r("Just-In-Time (JIT) compilation"),R4=p(),Ch=n("li"),hl=n("a"),M4=r("Automatic Differentiation"),E4=p(),qh=n("li"),ml=n("a"),z4=r("Vectorization"),C4=p(),jh=n("li"),fl=n("a"),q4=r("Parallelization"),j4=p(),Pt=n("div"),T(ul.$$.fragment),P4=p(),ln=n("p"),L4=r("The "),Ph=n("code"),A4=r("FlaxRobertaPreTrainedModel"),O4=r(" forward method, overrides the "),Lh=n("code"),N4=r("__call__"),I4=r(" special method."),D4=p(),T(Qs.$$.fragment),S4=p(),T(Vs.$$.fragment),Af=p(),dn=n("h2"),Js=n("a"),Ah=n("span"),T(gl.$$.fragment),W4=p(),Oh=n("span"),B4=r("FlaxRobertaForTokenClassification"),Of=p(),We=n("div"),T(_l.$$.fragment),U4=p(),Nh=n("p"),H4=r(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q4=p(),bl=n("p"),V4=r("This model inherits from "),Od=n("a"),J4=r("FlaxPreTrainedModel"),K4=r(`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Xu.forEach(t),k4=h(vt),dl=s(vt,"P",{});var Yu=a(dl);v4=i(Yu,"This model is also a Flax Linen "),cl=s(Yu,"A",{href:!0,rel:!0});var WR=a(cl);T4=i(WR,"flax.linen.Module"),WR.forEach(t),y4=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),w4=h(vt),Eh=s(vt,"P",{});var BR=a(Eh);$4=i(BR,"Finally, this model supports inherent JAX features such as:"),BR.forEach(t),F4=h(vt),Jt=s(vt,"UL",{});var fa=a(Jt);zh=s(fa,"LI",{});var UR=a(zh);pl=s(UR,"A",{href:!0,rel:!0});var HR=a(pl);x4=i(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R4=h(fa),Ch=s(fa,"LI",{});var QR=a(Ch);hl=s(QR,"A",{href:!0,rel:!0});var VR=a(hl);M4=i(VR,"Automatic Differentiation"),VR.forEach(t),QR.forEach(t),E4=h(fa),qh=s(fa,"LI",{});var JR=a(qh);ml=s(JR,"A",{href:!0,rel:!0});var KR=a(ml);z4=i(KR,"Vectorization"),KR.forEach(t),JR.forEach(t),C4=h(fa),jh=s(fa,"LI",{});var GR=a(jh);fl=s(GR,"A",{href:!0,rel:!0});var XR=a(fl);q4=i(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),fa.forEach(t),j4=h(vt),Pt=s(vt,"DIV",{class:!0});var ua=a(Pt);y(ul.$$.fragment,ua),P4=h(ua),ln=s(ua,"P",{});var lc=a(ln);L4=i(lc,"The "),Ph=s(lc,"CODE",{});var YR=a(Ph);A4=i(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O4=i(lc," forward method, overrides the "),Lh=s(lc,"CODE",{});var ZR=a(Lh);N4=i(ZR,"__call__"),ZR.forEach(t),I4=i(lc," special method."),lc.forEach(t),D4=h(ua),y(Qs.$$.fragment,ua),S4=h(ua),y(Vs.$$.fragment,ua),ua.forEach(t),vt.forEach(t),Af=h(o),dn=s(o,"H2",{class:!0});var Zu=a(dn);Js=s(Zu,"A",{id:!0,class:!0,href:!0});var eM=a(Js);Ah=s(eM,"SPAN",{});var tM=a(Ah);y(gl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),W4=h(Zu),Oh=s(Zu,"SPAN",{});var oM=a(Oh);B4=i(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),Zu.forEach(t),Of=h(o),We=s(o,"DIV",{class:!0});var Tt=a(We);y(_l.$$.fragment,Tt),U4=h(Tt),Nh=s(Tt,"P",{});var nM=a(Nh);H4=i(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q4=h(Tt),bl=s(Tt,"P",{});var eg=a(bl);V4=i(eg,"This model inherits from "),Od=s(eg,"A",{href:!0});var sM=a(Od);J4=i(sM,"FlaxPreTrainedModel"),sM.forEach(t),K4=i(eg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),eg.forEach(t),G4=h(Tt),kl=s(Tt,"P",{});var tg=a(kl);X4=i(tg,"This model is also a Flax Linen "),vl=s(tg,"A",{href:!0,rel:!0});var aM=a(vl);Y4=i(aM,"flax.linen.Module"),aM.forEach(t),Z4=i(tg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
