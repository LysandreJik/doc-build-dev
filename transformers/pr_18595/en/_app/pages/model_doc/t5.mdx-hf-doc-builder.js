...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18595/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18595/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18595/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18595/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18595/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18595/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18595/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_tf_t5.py#L1146",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_tf_t5.py#L1322",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18595/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18595/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18595/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_tf_t5.py#L1569",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18595/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/t5/modeling_flax_t5.py#L987",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),m5=d(),k(Xn.$$.fragment),f5=d(),ft=a("div"),k(Ca.$$.fragment),_5=d(),tn=a("p"),g5=o("The "),Br=a("a"),T5=o("TFT5ForConditionalGeneration"),b5=o(" forward method, overrides the "),cd=a("code"),k5=o("__call__"),v5=o(" special method."),y5=d(),k(Qn.$$.fragment),w5=d(),k(eo.$$.fragment),tp=d(),nn=a("h2"),to=a("a"),pd=a("span"),k(Pa.$$.fragment),$5=d(),hd=a("span"),x5=o("TFT5EncoderModel"),np=d(),ce=a("div"),k(Na.$$.fragment),z5=d(),ud=a("p"),j5=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),E5=d(),Oa=a("p"),q5=o("The T5 model was proposed in "),La=a("a"),F5=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
`),Ns=r(oi,"A",{href:!0,rel:!0});var Qv=i(Ns);i_=s(Qv,"Unigram"),Qv.forEach(t),l_=s(oi,"."),oi.forEach(t),d_=c(Ot),Os=r(Ot,"P",{});var qp=i(Os);c_=s(qp,"This tokenizer inherits from "),Pr=r(qp,"A",{href:!0});var e1=i(Pr);p_=s(e1,"PreTrainedTokenizerFast"),e1.forEach(t),h_=s(qp,` which contains most of the main methods. Users should
...
adding special tokens. A sequence has the following format:`),t1.forEach(t),__=c(si),As=r(si,"UL",{});var Fp=i(As);Nr=r(Fp,"LI",{});var Db=i(Nr);g_=s(Db,"single sequence: "),Pl=r(Db,"CODE",{});var n1=i(Pl);T_=s(n1,"X </s>"),n1.forEach(t),Db.forEach(t),b_=c(Fp),Or=r(Fp,"LI",{});var Sb=i(Or);k_=s(Sb,"pair of sequences: "),Nl=r(Sb,"CODE",{});var o1=i(Nl);v_=s(o1,"A </s> B </s>"),o1.forEach(t),Sb.forEach(t),Fp.forEach(t),si.forEach(t),y_=c(Ot),Mn=r(Ot,"DIV",{class:!0});var Mp=i(Mn);v(Is.$$.fragment,Mp),w_=c(Mp),Ol=r(Mp,"P",{});var s1=i(Ol);$_=s(s1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qp.forEach(t),m5=c(Ye),v(Xn.$$.fragment,Ye),f5=c(Ye),ft=r(Ye,"DIV",{class:!0});var Po=i(ft);v(Ca.$$.fragment,Po),_5=c(Po),tn=r(Po,"P",{});var hi=i(tn);g5=s(hi,"The "),Br=r(hi,"A",{href:!0});var oy=i(Br);T5=s(oy,"TFT5ForConditionalGeneration"),oy.forEach(t),b5=s(hi," forward method, overrides the "),cd=r(hi,"CODE",{});var sy=i(cd);k5=s(sy,"__call__"),sy.forEach(t),v5=s(hi," special method."),hi.forEach(t),y5=c(Po),v(Qn.$$.fragment,Po),w5=c(Po),v(eo.$$.fragment,Po),Po.forEach(t),Ye.forEach(t),tp=c(n),nn=r(n,"H2",{class:!0});var eh=i(nn);to=r(eh,"A",{id:!0,class:!0,href:!0});var ay=i(to);pd=r(ay,"SPAN",{});var ry=i(pd);v(Pa.$$.fragment,ry),ry.forEach(t),ay.forEach(t),$5=c(eh),hd=r(eh,"SPAN",{});var iy=i(hd);x5=s(iy,"TFT5EncoderModel"),iy.forEach(t),eh.forEach(t),np=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);v(Na.$$.fragment,Ze),z5=c(Ze),ud=r(Ze,"P",{});var ly=i(ud);j5=s(ly,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),ly.forEach(t),E5=c(Ze),Oa=r(Ze,"P",{});var th=i(Oa);q5=s(th,"The T5 model was proposed in "),La=r(th,"A",{href:!0,rel:!0});var dy=i(La);F5=s(dy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
