...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/layoutlmv3/feature_extraction_layoutlmv3.py#L147",returnDescription:`
<p>A <a
...
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_18595/en/model_doc/layoutlmv3#transformers.LayoutLMv3FeatureExtractor"
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18595/en/model_doc/layoutlmv3#transformers.LayoutLMv3Tokenizer">LayoutLMv3Tokenizer</a>. See <a href="/docs/transformers/pr_18595/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18595/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1058",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18595/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1169",returnDescription:`
<p>A <a
...
`),Sn=r(E,"CODE",{});var Pu=i(Sn);Ji=a(Pu,"attention_mask"),Pu.forEach(t),Ki=a(E,", "),Dn=r(E,"CODE",{});var Cu=i(Dn);Zi=a(Cu,"token_type_ids"),Cu.forEach(t),el=a(E,", "),On=r(E,"CODE",{});var Au=i(On);tl=a(Au,"bbox"),Au.forEach(t),ol=a(E,". Optionally, one can provide integer "),Rn=r(E,"CODE",{});var ju=i(Rn);nl=a(ju,"word_labels"),ju.forEach(t),al=a(E,`, which are turned
into token-level `),Wn=r(E,"CODE",{});var Iu=i(Wn);sl=a(Iu,"labels"),Iu.forEach(t),rl=a(E," for token classification tasks (such as FUNSD, CORD)."),E.forEach(t),il=u(re),ae=r(re,"DIV",{class:!0});var en=i(ae);b(It.$$.fragment,en),ll=u(en),M=r(en,"P",{});var $=i(M);dl=a($,"This method first forwards the "),Bn=r($,"CODE",{});var Nu=i(Bn);cl=a(Nu,"images"),Nu.forEach(t),ul=a($," argument to "),Nt=r($,"A",{href:!0});var Lc=i(Nt);Un=r(Lc,"STRONG",{});var Su=i(Un);pl=a(Su,"call"),Su.forEach(t),ml=a(Lc,"()"),Lc.forEach(t),hl=a($,`. In case
`),Bo=r($,"A",{href:!0});var Du=i(Bo);fl=a(Du,"LayoutLMv3FeatureExtractor"),Du.forEach(t),gl=a($," was initialized with "),Qn=r($,"CODE",{});var Ou=i(Qn);_l=a(Ou,"apply_ocr"),Ou.forEach(t),vl=a($," set to "),Vn=r($,"CODE",{});var Ru=i(Vn);yl=a(Ru,"True"),Ru.forEach(t),bl=a($,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),St=r($,"A",{href:!0});var kc=i(St);Hn=r(kc,"STRONG",{});var Wu=i(Hn);Ll=a(Wu,"call"),Wu.forEach(t),kl=a(kc,"()"),kc.forEach(t),xl=a($,` and returns the output,
...
along with the additional arguments to `),Dt=r($,"A",{href:!0});var xc=i(Dt);ea=r(xc,"STRONG",{});var Yu=i(ea);Sl=a(Yu,"call"),Yu.forEach(t),Dl=a(xc,"()"),xc.forEach(t),Ol=a($,` and returns the output, together with
resized and normalized `),ta=r($,"CODE",{});var Ju=i(ta);Rl=a(Ju,"pixel_values"),Ju.forEach(t),Wl=a($,"."),$.forEach(t),Bl=u(en),oa=r(en,"P",{});var Ku=i(oa);Ul=a(Ku,"Please refer to the docstring of the above two methods for more information."),Ku.forEach(t),en.forEach(t),re.forEach(t),Ua=u(o),_e=r(o,"H2",{class:!0});var hs=i(_e);Se=r(hs,"A",{id:!0,class:!0,href:!0});var Zu=i(Se);na=r(Zu,"SPAN",{});var ep=i(na);b(Ot.$$.fragment,ep),ep.forEach(t),Zu.forEach(t),Ql=u(hs),aa=r(hs,"SPAN",{});var tp=i(aa);Vl=a(tp,"LayoutLMv3Model"),tp.forEach(t),hs.forEach(t),Qa=u(o),K=r(o,"DIV",{class:!0});var tn=i(K);b(Rt.$$.fragment,tn),Hl=u(tn),Wt=r(tn,"P",{});var fs=i(Wt);Gl=a(fs,`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Bt=r(fs,"A",{href:!0,rel:!0});var op=i(Bt);Xl=a(op,"torch.nn.Module"),op.forEach(t),Yl=a(fs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fs.forEach(t),Jl=u(tn),H=r(tn,"DIV",{class:!0});var et=i(H);b(Ut.$$.fragment,et),Kl=u(et),ve=r(et,"P",{});var on=i(ve);Zl=a(on,"The "),Qo=r(on,"A",{href:!0});var np=i(Qo);ed=a(np,"LayoutLMv3Model"),np.forEach(t),td=a(on," forward method, overrides the "),sa=r(on,"CODE",{});var ap=i(sa);od=a(ap,"__call__"),ap.forEach(t),nd=a(on," special method."),on.forEach(t),ad=u(et),b(De.$$.fragment,et),sd=u(et),b(Oe.$$.fragment,et),et.forEach(t),tn.forEach(t),Va=u(o),ye=r(o,"H2",{class:!0});var gs=i(ye);Re=r(gs,"A",{id:!0,class:!0,href:!0});var sp=i(Re);ra=r(sp,"SPAN",{});var rp=i(ra);b(Qt.$$.fragment,rp),rp.forEach(t),sp.forEach(t),rd=u(gs),ia=r(gs,"SPAN",{});var ip=i(ia);id=a(ip,"LayoutLMv3ForSequenceClassification"),ip.forEach(t),gs.forEach(t),Ha=u(o),R=r(o,"DIV",{class:!0});var tt=i(R);b(Vt.$$.fragment,tt),ld=u(tt),Ht=r(tt,"P",{});var _s=i(Ht);dd=a(_s,`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
`),no=r(ie,"A",{href:!0,rel:!0});var vp=i(no);jd=a(vp,"Kleister-NDA"),vp.forEach(t),Id=a(ie,"."),ie.forEach(t),Nd=u(nt),ao=r(nt,"P",{});var bs=i(ao);Sd=a(bs,"This model is a PyTorch "),so=r(bs,"A",{href:!0,rel:!0});var yp=i(so);Dd=a(yp,"torch.nn.Module"),yp.forEach(t),Od=a(bs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
