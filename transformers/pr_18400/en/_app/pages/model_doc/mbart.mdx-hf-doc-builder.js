...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart50/tokenization_mbart50.py#L49"}}),Io=new C({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[GM]},$$scope:{ctx:x}}}),es=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart50/tokenization_mbart50.py#L286",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart50/tokenization_mbart50.py#L256",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart50/tokenization_mbart50_fast.py#L170",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18400/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_mbart.py#L1575",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18400/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/pr_18400/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18400/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18400/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18400/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18400/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18400/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
language id for source text and target language id for target text, with `),kd=s(ea,"CODE",{});var e0=r(kd);pm=d(e0,"X"),e0.forEach(t),um=d(ea,` being the source or target text
respectively.`),ea.forEach(t),vp=u(o),zo=s(o,"P",{});var ru=r(zo);hm=d(ru,"MBart-50 has its own tokenizer "),ci=s(ru,"A",{href:!0});var t0=r(ci);mm=d(t0,"MBart50Tokenizer"),t0.forEach(t),fm=d(ru,"."),ru.forEach(t),Tp=u(o),pi=s(o,"UL",{});var o0=r(pi);yd=s(o0,"LI",{});var n0=r(yd);_m=d(n0,"Supervised training"),n0.forEach(t),o0.forEach(t),wp=u(o),v(wa.$$.fragment,o),Mp=u(o),ui=s(o,"UL",{});var a0=r(ui);Ma=s(a0,"LI",{});var iu=r(Ma);vd=s(iu,"P",{});var s0=r(vd);gm=d(s0,"Generation"),s0.forEach(t),bm=u(iu),Te=s(iu,"P",{});var nt=r(Te);km=d(nt,"To generate using the mBART-50 multilingual translation models, "),Td=s(nt,"CODE",{});var r0=r(Td);ym=d(r0,"eos_token_id"),r0.forEach(t),vm=d(nt,` is used as the
`),wd=s(nt,"CODE",{});var i0=r(wd);Tm=d(i0,"decoder_start_token_id"),i0.forEach(t),wm=d(nt,` and the target language id is forced as the first generated token. To force the
target language id as the first generated token, pass the `),Md=s(nt,"EM",{});var d0=r(Md);Mm=d(d0,"forced_bos_token_id"),d0.forEach(t),$m=d(nt," parameter to the "),$d=s(nt,"EM",{});var l0=r($d);xm=d(l0,"generate"),l0.forEach(t),zm=d(nt,` method.
The following example shows how to translate between Hindi to French and Arabic to English using the
`),xd=s(nt,"EM",{});var c0=r(xd);Fm=d(c0,"facebook/mbart-50-large-many-to-many"),c0.forEach(t),qm=d(nt," checkpoint."),nt.forEach(t),iu.forEach(t),a0.forEach(t),$p=u(o),v($a.$$.fragment,o),xp=u(o),Gt=s(o,"H2",{class:!0});var du=r(Gt);Fo=s(du,"A",{id:!0,class:!0,href:!0});var p0=r(Fo);zd=s(p0,"SPAN",{});var u0=r(zd);v(xa.$$.fragment,u0),u0.forEach(t),p0.forEach(t),Bm=u(du),Fd=s(du,"SPAN",{});var h0=r(Fd);jm=d(h0,"MBartConfig"),h0.forEach(t),du.forEach(t),zp=u(o),Le=s(o,"DIV",{class:!0});var ta=r(Le);v(za.$$.fragment,ta),Em=u(ta),Wt=s(ta,"P",{});var Ni=r(Wt);Cm=d(Ni,"This is the configuration class to store the configuration of a "),hi=s(Ni,"A",{href:!0});var m0=r(hi);Pm=d(m0,"MBartModel"),m0.forEach(t),Sm=d(Ni,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Fa=s(Ni,"A",{href:!0,rel:!0});var f0=r(Fa);Om=d(f0,"facebook/mbart-large-cc25"),f0.forEach(t),Am=d(Ni," architecture."),Ni.forEach(t),Im=u(ta),Rt=s(ta,"P",{});var Di=r(Rt);Nm=d(Di,"Configuration objects inherit from "),mi=s(Di,"A",{href:!0});var _0=r(mi);Dm=d(_0,"PretrainedConfig"),_0.forEach(t),Lm=d(Di,` and can be used to control the model outputs. Read the
documentation from `),fi=s(Di,"A",{href:!0});var g0=r(fi);Gm=d(g0,"PretrainedConfig"),g0.forEach(t),Wm=d(Di," for more information."),Di.forEach(t),Rm=u(ta),v(qo.$$.fragment,ta),ta.forEach(t),Fp=u(o),Ut=s(o,"H2",{class:!0});var lu=r(Ut);Bo=s(lu,"A",{id:!0,class:!0,href:!0});var b0=r(Bo);qd=s(b0,"SPAN",{});var k0=r(qd);v(qa.$$.fragment,k0),k0.forEach(t),b0.forEach(t),Um=u(lu),Bd=s(lu,"SPAN",{});var y0=r(Bd);Xm=d(y0,"MBartTokenizer"),y0.forEach(t),lu.forEach(t),qp=u(o),de=s(o,"DIV",{class:!0});var at=r(de);v(Ba.$$.fragment,at),Qm=u(at),jd=s(at,"P",{});var v0=r(jd);Hm=d(v0,"Construct an MBART tokenizer."),v0.forEach(t),Vm=u(at),mt=s(at,"P",{});var oa=r(mt);Jm=d(oa,"Adapted from "),_i=s(oa,"A",{href:!0});var T0=r(_i);Km=d(T0,"RobertaTokenizer"),T0.forEach(t),Zm=d(oa," and "),gi=s(oa,"A",{href:!0});var w0=r(gi);Ym=d(w0,"XLNetTokenizer"),w0.forEach(t),ef=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var M0=r(ja);tf=d(M0,"SentencePiece"),M0.forEach(t),of=d(oa,"."),oa.forEach(t),nf=u(at),Xt=s(at,"P",{});var Li=r(Xt);af=d(Li,"The tokenization method is "),Ed=s(Li,"CODE",{});var $0=r(Ed);sf=d($0,"<tokens> <eos> <language code>"),$0.forEach(t),rf=d(Li," for source language documents, and "),Cd=s(Li,"CODE",{});var x0=r(Cd);df=d(x0,"<language code> <tokens> <eos>"),x0.forEach(t),lf=d(Li," for target language documents."),Li.forEach(t),cf=u(at),v(jo.$$.fragment,at),pf=u(at),Je=s(at,"DIV",{class:!0});var na=r(Je);v(Ea.$$.fragment,na),uf=u(na),Ca=s(na,"P",{});var cu=r(Ca);hf=d(cu,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Pd=s(cu,"CODE",{});var z0=r(Pd);mf=d(z0,"X"),z0.forEach(t),ff=d(cu," represents the sequence:"),cu.forEach(t),_f=u(na),Pa=s(na,"UL",{});var pu=r(Pa);Sa=s(pu,"LI",{});var uu=r(Sa);Sd=s(uu,"CODE",{});var F0=r(Sd);gf=d(F0,"input_ids"),F0.forEach(t),bf=d(uu," (for encoder) "),Od=s(uu,"CODE",{});var q0=r(Od);kf=d(q0,"X [eos, src_lang_code]"),q0.forEach(t),uu.forEach(t),yf=u(pu),Oa=s(pu,"LI",{});var hu=r(Oa);Ad=s(hu,"CODE",{});var B0=r(Ad);vf=d(B0,"decoder_input_ids"),B0.forEach(t),Tf=d(hu,": (for decoder) "),Id=s(hu,"CODE",{});var j0=r(Id);wf=d(j0,"X [eos, tgt_lang_code]"),j0.forEach(t),hu.forEach(t),pu.forEach(t),Mf=u(na),Nd=s(na,"P",{});var E0=r(Nd);$f=d(E0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),E0.forEach(t),na.forEach(t),at.forEach(t),Bp=u(o),Qt=s(o,"H2",{class:!0});var mu=r(Qt);Eo=s(mu,"A",{id:!0,class:!0,href:!0});var C0=r(Eo);Dd=s(C0,"SPAN",{});var P0=r(Dd);v(Aa.$$.fragment,P0),P0.forEach(t),C0.forEach(t),xf=u(mu),Ld=s(mu,"SPAN",{});var S0=r(Ld);zf=d(S0,"MBartTokenizerFast"),S0.forEach(t),mu.forEach(t),jp=u(o),A=s(o,"DIV",{class:!0});var Z=r(A);v(Ia.$$.fragment,Z),Ff=u(Z),Ht=s(Z,"P",{});var Gi=r(Ht);qf=d(Gi,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Gd=s(Gi,"EM",{});var O0=r(Gd);Bf=d(O0,"tokenizers"),O0.forEach(t),jf=d(Gi,` library). Based on
`),Na=s(Gi,"A",{href:!0,rel:!0});var A0=r(Na);Ef=d(A0,"BPE"),A0.forEach(t),Cf=d(Gi,"."),Gi.forEach(t),Pf=u(Z),Da=s(Z,"P",{});var fu=r(Da);Sf=d(fu,"This tokenizer inherits from "),bi=s(fu,"A",{href:!0});var I0=r(bi);Of=d(I0,"PreTrainedTokenizerFast"),I0.forEach(t),Af=d(fu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),fu.forEach(t),If=u(Z),Vt=s(Z,"P",{});var Wi=r(Vt);Nf=d(Wi,"The tokenization method is "),Wd=s(Wi,"CODE",{});var N0=r(Wd);Df=d(N0,"<tokens> <eos> <language code>"),N0.forEach(t),Lf=d(Wi," for source language documents, and "),Rd=s(Wi,"CODE",{});var D0=r(Rd);Gf=d(D0,"<language code> <tokens> <eos>"),D0.forEach(t),Wf=d(Wi," for target language documents."),Wi.forEach(t),Rf=u(Z),v(Co.$$.fragment,Z),Uf=u(Z),qe=s(Z,"DIV",{class:!0});var Tt=r(qe);v(La.$$.fragment,Tt),Xf=u(Tt),Ud=s(Tt,"P",{});var L0=r(Ud);Qf=d(L0,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),L0.forEach(t),Hf=u(Tt),Ga=s(Tt,"P",{});var _u=r(Ga);Vf=d(_u,"An MBART sequence has the following format, where "),Xd=s(_u,"CODE",{});var G0=r(Xd);Jf=d(G0,"X"),G0.forEach(t),Kf=d(_u," represents the sequence:"),_u.forEach(t),Zf=u(Tt),Wa=s(Tt,"UL",{});var gu=r(Wa);Ra=s(gu,"LI",{});var bu=r(Ra);Qd=s(bu,"CODE",{});var W0=r(Qd);Yf=d(W0,"input_ids"),W0.forEach(t),e_=d(bu," (for encoder) "),Hd=s(bu,"CODE",{});var R0=r(Hd);t_=d(R0,"X [eos, src_lang_code]"),R0.forEach(t),bu.forEach(t),o_=u(gu),Ua=s(gu,"LI",{});var ku=r(Ua);Vd=s(ku,"CODE",{});var U0=r(Vd);n_=d(U0,"decoder_input_ids"),U0.forEach(t),a_=d(ku,": (for decoder) "),Jd=s(ku,"CODE",{});var X0=r(Jd);s_=d(X0,"X [eos, tgt_lang_code]"),X0.forEach(t),ku.forEach(t),gu.forEach(t),r_=u(Tt),Kd=s(Tt,"P",{});var Q0=r(Kd);i_=d(Q0,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Q0.forEach(t),Tt.forEach(t),d_=u(Z),Po=s(Z,"DIV",{class:!0});var yu=r(Po);v(Xa.$$.fragment,yu),l_=u(yu),Zd=s(yu,"P",{});var H0=r(Zd);c_=d(H0,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),H0.forEach(t),yu.forEach(t),p_=u(Z),So=s(Z,"DIV",{class:!0});var vu=r(So);v(Qa.$$.fragment,vu),u_=u(vu),Yd=s(vu,"P",{});var V0=r(Yd);h_=d(V0,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),V0.forEach(t),vu.forEach(t),m_=u(Z),Oo=s(Z,"DIV",{class:!0});var Tu=r(Oo);v(Ha.$$.fragment,Tu),f_=u(Tu),el=s(Tu,"P",{});var J0=r(el);__=d(J0,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),J0.forEach(t),Tu.forEach(t),Z.forEach(t),Ep=u(o),Jt=s(o,"H2",{class:!0});var wu=r(Jt);Ao=s(wu,"A",{id:!0,class:!0,href:!0});var K0=r(Ao);tl=s(K0,"SPAN",{});var Z0=r(tl);v(Va.$$.fragment,Z0),Z0.forEach(t),K0.forEach(t),g_=u(wu),ol=s(wu,"SPAN",{});var Y0=r(ol);b_=d(Y0,"MBart50Tokenizer"),Y0.forEach(t),wu.forEach(t),Cp=u(o),I=s(o,"DIV",{class:!0});var Y=r(I);v(Ja.$$.fragment,Y),k_=u(Y),Ka=s(Y,"P",{});var Mu=r(Ka);y_=d(Mu,"Construct a MBart50 tokenizer. Based on "),Za=s(Mu,"A",{href:!0,rel:!0});var e1=r(Za);v_=d(e1,"SentencePiece"),e1.forEach(t),T_=d(Mu,"."),Mu.forEach(t),w_=u(Y),Ya=s(Y,"P",{});var $u=r(Ya);M_=d($u,"This tokenizer inherits from "),ki=s($u,"A",{href:!0});var t1=r(ki);$_=d(t1,"PreTrainedTokenizer"),t1.forEach(t),x_=d($u,` which contains most of the main methods. Users should refer to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qu.forEach(t),cb=u(ia),Bs=s(ia,"P",{});var Hu=r(Bs);pb=d(Hu,"This model is also a PyTorch "),js=s(Hu,"A",{href:!0,rel:!0});var I1=r(js);ub=d(I1,"torch.nn.Module"),I1.forEach(t),hb=d(Hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hu.forEach(t),mb=u(ia),je=s(ia,"DIV",{class:!0});var Mt=r(je);v(Es.$$.fragment,Mt),fb=u(Mt),oo=s(Mt,"P",{});var Xi=r(oo);_b=d(Xi,"The "),Mi=s(Xi,"A",{href:!0});var N1=r(Mi);gb=d(N1,"MBartForConditionalGeneration"),N1.forEach(t),bb=d(Xi," forward method, overrides the "),Bl=s(Xi,"CODE",{});var D1=r(Bl);kb=d(D1,"__call__"),D1.forEach(t),yb=d(Xi," special method."),Xi.forEach(t),vb=u(Mt),v(Ko.$$.fragment,Mt),Tb=u(Mt),v(Zo.$$.fragment,Mt),wb=u(Mt),v(Yo.$$.fragment,Mt),Mt.forEach(t),ia.forEach(t),Dp=u(o),no=s(o,"H2",{class:!0});var Vu=r(no);en=s(Vu,"A",{id:!0,class:!0,href:!0});var L1=r(en);jl=s(L1,"SPAN",{});var G1=r(jl);v(Cs.$$.fragment,G1),G1.forEach(t),L1.forEach(t),Mb=u(Vu),El=s(Vu,"SPAN",{});var W1=r(El);$b=d(W1,"MBartForQuestionAnswering"),W1.forEach(t),Vu.forEach(t),Lp=u(o),we=s(o,"DIV",{class:!0});var $t=r(we);v(Ps.$$.fragment,$t),xb=u($t),ao=s($t,"P",{});var Qi=r(ao);zb=d(Qi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Cl=s(Qi,"CODE",{});var R1=r(Cl);Fb=d(R1,"span start logits"),R1.forEach(t),qb=d(Qi," and "),Pl=s(Qi,"CODE",{});var U1=r(Pl);Bb=d(U1,"span end logits"),U1.forEach(t),jb=d(Qi,")."),Qi.forEach(t),Eb=u($t),Ss=s($t,"P",{});var Ju=r(Ss);Cb=d(Ju,"This model inherits from "),$i=s(Ju,"A",{href:!0});var X1=r($i);Pb=d(X1,"PreTrainedModel"),X1.forEach(t),Sb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Db=u($t),Ee=s($t,"DIV",{class:!0});var xt=r(Ee);v(Is.$$.fragment,xt),Lb=u(xt),so=s(xt,"P",{});var Hi=r(so);Gb=d(Hi,"The "),xi=s(Hi,"A",{href:!0});var H1=r(xi);Wb=d(H1,"MBartForQuestionAnswering"),H1.forEach(t),Rb=d(Hi," forward method, overrides the "),Sl=s(Hi,"CODE",{});var V1=r(Sl);Ub=d(V1,"__call__"),V1.forEach(t),Xb=d(Hi," special method."),Hi.forEach(t),Qb=u(xt),v(tn.$$.fragment,xt),Hb=u(xt),v(on.$$.fragment,xt),Vb=u(xt),v(nn.$$.fragment,xt),xt.forEach(t),$t.forEach(t),Gp=u(o),ro=s(o,"H2",{class:!0});var Zu=r(ro);an=s(Zu,"A",{id:!0,class:!0,href:!0});var J1=r(an);Ol=s(J1,"SPAN",{});var K1=r(Ol);v(Ns.$$.fragment,K1),K1.forEach(t),J1.forEach(t),Jb=u(Zu),Al=s(Zu,"SPAN",{});var Z1=r(Al);Kb=d(Z1,"MBartForSequenceClassification"),Z1.forEach(t),Zu.forEach(t),Wp=u(o),Me=s(o,"DIV",{class:!0});var zt=r(Me);v(Ds.$$.fragment,zt),Zb=u(zt),Il=s(zt,"P",{});var Y1=r(Il);Yb=d(Y1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
