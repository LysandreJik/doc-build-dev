...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18439/en/model_doc/layoutlmv3#transformers.LayoutLMv3Model">LayoutLMv3Model</a>.`,name:"vocab_size"},{anchor:"transformers.LayoutLMv3Config.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18439/src/transformers/models/layoutlmv3/feature_extraction_layoutlmv3.py#L147",returnDescription:`
<p>A <a
...
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_18439/en/model_doc/layoutlmv3#transformers.LayoutLMv3FeatureExtractor"
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18439/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18439/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L978",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18439/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1087",returnDescription:`
<p>A <a
