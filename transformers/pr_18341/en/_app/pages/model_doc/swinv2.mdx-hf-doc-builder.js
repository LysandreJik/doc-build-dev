...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),v=i("Example:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Example:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),S(p,n,h),w=!0},p:Gt,i(n){w||(y(p.$$.fragment,n),w=!0)},o(n){T(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),k(p,n)}}}function gs(x){let d,v,f,p,w;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),p=i("Module"),w=i(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(n,h){_(n,d,h),e(d,v),e(d,f),e(f,p),e(d,w)},d(n){n&&o(d)}}}function _s(x){let d,v,f,p,w;return p=new Kt({props:{code:`from transformers import AutoFeatureExtractor, Swinv2Model
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">64</span>, <span class="hljs-number">768</span>]`}}),{c(){d=s("p"),v=i("Example:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Example:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),S(p,n,h),w=!0},p:Gt,i(n){w||(y(p.$$.fragment,n),w=!0)},o(n){T(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),k(p,n)}}}function ws(x){let d,v,f,p,w;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),p=i("Module"),w=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var M=r(f);p=l(M,"Module"),M.forEach(o),w=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(n,h){_(n,d,h),e(d,v),e(d,f),e(f,p),e(d,w)},d(n){n&&o(d)}}}function vs(x){let d,v,f,p,w;return p=new Kt({props:{code:`from transformers import AutoFeatureExtractor, Swinv2ForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">256</span>, <span class="hljs-number">256</span>]`}}),{c(){d=s("p"),v=i("Examples:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Examples:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),S(p,n,h),w=!0},p:Gt,i(n){w||(y(p.$$.fragment,n),w=!0)},o(n){T(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),k(p,n)}}}function bs(x){let d,v,f,p,w;return{c(){d=s("p"),v=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s("code"),p=i("Module"),w=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var M=r(f);p=l(M,"Module"),M.forEach(o),w=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(n,h){_(n,d,h),e(d,v),e(d,f),e(f,p),e(d,w)},d(n){n&&o(d)}}}function $s(x){let d,v,f,p,w;return p=new Kt({props:{code:`from transformers import AutoFeatureExtractor, Swinv2ForImageClassification
import torch
from datasets import load_dataset
...
Egyptian cat`}}),{c(){d=s("p"),v=i("Example:"),f=u(),b(p.$$.fragment)},l(n){d=a(n,"P",{});var h=r(d);v=l(h,"Example:"),h.forEach(o),f=g(n),$(p.$$.fragment,n)},m(n,h){_(n,d,h),e(d,v),_(n,f,h),S(p,n,h),w=!0},p:Gt,i(n){w||(y(p.$$.fragment,n),w=!0)},o(n){T(p.$$.fragment,n),w=!1},d(n){n&&o(d),n&&o(f),k(p,n)}}}function Ss(x){let d,v,f,p,w,n,h,M,Jt,Tt,z,Y,st,pe,Xt,at,Qt,kt,R,eo,he,to,oo,xt,Oe,no,Mt,Ne,rt,so,Ft,De,ao,Et,Le,me,ro,Ve,io,lo,jt,q,co,fe,po,ho,ue,mo,fo,Ct,O,G,it,ge,uo,lt,go,It,F,_e,_o,N,wo,We,vo,bo,we,$o,So,yo,D,To,He,ko,xo,Ue,Mo,Fo,Eo,K,At,L,J,dt,ve,jo,ct,Co,Pt,A,be,Io,$e,Ao,Se,Po,qo,zo,j,ye,Oo,V,No,Ze,Do,Lo,pt,Vo,Wo,Ho,X,Uo,Q,qt,W,ee,ht,Te,Zo,mt,Bo,zt,P,ke,Yo,H,Ro,xe,Go,Ko,Me,Jo,Xo,Qo,C,Fe,en,U,tn,Be,on,nn,ft,sn,an,rn,te,ln,oe,Ot,Z,ne,ut,Ee,dn,gt,cn,Nt,E,je,pn,_t,hn,mn,Ce,fn,Ie,un,gn,_n,I,Ae,wn,B,vn,Ye,bn,$n,wt,Sn,yn,Tn,se,kn,ae,Dt;return n=new nt({}),pe=new nt({}),ge=new nt({}),_e=new ze({props:{name:"class transformers.Swinv2Config",anchor:"transformers.Swinv2Config",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Swinv2Config.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18341/en/model_doc/swinv2#transformers.Swinv2Config"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vr_18341/src/transformers/models/swinv2/modeling_swinv2.py#L1112",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18341/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18341/src/transformers/models/swinv2/modeling_swinv2.py#L1207"}}),Ae=new ze({props:{name:"forward",anchor:"transformers.Swinv2ForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Swinv2ForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_18341/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18341/src/transformers/models/swinv2/modeling_swinv2.py#L1222",returnDescription:`
...
documentation from `),Ue=s("a"),Mo=i("PretrainedConfig"),Fo=i(" for more information."),Eo=u(),b(K.$$.fragment),At=u(),L=s("h2"),J=s("a"),dt=s("span"),b(ve.$$.fragment),jo=u(),ct=s("span"),Co=i("Swinv2Model"),Pt=u(),A=s("div"),b(be.$$.fragment),Io=u(),$e=s("p"),Ao=i(`The bare Swinv2 Model transformer outputting raw hidden-states without any specific head on top.
...
documentation from `),Ue=a(Ke,"A",{href:!0});var Hn=r(Ue);Mo=l(Hn,"PretrainedConfig"),Hn.forEach(o),Fo=l(Ke," for more information."),Ke.forEach(o),Eo=g(re),$(K.$$.fragment,re),re.forEach(o),At=g(t),L=a(t,"H2",{class:!0});var Ht=r(L);J=a(Ht,"A",{id:!0,class:!0,href:!0});var Un=r(J);dt=a(Un,"SPAN",{});var Zn=r(dt);$(ve.$$.fragment,Zn),Zn.forEach(o),Un.forEach(o),jo=g(Ht),ct=a(Ht,"SPAN",{});var Bn=r(ct);Co=l(Bn,"Swinv2Model"),Bn.forEach(o),Ht.forEach(o),Pt=g(t),A=a(t,"DIV",{class:!0});var Je=r(A);$(be.$$.fragment,Je),Io=g(Je),$e=a(Je,"P",{});var Ut=r($e);Ao=l(Ut,`The bare Swinv2 Model transformer outputting raw hidden-states without any specific head on top.
