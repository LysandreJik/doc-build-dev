...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L742",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18414/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L909",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L1064",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L1180",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L1279",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L1377",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_roberta.py#L1482",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18414/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18414/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),qo=s(lo,"P",{});var Vd=a(qo);yv=i(Vd,"The "),gd=s(Vd,"A",{href:!0});var h0=a(gd);wv=i(h0,"RobertaForTokenClassification"),h0.forEach(t),$v=i(Vd," forward method, overrides the "),rp=s(Vd,"CODE",{});var m0=a(rp);Fv=i(m0,"__call__"),m0.forEach(t),xv=i(Vd," special method."),Vd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f0=a(Yn);ip=s(f0,"SPAN",{});var u0=a(ip);y(Rr.$$.fragment,u0),u0.forEach(t),f0.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var g0=a(lp);Cv=i(g0,"RobertaForQuestionAnswering"),g0.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),qv=h(co),Po=s(co,"P",{});var Jd=a(Po);jv=i(Jd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(qr.$$.fragment,po),Vv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Jv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T0=a(bd);Kv=i(T0,"RobertaForQuestionAnswering"),T0.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y0=a(pp);Xv=i(y0,"__call__"),y0.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),e1=h(po),y(es.$$.fragment,po),t1=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w0=a(os);hp=s(w0,"SPAN",{});var $0=a(hp);y(jr.$$.fragment,$0),$0.forEach(t),w0.forEach(t),o1=h(gu),mp=s(gu,"SPAN",{});var F0=a(mp);n1=i(F0,"TFRobertaModel"),F0.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),s1=h(Ot),fp=s(Ot,"P",{});var x0=a(fp);a1=i(x0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x0.forEach(t),r1=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);i1=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R0=a(kd);l1=i(R0,"TFPreTrainedModel"),R0.forEach(t),d1=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),f1=h(Ot),y(ns.$$.fragment,Ot),u1=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),g1=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_1=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E0=a(vd);b1=i(E0,"TFRobertaModel"),E0.forEach(t),k1=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z0=a(up);v1=i(z0,"__call__"),z0.forEach(t),T1=i(Gd," special method."),Gd.forEach(t),y1=h(na),y(ss.$$.fragment,na),w1=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var C0=a(rs);gp=s(C0,"SPAN",{});var q0=a(gp);y(Ir.$$.fragment,q0),q0.forEach(t),C0.forEach(t),$1=h(ku),_p=s(ku,"SPAN",{});var j0=a(_p);F1=i(j0,"TFRobertaForCausalLM"),j0.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),x1=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),R1=h(sa),Do=s(sa,"P",{});var Xd=a(Do);M1=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P0=a(Td);E1=i(P0,"TFRobertaForCausalLM"),P0.forEach(t),z1=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L0=a(bp);C1=i(L0,"__call__"),L0.forEach(t),q1=i(Xd," special method."),Xd.forEach(t),j1=h(sa),y(is.$$.fragment,sa),P1=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var A0=a(ds);kp=s(A0,"SPAN",{});var O0=a(kp);y(Wr.$$.fragment,O0),O0.forEach(t),A0.forEach(t),L1=h(Tu),vp=s(Tu,"SPAN",{});var N0=a(vp);A1=i(N0,"TFRobertaForMaskedLM"),N0.forEach(t),Tu.forEach(t),_f=h(o),Ve=s(o,"DIV",{class:!0});var Nt=a(Ve);y(Br.$$.fragment,Nt),O1=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);N1=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var I0=a(Tp);I1=i(I0,"language modeling"),I0.forEach(t),D1=i(yu," head on top."),yu.forEach(t),S1=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);W1=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var D0=a(yd);B1=i(D0,"TFPreTrainedModel"),D0.forEach(t),U1=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),K1=h(Nt),y(cs.$$.fragment,Nt),G1=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Jr.$$.fragment,ho),X1=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);Y1=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W0=a(wd);Z1=i(W0,"TFRobertaForMaskedLM"),W0.forEach(t),eT=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B0=a(yp);tT=i(B0,"__call__"),B0.forEach(t),oT=i(Yd," special method."),Yd.forEach(t),nT=h(ho),y(ps.$$.fragment,ho),sT=h(ho),y(hs.$$.fragment,ho),aT=h(ho),y(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U0=a(fs);wp=s(U0,"SPAN",{});var H0=a(wp);y(Kr.$$.fragment,H0),H0.forEach(t),U0.forEach(t),rT=h(Fu),$p=s(Fu,"SPAN",{});var Q0=a($p);iT=i(Q0,"TFRobertaForSequenceClassification"),Q0.forEach(t),Fu.forEach(t),kf=h(o),Je=s(o,"DIV",{class:!0});var It=a(Je);y(Gr.$$.fragment,It),lT=h(It),Fp=s(It,"P",{});var V0=a(Fp);dT=i(V0,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G0=a(Fd);yT=i(G0,"TFRobertaForSequenceClassification"),G0.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X0=a(xp);$T=i(X0,"__call__"),X0.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y0=a(ks);Rp=s(Y0,"SPAN",{});var Z0=a(Rp);y(ti.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zT=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),CT=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);qT=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var sx=a(Rd);HT=i(sx,"TFRobertaForMultipleChoice"),sx.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var ax=a(zp);VT=i(ax,"__call__"),ax.forEach(t),JT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var rx=a(ws);Cp=s(rx,"SPAN",{});var ix=a(Cp);y(ii.$$.fragment,ix),ix.forEach(t),rx.forEach(t),XT=h(Cu),qp=s(Cu,"SPAN",{});var lx=a(qp);YT=i(lx,"TFRobertaForTokenClassification"),lx.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var dx=a(jp);ey=i(dx,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),dx.forEach(t),ty=h(St),di=s(St,"P",{});var qu=a(di);oy=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var cx=a(Md);ny=i(cx,"TFPreTrainedModel"),cx.forEach(t),sy=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var px=a(pi);iy=i(px,"tf.keras.Model"),px.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var hx=a(Ed);my=i(hx,"TFRobertaForTokenClassification"),hx.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var mx=a(Pp);uy=i(mx,"__call__"),mx.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var fx=a(Ms);Lp=s(fx,"SPAN",{});var ux=a(Lp);y(mi.$$.fragment,ux),ux.forEach(t),fx.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var gx=a(Ap);Ty=i(gx,"TFRobertaForQuestionAnswering"),gx.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _x=a(Op);$y=i(_x,"span start logits"),_x.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var bx=a(Np);xy=i(bx,"span end logits"),bx.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var kx=a(zd);zy=i(kx,"TFPreTrainedModel"),kx.forEach(t),Cy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var vx=a(_i);Py=i(vx,"tf.keras.Model"),vx.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),Cd=s(nc,"A",{href:!0});var Tx=a(Cd);Dy=i(Tx,"TFRobertaForQuestionAnswering"),Tx.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var yx=a(Ip);Wy=i(yx,"__call__"),yx.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(Cs.$$.fragment,uo),Qy=h(uo),y(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var wx=a(js);Dp=s(wx,"SPAN",{});var $x=a(Dp);y(ki.$$.fragment,$x),$x.forEach(t),wx.forEach(t),Vy=h(Ou),Sp=s(Ou,"SPAN",{});var Fx=a(Sp);Jy=i(Fx,"FlaxRobertaModel"),Fx.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var xx=a(Wp);Gy=i(xx,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xx.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var Rx=a(qd);Zy=i(Rx,"FlaxPreTrainedModel"),Rx.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Nu.forEach(t),tw=h(gt),yi=s(gt,"P",{});var Iu=a(yi);ow=i(Iu,"This model is also a Flax Linen "),wi=s(Iu,"A",{href:!0,rel:!0});var Mx=a(wi);nw=i(Mx,"flax.linen.Module"),Mx.forEach(t),sw=i(Iu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Iu.forEach(t),aw=h(gt),Bp=s(gt,"P",{});var Ex=a(Bp);rw=i(Ex,"Finally, this model supports inherent JAX features such as:"),Ex.forEach(t),iw=h(gt),Ut=s(gt,"UL",{});var ra=a(Ut);Up=s(ra,"LI",{});var zx=a(Up);$i=s(zx,"A",{href:!0,rel:!0});var Cx=a($i);lw=i(Cx,"Just-In-Time (JIT) compilation"),Cx.forEach(t),zx.forEach(t),dw=h(ra),Hp=s(ra,"LI",{});var qx=a(Hp);Fi=s(qx,"A",{href:!0,rel:!0});var jx=a(Fi);cw=i(jx,"Automatic Differentiation"),jx.forEach(t),qx.forEach(t),pw=h(ra),Qp=s(ra,"LI",{});var Px=a(Qp);xi=s(Px,"A",{href:!0,rel:!0});var Lx=a(xi);hw=i(Lx,"Vectorization"),Lx.forEach(t),Px.forEach(t),mw=h(ra),Vp=s(ra,"LI",{});var Ax=a(Vp);Ri=s(Ax,"A",{href:!0,rel:!0});var Ox=a(Ri);fw=i(Ox,"Parallelization"),Ox.forEach(t),Ax.forEach(t),ra.forEach(t),uw=h(gt),zt=s(gt,"DIV",{class:!0});var ia=a(zt);y(Mi.$$.fragment,ia),gw=h(ia),Zo=s(ia,"P",{});var sc=a(Zo);_w=i(sc,"The "),Jp=s(sc,"CODE",{});var Nx=a(Jp);bw=i(Nx,"FlaxRobertaPreTrainedModel"),Nx.forEach(t),kw=i(sc," forward method, overrides the "),Kp=s(sc,"CODE",{});var Ix=a(Kp);vw=i(Ix,"__call__"),Ix.forEach(t),Tw=i(sc," special method."),sc.forEach(t),yw=h(ia),y(Ps.$$.fragment,ia),ww=h(ia),y(Ls.$$.fragment,ia),ia.forEach(t),gt.forEach(t),Mf=h(o),en=s(o,"H2",{class:!0});var Du=a(en);As=s(Du,"A",{id:!0,class:!0,href:!0});var Dx=a(As);Gp=s(Dx,"SPAN",{});var Sx=a(Gp);y(Ei.$$.fragment,Sx),Sx.forEach(t),Dx.forEach(t),$w=h(Du),Xp=s(Du,"SPAN",{});var Wx=a(Xp);Fw=i(Wx,"FlaxRobertaForCausalLM"),Wx.forEach(t),Du.forEach(t),Ef=h(o),Ne=s(o,"DIV",{class:!0});var _t=a(Ne);y(zi.$$.fragment,_t),xw=h(_t),Yp=s(_t,"P",{});var Bx=a(Yp);Rw=i(Bx,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
