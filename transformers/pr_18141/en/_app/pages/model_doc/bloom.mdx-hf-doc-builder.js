...
resolved in the future once the main model has been fine-tuned with TP_rank=1.`,name:"slow_but_exact"},{anchor:"transformers.BloomConfig.force_lm_head_in_fp32",description:`<strong>force_lm_head_in_fp32</strong> (<code>bool</code> defaults to <code>True</code>) &#x2014;
Casts <code>lm_head</code> in fp32 in order to increase the chances that obtained logits are totally ordered, ie with
no values that is equal to another.`,name:"force_lm_head_in_fp32"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/configuration_bloom.py#L42"}}),_e=new Z({props:{anchor:"transformers.BloomConfig.example",$$slots:{default:[yl]},$$scope:{ctx:F}}}),Xe=new Oe({}),Ze=new X({props:{name:"class transformers.BloomModel",anchor:"transformers.BloomModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L562"}}),so=new X({props:{name:"forward",anchor:"transformers.BloomModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L800",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L901"}}),$o=new X({props:{name:"forward",anchor:"transformers.BloomForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L913",returnDescription:`
...
`}}),ze=new Ht({props:{$$slots:{default:[ql]},$$scope:{ctx:F}}}),Me=new Z({props:{anchor:"transformers.BloomForSequenceClassification.forward.example",$$slots:{default:[xl]},$$scope:{ctx:F}}}),qe=new Z({props:{anchor:"transformers.BloomForSequenceClassification.forward.example-2",$$slots:{default:[El]},$$scope:{ctx:F}}}),xe=new Z({props:{anchor:"transformers.BloomForSequenceClassification.forward.example-3",$$slots:{default:[jl]},$$scope:{ctx:F}}}),Ee=new Z({props:{anchor:"transformers.BloomForSequenceClassification.forward.example-4",$$slots:{default:[Pl]},$$scope:{ctx:F}}}),wo=new Oe({}),yo=new X({props:{name:"class transformers.BloomForTokenClassification",anchor:"transformers.BloomForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18141/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18141/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L1026"}}),Co=new X({props:{name:"forward",anchor:"transformers.BloomForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18141/src/transformers/models/bloom/modeling_bloom.py#L1046",returnDescription:`
<p>A <a
...
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Vt=u(),x=a("ul"),et=a("li"),He=a("a"),Cs=i("bloom-350m"),zs=u(),ot=a("li"),Ue=a("a"),Ms=i("bloom-760m"),qs=u(),tt=a("li"),Ve=a("a"),xs=i("bloom-1b3"),Es=u(),st=a("li"),Re=a("a"),js=i("bloom-2b5"),Ps=u(),nt=a("li"),Ge=a("a"),Ss=i("bloom-6b3"),As=u(),xo=a("li"),Ye=a("a"),Ns=i("bloom"),Ls=i(" (176B parameters)"),Rt=u(),se=a("h2"),ge=a("a"),at=a("span"),v(Je.$$.fragment),Is=u(),rt=a("span"),Os=i("BloomConfig"),Gt=u(),D=a("div"),v(Ke.$$.fragment),Ds=u(),ne=a("p"),Ws=i("This is the configuration class to store the configuration of a "),Eo=a("a"),Hs=i("BloomModel"),Us=i(`. It is used to instantiate a Bloom
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),za=u(),ko=a("p"),Ma=i("This model is also a PyTorch "),vo=a("a"),qa=i("torch.nn.Module"),xa=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=u(),q=a("div"),v($o.$$.fragment),ja=u(),pe=a("p"),Pa=i("The "),Ho=a("a"),Sa=i("BloomForSequenceClassification"),Aa=i(" forward method, overrides the "),Ct=a("code"),Na=i("__call__"),La=i(" special method."),Ia=u(),v(ze.$$.fragment),Oa=u(),v(Me.$$.fragment),Da=u(),v(qe.$$.fragment),Wa=u(),v(xe.$$.fragment),Ha=u(),v(Ee.$$.fragment),ts=u(),he=a("h2"),je=a("a"),zt=a("span"),v(wo.$$.fragment),Ua=u(),Mt=a("span"),Va=i("BloomForTokenClassification"),ss=u(),P=a("div"),v(yo.$$.fragment),Ra=u(),qt=a("p"),Ga=i(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tr=u(),A=a("div"),v(Co.$$.fragment),sr=u(),ue=a("p"),nr=i("The "),Vo=a("a"),ar=i("BloomForTokenClassification"),rr=i(" forward method, overrides the "),xt=a("code"),lr=i("__call__"),ir=i(" special method."),dr=u(),v(Pe.$$.fragment),cr=u(),v(Se.$$.fragment),mr=u(),v(Ae.$$.fragment),this.h()},l(o){const _=$l('[data-svelte="svelte-1phssyn"]',document.head);n=r(_,"META",{name:!0,content:!0}),_.forEach(t),g=f(o),c=r(o,"H1",{class:!0});var zo=l(c);m=r(zo,"A",{id:!0,class:!0,href:!0});var Et=l(m);b=r(Et,"SPAN",{});var jt=l(b);$(s.$$.fragment,jt),jt.forEach(t),Et.forEach(t),p=f(zo),C=r(zo,"SPAN",{});var Pt=l(C);te=d(Pt,"BLOOM"),Pt.forEach(t),zo.forEach(t),O=f(o),H=r(o,"H2",{class:!0});var Mo=l(H);R=r(Mo,"A",{id:!0,class:!0,href:!0});var St=l(R);Xo=r(St,"SPAN",{});var At=l(Xo);$(De.$$.fragment,At),At.forEach(t),St.forEach(t),ws=f(Mo),Zo=r(Mo,"SPAN",{});var Nt=l(Zo);ys=d(Nt,"Overview"),Nt.forEach(t),Mo.forEach(t),Ut=f(o),fe=r(o,"P",{});var qo=l(fe);Ts=d(qo,"The BLOOM model has been proposed with its various versions through the "),We=r(qo,"A",{href:!0,rel:!0});var Lt=l(We);Bs=d(Lt,"BigScience Workshop"),Lt.forEach(t),Fs=d(qo,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of BLOOM is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on different 46 languages including code.
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),qo.forEach(t),Vt=f(o),x=r(o,"UL",{});var S=l(x);et=r(S,"LI",{});var It=l(et);He=r(It,"A",{href:!0,rel:!0});var Ot=l(He);Cs=d(Ot,"bloom-350m"),Ot.forEach(t),It.forEach(t),zs=f(S),ot=r(S,"LI",{});var Dt=l(ot);Ue=r(Dt,"A",{href:!0,rel:!0});var Wt=l(Ue);Ms=d(Wt,"bloom-760m"),Wt.forEach(t),Dt.forEach(t),qs=f(S),tt=r(S,"LI",{});var ur=l(tt);Ve=r(ur,"A",{href:!0,rel:!0});var fr=l(Ve);xs=d(fr,"bloom-1b3"),fr.forEach(t),ur.forEach(t),Es=f(S),st=r(S,"LI",{});var gr=l(st);Re=r(gr,"A",{href:!0,rel:!0});var _r=l(Re);js=d(_r,"bloom-2b5"),_r.forEach(t),gr.forEach(t),Ps=f(S),nt=r(S,"LI",{});var br=l(nt);Ge=r(br,"A",{href:!0,rel:!0});var kr=l(Ge);Ss=d(kr,"bloom-6b3"),kr.forEach(t),br.forEach(t),As=f(S),xo=r(S,"LI",{});var pr=l(xo);Ye=r(pr,"A",{href:!0,rel:!0});var vr=l(Ye);Ns=d(vr,"bloom"),vr.forEach(t),Ls=d(pr," (176B parameters)"),pr.forEach(t),S.forEach(t),Rt=f(o),se=r(o,"H2",{class:!0});var as=l(se);ge=r(as,"A",{id:!0,class:!0,href:!0});var $r=l(ge);at=r($r,"SPAN",{});var wr=l(at);$(Je.$$.fragment,wr),wr.forEach(t),$r.forEach(t),Is=f(as),rt=r(as,"SPAN",{});var yr=l(rt);Os=d(yr,"BloomConfig"),yr.forEach(t),as.forEach(t),Gt=f(o),D=r(o,"DIV",{class:!0});var Ne=l(D);$(Ke.$$.fragment,Ne),Ds=f(Ne),ne=r(Ne,"P",{});var Ro=l(ne);Ws=d(Ro,"This is the configuration class to store the configuration of a "),Eo=r(Ro,"A",{href:!0});var Tr=l(Eo);Hs=d(Tr,"BloomModel"),Tr.forEach(t),Us=d(Ro,`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
...
documentation from `),Po=r(Go,"A",{href:!0});var Cr=l(Po);Qs=d(Cr,"PretrainedConfig"),Cr.forEach(t),Xs=d(Go," for more information."),Go.forEach(t),Zs=f(Ne),$(_e.$$.fragment,Ne),Ne.forEach(t),Yt=f(o),re=r(o,"H2",{class:!0});var rs=l(re);be=r(rs,"A",{id:!0,class:!0,href:!0});var zr=l(be);lt=r(zr,"SPAN",{});var Mr=l(lt);$(Xe.$$.fragment,Mr),Mr.forEach(t),zr.forEach(t),en=f(rs),it=r(rs,"SPAN",{});var qr=l(it);on=d(qr,"BloomModel"),qr.forEach(t),rs.forEach(t),Jt=f(o),E=r(o,"DIV",{class:!0});var G=l(E);$(Ze.$$.fragment,G),tn=f(G),dt=r(G,"P",{});var xr=l(dt);sn=d(xr,"The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),xr.forEach(t),nn=f(G),eo=r(G,"P",{});var ls=l(eo);an=d(ls,"This model inherits from "),So=r(ls,"A",{href:!0});var Er=l(So);rn=d(Er,"PreTrainedModel"),Er.forEach(t),ln=d(ls,`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),_s.forEach(t),za=f(L),ko=r(L,"P",{});var bs=l(ko);Ma=d(bs,"This model is also a PyTorch "),vo=r(bs,"A",{href:!0,rel:!0});var ll=l(vo);qa=d(ll,"torch.nn.Module"),ll.forEach(t),xa=d(bs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bs.forEach(t),Ea=f(L),q=r(L,"DIV",{class:!0});var I=l(q);$($o.$$.fragment,I),ja=f(I),pe=r(I,"P",{});var Ko=l(pe);Pa=d(Ko,"The "),Ho=r(Ko,"A",{href:!0});var il=l(Ho);Sa=d(il,"BloomForSequenceClassification"),il.forEach(t),Aa=d(Ko," forward method, overrides the "),Ct=r(Ko,"CODE",{});var dl=l(Ct);Na=d(dl,"__call__"),dl.forEach(t),La=d(Ko," special method."),Ko.forEach(t),Ia=f(I),$(ze.$$.fragment,I),Oa=f(I),$(Me.$$.fragment,I),Da=f(I),$(qe.$$.fragment,I),Wa=f(I),$(xe.$$.fragment,I),Ha=f(I),$(Ee.$$.fragment,I),I.forEach(t),L.forEach(t),ts=f(o),he=r(o,"H2",{class:!0});var ks=l(he);je=r(ks,"A",{id:!0,class:!0,href:!0});var cl=l(je);zt=r(cl,"SPAN",{});var ml=l(zt);$(wo.$$.fragment,ml),ml.forEach(t),cl.forEach(t),Ua=f(ks),Mt=r(ks,"SPAN",{});var pl=l(Mt);Va=d(pl,"BloomForTokenClassification"),pl.forEach(t),ks.forEach(t),ss=f(o),P=r(o,"DIV",{class:!0});var K=l(P);$(yo.$$.fragment,K),Ra=f(K),qt=r(K,"P",{});var hl=l(qt);Ga=d(hl,`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
