...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),v(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),k(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,_o,Ke,ca,To,pa,vn,fe,ua,Ze,ha,ma,kn,Vt,ga,yn,Yt,bo,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,va,ka,vo,ya,wa,ko,$a,xa,yo,La,za,wo,qa,Fa,ja,Qe,Ma,Zt,Ca,Ea,Oa,Xe,Pa,$o,Ga,Sa,Aa,F,Na,xo,Ia,Da,Lo,Wa,Ba,zo,Ua,Ha,qo,Va,Ya,Fo,Ra,Ja,jo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,vs,ks,zn,te,_e,Ao,st,ys,No,ws,qn,K,rt,$s,Z,xs,Qt,Ls,zs,Xt,qs,Fs,dt,js,Ms,Cs,oe,Es,eo,Os,Ps,to,Gs,Ss,Fn,ne,Te,Io,it,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Bs,pt,Us,Hs,Vs,ut,Ys,oo,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,no,nr,ar,Bo,sr,rr,dr,be,ir,ve,Mn,se,ke,Uo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,vt,_r,Tr,br,kt,vr,ao,kr,yr,wr,yt,$r,wt,xr,Lr,zr,W,$t,qr,re,Fr,so,jr,Mr,Yo,Cr,Er,Or,ye,Pr,we,En,de,$e,Ro,xt,Gr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Wr,Br,Ur,Ft,Hr,ro,Vr,Yr,Rr,jt,Jr,Mt,Kr,Zr,Qr,B,Ct,Xr,ie,ed,io,td,od,Zo,nd,ad,sd,xe,rd,Le,Pn,le,ze,Qo,Et,dd,Xo,id,Gn,A,Ot,ld,U,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,Fe,Td,je,Gt,bd,Me,vd,Ce,St,kd,Ee,Sn,pe,Oe,on,At,yd,nn,wd,An,N,Nt,$d,H,It,xd,ue,Ld,an,zd,qd,sn,Fd,jd,Md,Pe,Cd,Ge,Ed,Se,Dt,Od,Ae,Pd,Ne,Wt,Gd,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5Model">LongT5Model</a>.`,name:"vocab_size"},{anchor:"transformers.LongT5Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18633/src/transformers/models/longt5/modeling_longt5.py#L1929",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18633/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18633/src/transformers/models/longt5/modeling_longt5.py#L2118"}}),Ct=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18633/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18633/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18633/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18633/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18633/src/transformers/models/longt5/modeling_longt5.py#L2153",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18633/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18633/src/transformers/models/longt5/modeling_flax_longt5.py#L1718",returnDescription:`
<p>A <a
...
Transient-Global attention.`),kn=u(),Vt=r("p"),ga=a("The abstract from the paper is the following:"),yn=u(),Yt=r("p"),bo=r("em"),fa=a(`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
...
and behavior.`),er=u(),D=r("div"),v(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),no=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Bo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),v(be.$$.fragment),ir=u(),v(ve.$$.fragment),Mn=u(),se=r("h2"),ke=r("a"),Uo=r("span"),v(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),v(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),vt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=u(),W=r("div"),v($t.$$.fragment),qr=u(),re=r("p"),Fr=a("The "),so=r("a"),jr=a("LongT5ForConditionalGeneration"),Mr=a(" forward method, overrides the "),Yo=r("code"),Cr=a("__call__"),Er=a(" special method."),Or=u(),v(ye.$$.fragment),Pr=u(),v(we.$$.fragment),En=u(),de=r("h2"),$e=r("a"),Ro=r("span"),v(xt.$$.fragment),Gr=u(),Jo=r("span"),Sr=a("LongT5EncoderModel"),On=u(),C=r("div"),v(Lt.$$.fragment),Ar=u(),Ko=r("p"),Nr=a("The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Ir=u(),zt=r("p"),Dr=a("The LongT5 model was proposed in "),qt=r("a"),Wr=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
The original code can be found `),at=d(lo,"A",{href:!0,rel:!0});var ri=i(at);vs=s(ri,"here"),ri.forEach(o),ks=s(lo,"."),lo.forEach(o),zn=h(t),te=d(t,"H2",{class:!0});var Bn=i(te);_e=d(Bn,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);k(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),ys=h(Bn),No=d(Bn,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Bn.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var co=i(K);k(rt.$$.fragment,co),$s=h(co),Z=d(co,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Qt=d(De,"A",{href:!0});var ci=i(Qt);Ls=s(ci,"LongT5Model"),ci.forEach(o),zs=s(De," or a "),Xt=d(De,"A",{href:!0});var pi=i(Xt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),Fs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
...
documentation from `),to=d(po,"A",{href:!0});var mi=i(to);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(po," for more information."),po.forEach(o),co.forEach(o),Fn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);k(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),jn=h(t),j=d(t,"DIV",{class:!0});var Y=i(j);k(lt.$$.fragment,Y),Is=h(Y),Wo=d(Y,"P",{});var Ti=i(Wo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Ws=h(Y),ct=d(Y,"P",{});var Hn=i(ct);Bs=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),bi.forEach(o),Hs=s(Hn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Hn.forEach(o),Vs=h(Y),ut=d(Y,"P",{});var Vn=i(ut);Ys=s(Vn,"This model inherits from "),oo=d(Vn,"A",{href:!0});var vi=i(oo);Rs=s(vi,"PreTrainedModel"),vi.forEach(o),Js=s(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yn.forEach(o),er=h(Y),D=d(Y,"DIV",{class:!0});var We=i(D);k(gt.$$.fragment,We),tr=h(We),ae=d(We,"P",{});var uo=i(ae);or=s(uo,"The "),no=d(uo,"A",{href:!0});var yi=i(no);nr=s(yi,"LongT5Model"),yi.forEach(o),ar=s(uo," forward method, overrides the "),Bo=d(uo,"CODE",{});var wi=i(Bo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(uo," special method."),uo.forEach(o),dr=h(We),k(be.$$.fragment,We),ir=h(We),k(ve.$$.fragment,We),We.forEach(o),Y.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Rn=i(se);ke=d(Rn,"A",{id:!0,class:!0,href:!0});var $i=i(ke);Uo=d($i,"SPAN",{});var xi=i(Uo);k(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Rn),Ho=d(Rn,"SPAN",{});var Li=i(Ho);cr=s(Li,"LongT5ForConditionalGeneration"),Li.forEach(o),Rn.forEach(o),Cn=h(t),M=d(t,"DIV",{class:!0});var R=i(M);k(_t.$$.fragment,R),pr=h(R),Tt=d(R,"P",{});var Jn=i(Tt);ur=s(Jn,"LONGT5 Model with a "),Vo=d(Jn,"CODE",{});var zi=i(Vo);hr=s(zi,"language modeling"),zi.forEach(o),mr=s(Jn," head on top."),Jn.forEach(o),gr=h(R),bt=d(R,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),vt=d(Kn,"A",{href:!0,rel:!0});var qi=i(vt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),qi.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(R),kt=d(R,"P",{});var Zn=i(kt);vr=s(Zn,"This model inherits from "),ao=d(Zn,"A",{href:!0});var Fi=i(ao);kr=s(Fi,"PreTrainedModel"),Fi.forEach(o),yr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oa.forEach(o),Qr=h(J),B=d(J,"DIV",{class:!0});var Ue=i(B);k(Ct.$$.fragment,Ue),Xr=h(Ue),ie=d(Ue,"P",{});var mo=i(ie);ed=s(mo,"The "),io=d(mo,"A",{href:!0});var Ii=i(io);td=s(Ii,"LongT5EncoderModel"),Ii.forEach(o),od=s(mo," forward method, overrides the "),Zo=d(mo,"CODE",{});var Di=i(Zo);nd=s(Di,"__call__"),Di.forEach(o),ad=s(mo," special method."),mo.forEach(o),sd=h(Ue),k(xe.$$.fragment,Ue),rd=h(Ue),k(Le.$$.fragment,Ue),Ue.forEach(o),J.forEach(o),Pn=h(t),le=d(t,"H2",{class:!0});var na=i(le);ze=d(na,"A",{id:!0,class:!0,href:!0});var Wi=i(ze);Qo=d(Wi,"SPAN",{});var Bi=i(Qo);k(Et.$$.fragment,Bi),Bi.forEach(o),Wi.forEach(o),dd=h(na),Xo=d(na,"SPAN",{});var Ui=i(Xo);id=s(Ui,"FlaxLongT5Model"),Ui.forEach(o),na.forEach(o),Gn=h(t),A=d(t,"DIV",{class:!0});var He=i(A);k(Ot.$$.fragment,He),ld=h(He),U=d(He,"DIV",{class:!0});var Ve=i(U);k(Pt.$$.fragment,Ve),cd=h(Ve),ce=d(Ve,"P",{});var go=i(ce);pd=s(go,"The "),en=d(go,"CODE",{});var Hi=i(en);ud=s(Hi,"FlaxLongT5PreTrainedModel"),Hi.forEach(o),hd=s(go," forward method, overrides the "),tn=d(go,"CODE",{});var Vi=i(tn);md=s(Vi,"__call__"),Vi.forEach(o),gd=s(go," special method."),go.forEach(o),fd=h(Ve),k(qe.$$.fragment,Ve),_d=h(Ve),k(Fe.$$.fragment,Ve),Ve.forEach(o),Td=h(He),je=d(He,"DIV",{class:!0});var aa=i(je);k(Gt.$$.fragment,aa),bd=h(aa),k(Me.$$.fragment,aa),aa.forEach(o),vd=h(He),Ce=d(He,"DIV",{class:!0});var sa=i(Ce);k(St.$$.fragment,sa),kd=h(sa),k(Ee.$$.fragment,sa),sa.forEach(o),He.forEach(o),Sn=h(t),pe=d(t,"H2",{class:!0});var ra=i(pe);Oe=d(ra,"A",{id:!0,class:!0,href:!0});var Yi=i(Oe);on=d(Yi,"SPAN",{});var Ri=i(on);k(At.$$.fragment,Ri),Ri.forEach(o),Yi.forEach(o),yd=h(ra),nn=d(ra,"SPAN",{});var Ji=i(nn);wd=s(Ji,"FlaxLongT5ForConditionalGeneration"),Ji.forEach(o),ra.forEach(o),An=h(t),N=d(t,"DIV",{class:!0});var Ye=i(N);k(Nt.$$.fragment,Ye),$d=h(Ye),H=d(Ye,"DIV",{class:!0});var Re=i(H);k(It.$$.fragment,Re),xd=h(Re),ue=d(Re,"P",{});var fo=i(ue);Ld=s(fo,"The "),an=d(fo,"CODE",{});var Ki=i(an);zd=s(Ki,"FlaxLongT5PreTrainedModel"),Ki.forEach(o),qd=s(fo," forward method, overrides the "),sn=d(fo,"CODE",{});var Zi=i(sn);Fd=s(Zi,"__call__"),Zi.forEach(o),jd=s(fo," special method."),fo.forEach(o),Md=h(Re),k(Pe.$$.fragment,Re),Cd=h(Re),k(Ge.$$.fragment,Re),Re.forEach(o),Ed=h(Ye),Se=d(Ye,"DIV",{class:!0});var da=i(Se);k(Dt.$$.fragment,da),Od=h(da),k(Ae.$$.fragment,da),da.forEach(o),Pd=h(Ye),Ne=d(Ye,"DIV",{class:!0});var ia=i(Ne);k(Wt.$$.fragment,ia),Gd=h(ia),k(Ie.$$.fragment,ia),ia.forEach(o),Ye.forEach(o),this.h()},h(){g(l,"name","hf:doc:metadata"),g(l,"content",JSON.stringify(Tl)),g(p,"id","longt5"),g(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(p,"href","#longt5"),g(m,"class","relative group"),g(ge,"id","overview"),g(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ge,"href","#overview"),g(ee,"class","relative group"),g(Ze,"href","https://arxiv.org/abs/2112.07916"),g(Ze,"rel","nofollow"),g(Jt,"href","/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(Kt,"href","/docs/transformers/pr_18633/en/model_doc/t5#transformers.T5ForConditionalGeneration"),g(Zt,"href","/docs/transformers/pr_18633/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),g(tt,"href","https://huggingface.co/datasets/scientific_papers"),g(tt,"rel","nofollow"),g(nt,"href","https://huggingface.co/stancld"),g(nt,"rel","nofollow"),g(at,"href","https://github.com/google-research/longt5"),g(at,"rel","nofollow"),g(_e,"id","transformers.LongT5Config"),g(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(_e,"href","#transformers.LongT5Config"),g(te,"class","relative group"),g(Qt,"href","/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5Model"),g(Xt,"href","/docs/transformers/pr_18633/en/model_doc/longt5#transformers.FlaxLongT5Model"),g(dt,"href","https://huggingface.co/google/long-t5-local-base"),g(dt,"rel","nofollow"),g(eo,"href","/docs/transformers/pr_18633/en/main_classes/configuration#transformers.PretrainedConfig"),g(to,"href","/docs/transformers/pr_18633/en/main_classes/configuration#transformers.PretrainedConfig"),g(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Te,"id","transformers.LongT5Model"),g(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Te,"href","#transformers.LongT5Model"),g(ne,"class","relative group"),g(pt,"href","https://arxiv.org/abs/2112.07916"),g(pt,"rel","nofollow"),g(oo,"href","/docs/transformers/pr_18633/en/main_classes/model#transformers.PreTrainedModel"),g(mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(mt,"rel","nofollow"),g(no,"href","/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5Model"),g(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ke,"id","transformers.LongT5ForConditionalGeneration"),g(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ke,"href","#transformers.LongT5ForConditionalGeneration"),g(se,"class","relative group"),g(vt,"href","https://arxiv.org/abs/2112.07916"),g(vt,"rel","nofollow"),g(ao,"href","/docs/transformers/pr_18633/en/main_classes/model#transformers.PreTrainedModel"),g(wt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(wt,"rel","nofollow"),g(so,"href","/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g($e,"id","transformers.LongT5EncoderModel"),g($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g($e,"href","#transformers.LongT5EncoderModel"),g(de,"class","relative group"),g(qt,"href","https://arxiv.org/abs/2112.07916"),g(qt,"rel","nofollow"),g(ro,"href","/docs/transformers/pr_18633/en/main_classes/model#transformers.PreTrainedModel"),g(Mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(Mt,"rel","nofollow"),g(io,"href","/docs/transformers/pr_18633/en/model_doc/longt5#transformers.LongT5EncoderModel"),g(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ze,"id","transformers.FlaxLongT5Model"),g(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ze,"href","#transformers.FlaxLongT5Model"),g(le,"class","relative group"),g(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Oe,"id","transformers.FlaxLongT5ForConditionalGeneration"),g(Oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Oe,"href","#transformers.FlaxLongT5ForConditionalGeneration"),g(pe,"class","relative group"),g(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,f){e(document.head,l),T(t,b,f),T(t,m,f),e(m,p),e(p,_),y(n,_,null),e(m,c),e(m,z),e(z,la),T(t,bn,f),T(t,ee,f),e(ee,ge),e(ge,_o),y(Ke,_o,null),e(ee,ca),e(ee,To),e(To,pa),T(t,vn,f),T(t,fe,f),e(fe,ua),e(fe,Ze),e(Ze,ha),e(fe,ma),T(t,kn,f),T(t,Vt,f),e(Vt,ga),T(t,yn,f),T(t,Yt,f),e(Yt,bo),e(bo,fa),T(t,wn,f),T(t,Rt,f),e(Rt,_a),T(t,$n,f),T(t,E,f),e(E,O),e(O,Jt),e(Jt,Ta),e(O,ba),e(O,Kt),e(Kt,va),e(O,ka),e(O,vo),e(vo,ya),e(O,wa),e(O,ko),e(ko,$a),e(O,xa),e(O,yo),e(yo,La),e(O,za),e(O,wo),e(wo,qa),e(O,Fa),e(E,ja),e(E,Qe),e(Qe,Ma),e(Qe,Zt),e(Zt,Ca),e(Qe,Ea),e(E,Oa),e(E,Xe),e(Xe,Pa),e(Xe,$o),e($o,Ga),e(Xe,Sa),e(E,Aa),e(E,F),e(F,Na),e(F,xo),e(xo,Ia),e(F,Da),e(F,Lo),e(Lo,Wa),e(F,Ba),e(F,zo),e(zo,Ua),e(F,Ha),e(F,qo),e(qo,Va),e(F,Ya),e(F,Fo),e(Fo,Ra),e(F,Ja),e(F,jo),e(jo,Ka),e(F,Za),e(E,Qa),e(E,q),e(q,Mo),e(Mo,Xa),e(q,es),e(q,Co),e(Co,ts),e(q,os),e(q,Eo),e(Eo,ns),e(q,as),e(q,Oo),e(Oo,ss),e(q,rs),e(q,Po),e(Po,ds),e(q,is),e(q,Go),e(Go,ls),e(q,cs),e(q,So),e(So,ps),e(q,us),e(E,hs),e(E,et),e(et,ms),e(et,tt),e(tt,gs),e(et,fs),T(t,xn,f),y(ot,t,f),T(t,Ln,f),T(t,Q,f),e(Q,_s),e(Q,nt),e(nt,Ts),e(Q,bs),e(Q,at),e(at,vs),e(Q,ks),T(t,zn,f),T(t,te,f),e(te,_e),e(_e,Ao),y(st,Ao,null),e(te,ys),e(te,No),e(No,ws),T(t,qn,f),T(t,K,f),y(rt,K,null),e(K,$s),e(K,Z),e(Z,xs),e(Z,Qt),e(Qt,Ls),e(Z,zs),e(Z,Xt),e(Xt,qs),e(Z,Fs),e(Z,dt),e(dt,js),e(Z,Ms),e(K,Cs),e(K,oe),e(oe,Es),e(oe,eo),e(eo,Os),e(oe,Ps),e(oe,to),e(to,Gs),e(oe,Ss),T(t,Fn,f),T(t,ne,f),e(ne,Te),e(Te,Io),y(it,Io,null),e(ne,As),e(ne,Do),e(Do,Ns),T(t,jn,f),T(t,j,f),y(lt,j,null),e(j,Is),e(j,Wo),e(Wo,Ds),e(j,Ws),e(j,ct),e(ct,Bs),e(ct,pt),e(pt,Us),e(ct,Hs),e(j,Vs),e(j,ut),e(ut,Ys),e(ut,oo),e(oo,Rs),e(ut,Js),e(j,Ks),e(j,ht),e(ht,Zs),e(ht,mt),e(mt,Qs),e(ht,Xs),e(j,er),e(j,D),y(gt,D,null),e(D,tr),e(D,ae),e(ae,or),e(ae,no),e(no,nr),e(ae,ar),e(ae,Bo),e(Bo,sr),e(ae,rr),e(D,dr),y(be,D,null),e(D,ir),y(ve,D,null),T(t,Mn,f),T(t,se,f),e(se,ke),e(ke,Uo),y(ft,Uo,null),e(se,lr),e(se,Ho),e(Ho,cr),T(t,Cn,f),T(t,M,f),y(_t,M,null),e(M,pr),e(M,Tt),e(Tt,ur),e(Tt,Vo),e(Vo,hr),e(Tt,mr),e(M,gr),e(M,bt),e(bt,fr),e(bt,vt),e(vt,_r),e(bt,Tr),e(M,br),e(M,kt),e(kt,vr),e(kt,ao),e(ao,kr),e(kt,yr),e(M,wr),e(M,yt),e(yt,$r),e(yt,wt),e(wt,xr),e(yt,Lr),e(M,zr),e(M,W),y($t,W,null),e(W,qr),e(W,re),e(re,Fr),e(re,so),e(so,jr),e(re,Mr),e(re,Yo),e(Yo,Cr),e(re,Er),e(W,Or),y(ye,W,null),e(W,Pr),y(we,W,null),T(t,En,f),T(t,de,f),e(de,$e),e($e,Ro),y(xt,Ro,null),e(de,Gr),e(de,Jo),e(Jo,Sr),T(t,On,f),T(t,C,f),y(Lt,C,null),e(C,Ar),e(C,Ko),e(Ko,Nr),e(C,Ir),e(C,zt),e(zt,Dr),e(zt,qt),e(qt,Wr),e(zt,Br),e(C,Ur),e(C,Ft),e(Ft,Hr),e(Ft,ro),e(ro,Vr),e(Ft,Yr),e(C,Rr),e(C,jt),e(jt,Jr),e(jt,Mt),e(Mt,Kr),e(jt,Zr),e(C,Qr),e(C,B),y(Ct,B,null),e(B,Xr),e(B,ie),e(ie,ed),e(ie,io),e(io,td),e(ie,od),e(ie,Zo),e(Zo,nd),e(ie,ad),e(B,sd),y(xe,B,null),e(B,rd),y(Le,B,null),T(t,Pn,f),T(t,le,f),e(le,ze),e(ze,Qo),y(Et,Qo,null),e(le,dd),e(le,Xo),e(Xo,id),T(t,Gn,f),T(t,A,f),y(Ot,A,null),e(A,ld),e(A,U),y(Pt,U,null),e(U,cd),e(U,ce),e(ce,pd),e(ce,en),e(en,ud),e(ce,hd),e(ce,tn),e(tn,md),e(ce,gd),e(U,fd),y(qe,U,null),e(U,_d),y(Fe,U,null),e(A,Td),e(A,je),y(Gt,je,null),e(je,bd),y(Me,je,null),e(A,vd),e(A,Ce),y(St,Ce,null),e(Ce,kd),y(Ee,Ce,null),T(t,Sn,f),T(t,pe,f),e(pe,Oe),e(Oe,on),y(At,on,null),e(pe,yd),e(pe,nn),e(nn,wd),T(t,An,f),T(t,N,f),y(Nt,N,null),e(N,$d),e(N,H),y(It,H,null),e(H,xd),e(H,ue),e(ue,Ld),e(ue,an),e(an,zd),e(ue,qd),e(ue,sn),e(sn,Fd),e(ue,jd),e(H,Md),y(Pe,H,null),e(H,Cd),y(Ge,H,null),e(N,Ed),e(N,Se),y(Dt,Se,null),e(Se,Od),y(Ae,Se,null),e(N,Pd),e(N,Ne),y(Wt,Ne,null),e(Ne,Gd),y(Ie,Ne,null),Nn=!0},p(t,[f]){const Bt={};f&2&&(Bt.$$scope={dirty:f,ctx:t}),be.$set(Bt);const rn={};f&2&&(rn.$$scope={dirty:f,ctx:t}),ve.$set(rn);const dn={};f&2&&(dn.$$scope={dirty:f,ctx:t}),ye.$set(dn);const ln={};f&2&&(ln.$$scope={dirty:f,ctx:t}),we.$set(ln);const Ut={};f&2&&(Ut.$$scope={dirty:f,ctx:t}),xe.$set(Ut);const cn={};f&2&&(cn.$$scope={dirty:f,ctx:t}),Le.$set(cn);const pn={};f&2&&(pn.$$scope={dirty:f,ctx:t}),qe.$set(pn);const un={};f&2&&(un.$$scope={dirty:f,ctx:t}),Fe.$set(un);const Ht={};f&2&&(Ht.$$scope={dirty:f,ctx:t}),Me.$set(Ht);const hn={};f&2&&(hn.$$scope={dirty:f,ctx:t}),Ee.$set(hn);const mn={};f&2&&(mn.$$scope={dirty:f,ctx:t}),Pe.$set(mn);const gn={};f&2&&(gn.$$scope={dirty:f,ctx:t}),Ge.$set(gn);const fn={};f&2&&(fn.$$scope={dirty:f,ctx:t}),Ae.$set(fn);const _n={};f&2&&(_n.$$scope={dirty:f,ctx:t}),Ie.$set(_n)},i(t){Nn||(w(n.$$.fragment,t),w(Ke.$$.fragment,t),w(ot.$$.fragment,t),w(st.$$.fragment,t),w(rt.$$.fragment,t),w(it.$$.fragment,t),w(lt.$$.fragment,t),w(gt.$$.fragment,t),w(be.$$.fragment,t),w(ve.$$.fragment,t),w(ft.$$.fragment,t),w(_t.$$.fragment,t),w($t.$$.fragment,t),w(ye.$$.fragment,t),w(we.$$.fragment,t),w(xt.$$.fragment,t),w(Lt.$$.fragment,t),w(Ct.$$.fragment,t),w(xe.$$.fragment,t),w(Le.$$.fragment,t),w(Et.$$.fragment,t),w(Ot.$$.fragment,t),w(Pt.$$.fragment,t),w(qe.$$.fragment,t),w(Fe.$$.fragment,t),w(Gt.$$.fragment,t),w(Me.$$.fragment,t),w(St.$$.fragment,t),w(Ee.$$.fragment,t),w(At.$$.fragment,t),w(Nt.$$.fragment,t),w(It.$$.fragment,t),w(Pe.$$.fragment,t),w(Ge.$$.fragment,t),w(Dt.$$.fragment,t),w(Ae.$$.fragment,t),w(Wt.$$.fragment,t),w(Ie.$$.fragment,t),Nn=!0)},o(t){$(n.$$.fragment,t),$(Ke.$$.fragment,t),$(ot.$$.fragment,t),$(st.$$.fragment,t),$(rt.$$.fragment,t),$(it.$$.fragment,t),$(lt.$$.fragment,t),$(gt.$$.fragment,t),$(be.$$.fragment,t),$(ve.$$.fragment,t),$(ft.$$.fragment,t),$(_t.$$.fragment,t),$($t.$$.fragment,t),$(ye.$$.fragment,t),$(we.$$.fragment,t),$(xt.$$.fragment,t),$(Lt.$$.fragment,t),$(Ct.$$.fragment,t),$(xe.$$.fragment,t),$(Le.$$.fragment,t),$(Et.$$.fragment,t),$(Ot.$$.fragment,t),$(Pt.$$.fragment,t),$(qe.$$.fragment,t),$(Fe.$$.fragment,t),$(Gt.$$.fragment,t),$(Me.$$.fragment,t),$(St.$$.fragment,t),$(Ee.$$.fragment,t),$(At.$$.fragment,t),$(Nt.$$.fragment,t),$(It.$$.fragment,t),$(Pe.$$.fragment,t),$(Ge.$$.fragment,t),$(Dt.$$.fragment,t),$(Ae.$$.fragment,t),$(Wt.$$.fragment,t),$(Ie.$$.fragment,t),Nn=!1},d(t){o(l),t&&o(b),t&&o(m),x(n),t&&o(bn),t&&o(ee),x(Ke),t&&o(vn),t&&o(fe),t&&o(kn),t&&o(Vt),t&&o(yn),t&&o(Yt),t&&o(wn),t&&o(Rt),t&&o($n),t&&o(E),t&&o(xn),x(ot,t),t&&o(Ln),t&&o(Q),t&&o(zn),t&&o(te),x(st),t&&o(qn),t&&o(K),x(rt),t&&o(Fn),t&&o(ne),x(it),t&&o(jn),t&&o(j),x(lt),x(gt),x(be),x(ve),t&&o(Mn),t&&o(se),x(ft),t&&o(Cn),t&&o(M),x(_t),x($t),x(ye),x(we),t&&o(En),t&&o(de),x(xt),t&&o(On),t&&o(C),x(Lt),x(Ct),x(xe),x(Le),t&&o(Pn),t&&o(le),x(Et),t&&o(Gn),t&&o(A),x(Ot),x(Pt),x(qe),x(Fe),x(Gt),x(Me),x(St),x(Ee),t&&o(Sn),t&&o(pe),x(At),t&&o(An),t&&o(N),x(Nt),x(It),x(Pe),x(Ge),x(Dt),x(Ae),x(Wt),x(Ie)}}}const Tl={local:"longt5",sections:[{local:"overview",title:"Overview"},{local:"transformers.LongT5Config",title:"LongT5Config"},{local:"transformers.LongT5Model",title:"LongT5Model"},{local:"transformers.LongT5ForConditionalGeneration",title:"LongT5ForConditionalGeneration"},{local:"transformers.LongT5EncoderModel",title:"LongT5EncoderModel"},{local:"transformers.FlaxLongT5Model",title:"FlaxLongT5Model"},{local:"transformers.FlaxLongT5ForConditionalGeneration",title:"FlaxLongT5ForConditionalGeneration"}],title:"LongT5"};function bl(L){return ol(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ll extends Qi{constructor(l){super();Xi(this,l,bl,_l,el,{})}}export{Ll as default,Tl as metadata};
