...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L742",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L909",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L1064",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L1180",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L1279",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L1377",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/roberta/modeling_roberta.py#L1482",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18020/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
not make use of token type ids, therefore a list of zeros is returned.`),Zh.forEach(t),kl.forEach(t),sg=p(et),Fl=s(et,"DIV",{class:!0});var em=a(Fl);y(ta.$$.fragment,em),em.forEach(t),et.forEach(t),sm=p(o),co=s(o,"H2",{class:!0});var Um=a(co);an=s(Um,"A",{id:!0,class:!0,href:!0});var l$=a(an);lc=s(l$,"SPAN",{});var d$=a(lc);y(oa.$$.fragment,d$),d$.forEach(t),l$.forEach(t),ag=p(Um),dc=s(Um,"SPAN",{});var c$=a(dc);rg=i(c$,"XLMRobertaTokenizerFast"),c$.forEach(t),Um.forEach(t),am=p(o),at=s(o,"DIV",{class:!0});var Gt=a(at);y(na.$$.fragment,Gt),ig=p(Gt),yt=s(Gt,"P",{});var Yt=a(yt);lg=i(Yt,"Construct a \u201Cfast\u201D XLM-RoBERTa tokenizer (backed by HuggingFace\u2019s "),cc=s(Yt,"EM",{});var p$=a(cc);dg=i(p$,"tokenizers"),p$.forEach(t),cg=i(Yt,` library). Adapted from
`),xl=s(Yt,"A",{href:!0});var h$=a(xl);pg=i(h$,"RobertaTokenizer"),h$.forEach(t),hg=i(Yt," and "),Rl=s(Yt,"A",{href:!0});var m$=a(Rl);mg=i(m$,"XLNetTokenizer"),m$.forEach(t),ug=i(Yt,`. Based on
`),sa=s(Yt,"A",{href:!0,rel:!0});var u$=a(sa);fg=i(u$,"BPE"),u$.forEach(t),gg=i(Yt,"."),Yt.forEach(t),_g=p(Gt),aa=s(Gt,"P",{});var Qm=a(aa);bg=i(Qm,"This tokenizer inherits from "),Ll=s(Qm,"A",{href:!0});var f$=a(Ll);kg=i(f$,"PreTrainedTokenizerFast"),f$.forEach(t),vg=i(Qm,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Qm.forEach(t),Tg=p(Gt),Kt=s(Gt,"DIV",{class:!0});var Ed=a(Kt);y(ra.$$.fragment,Ed),yg=p(Ed),pc=s(Ed,"P",{});var g$=a(pc);wg=i(g$,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),g$.forEach(t),$g=p(Ed),ia=s(Ed,"UL",{});var Hm=a(ia);El=s(Hm,"LI",{});var r$=a(El);Mg=i(r$,"single sequence: "),hc=s(r$,"CODE",{});var _$=a(hc);Fg=i(_$,"<s> X </s>"),_$.forEach(t),r$.forEach(t),xg=p(Hm),zl=s(Hm,"LI",{});var i$=a(zl);Rg=i(i$,"pair of sequences: "),mc=s(i$,"CODE",{});var b$=a(mc);Lg=i(b$,"<s> A </s></s> B </s>"),b$.forEach(t),i$.forEach(t),Hm.forEach(t),Ed.forEach(t),Eg=p(Gt),rn=s(Gt,"DIV",{class:!0});var Vm=a(rn);y(la.$$.fragment,Vm),zg=p(Vm),uc=s(Vm,"P",{});var k$=a(uc);qg=i(k$,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),k$.forEach(t),Vm.forEach(t),Gt.forEach(t),rm=p(o),po=s(o,"H2",{class:!0});var Jm=a(po);ln=s(Jm,"A",{id:!0,class:!0,href:!0});var v$=a(ln);fc=s(v$,"SPAN",{});var T$=a(fc);y(da.$$.fragment,T$),T$.forEach(t),v$.forEach(t),Cg=p(Jm),gc=s(Jm,"SPAN",{});var y$=a(gc);jg=i(y$,"XLMRobertaModel"),y$.forEach(t),Jm.forEach(t),im=p(o),He=s(o,"DIV",{class:!0});var jt=a(He);y(ca.$$.fragment,jt),Xg=p(jt),_c=s(jt,"P",{});var w$=a(_c);Pg=i(w$,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),w$.forEach(t),Ag=p(jt),pa=s(jt,"P",{});var Km=a(pa);Og=i(Km,"This model inherits from "),ql=s(Km,"A",{href:!0});var $$=a(ql);Ng=i($$,"PreTrainedModel"),$$.forEach(t),Ig=i(Km,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Km.forEach(t),Dg=p(jt),ha=s(jt,"P",{});var Gm=a(ha);Sg=i(Gm,"This model is also a PyTorch "),ma=s(Gm,"A",{href:!0,rel:!0});var M$=a(ma);Wg=i(M$,"torch.nn.Module"),M$.forEach(t),Bg=i(Gm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gm.forEach(t),Ug=p(jt),ua=s(jt,"P",{});var Ym=a(ua);Qg=i(Ym,"This class overrides "),Cl=s(Ym,"A",{href:!0});var F$=a(Cl);Hg=i(F$,"RobertaModel"),F$.forEach(t),Vg=i(Ym,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Ym.forEach(t),Jg=p(jt),wt=s(jt,"DIV",{class:!0});var xs=a(wt);y(fa.$$.fragment,xs),Kg=p(xs),ho=s(xs,"P",{});var zd=a(ho);Gg=i(zd,"The "),jl=s(zd,"A",{href:!0});var x$=a(jl);Yg=i(x$,"RobertaModel"),x$.forEach(t),Zg=i(zd," forward method, overrides the "),bc=s(zd,"CODE",{});var R$=a(bc);e_=i(R$,"__call__"),R$.forEach(t),t_=i(zd," special method."),zd.forEach(t),o_=p(xs),y(dn.$$.fragment,xs),n_=p(xs),y(cn.$$.fragment,xs),xs.forEach(t),jt.forEach(t),lm=p(o),mo=s(o,"H2",{class:!0});var Zm=a(mo);pn=s(Zm,"A",{id:!0,class:!0,href:!0});var L$=a(pn);kc=s(L$,"SPAN",{});var E$=a(kc);y(ga.$$.fragment,E$),E$.forEach(t),L$.forEach(t),s_=p(Zm),vc=s(Zm,"SPAN",{});var z$=a(vc);a_=i(z$,"XLMRobertaForCausalLM"),z$.forEach(t),Zm.forEach(t),dm=p(o),Ve=s(o,"DIV",{class:!0});var Xt=a(Ve);y(_a.$$.fragment,Xt),r_=p(Xt),ba=s(Xt,"P",{});var eu=a(ba);i_=i(eu,"XLM-RoBERTa Model with a "),Tc=s(eu,"CODE",{});var q$=a(Tc);l_=i(q$,"language modeling"),q$.forEach(t),d_=i(eu," head on top for CLM fine-tuning."),eu.forEach(t),c_=p(Xt),ka=s(Xt,"P",{});var tu=a(ka);p_=i(tu,"This model inherits from "),Xl=s(tu,"A",{href:!0});var C$=a(Xl);h_=i(C$,"PreTrainedModel"),C$.forEach(t),m_=i(tu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tu.forEach(t),u_=p(Xt),va=s(Xt,"P",{});var ou=a(va);f_=i(ou,"This model is also a PyTorch "),Ta=s(ou,"A",{href:!0,rel:!0});var j$=a(Ta);g_=i(j$,"torch.nn.Module"),j$.forEach(t),__=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),b_=p(Xt),ya=s(Xt,"P",{});var nu=a(ya);k_=i(nu,"This class overrides "),Pl=s(nu,"A",{href:!0});var X$=a(Pl);v_=i(X$,"RobertaForCausalLM"),X$.forEach(t),T_=i(nu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),nu.forEach(t),y_=p(Xt),$t=s(Xt,"DIV",{class:!0});var Rs=a($t);y(wa.$$.fragment,Rs),w_=p(Rs),uo=s(Rs,"P",{});var qd=a(uo);$_=i(qd,"The "),Al=s(qd,"A",{href:!0});var P$=a(Al);M_=i(P$,"RobertaForCausalLM"),P$.forEach(t),F_=i(qd," forward method, overrides the "),yc=s(qd,"CODE",{});var A$=a(yc);x_=i(A$,"__call__"),A$.forEach(t),R_=i(qd," special method."),qd.forEach(t),L_=p(Rs),y(hn.$$.fragment,Rs),E_=p(Rs),y(mn.$$.fragment,Rs),Rs.forEach(t),Xt.forEach(t),cm=p(o),fo=s(o,"H2",{class:!0});var su=a(fo);un=s(su,"A",{id:!0,class:!0,href:!0});var O$=a(un);wc=s(O$,"SPAN",{});var N$=a(wc);y($a.$$.fragment,N$),N$.forEach(t),O$.forEach(t),z_=p(su),$c=s(su,"SPAN",{});var I$=a($c);q_=i(I$,"XLMRobertaForMaskedLM"),I$.forEach(t),su.forEach(t),pm=p(o),Je=s(o,"DIV",{class:!0});var Pt=a(Je);y(Ma.$$.fragment,Pt),C_=p(Pt),Fa=s(Pt,"P",{});var au=a(Fa);j_=i(au,"XLM-RoBERTa Model with a "),Mc=s(au,"CODE",{});var D$=a(Mc);X_=i(D$,"language modeling"),D$.forEach(t),P_=i(au," head on top."),au.forEach(t),A_=p(Pt),xa=s(Pt,"P",{});var ru=a(xa);O_=i(ru,"This model inherits from "),Ol=s(ru,"A",{href:!0});var S$=a(Ol);N_=i(S$,"PreTrainedModel"),S$.forEach(t),I_=i(ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ru.forEach(t),D_=p(Pt),Ra=s(Pt,"P",{});var iu=a(Ra);S_=i(iu,"This model is also a PyTorch "),La=s(iu,"A",{href:!0,rel:!0});var W$=a(La);W_=i(W$,"torch.nn.Module"),W$.forEach(t),B_=i(iu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),iu.forEach(t),U_=p(Pt),Ea=s(Pt,"P",{});var lu=a(Ea);Q_=i(lu,"This class overrides "),Nl=s(lu,"A",{href:!0});var B$=a(Nl);H_=i(B$,"RobertaForMaskedLM"),B$.forEach(t),V_=i(lu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),lu.forEach(t),J_=p(Pt),rt=s(Pt,"DIV",{class:!0});var Zt=a(rt);y(za.$$.fragment,Zt),K_=p(Zt),go=s(Zt,"P",{});var Cd=a(go);G_=i(Cd,"The "),Il=s(Cd,"A",{href:!0});var U$=a(Il);Y_=i(U$,"RobertaForMaskedLM"),U$.forEach(t),Z_=i(Cd," forward method, overrides the "),Fc=s(Cd,"CODE",{});var Q$=a(Fc);eb=i(Q$,"__call__"),Q$.forEach(t),tb=i(Cd," special method."),Cd.forEach(t),ob=p(Zt),y(fn.$$.fragment,Zt),nb=p(Zt),y(gn.$$.fragment,Zt),sb=p(Zt),y(_n.$$.fragment,Zt),Zt.forEach(t),Pt.forEach(t),hm=p(o),_o=s(o,"H2",{class:!0});var du=a(_o);bn=s(du,"A",{id:!0,class:!0,href:!0});var H$=a(bn);xc=s(H$,"SPAN",{});var V$=a(xc);y(qa.$$.fragment,V$),V$.forEach(t),H$.forEach(t),ab=p(du),Rc=s(du,"SPAN",{});var J$=a(Rc);rb=i(J$,"XLMRobertaForSequenceClassification"),J$.forEach(t),du.forEach(t),mm=p(o),Ke=s(o,"DIV",{class:!0});var At=a(Ke);y(Ca.$$.fragment,At),ib=p(At),Lc=s(At,"P",{});var K$=a(Lc);lb=i(K$,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),K$.forEach(t),db=p(At),ja=s(At,"P",{});var cu=a(ja);cb=i(cu,"This model inherits from "),Dl=s(cu,"A",{href:!0});var G$=a(Dl);pb=i(G$,"PreTrainedModel"),G$.forEach(t),hb=i(cu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cu.forEach(t),mb=p(At),Xa=s(At,"P",{});var pu=a(Xa);ub=i(pu,"This model is also a PyTorch "),Pa=s(pu,"A",{href:!0,rel:!0});var Y$=a(Pa);fb=i(Y$,"torch.nn.Module"),Y$.forEach(t),gb=i(pu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),_b=p(At),Aa=s(At,"P",{});var hu=a(Aa);bb=i(hu,"This class overrides "),Sl=s(hu,"A",{href:!0});var Z$=a(Sl);kb=i(Z$,"RobertaForSequenceClassification"),Z$.forEach(t),vb=i(hu,`. Please check the superclass for the appropriate
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y0=p(nt),sh=s(nt,"P",{});var eR=a(sh);Z0=i(eR,"Finally, this model supports inherent JAX features such as:"),eR.forEach(t),e2=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var tR=a(ah);Wi=s(tR,"A",{href:!0,rel:!0});var oR=a(Wi);t2=i(oR,"Just-In-Time (JIT) compilation"),oR.forEach(t),tR.forEach(t),o2=p(Is),rh=s(Is,"LI",{});var nR=a(rh);Bi=s(nR,"A",{href:!0,rel:!0});var sR=a(Bi);n2=i(sR,"Automatic Differentiation"),sR.forEach(t),nR.forEach(t),s2=p(Is),ih=s(Is,"LI",{});var aR=a(ih);Ui=s(aR,"A",{href:!0,rel:!0});var rR=a(Ui);a2=i(rR,"Vectorization"),rR.forEach(t),aR.forEach(t),r2=p(Is),lh=s(Is,"LI",{});var iR=a(lh);Qi=s(iR,"A",{href:!0,rel:!0});var lR=a(Qi);i2=i(lR,"Parallelization"),lR.forEach(t),iR.forEach(t),Is.forEach(t),l2=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);d2=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var dR=a(Md);c2=i(dR,"FlaxRobertaForTokenClassification"),dR.forEach(t),p2=i(ff,`. Please check the superclass for the appropriate
