...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L1074",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L1559",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L1188",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L977",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L1463",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L1275",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18020/src/transformers/models/electra/modeling_electra.py#L1357",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18020/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_18020/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
softmax) e.g. for RocStories/SWAG tasks.`),$0=c(),Cl=n("p"),F0=r("This model inherits from "),cc=n("a"),x0=r("FlaxPreTrainedModel"),M0=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),z0=c(),jl=n("p"),C0=r(`This model is also a Flax Linen
`),ql=n("a"),j0=r("flax.nn.Module"),q0=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),P0=c(),dm=n("p"),A0=r("Finally, this model supports inherent JAX features such as:"),O0=c(),Zt=n("ul"),cm=n("li"),Pl=n("a"),L0=r("Just-In-Time (JIT) compilation"),N0=c(),pm=n("li"),Al=n("a"),I0=r("Automatic Differentiation"),D0=c(),hm=n("li"),Ol=n("a"),S0=r("Vectorization"),W0=c(),mm=n("li"),Ll=n("a"),U0=r("Parallelization"),R0=c(),Nt=n("div"),b(Nl.$$.fragment),H0=c(),gn=n("p"),Q0=r("The "),um=n("code"),V0=r("FlaxElectraPreTrainedModel"),B0=r(" forward method, overrides the "),fm=n("code"),K0=r("__call__"),J0=r(" special method."),G0=c(),b(ea.$$.fragment),X0=c(),b(ta.$$.fragment),Ef=c(),_n=n("h2"),oa=n("a"),gm=n("span"),b(Il.$$.fragment),Y0=c(),_m=n("span"),Z0=r("FlaxElectraForTokenClassification"),wf=c(),Ae=n("div"),b(Dl.$$.fragment),e$=c(),km=n("p"),t$=r("Electra model with a token classification head on top."),o$=c(),vm=n("p"),n$=r("Both the discriminator and generator may be loaded into this model."),s$=c(),Sl=n("p"),a$=r("This model inherits from "),pc=n("a"),r$=r("FlaxPreTrainedModel"),i$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),l$=c(),Wl=n("p"),d$=r(`This model is also a Flax Linen
`),Ul=n("a"),c$=r("flax.nn.Module"),p$=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),h$=c(),Tm=n("p"),m$=r("Finally, this model supports inherent JAX features such as:"),u$=c(),eo=n("ul"),bm=n("li"),Rl=n("a"),f$=r("Just-In-Time (JIT) compilation"),g$=c(),ym=n("li"),Hl=n("a"),_$=r("Automatic Differentiation"),k$=c(),Em=n("li"),Ql=n("a"),v$=r("Vectorization"),T$=c(),wm=n("li"),Vl=n("a"),b$=r("Parallelization"),y$=c(),It=n("div"),b(Bl.$$.fragment),E$=c(),kn=n("p"),w$=r("The "),$m=n("code"),$$=r("FlaxElectraPreTrainedModel"),F$=r(" forward method, overrides the "),Fm=n("code"),x$=r("__call__"),M$=r(" special method."),z$=c(),b(na.$$.fragment),C$=c(),b(sa.$$.fragment),$f=c(),vn=n("h2"),aa=n("a"),xm=n("span"),b(Kl.$$.fragment),j$=c(),Mm=n("span"),q$=r("FlaxElectraForQuestionAnswering"),Ff=c(),Re=n("div"),b(Jl.$$.fragment),P$=c(),Tn=n("p"),A$=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zm=n("code"),O$=r("span start logits"),L$=r(" and "),Cm=n("code"),N$=r("span end logits"),I$=r(")."),D$=c(),Gl=n("p"),S$=r("This model inherits from "),hc=n("a"),W$=r("FlaxPreTrainedModel"),U$=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),R$=c(),Xl=n("p"),H$=r(`This model is also a Flax Linen
`),Yl=n("a"),Q$=r("flax.nn.Module"),V$=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),B$=c(),jm=n("p"),K$=r("Finally, this model supports inherent JAX features such as:"),J$=c(),to=n("ul"),qm=n("li"),Zl=n("a"),G$=r("Just-In-Time (JIT) compilation"),X$=c(),Pm=n("li"),ed=n("a"),Y$=r("Automatic Differentiation"),Z$=c(),Am=n("li"),td=n("a"),eF=r("Vectorization"),tF=c(),Om=n("li"),od=n("a"),oF=r("Parallelization"),nF=c(),Dt=n("div"),b(nd.$$.fragment),sF=c(),bn=n("p"),aF=r("The "),Lm=n("code"),rF=r("FlaxElectraPreTrainedModel"),iF=r(" forward method, overrides the "),Nm=n("code"),lF=r("__call__"),dF=r(" special method."),cF=c(),b(ra.$$.fragment),pF=c(),b(ia.$$.fragment),this.h()},l(o){const v=uC('[data-svelte="svelte-1phssyn"]',document.head);d=s(v,"META",{name:!0,content:!0}),v.forEach(t),g=p(o),h=s(o,"H1",{class:!0});var sd=a(h);m=s(sd,"A",{id:!0,class:!0,href:!0});var Im=a(m);_=s(Im,"SPAN",{});var Dm=a(_);y(l.$$.fragment,Dm),Dm.forEach(t),Im.forEach(t),u=p(sd),M=s(sd,"SPAN",{});var Sm=a(M);ue=i(Sm,"ELECTRA"),Sm.forEach(t),sd.forEach(t),J=p(o),C=s(o,"H2",{class:!0});var ad=a(C);ee=s(ad,"A",{id:!0,class:!0,href:!0});var Wm=a(ee);D=s(Wm,"SPAN",{});var Um=a(D);y(oe.$$.fragment,Um),Um.forEach(t),Wm.forEach(t),fe=p(ad),S=s(ad,"SPAN",{});var Rm=a(S);ge=i(Rm,"Overview"),Rm.forEach(t),ad.forEach(t),pe=p(o),K=s(o,"P",{});var rd=a(K);O=i(rd,"The ELECTRA model was proposed in the paper "),ne=s(rd,"A",{href:!0,rel:!0});var Hm=a(ne);X=i(Hm,`ELECTRA: Pre-training Text Encoders as Discriminators Rather Than
