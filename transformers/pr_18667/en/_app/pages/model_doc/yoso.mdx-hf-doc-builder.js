import{S as Fi,i as qi,s as Ci,e as r,k as g,w,t as d,M as ji,c as i,d as t,m as _,a as l,x as $,h as c,b as f,N as zi,G as e,g as b,y as v,q as y,o as T,B as Y,v as Oi,L as S}from"../../chunks/vendor-hf-doc-builder.js";import{T as ft}from"../../chunks/Tip-hf-doc-builder.js";import{D as A}from"../../chunks/Docstring-hf-doc-builder.js";import{C as P}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as we}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ai(M){let n,u,a,p,k;return p=new P({props:{code:`from transformers import YosoModel, YosoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(n.$$.fragment)},l(a){$(n.$$.fragment,a)},m(a,p){v(n,a,p),u=!0},p:S,i(a){u||(y(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Xi(M){let n,u,a,p,k,s,h,x,Hs,is,Z,$e,gt,oo,Qs,_t,Us,ls,X,Bs,to,Vs,Rs,Gs,ds,No,Ks,cs,Io,bt,Js,ps,Do,Zs,hs,V,kt,Xs,en,ee,on,wt,tn,sn,$t,nn,an,rn,oe,ln,vt,dn,cn,yt,pn,hn,ms,ve,Cr,us,ye,mn,Wo,un,fn,fs,R,gn,so,_n,bn,no,kn,wn,gs,te,Te,Tt,ao,$n,Yt,vn,_s,O,ro,yn,se,Tn,Ho,Yn,Mn,io,xn,Fn,qn,ne,Cn,Qo,jn,zn,Uo,On,An,En,Ye,bs,ae,Me,Mt,lo,Sn,xt,Pn,ks,I,co,Ln,po,Nn,ho,In,Dn,Wn,L,mo,Hn,re,Qn,Bo,Un,Bn,Ft,Vn,Rn,Gn,xe,Kn,Fe,ws,ie,qe,qt,uo,Jn,Ct,Zn,$s,D,fo,Xn,le,ea,jt,oa,ta,go,sa,na,aa,q,_o,ra,de,ia,Vo,la,da,zt,ca,pa,ha,Ce,ma,je,ua,ze,vs,ce,Oe,Ot,bo,fa,At,ga,ys,W,ko,_a,wo,ba,$o,ka,wa,$a,F,vo,va,pe,ya,Ro,Ta,Ya,Et,Ma,xa,Fa,Ae,qa,Ee,Ca,Se,ja,Pe,za,Le,Ts,he,Ne,St,yo,Oa,Pt,Aa,Ys,H,To,Ea,Yo,Sa,Mo,Pa,La,Na,N,xo,Ia,me,Da,Go,Wa,Ha,Lt,Qa,Ua,Ba,Ie,Va,De,Ms,ue,We,Nt,Fo,Ra,It,Ga,xs,Q,qo,Ka,Co,Ja,jo,Za,Xa,er,C,zo,or,fe,tr,Ko,sr,nr,Dt,ar,rr,ir,He,lr,Qe,dr,Ue,Fs,ge,Be,Wt,Oo,cr,Ht,pr,qs,U,Ao,hr,B,mr,Qt,ur,fr,Ut,gr,_r,Eo,br,kr,wr,j,So,$r,_e,vr,Jo,yr,Tr,Bt,Yr,Mr,xr,Ve,Fr,Re,qr,Ge,Cs;return s=new we({}),oo=new we({}),ao=new we({}),ro=new A({props:{name:"class transformers.YosoConfig",anchor:"transformers.YosoConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 4096"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_expectation",val:" = True"},{name:"hash_code_len",val:" = 9"},{name:"num_hash",val:" = 64"},{name:"conv_window",val:" = None"},{name:"use_fast_hash",val:" = True"},{name:"lsh_backward",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.YosoConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
Vocabulary size of the YOSO model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18667/en/model_doc/yoso#transformers.YosoModel">YosoModel</a>.`,name:"vocab_size"},{anchor:"transformers.YosoConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Whether or not to perform backpropagation using Locality Sensitive Hashing.`,name:"lsh_backward"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/configuration_yoso.py#L29"}}),Ye=new E({props:{anchor:"transformers.YosoConfig.example",$$slots:{default:[Ai]},$$scope:{ctx:M}}}),lo=new we({}),co=new A({props:{name:"class transformers.YosoModel",anchor:"transformers.YosoModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.YosoModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18667/en/model_doc/yoso#transformers.YosoConfig">YosoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18667/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/modeling_yoso.py#L748"}}),mo=new A({props:{name:"forward",anchor:"transformers.YosoModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.YosoModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18667/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/pr_18667/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18667/en/model_doc/yoso#transformers.YosoConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/modeling_yoso.py#L876",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/modeling_yoso.py#L972",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/modeling_yoso.py#L1065",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/modeling_yoso.py#L1158",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18667/src/transformers/models/yoso/modeling_yoso.py#L1245",returnDescription:`
<p>A <a
...
does not require compiling CUDA kernels.`),ms=g(),ve=r("img"),us=g(),ye=r("small"),mn=d("YOSO Attention Algorithm. Taken from the "),Wo=r("a"),un=d("original paper"),fn=d("."),fs=g(),R=r("p"),gn=d("This model was contributed by "),so=r("a"),_n=d("novice03"),bn=d(". The original code can be found "),no=r("a"),kn=d("here"),wn=d("."),gs=g(),te=r("h2"),Te=r("a"),Tt=r("span"),w(ao.$$.fragment),$n=g(),Yt=r("span"),vn=d("YosoConfig"),_s=g(),O=r("div"),w(ro.$$.fragment),yn=g(),se=r("p"),Tn=d("This is the configuration class to store the configuration of a "),Ho=r("a"),Yn=d("YosoModel"),Mn=d(`. It is used to instantiate an YOSO
...
does not require compiling CUDA kernels.`),Zo.forEach(t),be.forEach(t),ms=_(o),ve=i(o,"IMG",{src:!0,alt:!0,width:!0}),us=_(o),ye=i(o,"SMALL",{});var js=l(ye);mn=c(js,"YOSO Attention Algorithm. Taken from the "),Wo=i(js,"A",{href:!0});var Or=l(Wo);un=c(Or,"original paper"),Or.forEach(t),fn=c(js,"."),js.forEach(t),fs=_(o),R=i(o,"P",{});var Xo=l(R);gn=c(Xo,"This model was contributed by "),so=i(Xo,"A",{href:!0,rel:!0});var Ar=l(so);_n=c(Ar,"novice03"),Ar.forEach(t),bn=c(Xo,". The original code can be found "),no=i(Xo,"A",{href:!0,rel:!0});var Er=l(no);kn=c(Er,"here"),Er.forEach(t),wn=c(Xo,"."),Xo.forEach(t),gs=_(o),te=i(o,"H2",{class:!0});var zs=l(te);Te=i(zs,"A",{id:!0,class:!0,href:!0});var Sr=l(Te);Tt=i(Sr,"SPAN",{});var Pr=l(Tt);$(ao.$$.fragment,Pr),Pr.forEach(t),Sr.forEach(t),$n=_(zs),Yt=i(zs,"SPAN",{});var Lr=l(Yt);vn=c(Lr,"YosoConfig"),Lr.forEach(t),zs.forEach(t),_s=_(o),O=i(o,"DIV",{class:!0});var Je=l(O);$(ro.$$.fragment,Je),yn=_(Je),se=i(Je,"P",{});var et=l(se);Tn=c(et,"This is the configuration class to store the configuration of a "),Ho=i(et,"A",{href:!0});var Nr=l(Ho);Yn=c(Nr,"YosoModel"),Nr.forEach(t),Mn=c(et,`. It is used to instantiate an YOSO
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the YOSO
