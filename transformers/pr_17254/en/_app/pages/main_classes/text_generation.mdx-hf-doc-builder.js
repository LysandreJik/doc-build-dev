...
should be prefixed with *decoder</em>*.`,name:"exponential_decay_length_penalty"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L867",returnDescription:`
<p>A <a
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L1564",returnDescription:`
<p><a
  href="/docs/transformers/pr_17254/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L1796",returnDescription:`
<p><a
  href="/docs/transformers/pr_17254/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L2052",returnDescription:`
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L2359",returnDescription:`
<p><a
  href="/docs/transformers/pr_17254/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L2676",returnDescription:`
<p><a
  href="/docs/transformers/pr_17254/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_utils.py#L3038",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/pr_17254/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_tf_utils.py#L375",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_17254/en/main_classes/output#transformers.utils.ModelOutput"
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If the model
is an encoder-decoder model, encoder specific kwargs should not be prefixed and decoder specific kwargs
should be prefixed with *decoder</em>*. Also accepts <code>encoder_outputs</code> to skip encoder part.`,name:"params"}],source:"https://github.com/huggingface/transformers/blob/vr_17254/src/transformers/generation_flax_utils.py#L182",returnDescription:`
<p><a
  href="/docs/transformers/pr_17254/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
