import{S as ci,i as ui,s as pi,e as s,k as h,w as y,t as i,M as hi,c as a,d as t,m as g,a as r,x as w,h as d,b as m,G as e,g as b,y as k,q as B,o as T,B as $,v as gi,L as U}from"../../chunks/vendor-hf-doc-builder.js";import{T as $n}from"../../chunks/Tip-hf-doc-builder.js";import{D}from"../../chunks/Docstring-hf-doc-builder.js";import{C as V}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ne}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as R}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function mi(P){let l,_,c,u,v;return u=new V({props:{code:`    >>> from transformers import BigBirdPegasusModel, BigBirdPegasusConfig
    ...
    >>> configuration = model.config`,highlighted:`    &gt;&gt;&gt; <span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> BigBirdPegasusModel, BigBirdPegasusConfig

    <span class="hljs-comment"># Initializing a BigBirdPegasus bigbird-pegasus-base style configuration</span>
    &gt;&gt;&gt; configuration = BigBirdPegasusConfig()

    <span class="hljs-comment"># Initializing a model from the bigbird-pegasus-base style configuration </span>
    &gt;&gt;&gt; model = BigBirdPegasusModel(configuration)

    <span class="hljs-comment"># Accessing the model configuration </span>
    &gt;&gt;&gt; configuration = model.config`}}),{c(){l=s("p"),_=i("Example:"),c=h(),y(u.$$.fragment)},l(n){l=a(n,"P",{});var p=r(l);_=d(p,"Example:"),p.forEach(t),c=g(n),w(u.$$.fragment,n)},m(n,p){b(n,l,p),e(l,_),b(n,c,p),k(u,n,p),v=!0},p:U,i(n){v||(B(u.$$.fragment,n),v=!0)},o(n){T(u.$$.fragment,n),v=!1},d(n){n&&t(l),n&&t(c),$(u,n)}}}function fi(P){let l,_,c,u,v;return{c(){l=s("p"),_=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s("code"),u=i("Module"),v=i(`
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18569/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18569/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2518",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18569/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2789",returnDescription:`
<p>A <a
