import{S as md,i as fd,s as gd,e as s,k as u,w as k,t as i,M as _d,c as n,d as o,m as h,a,x as T,h as l,b as c,G as e,g as _,y,q as w,o as $,B as V,v as vd,L as Gt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Eo}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ke}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as G}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Kt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function bd(B){let d,b,g,m,v;return m=new Ke({props:{code:`from transformers import VisualBertModel, VisualBertConfig
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){d=s("p"),b=i("Example:"),g=u(),k(m.$$.fragment)},l(r){d=n(r,"P",{});var p=a(d);b=l(p,"Example:"),p.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,p){_(r,d,p),e(d,b),_(r,g,p),y(m,r,p),v=!0},p:Gt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function Ed(B){let d,b,g,m,v,r,p,q,qn,Vs,J,me,Mo,Ge,zn,Ao,xn,Bs,fe,Fn,Je,Pn,En,qs,Jt,Mn,zs,Yt,jo,An,xs,Xt,jn,Fs,ge,Co,Ye,Cn,Zt,Ln,On,Rn,Lo,Oo,Nn,Ps,Y,_e,Ro,Xe,In,No,Dn,Es,eo,Sn,Ms,to,Wn,As,ve,Qn,oo,Hn,Un,js,be,Io,so,Ze,Kn,Gn,Jn,Do,no,et,Yn,Xn,Cs,ke,Zn,ao,ea,ta,Ls,tt,Os,D,oa,ot,sa,na,st,aa,ra,Rs,X,Te,So,nt,ia,Wo,la,Ns,A,at,da,Z,ca,ro,pa,ua,rt,ha,ma,fa,ee,ga,io,_a,va,lo,ba,ka,Ta,ye,Is,te,we,Qo,it,ya,Ho,wa,Ds,z,lt,$a,dt,Va,co,Ba,qa,za,ct,xa,pt,Fa,Pa,Ea,ut,Ma,ht,Aa,ja,Ca,C,mt,La,oe,Oa,po,Ra,Na,Uo,Ia,Da,Sa,$e,Wa,Ve,Ss,se,Be,Ko,ft,Qa,Go,Ha,Ws,x,gt,Ua,ne,Ka,Jo,Ga,Ja,Yo,Ya,Xa,Za,_t,er,uo,tr,or,sr,vt,nr,bt,ar,rr,ir,L,kt,lr,ae,dr,ho,cr,pr,Xo,ur,hr,mr,qe,fr,ze,Qs,re,xe,Zo,Tt,gr,es,_r,Hs,F,yt,vr,ts,br,kr,wt,Tr,mo,yr,wr,$r,$t,Vr,Vt,Br,qr,zr,O,Bt,xr,ie,Fr,fo,Pr,Er,os,Mr,Ar,jr,Fe,Cr,Pe,Us,le,Ee,ss,qt,Lr,ns,Or,Ks,P,zt,Rr,as,Nr,Ir,xt,Dr,go,Sr,Wr,Qr,Ft,Hr,Pt,Ur,Kr,Gr,R,Et,Jr,de,Yr,_o,Xr,Zr,rs,ei,ti,oi,Me,si,Ae,Gs,ce,je,is,Mt,ni,ls,ai,Js,E,At,ri,ds,ii,li,jt,di,vo,ci,pi,ui,Ct,hi,Lt,mi,fi,gi,N,Ot,_i,pe,vi,bo,bi,ki,cs,Ti,yi,wi,Ce,$i,Le,Ys,ue,Oe,ps,Rt,Vi,us,Bi,Xs,M,Nt,qi,hs,zi,xi,It,Fi,ko,Pi,Ei,Mi,Dt,Ai,St,ji,Ci,Li,I,Wt,Oi,he,Ri,To,Ni,Ii,ms,Di,Si,Wi,Re,Qi,Ne,Zs;return r=new G({}),Ge=new G({}),Xe=new G({}),tt=new Ke({props:{code:`import torch
from transformers import BertTokenizer, VisualBertModel
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18731/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>. Vocabulary size of the model. Defines the
different tokens that can be represented by the <code>inputs_ids</code> passed to the forward method of
<a href="/docs/transformers/pr_18731/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.VisualBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18731/en/model_doc/visual_bert#transformers.VisualBertConfig"
...
</ul>`,name:"sentence_image_labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18731/src/transformers/models/visual_bert/modeling_visual_bert.py#L889",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18731/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18731/src/transformers/models/visual_bert/modeling_visual_bert.py#L1175"}}),Bt=new j({props:{name:"forward",anchor:"transformers.VisualBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18731/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18731/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18731/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18731/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18731/src/transformers/models/visual_bert/modeling_visual_bert.py#L1022"}}),Et=new j({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18731/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18731/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18731/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18731/src/transformers/models/visual_bert/modeling_visual_bert.py#L1033",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18731/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18731/src/transformers/models/visual_bert/modeling_visual_bert.py#L1461"}}),Wt=new j({props:{name:"forward",anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"region_to_phrase_position",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18731/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18731/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18731/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
outputs from the attention layer.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18731/src/transformers/models/visual_bert/modeling_visual_bert.py#L1473",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18731/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/pr_18731/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Eo({props:{$$slots:{default:[Fd]},$$scope:{ctx:B}}}),Ne=new Kt({props:{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.example",$$slots:{default:[Pd]},$$scope:{ctx:B}}}),{c(){d=s("meta"),b=u(),g=s("h1"),m=s("a"),v=s("span"),k(r.$$.fragment),p=u(),q=s("span"),qn=i("VisualBERT"),Vs=u(),J=s("h2"),me=s("a"),Mo=s("span"),k(Ge.$$.fragment),zn=u(),Ao=s("span"),xn=i("Overview"),Bs=u(),fe=s("p"),Fn=i("The VisualBERT model was proposed in "),Je=s("a"),Pn=i("VisualBERT: A Simple and Performant Baseline for Vision and Language"),En=i(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),qs=u(),Jt=s("p"),Mn=i("The abstract from the paper is the following:"),zs=u(),Yt=s("p"),jo=s("em"),An=i(`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
...
to get the visual embeddings. The following example notebooks show how to use VisualBERT with Detectron-like models:`),js=u(),be=s("ul"),Io=s("li"),so=s("p"),Ze=s("a"),Kn=i("VisualBERT VQA demo notebook"),Gn=i(` : This notebook
contains an example on VisualBERT VQA.`),Jn=u(),Do=s("li"),no=s("p"),et=s("a"),Yn=i("Generate Embeddings for VisualBERT (Colab Notebook)"),Xn=i(` : This notebook contains
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ca=u(),C=s("div"),k(mt.$$.fragment),La=u(),oe=s("p"),Oa=i("The "),po=s("a"),Ra=i("VisualBertModel"),Na=i(" forward method, overrides the "),Uo=s("code"),Ia=i("__call__"),Da=i(" special method."),Sa=u(),k($e.$$.fragment),Wa=u(),k(Ve.$$.fragment),Ss=u(),se=s("h2"),Be=s("a"),Ko=s("span"),k(ft.$$.fragment),Qa=u(),Go=s("span"),Ha=i("VisualBertForPreTraining"),Ws=u(),x=s("div"),k(gt.$$.fragment),Ua=u(),ne=s("p"),Ka=i("VisualBert Model with two heads on top as done during the pretraining: a "),Jo=s("code"),Ga=i("masked language modeling"),Ja=i(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr=u(),R=s("div"),k(Et.$$.fragment),Jr=u(),de=s("p"),Yr=i("The "),_o=s("a"),Xr=i("VisualBertForMultipleChoice"),Zr=i(" forward method, overrides the "),rs=s("code"),ei=i("__call__"),ti=i(" special method."),oi=u(),k(Me.$$.fragment),si=u(),k(Ae.$$.fragment),Gs=u(),ce=s("h2"),je=s("a"),is=s("span"),k(Mt.$$.fragment),ni=u(),ls=s("span"),ai=i("VisualBertForVisualReasoning"),Js=u(),E=s("div"),k(At.$$.fragment),ri=u(),ds=s("p"),ii=i(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
