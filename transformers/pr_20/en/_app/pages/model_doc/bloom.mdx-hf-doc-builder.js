...
`}}),{c(){n=a("p"),g=i("Example of single-label classification:"),c=u(),v(p.$$.fragment)},l(s){n=r(s,"P",{});var m=l(n);g=d(m,"Example of single-label classification:"),m.forEach(t),c=f(s),$(p.$$.fragment,s)},m(s,m){k(s,n,m),e(n,g),k(s,c,m),y(p,s,m),b=!0},p:ee,i(s){b||(w(p.$$.fragment,s),b=!0)},o(s){T(p.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(p,s)}}}function xl(F){let n,g;return n=new oe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){v(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,p){y(n,c,p),g=!0},p:ee,i(c){g||(w(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function jl(F){let n,g,c,p,b;return p=new oe({props:{code:`import torch
from transformers import BloomTokenizerFast, BloomForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){n=a("p"),g=i("Example of multi-label classification:"),c=u(),v(p.$$.fragment)},l(s){n=r(s,"P",{});var m=l(n);g=d(m,"Example of multi-label classification:"),m.forEach(t),c=f(s),$(p.$$.fragment,s)},m(s,m){k(s,n,m),e(n,g),k(s,c,m),y(p,s,m),b=!0},p:ee,i(s){b||(w(p.$$.fragment,s),b=!0)},o(s){T(p.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(p,s)}}}function Pl(F){let n,g;return n=new oe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,p){y(n,c,p),g=!0},p:ee,i(c){g||(w(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function Ol(F){let n,g,c,p,b;return{c(){n=a("p"),g=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=i("Module"),b=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=r(s,"P",{});var m=l(n);g=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var C=l(c);p=d(C,"Module"),C.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(s,m){k(s,n,m),e(n,g),e(n,c),e(c,p),e(n,b)},d(s){s&&t(n)}}}function Sl(F){let n,g,c,p,b;return p=new oe({props:{code:`from transformers import BloomTokenizerFast, BloomForTokenClassification
import torch
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_20/en/model_doc/bloom#transformers.BloomTokenizerFast">BloomTokenizerFast</a>. See <a href="/docs/transformers/pr_20/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_20/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/bloom/modeling_bloom.py#L633",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_20/en/model_doc/bloom#transformers.BloomConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/bloom/modeling_bloom.py#L820",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/bloom/modeling_bloom.py#L960",returnDescription:`
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/bloom/modeling_bloom.py#L1097",returnDescription:`
<p>A <a
...
and behavior.`),hn=u(),U=a("div"),v(so.$$.fragment),un=u(),le=a("p"),fn=i("The "),So=a("a"),gn=i("BloomModel"),_n=i(" forward method, overrides the "),ct=a("code"),bn=i("__call__"),kn=i(" special method."),vn=u(),v(ke.$$.fragment),$n=u(),v(ve.$$.fragment),Kt=u(),ie=a("h2"),$e=a("a"),pt=a("span"),v(no.$$.fragment),yn=u(),mt=a("span"),wn=i("BloomTokenizerFast"),Qt=u(),z=a("div"),v(ao.$$.fragment),Tn=u(),ro=a("p"),Bn=i("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ht=a("em"),Fn=i("tokenizers"),Cn=i(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),Xt=u(),de=a("h2"),Te=a("a"),gt=a("span"),v(co.$$.fragment),In=u(),_t=a("span"),Dn=i("BloomForCausalLM"),Zt=u(),j=a("div"),v(po.$$.fragment),Wn=u(),bt=a("p"),Hn=i(`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xa=u(),M=a("div"),v($o.$$.fragment),ja=u(),me=a("p"),Pa=i("The "),Ho=a("a"),Oa=i("BloomForSequenceClassification"),Sa=i(" forward method, overrides the "),Ct=a("code"),Aa=i("__call__"),Na=i(" special method."),La=u(),v(ze.$$.fragment),Ia=u(),v(Ee.$$.fragment),Da=u(),v(Me.$$.fragment),Wa=u(),v(qe.$$.fragment),Ha=u(),v(xe.$$.fragment),ts=u(),he=a("h2"),je=a("a"),zt=a("span"),v(yo.$$.fragment),Ua=u(),Et=a("span"),Va=i("BloomForTokenClassification"),ss=u(),P=a("div"),v(wo.$$.fragment),Ra=u(),Mt=a("p"),Ga=i(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
