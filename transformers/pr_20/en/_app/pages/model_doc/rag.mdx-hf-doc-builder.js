...
<span class="hljs-meta">&gt;&gt;&gt; </span>retriever = RagRetriever.from_pretrained(<span class="hljs-string">&quot;facebook/dpr-ctx_encoder-single-nq-base&quot;</span>, index_name=<span class="hljs-string">&quot;legacy&quot;</span>)`}}),{c(){c=s("p"),b=o("Examples:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Examples:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function $b(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function zb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Eb(F){let c,b,m,g,f;return g=new dn({props:{code:`from transformers import RagTokenizer, RagRetriever, RagModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids=inputs[<span class="hljs-string">&quot;input_ids&quot;</span>])`}}),{c(){c=s("p"),b=o("Example:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Example:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function jb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Gb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Mb(F){let c,b,m,g,f;return g=new dn({props:{code:`from transformers import RagTokenizer, RagRetriever, RagSequenceForGeneration
import torch
...
<span class="hljs-meta">... </span>)`}}),{c(){c=s("p"),b=o("Example:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Example:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function Ab(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Pb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Nb(F){let c,b,m,g,f;return g=new dn({props:{code:`from transformers import RagTokenizer, RagRetriever, RagTokenForGeneration
import torch
...
<span class="hljs-meta">... </span>    doc_scores=doc_scores,
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_string = tokenizer.batch_decode(generated, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){c=s("p"),b=o("Example:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Example:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function Ob(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Cb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Sb(F){let c,b,m,g,f;return g=new dn({props:{code:`from transformers import RagTokenizer, RagRetriever, TFRagModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids)`}}),{c(){c=s("p"),b=o("Example:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Example:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function Lb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Db(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Ib(F){let c,b,m,g,f;return g=new dn({props:{code:`from transformers import RagTokenizer, RagRetriever, TFRagSequenceForGeneration
...
<span class="hljs-meta">... </span>    doc_scores=doc_scores,
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_string = tokenizer.batch_decode(generated, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){c=s("p"),b=o("Example:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Example:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function Wb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Hb(F){let c,b,m,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var R=d(m);g=n(R,"Module"),R.forEach(t),f=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){v(i,c,u),e(c,b),e(c,m),e(m,g),e(c,f)},d(i){i&&t(c)}}}function Bb(F){let c,b,m,g,f;return g=new dn({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">... </span>    doc_scores=doc_scores,
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_string = tokenizer.batch_decode(generated, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){c=s("p"),b=o("Example:"),m=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var u=d(c);b=n(u,"Example:"),u.forEach(t),m=h(i),w(g.$$.fragment,i)},m(i,u){v(i,c,u),e(c,b),v(i,m,u),k(g,i,u),f=!0},p:an,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(m),x(g,i)}}}function Qb(F){let c,b,m,g,f,i,u,R,Yd,La,qe,Ke,zr,Wt,Jd,Er,Xd,Da,cn,Zd,Ia,Ye,ei,Ht,ti,oi,Wa,ln,ni,Ha,pn,jr,ri,Ba,Je,si,Bt,ai,di,Qa,ye,Xe,Gr,Qt,ii,Mr,ci,Ua,ee,Ut,li,de,hn,pi,hi,Ar,ui,mi,un,gi,_i,mn,fi,vi,bi,Ze,Vt,Ti,Kt,wi,gn,ki,qi,yi,et,Yt,xi,Jt,Ri,_n,Fi,$i,Va,xe,tt,Pr,Xt,zi,Nr,Ei,Ka,Zt,eo,Ya,Re,ot,Or,to,ji,Cr,Gi,Ja,Fe,oo,Mi,Sr,Ai,Xa,no,ro,Za,$e,nt,Lr,so,Pi,Dr,Ni,ed,Z,ao,Oi,Ir,Ci,Si,rt,Li,st,io,Di,Wr,Ii,Wi,at,co,Hi,ze,Bi,Hr,Qi,Ui,Br,Vi,Ki,Yi,dt,lo,Ji,po,Xi,Qr,Zi,ec,td,Ee,it,Ur,ho,tc,Vr,oc,od,S,uo,nc,je,rc,fn,sc,ac,Kr,dc,ic,cc,ct,lc,Yr,pc,hc,te,uc,Jr,mc,gc,vn,_c,fc,Xr,vc,bc,bn,Tc,wc,kc,M,qc,Tn,yc,xc,Zr,Rc,Fc,es,$c,zc,ts,Ec,jc,os,Gc,Mc,wn,Ac,Pc,ns,Nc,Oc,kn,Cc,Sc,qn,Lc,Dc,rs,Ic,Wc,Hc,mo,Bc,yn,Qc,Uc,Vc,go,Kc,_o,Yc,Jc,Xc,ie,fo,Zc,Ge,el,xn,tl,ol,ss,nl,rl,sl,lt,al,pt,nd,Me,ht,as,vo,dl,ds,il,rd,E,bo,cl,Ae,ll,Rn,pl,hl,is,ul,ml,gl,ut,_l,cs,fl,vl,ls,bl,Tl,oe,wl,ps,kl,ql,Fn,yl,xl,hs,Rl,Fl,$n,$l,zl,El,A,jl,zn,Gl,Ml,us,Al,Pl,ms,Nl,Ol,gs,Cl,Sl,_s,Ll,Dl,En,Il,Wl,fs,Hl,Bl,jn,Ql,Ul,Gn,Vl,Kl,vs,Yl,Jl,Xl,To,Zl,Mn,ep,tp,op,wo,np,ko,rp,sp,ap,ce,qo,dp,Pe,ip,An,cp,lp,bs,pp,hp,up,mt,mp,gt,gp,_t,yo,_p,xo,fp,Pn,vp,bp,sd,Ne,ft,Ts,Ro,Tp,ws,wp,ad,j,Fo,kp,Oe,qp,Nn,yp,xp,ks,Rp,Fp,$p,vt,zp,qs,Ep,jp,ys,Gp,Mp,ne,Ap,xs,Pp,Np,On,Op,Cp,Rs,Sp,Lp,Cn,Dp,Ip,Wp,P,Hp,Sn,Bp,Qp,Fs,Up,Vp,$s,Kp,Yp,zs,Jp,Xp,Es,Zp,eh,Ln,th,oh,js,nh,rh,Dn,sh,ah,In,dh,ih,Gs,ch,lh,ph,$o,hh,Wn,uh,mh,gh,zo,_h,Eo,fh,vh,bh,le,jo,Th,Ce,wh,Hn,kh,qh,Ms,yh,xh,Rh,bt,Fh,Tt,$h,wt,Go,zh,As,Eh,dd,Se,kt,Ps,Mo,jh,Ns,Gh,id,N,Ao,Mh,Le,Ah,Bn,Ph,Nh,Os,Oh,Ch,Sh,qt,Lh,Cs,Dh,Ih,re,Wh,Ss,Hh,Bh,Qn,Qh,Uh,Ls,Vh,Kh,Un,Yh,Jh,Xh,L,Zh,Vn,eu,tu,Ds,ou,nu,Is,ru,su,Ws,au,du,Hs,iu,cu,Kn,lu,pu,Bs,hu,uu,Yn,mu,gu,Qs,_u,fu,vu,Po,bu,Jn,Tu,wu,ku,No,qu,Oo,yu,xu,Ru,Us,Fu,$u,pe,Co,zu,De,Eu,Xn,ju,Gu,Vs,Mu,Au,Pu,yt,Nu,xt,cd,Ie,Rt,Ks,So,Ou,Ys,Cu,ld,$,Lo,Su,We,Lu,Zn,Du,Iu,Js,Wu,Hu,Bu,Ft,Qu,Xs,Uu,Vu,Zs,Ku,Yu,se,Ju,ea,Xu,Zu,er,em,tm,ta,om,nm,tr,rm,sm,am,D,dm,or,im,cm,oa,lm,pm,na,hm,um,ra,mm,gm,sa,_m,fm,nr,vm,bm,aa,Tm,wm,rr,km,qm,da,ym,xm,Rm,Do,Fm,sr,$m,zm,Em,Io,jm,Wo,Gm,Mm,Am,ia,Pm,Nm,he,Ho,Om,He,Cm,ar,Sm,Lm,ca,Dm,Im,Wm,$t,Hm,zt,Bm,Et,Bo,Qm,Qo,Um,dr,Vm,Km,pd,Be,jt,la,Uo,Ym,pa,Jm,hd,z,Vo,Xm,Qe,Zm,ir,eg,tg,ha,og,ng,rg,Gt,sg,ua,ag,dg,ma,ig,cg,ae,lg,ga,pg,hg,cr,ug,mg,_a,gg,_g,lr,fg,vg,bg,I,Tg,pr,wg,kg,fa,qg,yg,va,xg,Rg,ba,Fg,$g,Ta,zg,Eg,hr,jg,Gg,wa,Mg,Ag,ur,Pg,Ng,ka,Og,Cg,Sg,Ko,Lg,mr,Dg,Ig,Wg,Yo,Hg,Jo,Bg,Qg,Ug,qa,Vg,Kg,ue,Xo,Yg,Ue,Jg,gr,Xg,Zg,ya,e_,t_,o_,Mt,n_,At,r_,Pt,Zo,s_,xa,a_,ud;return i=new _e({}),Wt=new _e({}),Qt=new _e({}),Ut=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"doc_sep"},{anchor:"transformers.RagConfig.n_docs",description:`<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to 5) &#x2014;
...
<a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>.`,name:"retrieval_batch_size"},{anchor:"transformers.RagConfig.dataset",description:`<strong>dataset</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;wiki_dpr&quot;</code>) &#x2014;
...
generator_tokenizer.`,name:"question_encoder_tokenizer"},{anchor:"transformers.RagRetriever.generator_tokenizer",description:`<strong>generator_tokenizer</strong> (<a href="/docs/transformers/pr_20/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
...
Prefix added at the beginning of each input, typically used with T5-based models.`,name:"prefix"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/retrieval_rag.py#L465",returnDescription:`
...
The number of docs retrieved per query.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/retrieval_rag.py#L537",returnDescription:`
...
<code>context_attention_mask</code>. See returned tensors for more detail.`,name:"output_retrieved(bool,"},{anchor:"transformers.RagModel.forward.n_docs",description:"<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to `config.n_docs&#x201C;) &#x2014;\nNumber of documents to retrieve and/or number of documents for which to generate an answer.",name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_rag.py#L538",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_20/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagConfig"
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_rag.py#L772",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_20/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
...
`}}),mt=new ge({props:{$$slots:{default:[Gb]},$$scope:{ctx:F}}}),gt=new sn({props:{anchor:"transformers.RagSequenceForGeneration.forward.example",$$slots:{default:[Mb]},$$scope:{ctx:F}}}),yo=new G({props:{name:"generate",anchor:"transformers.RagSequenceForGeneration.generate",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"doc_scores",val:": typing.Optional[torch.FloatTensor] = None"},{name:"do_deduplication",val:": typing.Optional[bool] = None"},{name:"num_return_sequences",val:": typing.Optional[int] = None"},{name:"num_beams",val:": typing.Optional[int] = None"},{name:"n_docs",val:": typing.Optional[int] = None"},{name:"**model_kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.generate.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_20/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate)</code>
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/pr_20/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_rag.py#L913",returnDescription:`
<p>The generated
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.RagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.RagTokenForGeneration.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.PreTrainedModel">PreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.RagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_rag.py#L1141"}}),vt=new ge({props:{$$slots:{default:[Ab]},$$scope:{ctx:F}}}),jo=new G({props:{name:"forward",anchor:"transformers.RagTokenForGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.BoolTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"context_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"doc_scores",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"output_retrieved",val:": typing.Optional[bool] = None"},{name:"do_marginalize",val:": typing.Optional[bool] = None"},{name:"reduce_loss",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"n_docs",val:": typing.Optional[int] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagTokenForGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
obtain the indices.</p>
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_rag.py#L1240",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_20/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/pr_20/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
crash. Note that using <code>remove_invalid_values</code> can slow down generation.`,name:"remove_invalid_values"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_rag.py#L1381",returnDescription:`
<p>The generated
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagModel.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
An encoder model compatible with the faiss index encapsulated by the <code>retriever</code>.`,name:"question_encoder"},{anchor:"transformers.TFRagModel.generator",description:`<strong>generator</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagModel.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
A retriever class encapsulating a faiss index queried to obtain context documents for current inputs.`,name:"retriever"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_tf_rag.py#L485"}}),qt=new ge({props:{$$slots:{default:[Ob]},$$scope:{ctx:F}}}),Co=new G({props:{name:"call",anchor:"transformers.TFRagModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"doc_scores",val:" = None"},{name:"context_input_ids",val:" = None"},{name:"context_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"output_retrieved",val:" = None"},{name:"n_docs",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFRagModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. <a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagConfig">RagConfig</a>, used to initialize the model, specifies
which generator to use, it also specifies a compatible generator tokenizer. Use that tokenizer class to
...
Whether or not to return a <code>TFRetrievAugLMOutput</code> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.TFRagModel.call.n_docs",description:"<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to `config.n_docs&#x201C;) &#x2014;\nNumber of documents to retrieve and/or number of documents for which to generate an answer.",name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_tf_rag.py#L536",returnDescription:`
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagSequenceForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagSequenceForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_tf_rag.py#L1419",returnDescription:`
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"},{anchor:"transformers.TFRagTokenForGeneration.question_encoder",description:`<strong>question_encoder</strong> (<a href="/docs/transformers/pr_20/en/main_classes/model#transformers.TFPreTrainedModel">TFPreTrainedModel</a>) &#x2014;
...
A seq2seq model used as the generator in the RAG architecture.`,name:"generator"},{anchor:"transformers.TFRagTokenForGeneration.retriever",description:`<strong>retriever</strong> (<a href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagRetriever">RagRetriever</a>) &#x2014;
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_tf_rag.py#L826",returnDescription:`
<p>A <code>transformers.models.rag.modeling_tf_rag.TFRetrievAugLMMarginOutput</code> or a tuple of <code>tf.Tensor</code> (if
<code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various elements depending on the
configuration (<a
  href="/docs/transformers/pr_20/en/model_doc/rag#transformers.RagConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_20/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.
model_specific_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"return_dict_in_generate"}],source:"https://github.com/huggingface/transformers/blob/vr_20/src/transformers/models/rag/modeling_tf_rag.py#L981",returnDescription:`
<p>The generated sequences. The
second dimension (sequence_length) is either equal to <code>max_length</code> or shorter if all batches finished early
due to the <code>eos_token_id</code>.</p>
`,returnType:`
<p><code>tf.Tensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),{c(){c=s("meta"),b=p(),m=s("h1"),g=s("a"),f=s("span"),T(i.$$.fragment),u=p(),R=s("span"),Yd=o("RAG"),La=p(),qe=s("h2"),Ke=s("a"),zr=s("span"),T(Wt.$$.fragment),Jd=p(),Er=s("span"),Xd=o("Overview"),Da=p(),cn=s("p"),Zd=o(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
parametric-only seq2seq baseline.`),Ba=p(),Je=s("p"),si=o("This model was contributed by "),Bt=s("a"),ai=o("ola13"),di=o("."),Qa=p(),ye=s("h2"),Xe=s("a"),Gr=s("span"),T(Qt.$$.fragment),ii=p(),Mr=s("span"),ci=o("RagConfig"),Ua=p(),ee=s("div"),T(Ut.$$.fragment),li=p(),de=s("p"),hn=s("a"),pi=o("RagConfig"),hi=o(" stores the configuration of a "),Ar=s("em"),ui=o("RagModel"),mi=o(". Configuration objects inherit from "),un=s("a"),gi=o("PretrainedConfig"),_i=o(` and
can be used to control the model outputs. Read the documentation from `),mn=s("a"),fi=o("PretrainedConfig"),vi=o(" for more information."),bi=p(),Ze=s("div"),T(Vt.$$.fragment),Ti=p(),Kt=s("p"),wi=o("Instantiate a "),gn=s("a"),ki=o("EncoderDecoderConfig"),qi=o(` (or a derived class) from a pre-trained encoder model configuration and
...
contents, and it formats them to be used with a RagModel.`),Si=p(),T(rt.$$.fragment),Li=p(),st=s("div"),T(io.$$.fragment),Di=p(),Wr=s("p"),Ii=o("Retriever initialization function. It loads the index into memory."),Wi=p(),at=s("div"),T(co.$$.fragment),Hi=p(),ze=s("p"),Bi=o("Postprocessing retrieved "),Hr=s("code"),Qi=o("docs"),Ui=o(" and combining them with "),Br=s("code"),Vi=o("input_strings"),Ki=o("."),Yi=p(),dt=s("div"),T(lo.$$.fragment),Ji=p(),po=s("p"),Xi=o("Retrieves documents for specified "),Qr=s("code"),Zi=o("question_hidden_states"),ec=o("."),td=p(),Ee=s("h2"),it=s("a"),Ur=s("span"),T(ho.$$.fragment),tc=p(),Vr=s("span"),oc=o("RagModel"),od=p(),S=s("div"),T(uo.$$.fragment),nc=p(),je=s("p"),rc=o("The "),fn=s("a"),sc=o("RagModel"),ac=o(" forward method, overrides the "),Kr=s("code"),dc=o("__call__"),ic=o(" special method."),cc=p(),T(ct.$$.fragment),lc=p(),Yr=s("p"),pc=o(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),hc=p(),te=s("p"),uc=o("The question encoder can be any "),Jr=s("em"),mc=o("autoencoding"),gc=o(" model, preferably "),vn=s("a"),_c=o("DPRQuestionEncoder"),fc=o(`, and the generator can be
...
`),qn=s("a"),Lc=o("T5ForConditionalGeneration"),Dc=o(" as the "),rs=s("code"),Ic=o("generator"),Wc=o("."),Hc=p(),mo=s("p"),Bc=o("This model inherits from "),yn=s("a"),Qc=o("PreTrainedModel"),Uc=o(`. Check the superclass documentation for the generic methods the
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),us=s("em"),Al=o("autoencoding"),Pl=o(" model as the "),ms=s("code"),Nl=o("question_encoder"),Ol=o(" and any "),gs=s("em"),Cl=o("seq2seq"),Sl=o(" model with language model head as the "),_s=s("code"),Ll=o("generator"),Dl=o(`.
...
`),In=s("a"),dh=o("T5ForConditionalGeneration"),ih=o(" as the "),Gs=s("code"),ch=o("generator"),lh=o("."),ph=p(),$o=s("p"),hh=o("This model inherits from "),Wn=s("a"),uh=o("PreTrainedModel"),mh=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
any `),Ls=s("em"),Vh=o("seq2seq"),Kh=o(" model, preferably "),Un=s("a"),Yh=o("TFBartForConditionalGeneration"),Jh=o("."),Xh=p(),L=s("p"),Zh=o("The model can be initialized with a "),Vn=s("a"),eu=o("RagRetriever"),tu=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),Ds=s("em"),ou=o("autoencoding"),nu=o(" model as the "),Is=s("code"),ru=o("question_encoder"),su=o(" and any "),Ws=s("em"),au=o("seq2seq"),du=o(" model with language model head as the "),Hs=s("code"),iu=o("generator"),cu=o(`.
It has been tested with `),Kn=s("a"),lu=o("TFDPRQuestionEncoder"),pu=o(" as the "),Bs=s("code"),hu=o("question_encoder"),uu=o(" and "),Yn=s("a"),mu=o("TFBartForConditionalGeneration"),gu=o(`
as the `),Qs=s("code"),_u=o("generator"),fu=o("."),vu=p(),Po=s("p"),bu=o("This model inherits from "),Jn=s("a"),Tu=o("TFPreTrainedModel"),wu=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ku=p(),No=s("p"),qu=o("This model is also a Tensorflow "),Oo=s("a"),yu=o("tf.keras.Model"),xu=o(`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Ru=p(),Us=s("p"),Fu=o(`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),$u=p(),pe=s("div"),T(Co.$$.fragment),zu=p(),De=s("p"),Eu=o("The "),Xn=s("a"),ju=o("TFRagModel"),Gu=o(" forward method, overrides the "),Vs=s("code"),Mu=o("__call__"),Au=o(" special method."),Pu=p(),T(yt.$$.fragment),Nu=p(),T(xt.$$.fragment),cd=p(),Ie=s("h2"),Rt=s("a"),Ks=s("span"),T(So.$$.fragment),Ou=p(),Ys=s("span"),Cu=o("TFRagSequenceForGeneration"),ld=p(),$=s("div"),T(Lo.$$.fragment),Su=p(),We=s("p"),Lu=o("The "),Zn=s("a"),Du=o("TFRagSequenceForGeneration"),Iu=o(" forward method, overrides the "),Js=s("code"),Wu=o("__call__"),Hu=o(" special method."),Bu=p(),T(Ft.$$.fragment),Qu=p(),Xs=s("p"),Uu=o("A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),Vu=p(),Zs=s("p"),Ku=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Yu=p(),se=s("p"),Ju=o("The question encoder can be any "),ea=s("em"),Xu=o("autoencoding"),Zu=o(" model, preferably "),er=s("a"),em=o("TFDPRQuestionEncoder"),tm=o(`, and the generator can be
any `),ta=s("em"),om=o("seq2seq"),nm=o(" model, preferably "),tr=s("a"),rm=o("TFBartForConditionalGeneration"),sm=o("."),am=p(),D=s("p"),dm=o("The model can be initialized with a "),or=s("a"),im=o("RagRetriever"),cm=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),oa=s("em"),lm=o("autoencoding"),pm=o(" model as the "),na=s("code"),hm=o("question_encoder"),um=o(" and any "),ra=s("em"),mm=o("seq2seq"),gm=o(" model with language model head as the "),sa=s("code"),_m=o("generator"),fm=o(`.
It has been tested with `),nr=s("a"),vm=o("TFDPRQuestionEncoder"),bm=o(" as the "),aa=s("code"),Tm=o("question_encoder"),wm=o(" and "),rr=s("a"),km=o("TFBartForConditionalGeneration"),qm=o(`
as the `),da=s("code"),ym=o("generator"),xm=o("."),Rm=p(),Do=s("p"),Fm=o("This model inherits from "),sr=s("a"),$m=o("TFPreTrainedModel"),zm=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em=p(),Io=s("p"),jm=o("This model is also a Tensorflow "),Wo=s("a"),Gm=o("tf.keras.Model"),Mm=o(`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Am=p(),ia=s("p"),Pm=o(`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),Nm=p(),he=s("div"),T(Ho.$$.fragment),Om=p(),He=s("p"),Cm=o("The "),ar=s("a"),Sm=o("TFRagSequenceForGeneration"),Lm=o(" forward method, overrides the "),ca=s("code"),Dm=o("__call__"),Im=o(" special method."),Wm=p(),T($t.$$.fragment),Hm=p(),T(zt.$$.fragment),Bm=p(),Et=s("div"),T(Bo.$$.fragment),Qm=p(),Qo=s("p"),Um=o("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),dr=s("a"),Vm=o("generate()"),Km=o("`\ndocumentation for more information on how to set other generate input parameters"),pd=p(),Be=s("h2"),jt=s("a"),la=s("span"),T(Uo.$$.fragment),Ym=p(),pa=s("span"),Jm=o("TFRagTokenForGeneration"),hd=p(),z=s("div"),T(Vo.$$.fragment),Xm=p(),Qe=s("p"),Zm=o("The "),ir=s("a"),eg=o("TFRagTokenForGeneration"),tg=o(" forward method, overrides the "),ha=s("code"),og=o("__call__"),ng=o(" special method."),rg=p(),T(Gt.$$.fragment),sg=p(),ua=s("p"),ag=o("A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),dg=p(),ma=s("p"),ig=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),cg=p(),ae=s("p"),lg=o("The question encoder can be any "),ga=s("em"),pg=o("autoencoding"),hg=o(" model, preferably "),cr=s("a"),ug=o("TFDPRQuestionEncoder"),mg=o(`, and the generator can be
...
It has been tested with `),hr=s("a"),jg=o("TFDPRQuestionEncoder"),Gg=o(" as the "),wa=s("code"),Mg=o("question_encoder"),Ag=o(" and "),ur=s("a"),Pg=o("TFBartForConditionalGeneration"),Ng=o(`
as the `),ka=s("code"),Og=o("generator"),Cg=o("."),Sg=p(),Ko=s("p"),Lg=o("This model inherits from "),mr=s("a"),Dg=o("TFPreTrainedModel"),Ig=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
SavedModel format.`),Kg=p(),ue=s("div"),T(Xo.$$.fragment),Yg=p(),Ue=s("p"),Jg=o("The "),gr=s("a"),Xg=o("TFRagTokenForGeneration"),Zg=o(" forward method, overrides the "),ya=s("code"),e_=o("__call__"),t_=o(" special method."),o_=p(),T(Mt.$$.fragment),n_=p(),T(At.$$.fragment),r_=p(),Pt=s("div"),T(Zo.$$.fragment),s_=p(),xa=s("p"),a_=o("Implements TFRAG token decoding."),this.h()},l(r){const _=xb('[data-svelte="svelte-1phssyn"]',document.head);c=a(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(r),m=a(r,"H1",{class:!0});var en=d(m);g=a(en,"A",{id:!0,class:!0,href:!0});var Ra=d(g);f=a(Ra,"SPAN",{});var Fa=d(f);w(i.$$.fragment,Fa),Fa.forEach(t),Ra.forEach(t),u=h(en),R=a(en,"SPAN",{});var $a=d(R);Yd=n($a,"RAG"),$a.forEach(t),en.forEach(t),La=h(r),qe=a(r,"H2",{class:!0});var tn=d(qe);Ke=a(tn,"A",{id:!0,class:!0,href:!0});var za=d(Ke);zr=a(za,"SPAN",{});var Ea=d(zr);w(Wt.$$.fragment,Ea),Ea.forEach(t),za.forEach(t),Jd=h(tn),Er=a(tn,"SPAN",{});var ja=d(Er);Xd=n(ja,"Overview"),ja.forEach(t),tn.forEach(t),Da=h(r),cn=a(r,"P",{});var Ga=d(cn);Zd=n(Ga,`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
sequence-to-sequence models. RAG models retrieve documents, pass them to a seq2seq model, then marginalize to generate
outputs. The retriever and seq2seq modules are initialized from pretrained models, and fine-tuned jointly, allowing
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),Na.forEach(t),Pa.forEach(t),Ba=h(r),Je=a(r,"P",{});var nn=d(Je);si=n(nn,"This model was contributed by "),Bt=a(nn,"A",{href:!0,rel:!0});var Oa=d(Bt);ai=n(Oa,"ola13"),Oa.forEach(t),di=n(nn,"."),nn.forEach(t),Qa=h(r),ye=a(r,"H2",{class:!0});var rn=d(ye);Xe=a(rn,"A",{id:!0,class:!0,href:!0});var Ca=d(Xe);Gr=a(Ca,"SPAN",{});var Sa=d(Gr);w(Qt.$$.fragment,Sa),Sa.forEach(t),Ca.forEach(t),ii=h(rn),Mr=a(rn,"SPAN",{});var d_=d(Mr);ci=n(d_,"RagConfig"),d_.forEach(t),rn.forEach(t),Ua=h(r),ee=a(r,"DIV",{class:!0});var Nt=d(ee);w(Ut.$$.fragment,Nt),li=h(Nt),de=a(Nt,"P",{});var Ve=d(de);hn=a(Ve,"A",{href:!0});var i_=d(hn);pi=n(i_,"RagConfig"),i_.forEach(t),hi=n(Ve," stores the configuration of a "),Ar=a(Ve,"EM",{});var c_=d(Ar);ui=n(c_,"RagModel"),c_.forEach(t),mi=n(Ve,". Configuration objects inherit from "),un=a(Ve,"A",{href:!0});var l_=d(un);gi=n(l_,"PretrainedConfig"),l_.forEach(t),_i=n(Ve,` and
can be used to control the model outputs. Read the documentation from `),mn=a(Ve,"A",{href:!0});var p_=d(mn);fi=n(p_,"PretrainedConfig"),p_.forEach(t),vi=n(Ve," for more information."),Ve.forEach(t),bi=h(Nt),Ze=a(Nt,"DIV",{class:!0});var md=d(Ze);w(Vt.$$.fragment,md),Ti=h(md),Kt=a(md,"P",{});var gd=d(Kt);wi=n(gd,"Instantiate a "),gn=a(gd,"A",{href:!0});var h_=d(gn);ki=n(h_,"EncoderDecoderConfig"),h_.forEach(t),qi=n(gd,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),gd.forEach(t),md.forEach(t),yi=h(Nt),et=a(Nt,"DIV",{class:!0});var _d=d(et);w(Yt.$$.fragment,_d),xi=h(_d),Jt=a(_d,"P",{});var fd=d(Jt);Ri=n(fd,"Serializes this instance to a Python dictionary. Override the default "),_n=a(fd,"A",{href:!0});var u_=d(_n);Fi=n(u_,"to_dict()"),u_.forEach(t),$i=n(fd,"."),fd.forEach(t),_d.forEach(t),Nt.forEach(t),Va=h(r),xe=a(r,"H2",{class:!0});var vd=d(xe);tt=a(vd,"A",{id:!0,class:!0,href:!0});var m_=d(tt);Pr=a(m_,"SPAN",{});var g_=d(Pr);w(Xt.$$.fragment,g_),g_.forEach(t),m_.forEach(t),zi=h(vd),Nr=a(vd,"SPAN",{});var __=d(Nr);Ei=n(__,"RagTokenizer"),__.forEach(t),vd.forEach(t),Ka=h(r),Zt=a(r,"DIV",{class:!0});var f_=d(Zt);w(eo.$$.fragment,f_),f_.forEach(t),Ya=h(r),Re=a(r,"H2",{class:!0});var bd=d(Re);ot=a(bd,"A",{id:!0,class:!0,href:!0});var v_=d(ot);Or=a(v_,"SPAN",{});var b_=d(Or);w(to.$$.fragment,b_),b_.forEach(t),v_.forEach(t),ji=h(bd),Cr=a(bd,"SPAN",{});var T_=d(Cr);Gi=n(T_,"Rag specific outputs"),T_.forEach(t),bd.forEach(t),Ja=h(r),Fe=a(r,"DIV",{class:!0});var Td=d(Fe);w(oo.$$.fragment,Td),Mi=h(Td),Sr=a(Td,"P",{});var w_=d(Sr);Ai=n(w_,"Base class for retriever augmented marginalized models outputs."),w_.forEach(t),Td.forEach(t),Xa=h(r),no=a(r,"DIV",{class:!0});var k_=d(no);w(ro.$$.fragment,k_),k_.forEach(t),Za=h(r),$e=a(r,"H2",{class:!0});var wd=d($e);nt=a(wd,"A",{id:!0,class:!0,href:!0});var q_=d(nt);Lr=a(q_,"SPAN",{});var y_=d(Lr);w(so.$$.fragment,y_),y_.forEach(t),q_.forEach(t),Pi=h(wd),Dr=a(wd,"SPAN",{});var x_=d(Dr);Ni=n(x_,"RagRetriever"),x_.forEach(t),wd.forEach(t),ed=h(r),Z=a(r,"DIV",{class:!0});var me=d(Z);w(ao.$$.fragment,me),Oi=h(me),Ir=a(me,"P",{});var R_=d(Ir);Ci=n(R_,`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
contents, and it formats them to be used with a RagModel.`),R_.forEach(t),Si=h(me),w(rt.$$.fragment,me),Li=h(me),st=a(me,"DIV",{class:!0});var kd=d(st);w(io.$$.fragment,kd),Di=h(kd),Wr=a(kd,"P",{});var F_=d(Wr);Ii=n(F_,"Retriever initialization function. It loads the index into memory."),F_.forEach(t),kd.forEach(t),Wi=h(me),at=a(me,"DIV",{class:!0});var qd=d(at);w(co.$$.fragment,qd),Hi=h(qd),ze=a(qd,"P",{});var _r=d(ze);Bi=n(_r,"Postprocessing retrieved "),Hr=a(_r,"CODE",{});var $_=d(Hr);Qi=n($_,"docs"),$_.forEach(t),Ui=n(_r," and combining them with "),Br=a(_r,"CODE",{});var z_=d(Br);Vi=n(z_,"input_strings"),z_.forEach(t),Ki=n(_r,"."),_r.forEach(t),qd.forEach(t),Yi=h(me),dt=a(me,"DIV",{class:!0});var yd=d(dt);w(lo.$$.fragment,yd),Ji=h(yd),po=a(yd,"P",{});var xd=d(po);Xi=n(xd,"Retrieves documents for specified "),Qr=a(xd,"CODE",{});var E_=d(Qr);Zi=n(E_,"question_hidden_states"),E_.forEach(t),ec=n(xd,"."),xd.forEach(t),yd.forEach(t),me.forEach(t),td=h(r),Ee=a(r,"H2",{class:!0});var Rd=d(Ee);it=a(Rd,"A",{id:!0,class:!0,href:!0});var j_=d(it);Ur=a(j_,"SPAN",{});var G_=d(Ur);w(ho.$$.fragment,G_),G_.forEach(t),j_.forEach(t),tc=h(Rd),Vr=a(Rd,"SPAN",{});var M_=d(Vr);oc=n(M_,"RagModel"),M_.forEach(t),Rd.forEach(t),od=h(r),S=a(r,"DIV",{class:!0});var X=d(S);w(uo.$$.fragment,X),nc=h(X),je=a(X,"P",{});var fr=d(je);rc=n(fr,"The "),fn=a(fr,"A",{href:!0});var A_=d(fn);sc=n(A_,"RagModel"),A_.forEach(t),ac=n(fr," forward method, overrides the "),Kr=a(fr,"CODE",{});var P_=d(Kr);dc=n(P_,"__call__"),P_.forEach(t),ic=n(fr," special method."),fr.forEach(t),cc=h(X),w(ct.$$.fragment,X),lc=h(X),Yr=a(X,"P",{});var N_=d(Yr);pc=n(N_,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),N_.forEach(t),hc=h(X),te=a(X,"P",{});var fe=d(te);uc=n(fe,"The question encoder can be any "),Jr=a(fe,"EM",{});var O_=d(Jr);mc=n(O_,"autoencoding"),O_.forEach(t),gc=n(fe," model, preferably "),vn=a(fe,"A",{href:!0});var C_=d(vn);_c=n(C_,"DPRQuestionEncoder"),C_.forEach(t),fc=n(fe,`, and the generator can be
...
`),qn=a(W,"A",{href:!0});var K_=d(qn);Lc=n(K_,"T5ForConditionalGeneration"),K_.forEach(t),Dc=n(W," as the "),rs=a(W,"CODE",{});var Y_=d(rs);Ic=n(Y_,"generator"),Y_.forEach(t),Wc=n(W,"."),W.forEach(t),Hc=h(X),mo=a(X,"P",{});var Fd=d(mo);Bc=n(Fd,"This model inherits from "),yn=a(Fd,"A",{href:!0});var J_=d(yn);Qc=n(J_,"PreTrainedModel"),J_.forEach(t),Uc=n(Fd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
any `),hs=a(ve,"EM",{});var pf=d(hs);Rl=n(pf,"seq2seq"),pf.forEach(t),Fl=n(ve," model, preferably "),$n=a(ve,"A",{href:!0});var hf=d($n);$l=n(hf,"BartForConditionalGeneration"),hf.forEach(t),zl=n(ve,"."),ve.forEach(t),El=h(H),A=a(H,"P",{});var B=d(A);jl=n(B,"The model can be initialized with a "),zn=a(B,"A",{href:!0});var uf=d(zn);Gl=n(uf,"RagRetriever"),uf.forEach(t),Ml=n(B,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),us=a(B,"EM",{});var mf=d(us);Al=n(mf,"autoencoding"),mf.forEach(t),Pl=n(B," model as the "),ms=a(B,"CODE",{});var gf=d(ms);Nl=n(gf,"question_encoder"),gf.forEach(t),Ol=n(B," and any "),gs=a(B,"EM",{});var _f=d(gs);Cl=n(_f,"seq2seq"),_f.forEach(t),Sl=n(B," model with language model head as the "),_s=a(B,"CODE",{});var ff=d(_s);Ll=n(ff,"generator"),ff.forEach(t),Dl=n(B,`.
...
any `),Ls=a(Te,"EM",{});var iv=d(Ls);Vh=n(iv,"seq2seq"),iv.forEach(t),Kh=n(Te," model, preferably "),Un=a(Te,"A",{href:!0});var cv=d(Un);Yh=n(cv,"TFBartForConditionalGeneration"),cv.forEach(t),Jh=n(Te,"."),Te.forEach(t),Xh=h(V),L=a(V,"P",{});var K=d(L);Zh=n(K,"The model can be initialized with a "),Vn=a(K,"A",{href:!0});var lv=d(Vn);eu=n(lv,"RagRetriever"),lv.forEach(t),tu=n(K,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),Ds=a(K,"EM",{});var pv=d(Ds);ou=n(pv,"autoencoding"),pv.forEach(t),nu=n(K," model as the "),Is=a(K,"CODE",{});var hv=d(Is);ru=n(hv,"question_encoder"),hv.forEach(t),su=n(K," and any "),Ws=a(K,"EM",{});var uv=d(Ws);au=n(uv,"seq2seq"),uv.forEach(t),du=n(K," model with language model head as the "),Hs=a(K,"CODE",{});var mv=d(Hs);iu=n(mv,"generator"),mv.forEach(t),cu=n(K,`.
It has been tested with `),Kn=a(K,"A",{href:!0});var gv=d(Kn);lu=n(gv,"TFDPRQuestionEncoder"),gv.forEach(t),pu=n(K," as the "),Bs=a(K,"CODE",{});var _v=d(Bs);hu=n(_v,"question_encoder"),_v.forEach(t),uu=n(K," and "),Yn=a(K,"A",{href:!0});var fv=d(Yn);mu=n(fv,"TFBartForConditionalGeneration"),fv.forEach(t),gu=n(K,`
as the `),Qs=a(K,"CODE",{});var vv=d(Qs);_u=n(vv,"generator"),vv.forEach(t),fu=n(K,"."),K.forEach(t),vu=h(V),Po=a(V,"P",{});var Sd=d(Po);bu=n(Sd,"This model inherits from "),Jn=a(Sd,"A",{href:!0});var bv=d(Jn);Tu=n(bv,"TFPreTrainedModel"),bv.forEach(t),wu=n(Sd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sd.forEach(t),ku=h(V),No=a(V,"P",{});var Ld=d(No);qu=n(Ld,"This model is also a Tensorflow "),Oo=a(Ld,"A",{href:!0,rel:!0});var Tv=d(Oo);yu=n(Tv,"tf.keras.Model"),Tv.forEach(t),xu=n(Ld,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Ld.forEach(t),Ru=h(V),Us=a(V,"P",{});var wv=d(Us);Fu=n(wv,`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),wv.forEach(t),$u=h(V),pe=a(V,"DIV",{class:!0});var Lt=d(pe);w(Co.$$.fragment,Lt),zu=h(Lt),De=a(Lt,"P",{});var yr=d(De);Eu=n(yr,"The "),Xn=a(yr,"A",{href:!0});var kv=d(Xn);ju=n(kv,"TFRagModel"),kv.forEach(t),Gu=n(yr," forward method, overrides the "),Vs=a(yr,"CODE",{});var qv=d(Vs);Mu=n(qv,"__call__"),qv.forEach(t),Au=n(yr," special method."),yr.forEach(t),Pu=h(Lt),w(yt.$$.fragment,Lt),Nu=h(Lt),w(xt.$$.fragment,Lt),Lt.forEach(t),V.forEach(t),cd=h(r),Ie=a(r,"H2",{class:!0});var Dd=d(Ie);Rt=a(Dd,"A",{id:!0,class:!0,href:!0});var yv=d(Rt);Ks=a(yv,"SPAN",{});var xv=d(Ks);w(So.$$.fragment,xv),xv.forEach(t),yv.forEach(t),Ou=h(Dd),Ys=a(Dd,"SPAN",{});var Rv=d(Ys);Cu=n(Rv,"TFRagSequenceForGeneration"),Rv.forEach(t),Dd.forEach(t),ld=h(r),$=a(r,"DIV",{class:!0});var O=d($);w(Lo.$$.fragment,O),Su=h(O),We=a(O,"P",{});var xr=d(We);Lu=n(xr,"The "),Zn=a(xr,"A",{href:!0});var Fv=d(Zn);Du=n(Fv,"TFRagSequenceForGeneration"),Fv.forEach(t),Iu=n(xr," forward method, overrides the "),Js=a(xr,"CODE",{});var $v=d(Js);Wu=n($v,"__call__"),$v.forEach(t),Hu=n(xr," special method."),xr.forEach(t),Bu=h(O),w(Ft.$$.fragment,O),Qu=h(O),Xs=a(O,"P",{});var zv=d(Xs);Uu=n(zv,"A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),zv.forEach(t),Vu=h(O),Zs=a(O,"P",{});var Ev=d(Zs);Ku=n(Ev,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Ev.forEach(t),Yu=h(O),se=a(O,"P",{});var we=d(se);Ju=n(we,"The question encoder can be any "),ea=a(we,"EM",{});var jv=d(ea);Xu=n(jv,"autoencoding"),jv.forEach(t),Zu=n(we," model, preferably "),er=a(we,"A",{href:!0});var Gv=d(er);em=n(Gv,"TFDPRQuestionEncoder"),Gv.forEach(t),tm=n(we,`, and the generator can be
any `),ta=a(we,"EM",{});var Mv=d(ta);om=n(Mv,"seq2seq"),Mv.forEach(t),nm=n(we," model, preferably "),tr=a(we,"A",{href:!0});var Av=d(tr);rm=n(Av,"TFBartForConditionalGeneration"),Av.forEach(t),sm=n(we,"."),we.forEach(t),am=h(O),D=a(O,"P",{});var Y=d(D);dm=n(Y,"The model can be initialized with a "),or=a(Y,"A",{href:!0});var Pv=d(or);im=n(Pv,"RagRetriever"),Pv.forEach(t),cm=n(Y,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),oa=a(Y,"EM",{});var Nv=d(oa);lm=n(Nv,"autoencoding"),Nv.forEach(t),pm=n(Y," model as the "),na=a(Y,"CODE",{});var Ov=d(na);hm=n(Ov,"question_encoder"),Ov.forEach(t),um=n(Y," and any "),ra=a(Y,"EM",{});var Cv=d(ra);mm=n(Cv,"seq2seq"),Cv.forEach(t),gm=n(Y," model with language model head as the "),sa=a(Y,"CODE",{});var Sv=d(sa);_m=n(Sv,"generator"),Sv.forEach(t),fm=n(Y,`.
It has been tested with `),nr=a(Y,"A",{href:!0});var Lv=d(nr);vm=n(Lv,"TFDPRQuestionEncoder"),Lv.forEach(t),bm=n(Y," as the "),aa=a(Y,"CODE",{});var Dv=d(aa);Tm=n(Dv,"question_encoder"),Dv.forEach(t),wm=n(Y," and "),rr=a(Y,"A",{href:!0});var Iv=d(rr);km=n(Iv,"TFBartForConditionalGeneration"),Iv.forEach(t),qm=n(Y,`
as the `),da=a(Y,"CODE",{});var Wv=d(da);ym=n(Wv,"generator"),Wv.forEach(t),xm=n(Y,"."),Y.forEach(t),Rm=h(O),Do=a(O,"P",{});var Id=d(Do);Fm=n(Id,"This model inherits from "),sr=a(Id,"A",{href:!0});var Hv=d(sr);$m=n(Hv,"TFPreTrainedModel"),Hv.forEach(t),zm=n(Id,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Id.forEach(t),Em=h(O),Io=a(O,"P",{});var Wd=d(Io);jm=n(Wd,"This model is also a Tensorflow "),Wo=a(Wd,"A",{href:!0,rel:!0});var Bv=d(Wo);Gm=n(Bv,"tf.keras.Model"),Bv.forEach(t),Mm=n(Wd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Wd.forEach(t),Am=h(O),ia=a(O,"P",{});var Qv=d(ia);Pm=n(Qv,`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),Qv.forEach(t),Nm=h(O),he=a(O,"DIV",{class:!0});var Dt=d(he);w(Ho.$$.fragment,Dt),Om=h(Dt),He=a(Dt,"P",{});var Rr=d(He);Cm=n(Rr,"The "),ar=a(Rr,"A",{href:!0});var Uv=d(ar);Sm=n(Uv,"TFRagSequenceForGeneration"),Uv.forEach(t),Lm=n(Rr," forward method, overrides the "),ca=a(Rr,"CODE",{});var Vv=d(ca);Dm=n(Vv,"__call__"),Vv.forEach(t),Im=n(Rr," special method."),Rr.forEach(t),Wm=h(Dt),w($t.$$.fragment,Dt),Hm=h(Dt),w(zt.$$.fragment,Dt),Dt.forEach(t),Bm=h(O),Et=a(O,"DIV",{class:!0});var Hd=d(Et);w(Bo.$$.fragment,Hd),Qm=h(Hd),Qo=a(Hd,"P",{});var Bd=d(Qo);Um=n(Bd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),dr=a(Bd,"A",{href:!0});var Kv=d(dr);Vm=n(Kv,"generate()"),Kv.forEach(t),Km=n(Bd,"`\ndocumentation for more information on how to set other generate input parameters"),Bd.forEach(t),Hd.forEach(t),O.forEach(t),pd=h(r),Be=a(r,"H2",{class:!0});var Qd=d(Be);jt=a(Qd,"A",{id:!0,class:!0,href:!0});var Yv=d(jt);la=a(Yv,"SPAN",{});var Jv=d(la);w(Uo.$$.fragment,Jv),Jv.forEach(t),Yv.forEach(t),Ym=h(Qd),pa=a(Qd,"SPAN",{});var Xv=d(pa);Jm=n(Xv,"TFRagTokenForGeneration"),Xv.forEach(t),Qd.forEach(t),hd=h(r),z=a(r,"DIV",{class:!0});var C=d(z);w(Vo.$$.fragment,C),Xm=h(C),Qe=a(C,"P",{});var Fr=d(Qe);Zm=n(Fr,"The "),ir=a(Fr,"A",{href:!0});var Zv=d(ir);eg=n(Zv,"TFRagTokenForGeneration"),Zv.forEach(t),tg=n(Fr," forward method, overrides the "),ha=a(Fr,"CODE",{});var eb=d(ha);og=n(eb,"__call__"),eb.forEach(t),ng=n(Fr," special method."),Fr.forEach(t),rg=h(C),w(Gt.$$.fragment,C),sg=h(C),ua=a(C,"P",{});var tb=d(ua);ag=n(tb,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),tb.forEach(t),dg=h(C),ma=a(C,"P",{});var ob=d(ma);ig=n(ob,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),ob.forEach(t),cg=h(C),ae=a(C,"P",{});var ke=d(ae);lg=n(ke,"The question encoder can be any "),ga=a(ke,"EM",{});var nb=d(ga);pg=n(nb,"autoencoding"),nb.forEach(t),hg=n(ke," model, preferably "),cr=a(ke,"A",{href:!0});var rb=d(cr);ug=n(rb,"TFDPRQuestionEncoder"),rb.forEach(t),mg=n(ke,`, and the generator can be
...
It has been tested with `),hr=a(J,"A",{href:!0});var hb=d(hr);jg=n(hb,"TFDPRQuestionEncoder"),hb.forEach(t),Gg=n(J," as the "),wa=a(J,"CODE",{});var ub=d(wa);Mg=n(ub,"question_encoder"),ub.forEach(t),Ag=n(J," and "),ur=a(J,"A",{href:!0});var mb=d(ur);Pg=n(mb,"TFBartForConditionalGeneration"),mb.forEach(t),Ng=n(J,`
as the `),ka=a(J,"CODE",{});var gb=d(ka);Og=n(gb,"generator"),gb.forEach(t),Cg=n(J,"."),J.forEach(t),Sg=h(C),Ko=a(C,"P",{});var Ud=d(Ko);Lg=n(Ud,"This model inherits from "),mr=a(Ud,"A",{href:!0});var _b=d(mr);Dg=n(_b,"TFPreTrainedModel"),_b.forEach(t),Ig=n(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
