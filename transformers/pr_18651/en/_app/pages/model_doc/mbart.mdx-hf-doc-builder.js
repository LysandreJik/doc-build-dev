...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/configuration_mbart.py#L34"}}),qo=new E({props:{anchor:"transformers.MBartConfig.example",$$slots:{default:[N$]},$$scope:{ctx:x}}}),qa=new U({}),Ba=new F({props:{name:"class transformers.MBartTokenizer",anchor:"transformers.MBartTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"tokenizer_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"additional_special_tokens",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/tokenization_mbart.py#L53"}}),jo=new E({props:{anchor:"transformers.MBartTokenizer.example",$$slots:{default:[D$]},$$scope:{ctx:x}}}),Ca=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Qa=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/tokenization_mbart_fast.py#L245"}}),Va=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/tokenization_mbart_fast.py#L260"}}),Ha=new U({}),Ja=new F({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart50/tokenization_mbart50.py#L49"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[G$]},$$scope:{ctx:x}}}),es=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart50/tokenization_mbart50.py#L256",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ds=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart50/tokenization_mbart50.py#L343"}}),ls=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart50/tokenization_mbart50.py#L349"}}),cs=new U({}),ps=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_mbart.py#L1179",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18651/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_mbart.py#L1313",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_mbart.py#L1582",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_mbart.py#L1455",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_mbart.py#L1734",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18651/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18651/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18651/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ov=p(),fc=a("p"),Av=i("Finally, this model supports inherent JAX features such as:"),Iv=p(),gt=a("ul"),_c=a("li"),Sr=a("a"),Nv=i("Just-In-Time (JIT) compilation"),Dv=p(),gc=a("li"),Or=a("a"),Lv=i("Automatic Differentiation"),Gv=p(),bc=a("li"),Ar=a("a"),Wv=i("Vectorization"),Rv=p(),kc=a("li"),Ir=a("a"),Uv=i("Parallelization"),Xv=p(),tt=a("div"),y(Nr.$$.fragment),Qv=p(),yo=a("p"),Vv=i("The "),yc=a("code"),Hv=i("FlaxMBartPreTrainedModel"),Jv=i(" forward method, overrides the "),vc=a("code"),Kv=i("__call__"),Zv=i(" special method."),Yv=p(),y(Nn.$$.fragment),e1=p(),y(Dn.$$.fragment),t1=p(),Ln=a("div"),y(Dr.$$.fragment),o1=p(),y(Gn.$$.fragment),n1=p(),Wn=a("div"),y(Lr.$$.fragment),a1=p(),y(Rn.$$.fragment),ou=p(),vo=a("h2"),Un=a("a"),Tc=a("span"),y(Gr.$$.fragment),s1=p(),wc=a("span"),r1=i("FlaxMBartForQuestionAnswering"),nu=p(),D=a("div"),y(Wr.$$.fragment),i1=p(),To=a("p"),d1=i(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Mc=a("code"),l1=i("span start logits"),c1=i(" and "),$c=a("code"),p1=i("span end logits"),u1=i(")."),h1=p(),Rr=a("p"),m1=i("This model inherits from "),Oi=a("a"),f1=i("FlaxPreTrainedModel"),_1=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),g1=p(),Ur=a("p"),b1=i(`This model is also a Flax Linen
`),Xr=a("a"),k1=i("flax.nn.Module"),y1=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),v1=p(),xc=a("p"),T1=i("Finally, this model supports inherent JAX features such as:"),w1=p(),bt=a("ul"),zc=a("li"),Qr=a("a"),M1=i("Just-In-Time (JIT) compilation"),$1=p(),Fc=a("li"),Vr=a("a"),x1=i("Automatic Differentiation"),z1=p(),qc=a("li"),Hr=a("a"),F1=i("Vectorization"),q1=p(),Bc=a("li"),Jr=a("a"),B1=i("Parallelization"),j1=p(),ot=a("div"),y(Kr.$$.fragment),C1=p(),wo=a("p"),E1=i("The "),jc=a("code"),P1=i("FlaxMBartPreTrainedModel"),S1=i(" forward method, overrides the "),Cc=a("code"),O1=i("__call__"),A1=i(" special method."),I1=p(),y(Xn.$$.fragment),N1=p(),y(Qn.$$.fragment),D1=p(),Vn=a("div"),y(Zr.$$.fragment),L1=p(),y(Hn.$$.fragment),G1=p(),Jn=a("div"),y(Yr.$$.fragment),W1=p(),y(Kn.$$.fragment),this.h()},l(o){const _=A$('[data-svelte="svelte-1phssyn"]',document.head);l=s(_,"META",{name:!0,content:!0}),_.forEach(t),k=u(o),m=s(o,"H1",{class:!0});var ei=r(m);c=s(ei,"A",{id:!0,class:!0,href:!0});var Ec=r(c);g=s(Ec,"SPAN",{});var Pc=r(g);v(n.$$.fragment,Pc),Pc.forEach(t),Ec.forEach(t),h=u(ei),q=s(ei,"SPAN",{});var Sc=r(q);rt=d(Sc,"MBart and MBart-50"),Sc.forEach(t),ei.forEach(t),ze=u(o),C=s(o,"P",{});var Zn=r(C);Ae=s(Zn,"STRONG",{});var Oc=r(Ae);he=d(Oc,"DISCLAIMER:"),Oc.forEach(t),it=d(Zn," If you see something strange, file a "),me=s(Zn,"A",{href:!0,rel:!0});var Ac=r(me);fe=d(Ac,"Github Issue"),Ac.forEach(t),dt=d(Zn,` and assign
...
example shows how to translate English to Romanian using the `),cd=s(Mo,"EM",{});var rp=r(cd);Qh=d(rp,"facebook/mbart-large-en-ro"),rp.forEach(t),Vh=d(Mo," model."),Mo.forEach(t),ai.forEach(t),np.forEach(t),mp=u(o),v(ka.$$.fragment,o),fp=u(o),Dt=s(o,"H2",{class:!0});var si=r(Dt);$o=s(si,"A",{id:!0,class:!0,href:!0});var ip=r($o);pd=s(ip,"SPAN",{});var dp=r(pd);v(ya.$$.fragment,dp),dp.forEach(t),ip.forEach(t),Hh=u(si),ud=s(si,"SPAN",{});var lp=r(ud);Jh=d(lp,"Overview of MBart-50"),lp.forEach(t),si.forEach(t),_p=u(o),vt=s(o,"P",{});var Ii=r(vt);Kh=d(Ii,"MBart-50 was introduced in the "),va=s(Ii,"A",{href:!0,rel:!0});var R1=r(va);Zh=d(R1,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),R1.forEach(t),Yh=d(Ii,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),hd=s(Ii,"EM",{});var U1=r(hd);em=d(U1,"mbart-large-cc25"),U1.forEach(t),tm=d(Ii,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),Ii.forEach(t),gp=u(o),di=s(o,"P",{});var X1=r(di);om=d(X1,"According to the abstract"),X1.forEach(t),bp=u(o),li=s(o,"P",{});var Q1=r(li);md=s(Q1,"EM",{});var V1=r(md);nm=d(V1,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),V1.forEach(t),Q1.forEach(t),kp=u(o),Lt=s(o,"H3",{class:!0});var su=r(Lt);xo=s(su,"A",{id:!0,class:!0,href:!0});var H1=r(xo);fd=s(H1,"SPAN",{});var J1=r(fd);v(Ta.$$.fragment,J1),J1.forEach(t),H1.forEach(t),am=u(su),_d=s(su,"SPAN",{});var K1=r(_d);sm=d(K1,"Training of MBart-50"),K1.forEach(t),su.forEach(t),yp=u(o),He=s(o,"P",{});var ea=r(He);rm=d(ea,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
for both source and target text i.e the text format is `),gd=s(ea,"CODE",{});var Z1=r(gd);im=d(Z1,"[lang_code] X [eos]"),Z1.forEach(t),dm=d(ea,", where "),bd=s(ea,"CODE",{});var Y1=r(bd);lm=d(Y1,"lang_code"),Y1.forEach(t),cm=d(ea,` is source
