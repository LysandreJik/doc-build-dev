...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,h){$(s,c,h),g=!0},p:D,i(c){g||(w(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){y(s,c)}}}function Nh(N){let s,g,c,h,b,n,p,M,ua,_s,pe,Oe,cn,vt,fa,hn,ga,bs,Se,_a,$t,ba,za,zs,Po,ka,ks,Co,pn,va,vs,te,$a,wt,wa,Ta,Tt,ya,Na,$s,me,Le,mn,yt,Ma,un,Fa,ws,Z,Nt,xa,ue,ja,qo,Pa,Ca,Mt,qa,Ea,Aa,fe,Oa,Eo,Sa,La,Ao,Ia,Da,Ba,Ie,Ts,ge,De,fn,Ft,Wa,gn,Ha,ys,F,xt,Qa,_n,Ua,Va,jt,Ra,Oo,Za,Ja,Ka,Pt,Ga,Ct,Xa,Ya,er,qt,tr,Et,or,nr,sr,j,ar,bn,rr,ir,zn,lr,dr,kn,cr,hr,vn,pr,mr,$n,ur,fr,wn,gr,_r,br,J,At,zr,_e,kr,So,vr,$r,Tn,wr,Tr,yr,Be,Nr,We,Ns,be,He,yn,Ot,Mr,Nn,Fr,Ms,C,St,xr,ze,jr,Mn,Pr,Cr,Fn,qr,Er,Ar,Lt,Or,Lo,Sr,Lr,Ir,It,Dr,Dt,Br,Wr,Hr,K,Bt,Qr,ke,Ur,Io,Vr,Rr,xn,Zr,Jr,Kr,Qe,Gr,Ue,Fs,ve,Ve,jn,Wt,Xr,Pn,Yr,xs,q,Ht,ei,Qt,ti,Cn,oi,ni,si,Ut,ai,Do,ri,ii,li,Vt,di,Rt,ci,hi,pi,W,Zt,mi,$e,ui,Bo,fi,gi,qn,_i,bi,zi,Re,ki,Ze,vi,Je,js,we,Ke,En,Jt,$i,An,wi,Ps,E,Kt,Ti,Gt,yi,On,Ni,Mi,Fi,Xt,xi,Wo,ji,Pi,Ci,Yt,qi,eo,Ei,Ai,Oi,G,to,Si,Te,Li,Ho,Ii,Di,Sn,Bi,Wi,Hi,Ge,Qi,Xe,Cs,ye,Ye,Ln,oo,Ui,In,Vi,qs,A,no,Ri,Dn,Zi,Ji,so,Ki,Qo,Gi,Xi,Yi,ao,el,ro,tl,ol,nl,x,io,sl,Ne,al,Uo,rl,il,Bn,ll,dl,cl,et,hl,tt,pl,ot,ml,nt,ul,st,Es,Me,at,Wn,lo,fl,Hn,gl,As,O,co,_l,Qn,bl,zl,ho,kl,Vo,vl,$l,wl,po,Tl,mo,yl,Nl,Ml,X,uo,Fl,Fe,xl,Ro,jl,Pl,Un,Cl,ql,El,rt,Al,it,Os,xe,lt,Vn,fo,Ol,Rn,Sl,Ss,S,go,Ll,Zn,Il,Dl,_o,Bl,Zo,Wl,Hl,Ql,bo,Ul,zo,Vl,Rl,Zl,H,ko,Jl,je,Kl,Jo,Gl,Xl,Jn,Yl,ed,td,dt,od,ct,nd,ht,Ls,Pe,pt,Kn,vo,sd,Gn,ad,Is,L,$o,rd,Ce,id,Xn,ld,dd,Yn,cd,hd,pd,wo,md,Ko,ud,fd,gd,To,_d,yo,bd,zd,kd,Q,No,vd,qe,$d,Go,wd,Td,es,yd,Nd,Md,mt,Fd,ut,xd,ft,Ds;return n=new ee({}),vt=new ee({}),yt=new ee({}),Nt=new P({props:{name:"class transformers.NezhaConfig",anchor:"transformers.NezhaConfig",parameters:[{name:"vocab_size",val:" = 21128"},{name:"embedding_size",val:" = 128"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"max_relative_position",val:" = 64"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"classifier_dropout",val:" = 0.1"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 3"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.NezhaConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, optional, defaults to 21128) &#x2014;
Vocabulary size of the NEZHA model. Defines the different tokens that can be represented by the
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/pr_18737/en/model_doc/nezha#transformers.NezhaModel">NezhaModel</a>.`,name:"vocab_size"},{anchor:"transformers.NezhaConfig.embedding_size",description:`<strong>embedding_size</strong> (<code>int</code>, optional, defaults to 128) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L907",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18737/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18737/en/model_doc/nezha#transformers.NezhaConfig"
...
Whether or not to return a <a href="/docs/transformers/pr_18737/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.</p>
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1064",returnDescription:`
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1174",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1267",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18737/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1376",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1474",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1571",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18737/src/transformers/models/nezha/modeling_nezha.py#L1650",returnDescription:`
<p>A <a
...
`),vn=i("code"),pr=a("add_cross_attention"),mr=a(" set to "),$n=i("code"),ur=a("True"),fr=a("; an "),wn=i("code"),gr=a("encoder_hidden_states"),_r=a(" is then expected as an input to the forward pass."),br=m(),J=i("div"),k(At.$$.fragment),zr=m(),_e=i("p"),kr=a("The "),So=i("a"),vr=a("NezhaModel"),$r=a(" forward method, overrides the "),Tn=i("code"),wr=a("__call__"),Tr=a(" special method."),yr=m(),k(Be.$$.fragment),Nr=m(),k(We.$$.fragment),Ns=m(),be=i("h2"),He=i("a"),yn=i("span"),k(Ot.$$.fragment),Mr=m(),Nn=i("span"),Fr=a("NezhaForPreTraining"),Ms=m(),C=i("div"),k(St.$$.fragment),xr=m(),ze=i("p"),jr=a("Nezha Model with two heads on top as done during the pretraining: a "),Mn=i("code"),Pr=a("masked language modeling"),Cr=a(" head and a "),Fn=i("code"),qr=a("next sentence prediction (classification)"),Er=a(" head."),Ar=m(),Lt=i("p"),Or=a("This model inherits from "),Lo=i("a"),Sr=a("PreTrainedModel"),Lr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ir=m(),It=i("p"),Dr=a("This model is also a PyTorch "),Dt=i("a"),Br=a("torch.nn.Module"),Wr=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hr=m(),K=i("div"),k(Bt.$$.fragment),Qr=m(),ke=i("p"),Ur=a("The "),Io=i("a"),Vr=a("NezhaForPreTraining"),Rr=a(" forward method, overrides the "),xn=i("code"),Zr=a("__call__"),Jr=a(" special method."),Kr=m(),k(Qe.$$.fragment),Gr=m(),k(Ue.$$.fragment),Fs=m(),ve=i("h2"),Ve=i("a"),jn=i("span"),k(Wt.$$.fragment),Xr=m(),Pn=i("span"),Yr=a("NezhaForMaskedLM"),xs=m(),q=i("div"),k(Ht.$$.fragment),ei=m(),Qt=i("p"),ti=a("Nezha Model with a "),Cn=i("code"),oi=a("language modeling"),ni=a(" head on top."),si=m(),Ut=i("p"),ai=a("This model inherits from "),Do=i("a"),ri=a("PreTrainedModel"),ii=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),li=m(),Vt=i("p"),di=a("This model is also a PyTorch "),Rt=i("a"),ci=a("torch.nn.Module"),hi=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=m(),W=i("div"),k(Zt.$$.fragment),mi=m(),$e=i("p"),ui=a("The "),Bo=i("a"),fi=a("NezhaForMaskedLM"),gi=a(" forward method, overrides the "),qn=i("code"),_i=a("__call__"),bi=a(" special method."),zi=m(),k(Re.$$.fragment),ki=m(),k(Ze.$$.fragment),vi=m(),k(Je.$$.fragment),js=m(),we=i("h2"),Ke=i("a"),En=i("span"),k(Jt.$$.fragment),$i=m(),An=i("span"),wi=a("NezhaForNextSentencePrediction"),Ps=m(),E=i("div"),k(Kt.$$.fragment),Ti=m(),Gt=i("p"),yi=a("Nezha Model with a "),On=i("code"),Ni=a("next sentence prediction (classification)"),Mi=a(" head on top."),Fi=m(),Xt=i("p"),xi=a("This model inherits from "),Wo=i("a"),ji=a("PreTrainedModel"),Pi=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ci=m(),Yt=i("p"),qi=a("This model is also a PyTorch "),eo=i("a"),Ei=a("torch.nn.Module"),Ai=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Oi=m(),G=i("div"),k(to.$$.fragment),Si=m(),Te=i("p"),Li=a("The "),Ho=i("a"),Ii=a("NezhaForNextSentencePrediction"),Di=a(" forward method, overrides the "),Sn=i("code"),Bi=a("__call__"),Wi=a(" special method."),Hi=m(),k(Ge.$$.fragment),Qi=m(),k(Xe.$$.fragment),Cs=m(),ye=i("h2"),Ye=i("a"),Ln=i("span"),k(oo.$$.fragment),Ui=m(),In=i("span"),Vi=a("NezhaForSequenceClassification"),qs=m(),A=i("div"),k(no.$$.fragment),Ri=m(),Dn=i("p"),Zi=a(`Nezha Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
documentation from `),Ao=l(Xo,"A",{href:!0});var Cd=d(Ao);Ia=r(Cd,"PretrainedConfig"),Cd.forEach(o),Da=r(Xo," for more information."),Xo.forEach(o),Ba=u(Y),v(Ie.$$.fragment,Y),Y.forEach(o),Ts=u(t),ge=l(t,"H2",{class:!0});var Bs=d(ge);De=l(Bs,"A",{id:!0,class:!0,href:!0});var qd=d(De);fn=l(qd,"SPAN",{});var Ed=d(fn);v(Ft.$$.fragment,Ed),Ed.forEach(o),qd.forEach(o),Wa=u(Bs),gn=l(Bs,"SPAN",{});var Ad=d(gn);Ha=r(Ad,"NezhaModel"),Ad.forEach(o),Bs.forEach(o),ys=u(t),F=l(t,"DIV",{class:!0});var U=d(F);v(xt.$$.fragment,U),Qa=u(U),_n=l(U,"P",{});var Od=d(_n);Ua=r(Od,"The bare Nezha Model transformer outputting raw hidden-states without any specific head on top."),Od.forEach(o),Va=u(U),jt=l(U,"P",{});var Ws=d(jt);Ra=r(Ws,"This model inherits from "),Oo=l(Ws,"A",{href:!0});var Sd=d(Oo);Za=r(Sd,"PreTrainedModel"),Sd.forEach(o),Ja=r(Ws,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta.forEach(o),Oi=u(ae),G=l(ae,"DIV",{class:!0});var bt=d(G);v(to.$$.fragment,bt),Si=u(bt),Te=l(bt,"P",{});var nn=d(Te);Li=r(nn,"The "),Ho=l(nn,"A",{href:!0});var _c=d(Ho);Ii=r(_c,"NezhaForNextSentencePrediction"),_c.forEach(o),Di=r(nn," forward method, overrides the "),Sn=l(nn,"CODE",{});var bc=d(Sn);Bi=r(bc,"__call__"),bc.forEach(o),Wi=r(nn," special method."),nn.forEach(o),Hi=u(bt),v(Ge.$$.fragment,bt),Qi=u(bt),v(Xe.$$.fragment,bt),bt.forEach(o),ae.forEach(o),Cs=u(t),ye=l(t,"H2",{class:!0});var oa=d(ye);Ye=l(oa,"A",{id:!0,class:!0,href:!0});var zc=d(Ye);Ln=l(zc,"SPAN",{});var kc=d(Ln);v(oo.$$.fragment,kc),kc.forEach(o),zc.forEach(o),Ui=u(oa),In=l(oa,"SPAN",{});var vc=d(In);Vi=r(vc,"NezhaForSequenceClassification"),vc.forEach(o),oa.forEach(o),qs=u(t),A=l(t,"DIV",{class:!0});var re=d(A);v(no.$$.fragment,re),Ri=u(re),Dn=l(re,"P",{});var $c=d(Dn);Zi=r($c,`Nezha Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
