...
to the `),Ro=o("a"),e9=a("following documentation"),s9=a("."),sy=u(),Wt=o("p"),t9=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=o("a"),a9=a(`the DeepSpeedExamples
repo`),n9=a(":"),ty=u(),f(Uo.$$.fragment),ay=u(),Ft=o("p"),o9=a(`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Ff=o("code"),l9=a(".json"),r9=a(" files with:"),ny=u(),f(Go.$$.fragment),oy=u(),Vt=o("p"),p9=a("Some more examples are to be found in the "),Mo=o("a"),i9=a("main repo"),u9=a(" as well."),ly=u(),hi=o("p"),c9=a(`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),ry=u(),ne=o("p"),h9=a(`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Vf=o("code"),f9=a("AdamW"),d9=a(" optimizer and "),Yf=o("code"),m9=a("WarmupLR"),_9=a(` scheduler and will enable mixed
precision training if `),Kf=o("code"),v9=a("--fp16"),j9=a(" is passed:"),py=u(),f(Lo.$$.fragment),iy=u(),Yt=o("p"),w9=a("When you execute the program, DeepSpeed will log the configuration it received from the "),fi=o("a"),y9=a("Trainer"),g9=a(`
to the console, so you can see exactly what was the final configuration passed to it.`),uy=u(),di=o("a"),cy=u(),As=o("h3"),Kt=o("a"),Jf=o("span"),f(Zo.$$.fragment),b9=u(),Xf=o("span"),q9=a("Passing Configuration"),hy=u(),U=o("p"),E9=a(`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),mi=o("a"),$9=a("Trainer"),k9=a(" via "),_i=o("a"),P9=a("TrainingArguments"),z9=a(" then for the "),Qf=o("code"),D9=a("deepspeed"),O9=a(` argument you can
pass a nested `),ed=o("code"),A9=a("dict"),T9=a(`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),vi=o("a"),S9=a("TrainingArguments"),C9=a("."),fy=u(),ji=o("p"),x9=a("To summarize you can do:"),dy=u(),f(No.$$.fragment),my=u(),wi=o("p"),R9=a("or:"),_y=u(),f(Ho.$$.fragment),vy=u(),yi=o("a"),jy=u(),Ts=o("h3"),Jt=o("a"),sd=o("span"),f(Bo.$$.fragment),I9=u(),td=o("span"),U9=a("Shared Configuration"),wy=u(),f(Xt.$$.fragment),yy=u(),Me=o("p"),G9=a("Some configuration values are required by both the "),gi=o("a"),M9=a("Trainer"),L9=a(` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),bi=o("a"),Z9=a("Trainer"),N9=a(" command line arguments."),gy=u(),Qt=o("p"),H9=a(`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),qi=o("a"),B9=a("Trainer"),W9=a(` do the majority
of configuration for you.`),by=u(),Le=o("p"),F9=a("Therefore, in the rest of this guide you will find a special configuration value: "),ad=o("code"),V9=a("auto"),Y9=a(`, which when set will be
...
`),Ei=o("a"),K9=a("Trainer"),J9=a(` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),qy=u(),$i=o("p"),X9=a(`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),Ey=u(),ea=o("p"),Q9=a(`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
...
to the `),Ro=l(pq,"A",{href:!0,rel:!0});var OM=r(Ro);e9=n(OM,"following documentation"),OM.forEach(t),s9=n(pq,"."),pq.forEach(t),sy=c(e),Wt=l(e,"P",{});var iq=r(Wt);t9=n(iq,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=l(iq,"A",{href:!0,rel:!0});var AM=r(Io);a9=n(AM,`the DeepSpeedExamples
repo`),AM.forEach(t),n9=n(iq,":"),iq.forEach(t),ty=c(e),d(Uo.$$.fragment,e),ay=c(e),Ft=l(e,"P",{});var uq=r(Ft);o9=n(uq,`Continuing the code from above, let\u2019s say you\u2019re looking to configure the Lamb optimizer. So you can search through the
example `),Ff=l(uq,"CODE",{});var TM=r(Ff);l9=n(TM,".json"),TM.forEach(t),r9=n(uq," files with:"),uq.forEach(t),ny=c(e),d(Go.$$.fragment,e),oy=c(e),Vt=l(e,"P",{});var cq=r(Vt);p9=n(cq,"Some more examples are to be found in the "),Mo=l(cq,"A",{href:!0,rel:!0});var SM=r(Mo);i9=n(SM,"main repo"),SM.forEach(t),u9=n(cq," as well."),cq.forEach(t),ly=c(e),hi=l(e,"P",{});var CM=r(hi);c9=n(CM,`When using DeepSpeed you always need to supply a DeepSpeed configuration file, yet some configuration parameters have
to be configured via the command line. You will find the nuances in the rest of this guide.`),CM.forEach(t),ry=c(e),ne=l(e,"P",{});var xn=r(ne);h9=n(xn,`To get an idea of what DeepSpeed configuration file looks like, here is one that activates ZeRO stage 2 features,
including optimizer states cpu offload, uses `),Vf=l(xn,"CODE",{});var xM=r(Vf);f9=n(xM,"AdamW"),xM.forEach(t),d9=n(xn," optimizer and "),Yf=l(xn,"CODE",{});var RM=r(Yf);m9=n(RM,"WarmupLR"),RM.forEach(t),_9=n(xn,` scheduler and will enable mixed
precision training if `),Kf=l(xn,"CODE",{});var IM=r(Kf);v9=n(IM,"--fp16"),IM.forEach(t),j9=n(xn," is passed:"),xn.forEach(t),py=c(e),d(Lo.$$.fragment,e),iy=c(e),Yt=l(e,"P",{});var hq=r(Yt);w9=n(hq,"When you execute the program, DeepSpeed will log the configuration it received from the "),fi=l(hq,"A",{href:!0});var UM=r(fi);y9=n(UM,"Trainer"),UM.forEach(t),g9=n(hq,`
to the console, so you can see exactly what was the final configuration passed to it.`),hq.forEach(t),uy=c(e),di=l(e,"A",{id:!0}),r(di).forEach(t),cy=c(e),As=l(e,"H3",{class:!0});var fq=r(As);Kt=l(fq,"A",{id:!0,class:!0,href:!0});var GM=r(Kt);Jf=l(GM,"SPAN",{});var MM=r(Jf);d(Zo.$$.fragment,MM),MM.forEach(t),GM.forEach(t),b9=c(fq),Xf=l(fq,"SPAN",{});var LM=r(Xf);q9=n(LM,"Passing Configuration"),LM.forEach(t),fq.forEach(t),hy=c(e),U=l(e,"P",{});var ye=r(U);E9=n(ye,`As discussed in this document normally the DeepSpeed configuration is passed as a path to a json file, but if you\u2019re
not using the command line interface to configure the training, and instead instantiate the
`),mi=l(ye,"A",{href:!0});var ZM=r(mi);$9=n(ZM,"Trainer"),ZM.forEach(t),k9=n(ye," via "),_i=l(ye,"A",{href:!0});var NM=r(_i);P9=n(NM,"TrainingArguments"),NM.forEach(t),z9=n(ye," then for the "),Qf=l(ye,"CODE",{});var HM=r(Qf);D9=n(HM,"deepspeed"),HM.forEach(t),O9=n(ye,` argument you can
pass a nested `),ed=l(ye,"CODE",{});var BM=r(ed);A9=n(BM,"dict"),BM.forEach(t),T9=n(ye,`. This allows you to create the configuration on the fly and doesn\u2019t require you to write it to
the file system before passing it to `),vi=l(ye,"A",{href:!0});var WM=r(vi);S9=n(WM,"TrainingArguments"),WM.forEach(t),C9=n(ye,"."),ye.forEach(t),fy=c(e),ji=l(e,"P",{});var FM=r(ji);x9=n(FM,"To summarize you can do:"),FM.forEach(t),dy=c(e),d(No.$$.fragment,e),my=c(e),wi=l(e,"P",{});var VM=r(wi);R9=n(VM,"or:"),VM.forEach(t),_y=c(e),d(Ho.$$.fragment,e),vy=c(e),yi=l(e,"A",{id:!0}),r(yi).forEach(t),jy=c(e),Ts=l(e,"H3",{class:!0});var dq=r(Ts);Jt=l(dq,"A",{id:!0,class:!0,href:!0});var YM=r(Jt);sd=l(YM,"SPAN",{});var KM=r(sd);d(Bo.$$.fragment,KM),KM.forEach(t),YM.forEach(t),I9=c(dq),td=l(dq,"SPAN",{});var JM=r(td);U9=n(JM,"Shared Configuration"),JM.forEach(t),dq.forEach(t),wy=c(e),d(Xt.$$.fragment,e),yy=c(e),Me=l(e,"P",{});var oh=r(Me);G9=n(oh,"Some configuration values are required by both the "),gi=l(oh,"A",{href:!0});var XM=r(gi);M9=n(XM,"Trainer"),XM.forEach(t),L9=n(oh,` and DeepSpeed to function correctly,
therefore, to prevent conflicting definitions, which could lead to hard to detect errors, we chose to configure those
via the `),bi=l(oh,"A",{href:!0});var QM=r(bi);Z9=n(QM,"Trainer"),QM.forEach(t),N9=n(oh," command line arguments."),oh.forEach(t),gy=c(e),Qt=l(e,"P",{});var mq=r(Qt);H9=n(mq,`Additionally, some configuration values are derived automatically based on the model\u2019s configuration, so instead of
remembering to manually adjust multiple values, it\u2019s the best to let the `),qi=l(mq,"A",{href:!0});var eL=r(qi);B9=n(eL,"Trainer"),eL.forEach(t),W9=n(mq,` do the majority
of configuration for you.`),mq.forEach(t),by=c(e),Le=l(e,"P",{});var lh=r(Le);F9=n(lh,"Therefore, in the rest of this guide you will find a special configuration value: "),ad=l(lh,"CODE",{});var sL=r(ad);V9=n(sL,"auto"),sL.forEach(t),Y9=n(lh,`, which when set will be
automatically replaced with the correct or most efficient value. Please feel free to choose to ignore this
recommendation and set the values explicitly, in which case be very careful that your the
`),Ei=l(lh,"A",{href:!0});var tL=r(Ei);K9=n(tL,"Trainer"),tL.forEach(t),J9=n(lh,` arguments and DeepSpeed configurations agree. For example, are you using the same
learning rate, or batch size, or gradient accumulation settings? if these mismatch the training may fail in very
difficult to detect ways. You have been warned.`),lh.forEach(t),qy=c(e),$i=l(e,"P",{});var aL=r($i);X9=n(aL,`There are multiple other values that are specific to DeepSpeed-only and those you will have to set manually to suit
your needs.`),aL.forEach(t),Ey=c(e),ea=l(e,"P",{});var _q=r(ea);Q9=n(_q,`In your own programs, you can also use the following approach if you\u2019d like to modify the DeepSpeed config as a master
