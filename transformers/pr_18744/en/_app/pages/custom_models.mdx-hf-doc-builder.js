...
after checking the validity of a few of them.`),Fs=c(),p($e.$$.fragment),Hs=c(),Qe=r("p"),_a=o("The three important things to remember when writing you own configuration are the following:"),Ss=c(),x=r("ul"),ke=r("li"),ga=o("you have to inherit from "),Ht=r("code"),ya=o("PretrainedConfig"),wa=o(","),ba=c(),U=r("li"),va=o("the "),St=r("code"),$a=o("__init__"),ka=o(" of your "),Bt=r("code"),Ea=o("PretrainedConfig"),ja=o(" must accept any kwargs,"),Ca=c(),K=r("li"),Pa=o("those "),Wt=r("code"),Aa=o("kwargs"),Ta=o(" need to be passed to the superclass "),Lt=r("code"),Ma=o("__init__"),Ra=o("."),Bs=c(),O=r("p"),qa=o(`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Ws=c(),D=r("p"),Da=o("Defining a "),Gt=r("code"),Fa=o("model_type"),Ha=o(" for your configuration (here "),Ut=r("code"),Sa=o('model_type="resnet"'),Ba=o(`) is not mandatory, unless you want to
...
directly upload your config to the Hub.`),Ks=c(),V=r("h2"),oe=r("a"),Qt=r("span"),p(Ce.$$.fragment),tn=c(),Xt=r("span"),sn=o("Writing a custom model"),Vs=c(),H=r("p"),on=o(`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
easy to transfer those weights:`),lo=c(),p(Me.$$.fragment),io=c(),B=r("p"),On=o("Now let\u2019s see how to make sure that when we do "),ct=r("a"),Dn=o("save_pretrained()"),Fn=o(" or "),dt=r("a"),Hn=o("push_to_hub()"),Sn=o(`, the
code of the model is saved.`),fo=c(),J=r("h2"),re=r("a"),ns=r("span"),p(Re.$$.fragment),Bn=c(),rs=r("span"),Wn=o("Sending the code to the Hub"),co=c(),p(le.$$.fragment),ho=c(),$=r("p"),Ln=o("First, make sure your model is fully defined in a "),ls=r("code"),Yn=o(".py"),zn=o(` file. It can rely on relative imports to some other files as
...
in this `),He=r("a"),Cr=o("model repo"),Pr=o("."),Ro=c(),de=r("p"),Ar=o("See the "),wt=r("a"),Tr=o("sharing tutorial"),Mr=o(" for more information on the push to Hub method."),qo=c(),Q=r("h2"),he=r("a"),ws=r("span"),p(Se.$$.fragment),Rr=c(),bs=r("span"),qr=o("Using a model with custom code"),Io=c(),R=r("p"),Ir=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
the `),vs=r("code"),Nr=o("from_pretrained"),xr=o(" method. All files and code uploaded to the Hub are scanned for malware (refer to the "),Be=r("a"),Or=o("Hub security"),Dr=o(` documentation for more information), but you should still
review the model code and author to avoid executing malicious code on your machine. Set `),$s=r("code"),Fr=o("trust_remote_code=True"),Hr=o(` to use
a model with custom code:`),No=c(),p(We.$$.fragment),xo=c(),me=r("p"),Sr=o("It is also strongly encouraged to pass a commit hash as a "),ks=r("code"),Br=o("revision"),Wr=o(` to make sure the author of the models did not
...
hash of any commit.`),Fo=c(),X=r("h2"),ue=r("a"),Es=r("span"),p(Ye.$$.fragment),Yr=c(),js=r("span"),zr=o("Registering a model with custom code to the auto classes"),Ho=c(),vt=r("p"),Gr=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
classes have the right `),Ps=r("code"),Jr=o("config_class"),Qr=o(" attributes, you can just add them to the auto classes likes this:"),Bo=c(),p(ze.$$.fragment),Wo=c(),q=r("p"),Xr=o("Note that the first argument used when registering your custom config to "),$t=r("a"),Zr=o("AutoConfig"),el=o(" needs to match the "),As=r("code"),tl=o("model_type"),sl=o(`
...
configurations will then give us the different types of ResNets that are possible. We then just store those arguments,
after checking the validity of a few of them.`),pl.forEach(s),Fs=d(e),_($e.$$.fragment,e),Hs=d(e),Qe=l(e,"P",{});var _l=i(Qe);_a=a(_l,"The three important things to remember when writing you own configuration are the following:"),_l.forEach(s),Ss=d(e),x=l(e,"UL",{});var Et=i(x);ke=l(Et,"LI",{});var Go=i(ke);ga=a(Go,"you have to inherit from "),Ht=l(Go,"CODE",{});var gl=i(Ht);ya=a(gl,"PretrainedConfig"),gl.forEach(s),wa=a(Go,","),Go.forEach(s),ba=d(Et),U=l(Et,"LI",{});var jt=i(U);va=a(jt,"the "),St=l(jt,"CODE",{});var yl=i(St);$a=a(yl,"__init__"),yl.forEach(s),ka=a(jt," of your "),Bt=l(jt,"CODE",{});var wl=i(Bt);Ea=a(wl,"PretrainedConfig"),wl.forEach(s),ja=a(jt," must accept any kwargs,"),jt.forEach(s),Ca=d(Et),K=l(Et,"LI",{});var Ct=i(K);Pa=a(Ct,"those "),Wt=l(Ct,"CODE",{});var bl=i(Wt);Aa=a(bl,"kwargs"),bl.forEach(s),Ta=a(Ct," need to be passed to the superclass "),Lt=l(Ct,"CODE",{});var vl=i(Lt);Ma=a(vl,"__init__"),vl.forEach(s),Ra=a(Ct,"."),Ct.forEach(s),Et.forEach(s),Bs=d(e),O=l(e,"P",{});var Pt=i(O);qa=a(Pt,`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Pt.forEach(s),Ws=d(e),D=l(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Gt=l(At,"CODE",{});var El=i(Gt);Fa=a(El,"model_type"),El.forEach(s),Ha=a(At," for your configuration (here "),Ut=l(At,"CODE",{});var jl=i(Ut);Sa=a(jl,'model_type="resnet"'),jl.forEach(s),Ba=a(At,`) is not mandatory, unless you want to
...
we will use the pretrained version of the resnet50d. Since our model is just a wrapper around it, it\u2019s going to be
easy to transfer those weights:`),Vl.forEach(s),lo=d(e),_(Me.$$.fragment,e),io=d(e),B=l(e,"P",{});var qt=i(B);On=a(qt,"Now let\u2019s see how to make sure that when we do "),ct=l(qt,"A",{href:!0});var Jl=i(ct);Dn=a(Jl,"save_pretrained()"),Jl.forEach(s),Fn=a(qt," or "),dt=l(qt,"A",{href:!0});var Ql=i(dt);Hn=a(Ql,"push_to_hub()"),Ql.forEach(s),Sn=a(qt,`, the
code of the model is saved.`),qt.forEach(s),fo=d(e),J=l(e,"H2",{class:!0});var Vo=i(J);re=l(Vo,"A",{id:!0,class:!0,href:!0});var Xl=i(re);ns=l(Xl,"SPAN",{});var Zl=i(ns);_(Re.$$.fragment,Zl),Zl.forEach(s),Xl.forEach(s),Bn=d(Vo),rs=l(Vo,"SPAN",{});var ei=i(rs);Wn=a(ei,"Sending the code to the Hub"),ei.forEach(s),Vo.forEach(s),co=d(e),_(le.$$.fragment,e),ho=d(e),$=l(e,"P",{});var j=i($);Ln=a(j,"First, make sure your model is fully defined in a "),ls=l(j,"CODE",{});var ti=i(ls);Yn=a(ti,".py"),ti.forEach(s),zn=a(j,` file. It can rely on relative imports to some other files as
long as all the files are in the same directory (we don\u2019t support submodules for this feature yet). For our example,
...
in this `),He=l(ge,"A",{href:!0,rel:!0});var bi=i(He);Cr=a(bi,"model repo"),bi.forEach(s),Pr=a(ge,"."),ge.forEach(s),Ro=d(e),de=l(e,"P",{});var Xo=i(de);Ar=a(Xo,"See the "),wt=l(Xo,"A",{href:!0});var vi=i(wt);Tr=a(vi,"sharing tutorial"),vi.forEach(s),Mr=a(Xo," for more information on the push to Hub method."),Xo.forEach(s),qo=d(e),Q=l(e,"H2",{class:!0});var Zo=i(Q);he=l(Zo,"A",{id:!0,class:!0,href:!0});var $i=i(he);ws=l($i,"SPAN",{});var ki=i(ws);_(Se.$$.fragment,ki),ki.forEach(s),$i.forEach(s),Rr=d(Zo),bs=l(Zo,"SPAN",{});var Ei=i(bs);qr=a(Ei,"Using a model with custom code"),Ei.forEach(s),Zo.forEach(s),Io=d(e),R=l(e,"P",{});var ye=i(R);Ir=a(ye,`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
the `),vs=l(ye,"CODE",{});var ji=i(vs);Nr=a(ji,"from_pretrained"),ji.forEach(s),xr=a(ye," method. All files and code uploaded to the Hub are scanned for malware (refer to the "),Be=l(ye,"A",{href:!0,rel:!0});var Ci=i(Be);Or=a(Ci,"Hub security"),Ci.forEach(s),Dr=a(ye,` documentation for more information), but you should still
review the model code and author to avoid executing malicious code on your machine. Set `),$s=l(ye,"CODE",{});var Pi=i($s);Fr=a(Pi,"trust_remote_code=True"),Pi.forEach(s),Hr=a(ye,` to use
a model with custom code:`),ye.forEach(s),No=d(e),_(We.$$.fragment,e),xo=d(e),me=l(e,"P",{});var ea=i(me);Sr=a(ea,"It is also strongly encouraged to pass a commit hash as a "),ks=l(ea,"CODE",{});var Ai=i(ks);Br=a(Ai,"revision"),Ai.forEach(s),Wr=a(ea,` to make sure the author of the models did not
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=l(e,"H2",{class:!0});var ta=i(X);ue=l(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=l(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yr=d(ta),js=l(ta,"SPAN",{});var qi=i(js);zr=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),Ho=d(e),vt=l(e,"P",{});var Ii=i(vt);Gr=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
