...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/pr_18711/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/pr_18711/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18711/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18711/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1255",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1466",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1568",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_mobilebert.py#L1358",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18711/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
splitting and wordpiece.`),Sd.forEach(t),fh=m(Bt),fs=a(Bt,"P",{});var Mc=i(fs);uh=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var C1=i(Pa);gh=s(C1,"BertTokenizerFast"),C1.forEach(t),_h=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=m(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var j1=i(Ao);Ii=a(j1,"SPAN",{});var N1=i(Ii);y(us.$$.fragment,N1),N1.forEach(t),j1.forEach(t),bh=m($c),Li=a($c,"SPAN",{});var O1=i(Li);Th=s(O1,"MobileBert specific outputs"),O1.forEach(t),$c.forEach(t),Rd=m(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),kh=m(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vh=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var S1=i(qa);yh=s(S1,"MobileBertForPreTraining"),S1.forEach(t),wh=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=m(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mh=m(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$h=s(xc,"Output type of "),Ca=a(xc,"A",{href:!0});var A1=i(Ca);Fh=s(A1,"TFMobileBertForPreTraining"),A1.forEach(t),Bh=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=m(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var I1=i(Io);Di=a(I1,"SPAN",{});var L1=i(Di);y(ks.$$.fragment,L1),L1.forEach(t),I1.forEach(t),Eh=m(zc),Wi=a(zc,"SPAN",{});var D1=i(Wi);xh=s(D1,"MobileBertModel"),D1.forEach(t),zc.forEach(t),Qd=m(o),je=a(o,"DIV",{class:!0});var ut=i(je);y(vs.$$.fragment,ut),zh=m(ut),Ri=a(ut,"P",{});var W1=i(Ri);Ph=s(W1,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),W1.forEach(t),qh=m(ut),ys=a(ut,"P",{});var Pc=i(ys);Ch=s(Pc,"This model inherits from "),ja=a(Pc,"A",{href:!0});var R1=i(ja);jh=s(R1,"PreTrainedModel"),R1.forEach(t),Nh=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Ef=m(qt),Ce=a(qt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),xf=m(nt),so=a(nt,"P",{});var _i=i(so);zf=s(_i,"The "),Ra=a(_i,"A",{href:!0});var FT=i(Ra);Pf=s(FT,"MobileBertForSequenceClassification"),FT.forEach(t),qf=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var BT=i(ll);Cf=s(BT,"__call__"),BT.forEach(t),jf=s(_i," special method."),_i.forEach(t),Nf=m(nt),y(Xo.$$.fragment,nt),Of=m(nt),y(en.$$.fragment,nt),Sf=m(nt),y(tn.$$.fragment,nt),Af=m(nt),y(on.$$.fragment,nt),If=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var ET=i(sn);dl=a(ET,"SPAN",{});var xT=i(dl);y(Xs.$$.fragment,xT),xT.forEach(t),ET.forEach(t),Lf=m(Kc),cl=a(Kc,"SPAN",{});var zT=i(cl);Df=s(zT,"MobileBertForMultipleChoice"),zT.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Wf=m(Ct),pl=a(Ct,"P",{});var PT=i(pl);Rf=s(PT,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),PT.forEach(t),Uf=m(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Hf=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qT=i(Ua);Qf=s(qT,"PreTrainedModel"),qT.forEach(t),Kf=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Vf=m(Ct),or=a(Ct,"P",{});var Gc=i(or);Gf=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var CT=i(nr);Yf=s(CT,"torch.nn.Module"),CT.forEach(t),Jf=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Zf=m(Ct),ct=a(Ct,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Xf=m(os),ao=a(os,"P",{});var bi=i(ao);eu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var jT=i(Ha);tu=s(jT,"MobileBertForMultipleChoice"),jT.forEach(t),ou=s(bi," forward method, overrides the "),hl=a(bi,"CODE",{});var NT=i(hl);nu=s(NT,"__call__"),NT.forEach(t),su=s(bi," special method."),bi.forEach(t),ru=m(os),y(rn.$$.fragment,os),au=m(os),y(an.$$.fragment,os),os.forEach(t),Ct.forEach(t),nc=m(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var OT=i(ln);ml=a(OT,"SPAN",{});var ST=i(ml);y(rr.$$.fragment,ST),ST.forEach(t),OT.forEach(t),iu=m(Yc),fl=a(Yc,"SPAN",{});var AT=i(fl);lu=s(AT,"MobileBertForTokenClassification"),AT.forEach(t),Yc.forEach(t),sc=m(o),Ve=a(o,"DIV",{class:!0});var jt=i(Ve);y(ar.$$.fragment,jt),du=m(jt),ul=a(jt,"P",{});var IT=i(ul);cu=s(IT,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),IT.forEach(t),pu=m(jt),ir=a(jt,"P",{});var Jc=i(ir);hu=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var LT=i(Qa);mu=s(LT,"PreTrainedModel"),LT.forEach(t),fu=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),uu=m(jt),lr=a(jt,"P",{});var Zc=i(lr);gu=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var DT=i(dr);_u=s(DT,"torch.nn.Module"),DT.forEach(t),bu=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tu=m(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),ku=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vu=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var WT=i(Ka);yu=s(WT,"MobileBertForTokenClassification"),WT.forEach(t),wu=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var RT=i(gl);Mu=s(RT,"__call__"),RT.forEach(t),$u=s(Ti," special method."),Ti.forEach(t),Fu=m(Nt),y(dn.$$.fragment,Nt),Bu=m(Nt),y(cn.$$.fragment,Nt),Eu=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var UT=i(hn);_l=a(UT,"SPAN",{});var HT=i(_l);y(pr.$$.fragment,HT),HT.forEach(t),UT.forEach(t),xu=m(Xc),bl=a(Xc,"SPAN",{});var QT=i(bl);zu=s(QT,"MobileBertForQuestionAnswering"),QT.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),Pu=m(Ot),po=a(Ot,"P",{});var ki=i(po);qu=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var KT=i(Tl);Cu=s(KT,"span start logits"),KT.forEach(t),ju=s(ki," and "),kl=a(ki,"CODE",{});var VT=i(kl);Nu=s(VT,"span end logits"),VT.forEach(t),Ou=s(ki,")."),ki.forEach(t),Su=m(Ot),mr=a(Ot,"P",{});var ep=i(mr);Au=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var GT=i(Va);Iu=s(GT,"PreTrainedModel"),GT.forEach(t),Lu=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
