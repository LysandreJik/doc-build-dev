...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/pr_18711/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18711/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18711/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_tf_t5.py#L1146",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_tf_t5.py#L1322",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18711/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18711/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18711/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_tf_t5.py#L1569",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18711/src/transformers/models/t5/modeling_flax_t5.py#L987",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),m1=d(),v(Xn.$$.fragment),f1=d(),ft=a("div"),v(Ca.$$.fragment),_1=d(),tn=a("p"),g1=o("The "),Br=a("a"),T1=o("TFT5ForConditionalGeneration"),b1=o(" forward method, overrides the "),cd=a("code"),v1=o("__call__"),k1=o(" special method."),y1=d(),v(Qn.$$.fragment),w1=d(),v(eo.$$.fragment),tp=d(),nn=a("h2"),to=a("a"),pd=a("span"),v(Pa.$$.fragment),$1=d(),hd=a("span"),x1=o("TFT5EncoderModel"),np=d(),ce=a("div"),v(Na.$$.fragment),z1=d(),ud=a("p"),j1=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),E1=d(),Oa=a("p"),q1=o("The T5 model was proposed in "),La=a("a"),F1=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
`),Ns=r(oi,"A",{href:!0,rel:!0});var Qk=i(Ns);i_=s(Qk,"Unigram"),Qk.forEach(t),l_=s(oi,"."),oi.forEach(t),d_=c(Ot),Os=r(Ot,"P",{});var qp=i(Os);c_=s(qp,"This tokenizer inherits from "),Pr=r(qp,"A",{href:!0});var ey=i(Pr);p_=s(ey,"PreTrainedTokenizerFast"),ey.forEach(t),h_=s(qp,` which contains most of the main methods. Users should
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qp.forEach(t),m1=c(Ye),k(Xn.$$.fragment,Ye),f1=c(Ye),ft=r(Ye,"DIV",{class:!0});var Po=i(ft);k(Ca.$$.fragment,Po),_1=c(Po),tn=r(Po,"P",{});var hi=i(tn);g1=s(hi,"The "),Br=r(hi,"A",{href:!0});var o5=i(Br);T1=s(o5,"TFT5ForConditionalGeneration"),o5.forEach(t),b1=s(hi," forward method, overrides the "),cd=r(hi,"CODE",{});var s5=i(cd);v1=s(s5,"__call__"),s5.forEach(t),k1=s(hi," special method."),hi.forEach(t),y1=c(Po),k(Qn.$$.fragment,Po),w1=c(Po),k(eo.$$.fragment,Po),Po.forEach(t),Ye.forEach(t),tp=c(n),nn=r(n,"H2",{class:!0});var eh=i(nn);to=r(eh,"A",{id:!0,class:!0,href:!0});var a5=i(to);pd=r(a5,"SPAN",{});var r5=i(pd);k(Pa.$$.fragment,r5),r5.forEach(t),a5.forEach(t),$1=c(eh),hd=r(eh,"SPAN",{});var i5=i(hd);x1=s(i5,"TFT5EncoderModel"),i5.forEach(t),eh.forEach(t),np=c(n),ce=r(n,"DIV",{class:!0});var Ze=i(ce);k(Na.$$.fragment,Ze),z1=c(Ze),ud=r(Ze,"P",{});var l5=i(ud);j1=s(l5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),l5.forEach(t),E1=c(Ze),Oa=r(Ze,"P",{});var th=i(Oa);q1=s(th,"The T5 model was proposed in "),La=r(th,"A",{href:!0,rel:!0});var d5=i(La);F1=s(d5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
