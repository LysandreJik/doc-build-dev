...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/configuration_mbart.py#L34"}}),qo=new E({props:{anchor:"transformers.MBartConfig.example",$$slots:{default:[NM]},$$scope:{ctx:x}}}),qa=new U({}),Ba=new F({props:{name:"class transformers.MBartTokenizer",anchor:"transformers.MBartTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"tokenizer_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"additional_special_tokens",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/tokenization_mbart.py#L53"}}),jo=new E({props:{anchor:"transformers.MBartTokenizer.example",$$slots:{default:[DM]},$$scope:{ctx:x}}}),Ca=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBartTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/tokenization_mbart_fast.py#L161",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/tokenization_mbart_fast.py#L190",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Qa=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/tokenization_mbart_fast.py#L245"}}),Va=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBartTokenizerFast.set_tgt_lang_special_tokens",parameters:[{name:"lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/tokenization_mbart_fast.py#L260"}}),Ha=new U({}),Ja=new F({props:{name:"class transformers.MBart50Tokenizer",anchor:"transformers.MBart50Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart50/tokenization_mbart50.py#L49"}}),Io=new E({props:{anchor:"transformers.MBart50Tokenizer.example",$$slots:{default:[GM]},$$scope:{ctx:x}}}),es=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.MBart50Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart50/tokenization_mbart50.py#L256",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ds=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart50/tokenization_mbart50.py#L343"}}),ls=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart50/tokenization_mbart50.py#L349"}}),cs=new U({}),ps=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_mbart.py#L1179",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18520/en/model_doc/mbart#transformers.MBartConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_mbart.py#L1313",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
`}}),Ko=new st({props:{$$slots:{default:[XM]},$$scope:{ctx:x}}}),Zo=new E({props:{anchor:"transformers.MBartForConditionalGeneration.forward.example",$$slots:{default:[QM]},$$scope:{ctx:x}}}),Yo=new E({props:{anchor:"transformers.MBartForConditionalGeneration.forward.example-2",$$slots:{default:[VM]},$$scope:{ctx:x}}}),Es=new U({}),Ps=new F({props:{name:"class transformers.MBartForQuestionAnswering",anchor:"transformers.MBartForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18520/en/model_doc/mbart#transformers.MBartConfig">MBartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_18520/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_mbart.py#L1570"}}),Is=new F({props:{name:"forward",anchor:"transformers.MBartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": Tensor = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MBartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18520/en/model_doc/mbart#transformers.MBartTokenizer">MBartTokenizer</a>. See <a href="/docs/transformers/pr_18520/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18520/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_mbart.py#L1582",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_mbart.py#L1455",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_mbart.py#L1734",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used in
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_tf_mbart.py#L1196",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_tf_mbart.py#L1306",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1039",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1102",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1369",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18520/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/mbart/modeling_flax_mbart.py#L1215",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18520/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqQuestionAnsweringModelOutput"
...
documentation from `),fi=s(Di,"A",{href:!0});var g2=r(fi);Gm=d(g2,"PretrainedConfig"),g2.forEach(t),Wm=d(Di," for more information."),Di.forEach(t),Rm=u(ta),v(qo.$$.fragment,ta),ta.forEach(t),Fp=u(o),Ut=s(o,"H2",{class:!0});var lu=r(Ut);Bo=s(lu,"A",{id:!0,class:!0,href:!0});var b2=r(Bo);qd=s(b2,"SPAN",{});var k2=r(qd);v(qa.$$.fragment,k2),k2.forEach(t),b2.forEach(t),Um=u(lu),Bd=s(lu,"SPAN",{});var y2=r(Bd);Xm=d(y2,"MBartTokenizer"),y2.forEach(t),lu.forEach(t),qp=u(o),de=s(o,"DIV",{class:!0});var at=r(de);v(Ba.$$.fragment,at),Qm=u(at),jd=s(at,"P",{});var v2=r(jd);Vm=d(v2,"Construct an MBART tokenizer."),v2.forEach(t),Hm=u(at),mt=s(at,"P",{});var oa=r(mt);Jm=d(oa,"Adapted from "),_i=s(oa,"A",{href:!0});var T2=r(_i);Km=d(T2,"RobertaTokenizer"),T2.forEach(t),Zm=d(oa," and "),gi=s(oa,"A",{href:!0});var w2=r(gi);Ym=d(w2,"XLNetTokenizer"),w2.forEach(t),ef=d(oa,`. Based on
`),ja=s(oa,"A",{href:!0,rel:!0});var M2=r(ja);tf=d(M2,"SentencePiece"),M2.forEach(t),of=d(oa,"."),oa.forEach(t),nf=u(at),Xt=s(at,"P",{});var Li=r(Xt);af=d(Li,"The tokenization method is "),Cd=s(Li,"CODE",{});var $2=r(Cd);sf=d($2,"<tokens> <eos> <language code>"),$2.forEach(t),rf=d(Li," for source language documents, and "),Ed=s(Li,"CODE",{});var x2=r(Ed);df=d(x2,"<language code> <tokens> <eos>"),x2.forEach(t),lf=d(Li," for target language documents."),Li.forEach(t),cf=u(at),v(jo.$$.fragment,at),pf=u(at),Je=s(at,"DIV",{class:!0});var na=r(Je);v(Ca.$$.fragment,na),uf=u(na),Ea=s(na,"P",{});var cu=r(Ea);hf=d(cu,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Pd=s(cu,"CODE",{});var z2=r(Pd);mf=d(z2,"X"),z2.forEach(t),ff=d(cu," represents the sequence:"),cu.forEach(t),_f=u(na),Pa=s(na,"UL",{});var pu=r(Pa);Sa=s(pu,"LI",{});var uu=r(Sa);Sd=s(uu,"CODE",{});var F2=r(Sd);gf=d(F2,"input_ids"),F2.forEach(t),bf=d(uu," (for encoder) "),Od=s(uu,"CODE",{});var q2=r(Od);kf=d(q2,"X [eos, src_lang_code]"),q2.forEach(t),uu.forEach(t),yf=u(pu),Oa=s(pu,"LI",{});var hu=r(Oa);Ad=s(hu,"CODE",{});var B2=r(Ad);vf=d(B2,"decoder_input_ids"),B2.forEach(t),Tf=d(hu,": (for decoder) "),Id=s(hu,"CODE",{});var j2=r(Id);wf=d(j2,"X [eos, tgt_lang_code]"),j2.forEach(t),hu.forEach(t),pu.forEach(t),Mf=u(na),Nd=s(na,"P",{});var C2=r(Nd);$f=d(C2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),C2.forEach(t),na.forEach(t),at.forEach(t),Bp=u(o),Qt=s(o,"H2",{class:!0});var mu=r(Qt);Co=s(mu,"A",{id:!0,class:!0,href:!0});var E2=r(Co);Dd=s(E2,"SPAN",{});var P2=r(Dd);v(Aa.$$.fragment,P2),P2.forEach(t),E2.forEach(t),xf=u(mu),Ld=s(mu,"SPAN",{});var S2=r(Ld);zf=d(S2,"MBartTokenizerFast"),S2.forEach(t),mu.forEach(t),jp=u(o),A=s(o,"DIV",{class:!0});var Z=r(A);v(Ia.$$.fragment,Z),Ff=u(Z),Vt=s(Z,"P",{});var Gi=r(Vt);qf=d(Gi,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Gd=s(Gi,"EM",{});var O2=r(Gd);Bf=d(O2,"tokenizers"),O2.forEach(t),jf=d(Gi,` library). Based on
`),Na=s(Gi,"A",{href:!0,rel:!0});var A2=r(Na);Cf=d(A2,"BPE"),A2.forEach(t),Ef=d(Gi,"."),Gi.forEach(t),Pf=u(Z),Da=s(Z,"P",{});var fu=r(Da);Sf=d(fu,"This tokenizer inherits from "),bi=s(fu,"A",{href:!0});var I2=r(bi);Of=d(I2,"PreTrainedTokenizerFast"),I2.forEach(t),Af=d(fu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),fu.forEach(t),If=u(Z),Ht=s(Z,"P",{});var Wi=r(Ht);Nf=d(Wi,"The tokenization method is "),Wd=s(Wi,"CODE",{});var N2=r(Wd);Df=d(N2,"<tokens> <eos> <language code>"),N2.forEach(t),Lf=d(Wi," for source language documents, and "),Rd=s(Wi,"CODE",{});var D2=r(Rd);Gf=d(D2,"<language code> <tokens> <eos>"),D2.forEach(t),Wf=d(Wi," for target language documents."),Wi.forEach(t),Rf=u(Z),v(Eo.$$.fragment,Z),Uf=u(Z),qe=s(Z,"DIV",{class:!0});var Tt=r(qe);v(La.$$.fragment,Tt),Xf=u(Tt),Ud=s(Tt,"P",{});var L2=r(Ud);Qf=d(L2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),L2.forEach(t),Vf=u(Tt),Ga=s(Tt,"P",{});var _u=r(Ga);Hf=d(_u,"An MBART sequence has the following format, where "),Xd=s(_u,"CODE",{});var G2=r(Xd);Jf=d(G2,"X"),G2.forEach(t),Kf=d(_u," represents the sequence:"),_u.forEach(t),Zf=u(Tt),Wa=s(Tt,"UL",{});var gu=r(Wa);Ra=s(gu,"LI",{});var bu=r(Ra);Qd=s(bu,"CODE",{});var W2=r(Qd);Yf=d(W2,"input_ids"),W2.forEach(t),e_=d(bu," (for encoder) "),Vd=s(bu,"CODE",{});var R2=r(Vd);t_=d(R2,"X [eos, src_lang_code]"),R2.forEach(t),bu.forEach(t),o_=u(gu),Ua=s(gu,"LI",{});var ku=r(Ua);Hd=s(ku,"CODE",{});var U2=r(Hd);n_=d(U2,"decoder_input_ids"),U2.forEach(t),a_=d(ku,": (for decoder) "),Jd=s(ku,"CODE",{});var X2=r(Jd);s_=d(X2,"X [eos, tgt_lang_code]"),X2.forEach(t),ku.forEach(t),gu.forEach(t),r_=u(Tt),Kd=s(Tt,"P",{});var Q2=r(Kd);i_=d(Q2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Q2.forEach(t),Tt.forEach(t),d_=u(Z),Po=s(Z,"DIV",{class:!0});var yu=r(Po);v(Xa.$$.fragment,yu),l_=u(yu),Zd=s(yu,"P",{});var V2=r(Zd);c_=d(V2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),V2.forEach(t),yu.forEach(t),p_=u(Z),So=s(Z,"DIV",{class:!0});var vu=r(So);v(Qa.$$.fragment,vu),u_=u(vu),Yd=s(vu,"P",{});var H2=r(Yd);h_=d(H2,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),H2.forEach(t),vu.forEach(t),m_=u(Z),Oo=s(Z,"DIV",{class:!0});var Tu=r(Oo);v(Va.$$.fragment,Tu),f_=u(Tu),el=s(Tu,"P",{});var J2=r(el);__=d(J2,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),J2.forEach(t),Tu.forEach(t),Z.forEach(t),Cp=u(o),Jt=s(o,"H2",{class:!0});var wu=r(Jt);Ao=s(wu,"A",{id:!0,class:!0,href:!0});var K2=r(Ao);tl=s(K2,"SPAN",{});var Z2=r(tl);v(Ha.$$.fragment,Z2),Z2.forEach(t),K2.forEach(t),g_=u(wu),ol=s(wu,"SPAN",{});var Y2=r(ol);b_=d(Y2,"MBart50Tokenizer"),Y2.forEach(t),wu.forEach(t),Ep=u(o),I=s(o,"DIV",{class:!0});var Y=r(I);v(Ja.$$.fragment,Y),k_=u(Y),Ka=s(Y,"P",{});var Mu=r(Ka);y_=d(Mu,"Construct a MBart50 tokenizer. Based on "),Za=s(Mu,"A",{href:!0,rel:!0});var e1=r(Za);v_=d(e1,"SentencePiece"),e1.forEach(t),T_=d(Mu,"."),Mu.forEach(t),w_=u(Y),Ya=s(Y,"P",{});var $u=r(Ya);M_=d($u,"This tokenizer inherits from "),ki=s($u,"A",{href:!0});var t1=r(ki);$_=d(t1,"PreTrainedTokenizer"),t1.forEach(t),x_=d($u,` which contains most of the main methods. Users should refer to
...
adding special tokens. An MBART-50 sequence has the following format, where `),nl=s(xu,"CODE",{});var o1=r(nl);j_=d(o1,"X"),o1.forEach(t),C_=d(xu," represents the sequence:"),xu.forEach(t),E_=u(aa),os=s(aa,"UL",{});var zu=r(os);ns=s(zu,"LI",{});var Fu=r(ns);al=s(Fu,"CODE",{});var n1=r(al);P_=d(n1,"input_ids"),n1.forEach(t),S_=d(Fu," (for encoder) "),sl=s(Fu,"CODE",{});var a1=r(sl);O_=d(a1,"[src_lang_code] X [eos]"),a1.forEach(t),Fu.forEach(t),A_=u(zu),as=s(zu,"LI",{});var qu=r(as);rl=s(qu,"CODE",{});var s1=r(rl);I_=d(s1,"labels"),s1.forEach(t),N_=d(qu,": (for decoder) "),il=s(qu,"CODE",{});var r1=r(il);D_=d(r1,"[tgt_lang_code] X [eos]"),r1.forEach(t),qu.forEach(t),zu.forEach(t),L_=u(aa),dl=s(aa,"P",{});var i1=r(dl);G_=d(i1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),i1.forEach(t),aa.forEach(t),W_=u(Y),No=s(Y,"DIV",{class:!0});var Bu=r(No);v(ss.$$.fragment,Bu),R_=u(Bu),ll=s(Bu,"P",{});var d1=r(ll);U_=d(d1,"Converts a sequence of tokens (strings for sub-words) in a single string."),d1.forEach(t),Bu.forEach(t),X_=u(Y),Do=s(Y,"DIV",{class:!0});var ju=r(Do);v(rs.$$.fragment,ju),Q_=u(ju),is=s(ju,"P",{});var Cu=r(is);V_=d(Cu,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),cl=s(Cu,"CODE",{});var l1=r(cl);H_=d(l1,"prepare_for_model"),l1.forEach(t),J_=d(Cu," method."),Cu.forEach(t),ju.forEach(t),K_=u(Y),Lo=s(Y,"DIV",{class:!0});var Eu=r(Lo);v(ds.$$.fragment,Eu),Z_=u(Eu),pl=s(Eu,"P",{});var c1=r(pl);Y_=d(c1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),c1.forEach(t),Eu.forEach(t),eg=u(Y),Go=s(Y,"DIV",{class:!0});var Pu=r(Go);v(ls.$$.fragment,Pu),tg=u(Pu),ul=s(Pu,"P",{});var p1=r(ul);og=d(p1,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),p1.forEach(t),Pu.forEach(t),Y.forEach(t),Pp=u(o),Kt=s(o,"H2",{class:!0});var Su=r(Kt);Wo=s(Su,"A",{id:!0,class:!0,href:!0});var u1=r(Wo);hl=s(u1,"SPAN",{});var h1=r(hl);v(cs.$$.fragment,h1),h1.forEach(t),u1.forEach(t),ng=u(Su),ml=s(Su,"SPAN",{});var m1=r(ml);ag=d(m1,"MBart50TokenizerFast"),m1.forEach(t),Su.forEach(t),Sp=u(o),J=s(o,"DIV",{class:!0});var Se=r(J);v(ps.$$.fragment,Se),sg=u(Se),Zt=s(Se,"P",{});var Ri=r(Zt);rg=d(Ri,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),fl=s(Ri,"EM",{});var f1=r(fl);ig=d(f1,"tokenizers"),f1.forEach(t),dg=d(Ri,` library). Based on
`),us=s(Ri,"A",{href:!0,rel:!0});var _1=r(us);lg=d(_1,"BPE"),_1.forEach(t),cg=d(Ri,"."),Ri.forEach(t),pg=u(Se),hs=s(Se,"P",{});var Ou=r(hs);ug=d(Ou,"This tokenizer inherits from "),yi=s(Ou,"A",{href:!0});var g1=r(yi);hg=d(g1,"PreTrainedTokenizerFast"),g1.forEach(t),mg=d(Ou,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Ou.forEach(t),fg=u(Se),v(Ro.$$.fragment,Se),_g=u(Se),Be=s(Se,"DIV",{class:!0});var wt=r(Be);v(ms.$$.fragment,wt),gg=u(wt),_l=s(wt,"P",{});var b1=r(_l);bg=d(b1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),b1.forEach(t),kg=u(wt),fs=s(wt,"P",{});var Au=r(fs);yg=d(Au,"An MBART-50 sequence has the following format, where "),gl=s(Au,"CODE",{});var k1=r(gl);vg=d(k1,"X"),k1.forEach(t),Tg=d(Au," represents the sequence:"),Au.forEach(t),wg=u(wt),_s=s(wt,"UL",{});var Iu=r(_s);gs=s(Iu,"LI",{});var Nu=r(gs);bl=s(Nu,"CODE",{});var y1=r(bl);Mg=d(y1,"input_ids"),y1.forEach(t),$g=d(Nu," (for encoder) "),kl=s(Nu,"CODE",{});var v1=r(kl);xg=d(v1,"[src_lang_code] X [eos]"),v1.forEach(t),Nu.forEach(t),zg=u(Iu),bs=s(Iu,"LI",{});var Du=r(bs);yl=s(Du,"CODE",{});var T1=r(yl);Fg=d(T1,"labels"),T1.forEach(t),qg=d(Du,": (for decoder) "),vl=s(Du,"CODE",{});var w1=r(vl);Bg=d(w1,"[tgt_lang_code] X [eos]"),w1.forEach(t),Du.forEach(t),Iu.forEach(t),jg=u(wt),Tl=s(wt,"P",{});var M1=r(Tl);Cg=d(M1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),M1.forEach(t),wt.forEach(t),Eg=u(Se),Uo=s(Se,"DIV",{class:!0});var Lu=r(Uo);v(ks.$$.fragment,Lu),Pg=u(Lu),wl=s(Lu,"P",{});var $1=r(wl);Sg=d($1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),$1.forEach(t),Lu.forEach(t),Og=u(Se),Xo=s(Se,"DIV",{class:!0});var Gu=r(Xo);v(ys.$$.fragment,Gu),Ag=u(Gu),Ml=s(Gu,"P",{});var x1=r(Ml);Ig=d(x1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),x1.forEach(t),Gu.forEach(t),Se.forEach(t),Op=u(o),Yt=s(o,"H2",{class:!0});var Wu=r(Yt);Qo=s(Wu,"A",{id:!0,class:!0,href:!0});var z1=r(Qo);$l=s(z1,"SPAN",{});var F1=r($l);v(vs.$$.fragment,F1),F1.forEach(t),z1.forEach(t),Ng=u(Wu),xl=s(Wu,"SPAN",{});var q1=r(xl);Dg=d(q1,"MBartModel"),q1.forEach(t),Wu.forEach(t),Ap=u(o),Ge=s(o,"DIV",{class:!0});var sa=r(Ge);v(Ts.$$.fragment,sa),Lg=u(sa),ws=s(sa,"P",{});var Ru=r(ws);Gg=d(Ru,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),vi=s(Ru,"A",{href:!0});var B1=r(vi);Wg=d(B1,"PreTrainedModel"),B1.forEach(t),Rg=d(Ru,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ru.forEach(t),Ug=u(sa),Ms=s(sa,"P",{});var Uu=r(Ms);Xg=d(Uu,"This model is also a PyTorch "),$s=s(Uu,"A",{href:!0,rel:!0});var j1=r($s);Qg=d(j1,"torch.nn.Module"),j1.forEach(t),Vg=d(Uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uu.forEach(t),Hg=u(sa),Ze=s(sa,"DIV",{class:!0});var ra=r(Ze);v(xs.$$.fragment,ra),Jg=u(ra),eo=s(ra,"P",{});var Ui=r(eo);Kg=d(Ui,"The "),Ti=s(Ui,"A",{href:!0});var C1=r(Ti);Zg=d(C1,"MBartModel"),C1.forEach(t),Yg=d(Ui," forward method, overrides the "),zl=s(Ui,"CODE",{});var E1=r(zl);eb=d(E1,"__call__"),E1.forEach(t),tb=d(Ui," special method."),Ui.forEach(t),ob=u(ra),v(Vo.$$.fragment,ra),nb=u(ra),v(Ho.$$.fragment,ra),ra.forEach(t),sa.forEach(t),Ip=u(o),to=s(o,"H2",{class:!0});var Xu=r(to);Jo=s(Xu,"A",{id:!0,class:!0,href:!0});var P1=r(Jo);Fl=s(P1,"SPAN",{});var S1=r(Fl);v(zs.$$.fragment,S1),S1.forEach(t),P1.forEach(t),ab=u(Xu),ql=s(Xu,"SPAN",{});var O1=r(ql);sb=d(O1,"MBartForConditionalGeneration"),O1.forEach(t),Xu.forEach(t),Np=u(o),We=s(o,"DIV",{class:!0});var ia=r(We);v(Fs.$$.fragment,ia),rb=u(ia),qs=s(ia,"P",{});var Qu=r(qs);ib=d(Qu,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),wi=s(Qu,"A",{href:!0});var A1=r(wi);db=d(A1,"PreTrainedModel"),A1.forEach(t),lb=d(Qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qu.forEach(t),cb=u(ia),Bs=s(ia,"P",{});var Vu=r(Bs);pb=d(Vu,"This model is also a PyTorch "),js=s(Vu,"A",{href:!0,rel:!0});var I1=r(js);ub=d(I1,"torch.nn.Module"),I1.forEach(t),hb=d(Vu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vu.forEach(t),mb=u(ia),je=s(ia,"DIV",{class:!0});var Mt=r(je);v(Cs.$$.fragment,Mt),fb=u(Mt),oo=s(Mt,"P",{});var Xi=r(oo);_b=d(Xi,"The "),Mi=s(Xi,"A",{href:!0});var N1=r(Mi);gb=d(N1,"MBartForConditionalGeneration"),N1.forEach(t),bb=d(Xi," forward method, overrides the "),Bl=s(Xi,"CODE",{});var D1=r(Bl);kb=d(D1,"__call__"),D1.forEach(t),yb=d(Xi," special method."),Xi.forEach(t),vb=u(Mt),v(Ko.$$.fragment,Mt),Tb=u(Mt),v(Zo.$$.fragment,Mt),wb=u(Mt),v(Yo.$$.fragment,Mt),Mt.forEach(t),ia.forEach(t),Dp=u(o),no=s(o,"H2",{class:!0});var Hu=r(no);en=s(Hu,"A",{id:!0,class:!0,href:!0});var L1=r(en);jl=s(L1,"SPAN",{});var G1=r(jl);v(Es.$$.fragment,G1),G1.forEach(t),L1.forEach(t),Mb=u(Hu),Cl=s(Hu,"SPAN",{});var W1=r(Cl);$b=d(W1,"MBartForQuestionAnswering"),W1.forEach(t),Hu.forEach(t),Lp=u(o),we=s(o,"DIV",{class:!0});var $t=r(we);v(Ps.$$.fragment,$t),xb=u($t),ao=s($t,"P",{});var Qi=r(ao);zb=d(Qi,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),El=s(Qi,"CODE",{});var R1=r(El);Fb=d(R1,"span start logits"),R1.forEach(t),qb=d(Qi," and "),Pl=s(Qi,"CODE",{});var U1=r(Pl);Bb=d(U1,"span end logits"),U1.forEach(t),jb=d(Qi,")."),Qi.forEach(t),Cb=u($t),Ss=s($t,"P",{});var Ju=r(Ss);Eb=d(Ju,"This model inherits from "),$i=s(Ju,"A",{href:!0});var X1=r($i);Pb=d(X1,"PreTrainedModel"),X1.forEach(t),Sb=d(Ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju.forEach(t),Ob=u($t),Os=s($t,"P",{});var Ku=r(Os);Ab=d(Ku,"This model is also a PyTorch "),As=s(Ku,"A",{href:!0,rel:!0});var Q1=r(As);Ib=d(Q1,"torch.nn.Module"),Q1.forEach(t),Nb=d(Ku,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ku.forEach(t),Db=u($t),Ce=s($t,"DIV",{class:!0});var xt=r(Ce);v(Is.$$.fragment,xt),Lb=u(xt),so=s(xt,"P",{});var Vi=r(so);Gb=d(Vi,"The "),xi=s(Vi,"A",{href:!0});var V1=r(xi);Wb=d(V1,"MBartForQuestionAnswering"),V1.forEach(t),Rb=d(Vi," forward method, overrides the "),Sl=s(Vi,"CODE",{});var H1=r(Sl);Ub=d(H1,"__call__"),H1.forEach(t),Xb=d(Vi," special method."),Vi.forEach(t),Qb=u(xt),v(tn.$$.fragment,xt),Vb=u(xt),v(on.$$.fragment,xt),Hb=u(xt),v(nn.$$.fragment,xt),xt.forEach(t),$t.forEach(t),Gp=u(o),ro=s(o,"H2",{class:!0});var Zu=r(ro);an=s(Zu,"A",{id:!0,class:!0,href:!0});var J1=r(an);Ol=s(J1,"SPAN",{});var K1=r(Ol);v(Ns.$$.fragment,K1),K1.forEach(t),J1.forEach(t),Jb=u(Zu),Al=s(Zu,"SPAN",{});var Z1=r(Al);Kb=d(Z1,"MBartForSequenceClassification"),Z1.forEach(t),Zu.forEach(t),Wp=u(o),Me=s(o,"DIV",{class:!0});var zt=r(Me);v(Ds.$$.fragment,zt),Zb=u(zt),Il=s(zt,"P",{});var Y1=r(Il);Yb=d(Y1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Y1.forEach(t),ek=u(zt),Ls=s(zt,"P",{});var Yu=r(Ls);tk=d(Yu,"This model inherits from "),zi=s(Yu,"A",{href:!0});var ew=r(zi);ok=d(ew,"PreTrainedModel"),ew.forEach(t),nk=d(Yu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(t),Bk=u(Ft),Ks=s(Ft,"P",{});var rh=r(Ks);jk=d(rh,"This model is also a "),Zs=s(rh,"A",{href:!0,rel:!0});var pw=r(Zs);Ck=d(pw,"tf.keras.Model"),pw.forEach(t),Ek=d(rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rh.forEach(t),Pk=u(Ft),v(fn.$$.fragment,Ft),Sk=u(Ft),Ye=s(Ft,"DIV",{class:!0});var da=r(Ye);v(Ys.$$.fragment,da),Ok=u(da),uo=s(da,"P",{});var Ji=r(uo);Ak=d(Ji,"The "),Bi=s(Ji,"A",{href:!0});var uw=r(Bi);Ik=d(uw,"TFMBartModel"),uw.forEach(t),Nk=d(Ji," forward method, overrides the "),Rl=s(Ji,"CODE",{});var hw=r(Rl);Dk=d(hw,"__call__"),hw.forEach(t),Lk=d(Ji," special method."),Ji.forEach(t),Gk=u(da),v(_n.$$.fragment,da),Wk=u(da),v(gn.$$.fragment,da),da.forEach(t),Ft.forEach(t),Vp=u(o),ho=s(o,"H2",{class:!0});var ih=r(ho);bn=s(ih,"A",{id:!0,class:!0,href:!0});var mw=r(bn);Ul=s(mw,"SPAN",{});var fw=r(Ul);v(er.$$.fragment,fw),fw.forEach(t),mw.forEach(t),Rk=u(ih),Xl=s(ih,"SPAN",{});var _w=r(Xl);Uk=d(_w,"TFMBartForConditionalGeneration"),_w.forEach(t),ih.forEach(t),Hp=u(o),xe=s(o,"DIV",{class:!0});var qt=r(xe);v(tr.$$.fragment,qt),Xk=u(qt),or=s(qt,"P",{});var dh=r(or);Qk=d(dh,`The MBART Model with a language modeling head. Can be used for summarization.
This model inherits from `),ji=s(dh,"A",{href:!0});var gw=r(ji);Vk=d(gw,"TFPreTrainedModel"),gw.forEach(t),Hk=d(dh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lh.forEach(t),ey=u(qt),v(kn.$$.fragment,qt),ty=u(qt),Ee=s(qt,"DIV",{class:!0});var Bt=r(Ee);v(sr.$$.fragment,Bt),oy=u(Bt),mo=s(Bt,"P",{});var Ki=r(mo);ny=d(Ki,"The "),Ci=s(Ki,"A",{href:!0});var kw=r(Ci);ay=d(kw,"TFMBartForConditionalGeneration"),kw.forEach(t),sy=d(Ki," forward method, overrides the "),Ql=s(Ki,"CODE",{});var yw=r(Ql);ry=d(yw,"__call__"),yw.forEach(t),iy=d(Ki," special method."),Ki.forEach(t),dy=u(Bt),v(yn.$$.fragment,Bt),ly=u(Bt),v(vn.$$.fragment,Bt),cy=u(Bt),v(Tn.$$.fragment,Bt),Bt.forEach(t),qt.forEach(t),Jp=u(o),fo=s(o,"H2",{class:!0});var ch=r(fo);wn=s(ch,"A",{id:!0,class:!0,href:!0});var vw=r(wn);Vl=s(vw,"SPAN",{});var Tw=r(Vl);v(rr.$$.fragment,Tw),Tw.forEach(t),vw.forEach(t),py=u(ch),Hl=s(ch,"SPAN",{});var ww=r(Hl);uy=d(ww,"FlaxMBartModel"),ww.forEach(t),ch.forEach(t),Kp=u(o),W=s(o,"DIV",{class:!0});var pe=r(W);v(ir.$$.fragment,pe),hy=u(pe),dr=s(pe,"P",{});var ph=r(dr);my=d(ph,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Ei=s(ph,"A",{href:!0});var Mw=r(Ei);fy=d(Mw,"FlaxPreTrainedModel"),Mw.forEach(t),_y=d(ph,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
