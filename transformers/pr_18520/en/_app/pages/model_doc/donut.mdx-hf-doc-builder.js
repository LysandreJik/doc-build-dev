...
methods above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/pr_18520/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(M,y){u(M,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(M){M&&s(m)}}}function Wi(C){let m,j,f,g,D,h,_,q;return{c(){m=o("p"),j=n("This class method is simply calling "),f=o("a"),g=n("save_pretrained()"),D=n(` and
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){m=o("p"),j=n("Example:"),f=d(),v(g.$$.fragment)},l(h){m=a(h,"P",{});var _=i(m);j=r(_,"Example:"),_.forEach(s),f=p(h),b(g.$$.fragment,h)},m(h,_){u(h,m,_),e(m,j),u(h,f,_),w(g,h,_),D=!0},p:Fi,i(h){D||(x(g.$$.fragment,h),D=!0)},o(h){k(g.$$.fragment,h),D=!1},d(h){h&&s(m),h&&s(f),$(g,h)}}}function Bi(C){let m,j,f,g,D,h,_,q,M,y,F,A,Bt,Pe,Po,Jt,zo,Ss,ae,So,ze,Mo,Fo,Ms,ft,Co,Fs,gt,Gt,Ao,Cs,ne,fr,As,re,Io,_t,Lo,Ro,Is,W,Oo,Se,No,Vo,Me,Uo,Wo,Ls,vt,Ho,Rs,ie,Fe,Xo,Ce,Bo,Jo,Go,Ae,Yo,bt,Qo,Ko,Os,G,le,Yt,Ie,Zo,Qt,ea,Ns,H,ta,Kt,sa,oa,wt,aa,na,Vs,T,ra,xt,ia,la,Zt,ca,da,es,pa,ua,kt,ma,ha,$t,fa,ga,ts,_a,va,ss,ba,wa,Us,jt,os,xa,Ws,Le,Hs,Dt,as,ka,Xs,Re,Bs,yt,ns,$a,Js,Oe,Gs,ce,ja,Ne,Da,ya,Ys,Y,de,rs,Ve,Ea,is,Ta,Qs,pe,qa,Ue,Pa,za,Ks,Q,ue,ls,We,Sa,cs,Ma,Zs,I,He,Fa,K,Ca,Et,Aa,Ia,Xe,La,Ra,Oa,Z,Na,Tt,Va,Ua,qt,Wa,Ha,Xa,me,eo,ee,he,ds,Be,Ba,ps,Ja,to,L,Je,Ga,us,Ya,Qa,Ge,Ka,Pt,Za,en,tn,X,Ye,sn,ms,on,an,fe,so,te,ge,hs,Qe,nn,fs,rn,oo,E,Ke,ln,gs,cn,dn,P,zt,pn,un,St,mn,hn,_s,fn,gn,vs,_n,vn,Ze,bs,bn,wn,xn,Mt,kn,$n,jn,_e,et,Dn,N,yn,ws,En,Tn,xs,qn,Pn,ks,zn,Sn,Mn,B,tt,Fn,$s,Cn,An,ve,In,J,st,Ln,ot,Rn,Ft,On,Nn,Vn,be,Un,we,at,Wn,nt,Hn,Ct,Xn,Bn,Jn,xe,rt,Gn,it,Yn,At,Qn,Kn,ao,se,ke,js,lt,Zn,Ds,er,no,V,ct,tr,dt,sr,pt,or,ar,nr,O,ut,rr,oe,ir,It,lr,cr,ys,dr,pr,ur,$e,mr,je,ro;return h=new qe({}),Pe=new qe({}),Ie=new qe({}),Le=new zs({props:{code:`import re
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/donut/feature_extraction_donut.py#L125",returnDescription:`
<p>A <a
...
An instance of [<code>XLMRobertaTokenizer</code>/<code>XLMRobertaTokenizerFast</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/donut/processing_donut.py#L25"}}),et=new U({props:{name:"__call__",anchor:"transformers.DonutProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/donut/processing_donut.py#L48"}}),tt=new U({props:{name:"from_pretrained",anchor:"transformers.DonutProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DonutProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
namespace).
kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_18520/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/processing_utils.py#L94"}}),be=new qo({props:{$$slots:{default:[Wi]},$$scope:{ctx:C}}}),at=new U({props:{name:"batch_decode",anchor:"transformers.DonutProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/donut/processing_donut.py#L81"}}),rt=new U({props:{name:"decode",anchor:"transformers.DonutProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/donut/processing_donut.py#L88"}}),lt=new qe({}),ct=new U({props:{name:"class transformers.DonutSwinModel",anchor:"transformers.DonutSwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.DonutSwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18520/en/model_doc/donut#transformers.DonutSwinConfig">DonutSwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18520/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18520/src/transformers/models/donut/modeling_donut_swin.py#L852"}}),ut=new U({props:{name:"forward",anchor:"transformers.DonutSwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.DonutSwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18520/en/model_doc/donut#transformers.DonutSwinConfig"
...
`}}),$e=new qo({props:{$$slots:{default:[Hi]},$$scope:{ctx:C}}}),je=new Mi({props:{anchor:"transformers.DonutSwinModel.forward.example",$$slots:{default:[Xi]},$$scope:{ctx:C}}}),{c(){m=o("meta"),j=d(),f=o("h1"),g=o("a"),D=o("span"),v(h.$$.fragment),_=d(),q=o("span"),M=n("Donut"),y=d(),F=o("h2"),A=o("a"),Bt=o("span"),v(Pe.$$.fragment),Po=d(),Jt=o("span"),zo=n("Overview"),Ss=d(),ae=o("p"),So=n("The Donut model was proposed in "),ze=o("a"),Mo=n("OCR-free Document Understanding Transformer"),Fo=n(` by
