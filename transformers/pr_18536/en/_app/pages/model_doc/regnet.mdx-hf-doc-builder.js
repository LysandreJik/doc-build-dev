import{S as cr,i as pr,s as fr,e as a,k as m,w as v,t as l,M as gr,c as r,d as o,m as u,a as n,x as $,h as i,b as c,G as e,g as _,y,q as N,o as T,B as R,v as hr,L as Jt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xo}from"../../chunks/Tip-hf-doc-builder.js";import{D as X}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ze}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Kt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function mr(x){let d,b,h,f,w;return f=new Qt({props:{code:`from transformers import RegNetConfig, RegNetModel
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,b),e(d,h),e(h,f),e(d,w)},d(s){s&&o(d)}}}function _r(x){let d,b,h,f,w;return f=new Qt({props:{code:`from transformers import AutoFeatureExtractor, RegNetModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">1088</span>, <span class="hljs-number">7</span>, <span class="hljs-number">7</span>]`}}),{c(){d=a("p"),b=l("Example:"),h=m(),v(f.$$.fragment)},l(s){d=r(s,"P",{});var p=n(d);b=i(p,"Example:"),p.forEach(o),h=u(s),$(f.$$.fragment,s)},m(s,p){_(s,d,p),e(d,b),_(s,h,p),y(f,s,p),w=!0},p:Jt,i(s){w||(N(f.$$.fragment,s),w=!0)},o(s){T(f.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),R(f,s)}}}function wr(x){let d,b,h,f,w;return{c(){d=a("p"),b=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),f=l("Module"),w=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){d=r(s,"P",{});var p=n(d);b=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var F=n(h);f=i(F,"Module"),F.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,b),e(d,h),e(h,f),e(d,w)},d(s){s&&o(d)}}}function br(x){let d,b,h,f,w;return f=new Qt({props:{code:`from transformers import AutoFeatureExtractor, RegNetForImageClassification
import torch
from datasets import load_dataset
...
tabby, tabby cat`}}),{c(){d=a("p"),b=l("Example:"),h=m(),v(f.$$.fragment)},l(s){d=r(s,"P",{});var p=n(d);b=i(p,"Example:"),p.forEach(o),h=u(s),$(f.$$.fragment,s)},m(s,p){_(s,d,p),e(d,b),_(s,h,p),y(f,s,p),w=!0},p:Jt,i(s){w||(N(f.$$.fragment,s),w=!0)},o(s){T(f.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),R(f,s)}}}function vr(x){let d,b,h,f,w;return{c(){d=a("p"),b=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),f=l("Module"),w=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){d=r(s,"P",{});var p=n(d);b=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var F=n(h);f=i(F,"Module"),F.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,b),e(d,h),e(h,f),e(d,w)},d(s){s&&o(d)}}}function $r(x){let d,b,h,f,w;return f=new Qt({props:{code:`from transformers import AutoFeatureExtractor, TFRegNetModel
from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(last_hidden_states.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">1088</span>, <span class="hljs-number">7</span>, <span class="hljs-number">7</span>]`}}),{c(){d=a("p"),b=l("Example:"),h=m(),v(f.$$.fragment)},l(s){d=r(s,"P",{});var p=n(d);b=i(p,"Example:"),p.forEach(o),h=u(s),$(f.$$.fragment,s)},m(s,p){_(s,d,p),e(d,b),_(s,h,p),y(f,s,p),w=!0},p:Jt,i(s){w||(N(f.$$.fragment,s),w=!0)},o(s){T(f.$$.fragment,s),w=!1},d(s){s&&o(d),s&&o(h),R(f,s)}}}function yr(x){let d,b,h,f,w;return{c(){d=a("p"),b=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),f=l("Module"),w=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){d=r(s,"P",{});var p=n(d);b=i(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var F=n(h);f=i(F,"Module"),F.forEach(o),w=i(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(s,p){_(s,d,p),e(d,b),e(d,h),e(h,f),e(d,w)},d(s){s&&o(d)}}}function Nr(x){let d,b,h,f,w;return f=new Qt({props:{code:`from transformers import AutoFeatureExtractor, TFRegNetForImageClassification
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18536/en/model_doc/regnet#transformers.RegNetConfig"
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18536/src/transformers/models/regnet/modeling_regnet.py#L400",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18536/en/main_classes/output#transformers.modeling_outputs.ImageClassifierOutputWithNoAttention"
...
behavior. &#x2014;
config (<a href="/docs/transformers/pr_18536/en/model_doc/regnet#transformers.RegNetConfig">RegNetConfig</a>): Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18536/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"regular"}],source:"https://github.com/huggingface/transformers/blob/vr_18536/src/transformers/models/regnet/modeling_tf_regnet.py#L406"}}),Be=new X({props:{name:"call",anchor:"transformers.TFRegNetModel.call",parameters:[{name:"pixel_values",val:": Tensor"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFRegNetModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_18536/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/pr_18536/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18536/src/transformers/models/regnet/modeling_tf_regnet.py#L411",returnDescription:`
...
`}}),pe=new xo({props:{$$slots:{default:[vr]},$$scope:{ctx:x}}}),fe=new Kt({props:{anchor:"transformers.TFRegNetModel.call.example",$$slots:{default:[$r]},$$scope:{ctx:x}}}),Ge=new Ze({}),Ke=new X({props:{name:"class transformers.TFRegNetForImageClassification",anchor:"transformers.TFRegNetForImageClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFRegNetForImageClassification.This",description:`<strong>This</strong> model is a Tensorflow &#x2014;
...
config (<a href="/docs/transformers/pr_18536/en/model_doc/regnet#transformers.RegNetConfig">RegNetConfig</a>): Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18536/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"regular"}],source:"https://github.com/huggingface/transformers/blob/vr_18536/src/transformers/models/regnet/modeling_tf_regnet.py#L466"}}),Je=new X({props:{name:"call",anchor:"transformers.TFRegNetForImageClassification.call",parameters:[{name:"pixel_values",val:": Tensor = None"},{name:"labels",val:": Tensor = None"},{name:"output_hidden_states",val:": bool = None"},{name:"return_dict",val:": bool = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFRegNetForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/pr_18536/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18536/src/transformers/models/regnet/modeling_tf_regnet.py#L477",returnDescription:`
<p>A <a
...
The original code can be found `),je=a("a"),Yo=l("here"),Zo=l("."),ro=m(),O=a("h2"),oe=a("a"),Tt=a("span"),v(Ce.$$.fragment),es=m(),Rt=a("span"),ts=l("RegNetConfig"),no=m(),k=a("div"),v(Ae.$$.fragment),os=m(),L=a("p"),ss=l("This is the configuration class to store the configuration of a "),rt=a("a"),as=l("RegNetModel"),rs=l(`. It is used to instantiate a RegNet
...
documentation from `),lt=a("a"),fs=l("PretrainedConfig"),gs=l(" for more information."),hs=m(),v(se.$$.fragment),lo=m(),U=a("h2"),ae=a("a"),xt=a("span"),v(Ie.$$.fragment),ms=m(),Ft=a("span"),us=l("RegNetModel"),io=m(),P=a("div"),v(Pe.$$.fragment),_s=m(),qe=a("p"),ws=l(`The bare RegNet model outputting raw features without any specific head on top.
This model is a PyTorch `),ze=a("a"),bs=l("torch.nn.Module"),vs=l(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$s=m(),C=a("div"),v(De.$$.fragment),ys=m(),H=a("p"),Ns=l("The "),it=a("a"),Ts=l("RegNetModel"),Rs=l(" forward method, overrides the "),Et=a("code"),xs=l("__call__"),Fs=l(" special method."),Es=m(),v(re.$$.fragment),ks=m(),v(ne.$$.fragment),co=m(),V=a("h2"),le=a("a"),kt=a("span"),v(Se.$$.fragment),js=m(),jt=a("span"),Cs=l("RegNetForImageClassification"),po=m(),j=a("div"),v(Oe.$$.fragment),As=m(),Ct=a("p"),Ms=l(`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
...
The original code can be found `),je=r(D,"A",{href:!0,rel:!0});var Ca=n(je);Yo=i(Ca,"here"),Ca.forEach(o),Zo=i(D,"."),D.forEach(o),ro=u(t),O=r(t,"H2",{class:!0});var bo=n(O);oe=r(bo,"A",{id:!0,class:!0,href:!0});var Aa=n(oe);Tt=r(Aa,"SPAN",{});var Ma=n(Tt);$(Ce.$$.fragment,Ma),Ma.forEach(o),Aa.forEach(o),es=u(bo),Rt=r(bo,"SPAN",{});var Ia=n(Rt);ts=i(Ia,"RegNetConfig"),Ia.forEach(o),bo.forEach(o),no=u(t),k=r(t,"DIV",{class:!0});var ue=n(k);$(Ae.$$.fragment,ue),os=u(ue),L=r(ue,"P",{});var ft=n(L);ss=i(ft,"This is the configuration class to store the configuration of a "),rt=r(ft,"A",{href:!0});var Pa=n(rt);as=i(Pa,"RegNetModel"),Pa.forEach(o),rs=i(ft,`. It is used to instantiate a RegNet
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the RegNet
...
documentation from `),lt=r(gt,"A",{href:!0});var Da=n(lt);fs=i(Da,"PretrainedConfig"),Da.forEach(o),gs=i(gt," for more information."),gt.forEach(o),hs=u(ue),$(se.$$.fragment,ue),ue.forEach(o),lo=u(t),U=r(t,"H2",{class:!0});var vo=n(U);ae=r(vo,"A",{id:!0,class:!0,href:!0});var Sa=n(ae);xt=r(Sa,"SPAN",{});var Oa=n(xt);$(Ie.$$.fragment,Oa),Oa.forEach(o),Sa.forEach(o),ms=u(vo),Ft=r(vo,"SPAN",{});var La=n(Ft);us=i(La,"RegNetModel"),La.forEach(o),vo.forEach(o),io=u(t),P=r(t,"DIV",{class:!0});var ht=n(P);$(Pe.$$.fragment,ht),_s=u(ht),qe=r(ht,"P",{});var $o=n(qe);ws=i($o,`The bare RegNet model outputting raw features without any specific head on top.
