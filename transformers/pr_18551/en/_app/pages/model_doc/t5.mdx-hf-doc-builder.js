...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18551/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18551/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18551/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18551/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_t5.py#L1536",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_18551/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_t5.py#L1807",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18551/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_tf_t5.py#L1146",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18551/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_tf_t5.py#L1322",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18551/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18551/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18551/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/pr_18551/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_tf_t5.py#L1569",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18551/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutput"
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/t5/modeling_flax_t5.py#L987",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18551/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
<p>A <a
  href="/docs/transformers/pr_18551/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
behavior.`),ST=d(),v(Kn.$$.fragment),GT=d(),mt=a("div"),v(wa.$$.fragment),UT=d(),Qt=a("p"),WT=o("The "),Wr=a("a"),RT=o("TFT5Model"),BT=o(" forward method, overrides the "),rd=a("code"),HT=o("__call__"),VT=o(" special method."),KT=d(),v(Yn.$$.fragment),YT=d(),v(Zn.$$.fragment),Qc=d(),en=a("h2"),Jn=a("a"),id=a("span"),v($a.$$.fragment),ZT=d(),ld=a("span"),JT=o("TFT5ForConditionalGeneration"),ep=d(),de=a("div"),v(xa.$$.fragment),XT=d(),za=a("p"),QT=o("T5 Model with a "),dd=a("code"),e5=o("language modeling"),t5=o(" head on top."),n5=d(),ja=a("p"),o5=o("The T5 model was proposed in "),Ea=a("a"),s5=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),a5=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),r5=d(),qa=a("p"),i5=o("This model inherits from "),Rr=a("a"),l5=o("TFPreTrainedModel"),d5=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c5=d(),Fa=a("p"),p5=o("This model is also a "),Ma=a("a"),h5=o("tf.keras.Model"),u5=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),m5=d(),v(Xn.$$.fragment),f5=d(),ft=a("div"),v(Ca.$$.fragment),_5=d(),tn=a("p"),g5=o("The "),Br=a("a"),T5=o("TFT5ForConditionalGeneration"),b5=o(" forward method, overrides the "),cd=a("code"),v5=o("__call__"),k5=o(" special method."),y5=d(),v(Qn.$$.fragment),w5=d(),v(eo.$$.fragment),tp=d(),nn=a("h2"),to=a("a"),pd=a("span"),v(Pa.$$.fragment),$5=d(),hd=a("span"),x5=o("TFT5EncoderModel"),np=d(),ce=a("div"),v(Na.$$.fragment),z5=d(),ud=a("p"),j5=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),E5=d(),Oa=a("p"),q5=o("The T5 model was proposed in "),La=a("a"),F5=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),M5=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),C5=d(),Aa=a("p"),P5=o("This model inherits from "),Hr=a("a"),N5=o("TFPreTrainedModel"),O5=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),L5=d(),Ia=a("p"),A5=o("This model is also a "),Da=a("a"),I5=o("tf.keras.Model"),D5=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),S5=d(),v(no.$$.fragment),G5=d(),_t=a("div"),v(Sa.$$.fragment),U5=d(),on=a("p"),W5=o("The "),Vr=a("a"),R5=o("TFT5EncoderModel"),B5=o(" forward method, overrides the "),md=a("code"),H5=o("__call__"),V5=o(" special method."),K5=d(),v(oo.$$.fragment),Y5=d(),v(so.$$.fragment),op=d(),sn=a("h2"),ao=a("a"),fd=a("span"),v(Ga.$$.fragment),Z5=d(),_d=a("span"),J5=o("FlaxT5Model"),sp=d(),Je=a("div"),v(Ua.$$.fragment),X5=d(),gt=a("div"),v(Wa.$$.fragment),Q5=d(),an=a("p"),eb=o("The "),gd=a("code"),tb=o("FlaxT5PreTrainedModel"),nb=o(" forward method, overrides the "),Td=a("code"),ob=o("__call__"),sb=o(" special method."),ab=d(),v(ro.$$.fragment),rb=d(),v(io.$$.fragment),ib=d(),lo=a("div"),v(Ra.$$.fragment),lb=d(),v(co.$$.fragment),db=d(),po=a("div"),v(Ba.$$.fragment),cb=d(),v(ho.$$.fragment),ap=d(),rn=a("h2"),uo=a("a"),bd=a("span"),v(Ha.$$.fragment),pb=d(),vd=a("span"),hb=o("FlaxT5ForConditionalGeneration"),rp=d(),Xe=a("div"),v(Va.$$.fragment),ub=d(),Tt=a("div"),v(Ka.$$.fragment),mb=d(),ln=a("p"),fb=o("The "),kd=a("code"),_b=o("FlaxT5PreTrainedModel"),gb=o(" forward method, overrides the "),yd=a("code"),Tb=o("__call__"),bb=o(" special method."),vb=d(),v(mo.$$.fragment),kb=d(),v(fo.$$.fragment),yb=d(),_o=a("div"),v(Ya.$$.fragment),wb=d(),v(go.$$.fragment),$b=d(),To=a("div"),v(Za.$$.fragment),xb=d(),v(bo.$$.fragment),ip=d(),dn=a("h2"),vo=a("a"),wd=a("span"),v(Ja.$$.fragment),zb=d(),$d=a("span"),jb=o("FlaxT5EncoderModel"),lp=d(),cn=a("div"),v(Xa.$$.fragment),Eb=d(),Pt=a("div"),v(Qa.$$.fragment),qb=d(),pn=a("p"),Fb=o("The "),Kr=a("a"),Mb=o("FlaxT5EncoderModel"),Cb=o(" forward method, overrides the "),xd=a("code"),Pb=o("__call__"),Nb=o(" special method."),Ob=d(),v(ko.$$.fragment),this.h()},l(n){const f=Cy('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),b=c(n),g=r(n,"H1",{class:!0});var er=i(g);u=r(er,"A",{id:!0,class:!0,href:!0});var zd=i(u);T=r(zd,"SPAN",{});var jd=i(T);k(l.$$.fragment,jd),jd.forEach(t),zd.forEach(t),_=c(er),E=r(er,"SPAN",{});var Ed=i(E);Ee=s(Ed,"T5"),Ed.forEach(t),er.forEach(t),se=c(n),q=r(n,"H2",{class:!0});var tr=i(q);ee=r(tr,"A",{id:!0,class:!0,href:!0});var qd=i(ee);G=r(qd,"SPAN",{});var Fd=i(G);k(ae.$$.fragment,Fd),Fd.forEach(t),qd.forEach(t),qe=c(tr),U=r(tr,"SPAN",{});var Md=i(U);Fe=s(Md,"Overview"),Md.forEach(t),tr.forEach(t),ke=c(n),W=r(n,"P",{});var nr=i(W);A=s(nr,"The T5 model was presented in "),re=r(nr,"A",{href:!0,rel:!0});var Cd=i(re);pe=s(Cd,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Cd.forEach(t),C=s(nr,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
to the documentation of byT5 which can be found `),lr=r(Jd,"A",{href:!0});var lv=i(lr);Lh=s(lv,"here"),lv.forEach(t),Ah=s(Jd,"."),Jd.forEach(t),rv.forEach(t),Yr.forEach(t),nc=c(n),gn=r(n,"P",{});var cp=i(gn);Ih=s(cp,"All checkpoints can be found on the "),Ro=r(cp,"A",{href:!0,rel:!0});var dv=i(Ro);Dh=s(dv,"hub"),dv.forEach(t),Sh=s(cp,"."),cp.forEach(t),oc=c(n),xt=r(n,"P",{});var Zr=i(xt);Gh=s(Zr,"This model was contributed by "),Bo=r(Zr,"A",{href:!0,rel:!0});var cv=i(Bo);Uh=s(cv,"thomwolf"),cv.forEach(t),Wh=s(Zr,". The original code can be found "),Ho=r(Zr,"A",{href:!0,rel:!0});var pv=i(Ho);Rh=s(pv,"here"),pv.forEach(t),Bh=s(Zr,"."),Zr.forEach(t),sc=c(n),dr=r(n,"A",{id:!0}),i(dr).forEach(t),ac=c(n),Lt=r(n,"H2",{class:!0});var pp=i(Lt);Tn=r(pp,"A",{id:!0,class:!0,href:!0});var hv=i(Tn);Pi=r(hv,"SPAN",{});var uv=i(Pi);k(Vo.$$.fragment,uv),uv.forEach(t),hv.forEach(t),Hh=c(pp),Ni=r(pp,"SPAN",{});var mv=i(Ni);Vh=s(mv,"Training"),mv.forEach(t),pp.forEach(t),rc=c(n),at=r(n,"P",{});var yo=i(at);Kh=s(yo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
language modeling head on top of the decoder.`),hp.forEach(t),lc=c(n),pr=r(n,"UL",{});var bv=i(pr);Ii=r(bv,"LI",{});var vv=i(Ii);su=s(vv,"Unsupervised denoising training"),vv.forEach(t),bv.forEach(t),dc=c(n),me=r(n,"P",{});var Be=i(me);au=s(Be,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Di=r(Be,"EM",{});var kv=i(Di);ru=s(kv,"a.k.a"),kv.forEach(t),iu=s(Be,` unique mask tokens) and
...
processed as follows:`),jv.forEach(t),pc=c(n),k(Ko.$$.fragment,n),hc=c(n),vn=r(n,"P",{});var up=i(vn);bu=s(up,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Yo=r(up,"A",{href:!0,rel:!0});var Ev=i(Yo);vu=s(Ev,"run_t5_mlm_flax.py"),Ev.forEach(t),ku=s(up,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),Mv.forEach(t),fc=c(n),k(Zo.$$.fragment,n),_c=c(n),oe=r(n,"P",{});var $e=i(oe);$u=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Bi=r($e,"CODE",{});var Cv=i(Bi);xu=s(Cv,"input_ids"),Cv.forEach(t),zu=s($e,` (which are the
...
ignored. The code example below illustrates all of this.`),He.forEach(t),bc=c(n),k(Xo.$$.fragment,n),vc=c(n),_r=r(n,"P",{});var Vv=i(_r);om=s(Vv,"Additional training tips:"),Vv.forEach(t),kc=c(n),gr=r(n,"UL",{});var Kv=i(gr);Qo=r(Kv,"LI",{});var mp=i(Qo);sm=s(mp,"T5 models need a slightly higher learning rate than the default one set in the "),al=r(mp,"CODE",{});var Yv=i(al);am=s(Yv,"Trainer"),Yv.forEach(t),rm=s(mp,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),fp.forEach(t),$c=c(n),Tr=r(n,"A",{id:!0}),i(Tr).forEach(t),xc=c(n),At=r(n,"H2",{class:!0});var _p=i(At);yn=r(_p,"A",{id:!0,class:!0,href:!0});var Qv=i(yn);il=r(Qv,"SPAN",{});var ek=i(il);k(ns.$$.fragment,ek),ek.forEach(t),Qv.forEach(t),fm=c(_p),ll=r(_p,"SPAN",{});var tk=i(ll);_m=s(tk,"Inference"),tk.forEach(t),_p.forEach(t),zc=c(n),rt=r(n,"P",{});var wo=i(rt);gm=s(wo,"At inference time, it is recommended to use "),br=r(wo,"A",{href:!0});var nk=i(br);Tm=s(nk,"generate()"),nk.forEach(t),bm=s(wo,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
and auto-regressively generates the decoder output. Check out `),os=r(wo,"A",{href:!0,rel:!0});var ok=i(os);vm=s(ok,"this blog post"),ok.forEach(t),km=s(wo,` to know all the details about generating text with Transformers.
There\u2019s also `),ss=r(wo,"A",{href:!0,rel:!0});var sk=i(ss);ym=s(sk,"this blog post"),sk.forEach(t),wm=s(wo,` which explains how
generation works in general in encoder-decoder models.`),wo.forEach(t),jc=c(n),k(as.$$.fragment,n),Ec=c(n),Re=r(n,"P",{});var Nt=i(Re);$m=s(Nt,"Note that T5 uses the "),dl=r(Nt,"CODE",{});var ak=i(dl);xm=s(ak,"pad_token_id"),ak.forEach(t),zm=s(Nt," as the "),cl=r(Nt,"CODE",{});var rk=i(cl);jm=s(rk,"decoder_start_token_id"),rk.forEach(t),Em=s(Nt,`, so when doing generation without using
`),vr=r(Nt,"A",{href:!0});var ik=i(vr);qm=s(ik,"generate()"),ik.forEach(t),Fm=s(Nt,", make sure you start it with the "),pl=r(Nt,"CODE",{});var lk=i(pl);Mm=s(lk,"pad_token_id"),lk.forEach(t),Cm=s(Nt,"."),Nt.forEach(t),qc=c(n),kr=r(n,"P",{});var dk=i(kr);Pm=s(dk,"The example above only shows a single example. You can also do batched inference, like so:"),dk.forEach(t),Fc=c(n),k(rs.$$.fragment,n),Mc=c(n),yr=r(n,"P",{});var ck=i(yr);Nm=s(ck,`Because T5 has been trained with the span-mask denoising objective,
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),ck.forEach(t),Cc=c(n),k(is.$$.fragment,n),Pc=c(n),wr=r(n,"A",{id:!0}),i(wr).forEach(t),Nc=c(n),It=r(n,"H2",{class:!0});var gp=i(It);wn=r(gp,"A",{id:!0,class:!0,href:!0});var pk=i(wn);hl=r(pk,"SPAN",{});var hk=i(hl);k(ls.$$.fragment,hk),hk.forEach(t),pk.forEach(t),Om=c(gp),ul=r(gp,"SPAN",{});var uk=i(ul);Lm=s(uk,"Performance"),uk.forEach(t),gp.forEach(t),Oc=c(n),it=r(n,"P",{});var $o=i(it);Am=s($o,"If you\u2019d like a faster training and inference performance, install "),ds=r($o,"A",{href:!0,rel:!0});var mk=i(ds);Im=s(mk,"apex"),mk.forEach(t),Dm=s($o," and then the model will automatically use "),ml=r($o,"CODE",{});var fk=i(ml);Sm=s(fk,"apex.normalization.FusedRMSNorm"),fk.forEach(t),Gm=s($o," instead of "),fl=r($o,"CODE",{});var _k=i(fl);Um=s(_k,"T5LayerNorm"),_k.forEach(t),Wm=s($o,". The former uses an optimized fused kernel which is several times faster than the latter."),$o.forEach(t),Lc=c(n),Dt=r(n,"H2",{class:!0});var Tp=i(Dt);$n=r(Tp,"A",{id:!0,class:!0,href:!0});var gk=i($n);_l=r(gk,"SPAN",{});var Tk=i(_l);k(cs.$$.fragment,Tk),Tk.forEach(t),gk.forEach(t),Rm=c(Tp),gl=r(Tp,"SPAN",{});var bk=i(gl);Bm=s(bk,"Example scripts"),bk.forEach(t),Tp.forEach(t),Ac=c(n),$r=r(n,"P",{});var vk=i($r);Hm=s(vk,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),vk.forEach(t),Ic=c(n),xn=r(n,"UL",{});var bp=i(xn);Tl=r(bp,"LI",{});var kk=i(Tl);St=r(kk,"P",{});var Qr=i(St);Vm=s(Qr,"pre-training: the "),ps=r(Qr,"A",{href:!0,rel:!0});var yk=i(ps);Km=s(yk,"run_t5_mlm_flax.py"),yk.forEach(t),Ym=s(Qr,`
script allows you to further pre-train T5 or pre-train T5 from scratch on your own data. The `),hs=r(Qr,"A",{href:!0,rel:!0});var wk=i(hs);Zm=s(wk,"t5_tokenizer_model.py"),wk.forEach(t),Jm=s(Qr,`
script allows you to further train a T5 tokenizer or train a T5 Tokenizer from scratch on your own data. Note that
Flax (a neural network library on top of JAX) is particularly useful to train on TPU hardware.`),Qr.forEach(t),kk.forEach(t),Xm=c(bp),bl=r(bp,"LI",{});var $k=i(bl);De=r($k,"P",{});var bt=i(De);Qm=s(bt,"fine-tuning: T5 is supported by the official summarization scripts ("),us=r(bt,"A",{href:!0,rel:!0});var xk=i(us);ef=s(xk,"PyTorch"),xk.forEach(t),tf=s(bt,", "),ms=r(bt,"A",{href:!0,rel:!0});var zk=i(ms);nf=s(zk,"Tensorflow"),zk.forEach(t),of=s(bt,", and "),fs=r(bt,"A",{href:!0,rel:!0});var jk=i(fs);sf=s(jk,"Flax"),jk.forEach(t),af=s(bt,`) and translation scripts
(`),_s=r(bt,"A",{href:!0,rel:!0});var Ek=i(_s);rf=s(Ek,"PyTorch"),Ek.forEach(t),lf=s(bt," and "),gs=r(bt,"A",{href:!0,rel:!0});var qk=i(gs);df=s(qk,"Tensorflow"),qk.forEach(t),cf=s(bt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),bt.forEach(t),$k.forEach(t),bp.forEach(t),Dc=c(n),Gt=r(n,"H2",{class:!0});var vp=i(Gt);zn=r(vp,"A",{id:!0,class:!0,href:!0});var Fk=i(zn);vl=r(Fk,"SPAN",{});var Mk=i(vl);k(Ts.$$.fragment,Mk),Mk.forEach(t),Fk.forEach(t),pf=c(vp),kl=r(vp,"SPAN",{});var Ck=i(kl);hf=s(Ck,"T5Config"),Ck.forEach(t),vp.forEach(t),Sc=c(n),kt=r(n,"DIV",{class:!0});var ei=i(kt);k(bs.$$.fragment,ei),uf=c(ei),yt=r(ei,"P",{});var xo=i(yt);mf=s(xo,"This is the configuration class to store the configuration of a "),xr=r(xo,"A",{href:!0});var Pk=i(xr);ff=s(Pk,"T5Model"),Pk.forEach(t),_f=s(xo," or a "),zr=r(xo,"A",{href:!0});var Nk=i(zr);gf=s(Nk,"TFT5Model"),Nk.forEach(t),Tf=s(xo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),vs=r(xo,"A",{href:!0,rel:!0});var Ok=i(vs);bf=s(Ok,"t5-small"),Ok.forEach(t),vf=s(xo," architecture."),xo.forEach(t),kf=c(ei),Ut=r(ei,"P",{});var ti=i(Ut);yf=s(ti,"Configuration objects inherit from "),jr=r(ti,"A",{href:!0});var Lk=i(jr);wf=s(Lk,"PretrainedConfig"),Lk.forEach(t),$f=s(ti,` and can be used to control the model outputs. Read the
documentation from `),Er=r(ti,"A",{href:!0});var Ak=i(Er);xf=s(Ak,"PretrainedConfig"),Ak.forEach(t),zf=s(ti," for more information."),ti.forEach(t),ei.forEach(t),Gc=c(n),Wt=r(n,"H2",{class:!0});var kp=i(Wt);jn=r(kp,"A",{id:!0,class:!0,href:!0});var Ik=i(jn);yl=r(Ik,"SPAN",{});var Dk=i(yl);k(ks.$$.fragment,Dk),Dk.forEach(t),Ik.forEach(t),jf=c(kp),wl=r(kp,"SPAN",{});var Sk=i(wl);Ef=s(Sk,"T5Tokenizer"),Sk.forEach(t),kp.forEach(t),Uc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);k(ys.$$.fragment,Ve),qf=c(Ve),ws=r(Ve,"P",{});var yp=i(ws);Ff=s(yp,"Construct a T5 tokenizer. Based on "),$s=r(yp,"A",{href:!0,rel:!0});var Gk=i($s);Mf=s(Gk,"SentencePiece"),Gk.forEach(t),Cf=s(yp,"."),yp.forEach(t),Pf=c(Ve),xs=r(Ve,"P",{});var wp=i(xs);Nf=s(wp,"This tokenizer inherits from "),qr=r(wp,"A",{href:!0});var Uk=i(qr);Of=s(Uk,"PreTrainedTokenizer"),Uk.forEach(t),Lf=s(wp,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wp.forEach(t),Af=c(Ve),Et=r(Ve,"DIV",{class:!0});var ni=i(Et);k(zs.$$.fragment,ni),If=c(ni),$l=r(ni,"P",{});var Wk=i($l);Df=s(Wk,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),Wk.forEach(t),Sf=c(ni),js=r(ni,"UL",{});var $p=i(js);Fr=r($p,"LI",{});var Ab=i(Fr);Gf=s(Ab,"single sequence: "),xl=r(Ab,"CODE",{});var Rk=i(xl);Uf=s(Rk,"X </s>"),Rk.forEach(t),Ab.forEach(t),Wf=c($p),Mr=r($p,"LI",{});var Ib=i(Mr);Rf=s(Ib,"pair of sequences: "),zl=r(Ib,"CODE",{});var Bk=i(zl);Bf=s(Bk,"A </s> B </s>"),Bk.forEach(t),Ib.forEach(t),$p.forEach(t),ni.forEach(t),Hf=c(Ve),En=r(Ve,"DIV",{class:!0});var xp=i(En);k(Es.$$.fragment,xp),Vf=c(xp),qs=r(xp,"P",{});var zp=i(qs);Kf=s(zp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),jl=r(zp,"CODE",{});var Hk=i(jl);Yf=s(Hk,"prepare_for_model"),Hk.forEach(t),Zf=s(zp," method."),zp.forEach(t),xp.forEach(t),Jf=c(Ve),qn=r(Ve,"DIV",{class:!0});var jp=i(qn);k(Fs.$$.fragment,jp),Xf=c(jp),El=r(jp,"P",{});var Vk=i(El);Qf=s(Vk,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),Vk.forEach(t),jp.forEach(t),e_=c(Ve),Cr=r(Ve,"DIV",{class:!0});var Kk=i(Cr);k(Ms.$$.fragment,Kk),Kk.forEach(t),Ve.forEach(t),Wc=c(n),Rt=r(n,"H2",{class:!0});var Ep=i(Rt);Fn=r(Ep,"A",{id:!0,class:!0,href:!0});var Yk=i(Fn);ql=r(Yk,"SPAN",{});var Zk=i(ql);k(Cs.$$.fragment,Zk),Zk.forEach(t),Yk.forEach(t),t_=c(Ep),Fl=r(Ep,"SPAN",{});var Jk=i(Fl);n_=s(Jk,"T5TokenizerFast"),Jk.forEach(t),Ep.forEach(t),Rc=c(n),Se=r(n,"DIV",{class:!0});var Ot=i(Se);k(Ps.$$.fragment,Ot),o_=c(Ot),Bt=r(Ot,"P",{});var oi=i(Bt);s_=s(oi,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),Ml=r(oi,"EM",{});var Xk=i(Ml);a_=s(Xk,"tokenizers"),Xk.forEach(t),r_=s(oi,` library). Based on
`),Ns=r(oi,"A",{href:!0,rel:!0});var Qk=i(Ns);i_=s(Qk,"Unigram"),Qk.forEach(t),l_=s(oi,"."),oi.forEach(t),d_=c(Ot),Os=r(Ot,"P",{});var qp=i(Os);c_=s(qp,"This tokenizer inherits from "),Pr=r(qp,"A",{href:!0});var e1=i(Pr);p_=s(e1,"PreTrainedTokenizerFast"),e1.forEach(t),h_=s(qp,` which contains most of the main methods. Users should
...
adding special tokens. A sequence has the following format:`),t1.forEach(t),__=c(si),As=r(si,"UL",{});var Fp=i(As);Nr=r(Fp,"LI",{});var Db=i(Nr);g_=s(Db,"single sequence: "),Pl=r(Db,"CODE",{});var n1=i(Pl);T_=s(n1,"X </s>"),n1.forEach(t),Db.forEach(t),b_=c(Fp),Or=r(Fp,"LI",{});var Sb=i(Or);v_=s(Sb,"pair of sequences: "),Nl=r(Sb,"CODE",{});var o1=i(Nl);k_=s(o1,"A </s> B </s>"),o1.forEach(t),Sb.forEach(t),Fp.forEach(t),si.forEach(t),y_=c(Ot),Mn=r(Ot,"DIV",{class:!0});var Mp=i(Mn);k(Is.$$.fragment,Mp),w_=c(Mp),Ol=r(Mp,"P",{});var s1=i(Ol);$_=s(s1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
