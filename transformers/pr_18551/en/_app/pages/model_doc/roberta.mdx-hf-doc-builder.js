...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18551/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),bT=h(It),y(us.$$.fragment,It),kT=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vT=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);TT=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var Gx=a(Fd);yT=i(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),wT=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var Xx=a(xp);$T=i(Xx,"__call__"),Xx.forEach(t),FT=i(Zd," special method."),Zd.forEach(t),xT=h(mo),y(gs.$$.fragment,mo),RT=h(mo),y(_s.$$.fragment,mo),MT=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Yx=a(ks);Rp=s(Yx,"SPAN",{});var Zx=a(Rp);y(ti.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),ET=h(Mu),Mp=s(Mu,"SPAN",{});var e5=a(Mp);zT=i(e5,"TFRobertaForMultipleChoice"),e5.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),CT=h(Dt),Ep=s(Dt,"P",{});var t5=a(Ep);qT=i(t5,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu.forEach(t),ST=h(Dt),y(vs.$$.fragment,Dt),WT=h(Dt),Et=s(Dt,"DIV",{class:!0});var aa=a(Et);y(ri.$$.fragment,aa),BT=h(aa),Qo=s(aa,"P",{});var ec=a(Qo);UT=i(ec,"The "),Rd=s(ec,"A",{href:!0});var s5=a(Rd);HT=i(s5,"TFRobertaForMultipleChoice"),s5.forEach(t),QT=i(ec," forward method, overrides the "),zp=s(ec,"CODE",{});var a5=a(zp);VT=i(a5,"__call__"),a5.forEach(t),JT=i(ec," special method."),ec.forEach(t),KT=h(aa),y(Ts.$$.fragment,aa),GT=h(aa),y(ys.$$.fragment,aa),aa.forEach(t),Dt.forEach(t),yf=h(o),Vo=s(o,"H2",{class:!0});var Cu=a(Vo);ws=s(Cu,"A",{id:!0,class:!0,href:!0});var r5=a(ws);Cp=s(r5,"SPAN",{});var i5=a(Cp);y(ii.$$.fragment,i5),i5.forEach(t),r5.forEach(t),XT=h(Cu),qp=s(Cu,"SPAN",{});var l5=a(qp);YT=i(l5,"TFRobertaForTokenClassification"),l5.forEach(t),Cu.forEach(t),wf=h(o),Ge=s(o,"DIV",{class:!0});var St=a(Ge);y(li.$$.fragment,St),ZT=h(St),jp=s(St,"P",{});var d5=a(jp);ey=i(d5,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d5.forEach(t),ty=h(St),di=s(St,"P",{});var qu=a(di);oy=i(qu,"This model inherits from "),Md=s(qu,"A",{href:!0});var c5=a(Md);ny=i(c5,"TFPreTrainedModel"),c5.forEach(t),sy=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qu.forEach(t),ay=h(St),ci=s(St,"P",{});var ju=a(ci);ry=i(ju,"This model is also a "),pi=s(ju,"A",{href:!0,rel:!0});var p5=a(pi);iy=i(p5,"tf.keras.Model"),p5.forEach(t),ly=i(ju,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju.forEach(t),dy=h(St),y($s.$$.fragment,St),cy=h(St),ht=s(St,"DIV",{class:!0});var fo=a(ht);y(hi.$$.fragment,fo),py=h(fo),Jo=s(fo,"P",{});var tc=a(Jo);hy=i(tc,"The "),Ed=s(tc,"A",{href:!0});var h5=a(Ed);my=i(h5,"TFRobertaForTokenClassification"),h5.forEach(t),fy=i(tc," forward method, overrides the "),Pp=s(tc,"CODE",{});var m5=a(Pp);uy=i(m5,"__call__"),m5.forEach(t),gy=i(tc," special method."),tc.forEach(t),_y=h(fo),y(Fs.$$.fragment,fo),by=h(fo),y(xs.$$.fragment,fo),ky=h(fo),y(Rs.$$.fragment,fo),fo.forEach(t),St.forEach(t),$f=h(o),Ko=s(o,"H2",{class:!0});var Pu=a(Ko);Ms=s(Pu,"A",{id:!0,class:!0,href:!0});var f5=a(Ms);Lp=s(f5,"SPAN",{});var u5=a(Lp);y(mi.$$.fragment,u5),u5.forEach(t),f5.forEach(t),vy=h(Pu),Ap=s(Pu,"SPAN",{});var g5=a(Ap);Ty=i(g5,"TFRobertaForQuestionAnswering"),g5.forEach(t),Pu.forEach(t),Ff=h(o),Xe=s(o,"DIV",{class:!0});var Wt=a(Xe);y(fi.$$.fragment,Wt),yy=h(Wt),Go=s(Wt,"P",{});var oc=a(Go);wy=i(oc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Op=s(oc,"CODE",{});var _5=a(Op);$y=i(_5,"span start logits"),_5.forEach(t),Fy=i(oc," and "),Np=s(oc,"CODE",{});var b5=a(Np);xy=i(b5,"span end logits"),b5.forEach(t),Ry=i(oc,")."),oc.forEach(t),My=h(Wt),ui=s(Wt,"P",{});var Lu=a(ui);Ey=i(Lu,"This model inherits from "),zd=s(Lu,"A",{href:!0});var k5=a(zd);zy=i(k5,"TFPreTrainedModel"),k5.forEach(t),Cy=i(Lu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu.forEach(t),qy=h(Wt),gi=s(Wt,"P",{});var Au=a(gi);jy=i(Au,"This model is also a "),_i=s(Au,"A",{href:!0,rel:!0});var v5=a(_i);Py=i(v5,"tf.keras.Model"),v5.forEach(t),Ly=i(Au,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Au.forEach(t),Ay=h(Wt),y(Es.$$.fragment,Wt),Oy=h(Wt),mt=s(Wt,"DIV",{class:!0});var uo=a(mt);y(bi.$$.fragment,uo),Ny=h(uo),Xo=s(uo,"P",{});var nc=a(Xo);Iy=i(nc,"The "),Cd=s(nc,"A",{href:!0});var T5=a(Cd);Dy=i(T5,"TFRobertaForQuestionAnswering"),T5.forEach(t),Sy=i(nc," forward method, overrides the "),Ip=s(nc,"CODE",{});var y5=a(Ip);Wy=i(y5,"__call__"),y5.forEach(t),By=i(nc," special method."),nc.forEach(t),Uy=h(uo),y(zs.$$.fragment,uo),Hy=h(uo),y(Cs.$$.fragment,uo),Qy=h(uo),y(qs.$$.fragment,uo),uo.forEach(t),Wt.forEach(t),xf=h(o),Yo=s(o,"H2",{class:!0});var Ou=a(Yo);js=s(Ou,"A",{id:!0,class:!0,href:!0});var w5=a(js);Dp=s(w5,"SPAN",{});var $5=a(Dp);y(ki.$$.fragment,$5),$5.forEach(t),w5.forEach(t),Vy=h(Ou),Sp=s(Ou,"SPAN",{});var F5=a(Sp);Jy=i(F5,"FlaxRobertaModel"),F5.forEach(t),Ou.forEach(t),Rf=h(o),Oe=s(o,"DIV",{class:!0});var gt=a(Oe);y(vi.$$.fragment,gt),Ky=h(gt),Wp=s(gt,"P",{});var x5=a(Wp);Gy=i(x5,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x5.forEach(t),Xy=h(gt),Ti=s(gt,"P",{});var Nu=a(Ti);Yy=i(Nu,"This model inherits from "),qd=s(Nu,"A",{href:!0});var R5=a(qd);Zy=i(R5,"FlaxPreTrainedModel"),R5.forEach(t),ew=i(Nu,`. Check the superclass documentation for the generic methods the
