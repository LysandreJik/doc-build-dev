...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),v(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),k(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,_o,Ke,ca,To,pa,vn,fe,ua,Ze,ha,ma,kn,Vt,ga,yn,Yt,bo,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,va,ka,vo,ya,wa,ko,$a,xa,yo,La,za,wo,qa,Fa,ja,Qe,Ma,Zt,Ca,Ea,Oa,Xe,Pa,$o,Ga,Sa,Aa,F,Na,xo,Ia,Da,Lo,Wa,Ua,zo,Ba,Ha,qo,Va,Ya,Fo,Ra,Ja,jo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,vs,ks,zn,te,_e,Ao,st,ys,No,ws,qn,K,rt,$s,Z,xs,Qt,Ls,zs,Xt,qs,Fs,dt,js,Ms,Cs,oe,Es,eo,Os,Ps,to,Gs,Ss,Fn,ne,Te,Io,it,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Us,pt,Bs,Hs,Vs,ut,Ys,oo,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,no,nr,ar,Uo,sr,rr,dr,be,ir,ve,Mn,se,ke,Bo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,vt,_r,Tr,br,kt,vr,ao,kr,yr,wr,yt,$r,wt,xr,Lr,zr,W,$t,qr,re,Fr,so,jr,Mr,Yo,Cr,Er,Or,ye,Pr,we,En,de,$e,Ro,xt,Gr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Wr,Ur,Br,Ft,Hr,ro,Vr,Yr,Rr,jt,Jr,Mt,Kr,Zr,Qr,U,Ct,Xr,ie,ed,io,td,od,Zo,nd,ad,sd,xe,rd,Le,Pn,le,ze,Qo,Et,dd,Xo,id,Gn,A,Ot,ld,B,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,Fe,Td,je,Gt,bd,Me,vd,Ce,St,kd,Ee,Sn,pe,Oe,on,At,yd,nn,wd,An,N,Nt,$d,H,It,xd,ue,Ld,an,zd,qd,sn,Fd,jd,Md,Pe,Cd,Ge,Ed,Se,Dt,Od,Ae,Pd,Ne,Wt,Gd,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18739/en/model_doc/longt5#transformers.LongT5Model">LongT5Model</a>.`,name:"vocab_size"},{anchor:"transformers.LongT5Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18739/en/model_doc/longt5#transformers.LongT5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18739/src/transformers/models/longt5/modeling_longt5.py#L1929",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18739/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18739/src/transformers/models/longt5/modeling_longt5.py#L2117"}}),Ct=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18739/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/pr_18739/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18739/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/pr_18739/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18739/src/transformers/models/longt5/modeling_longt5.py#L2152",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/vr_18739/src/transformers/models/longt5/modeling_flax_longt5.py#L1718",returnDescription:`
<p>A <a
...
and behavior.`),er=u(),D=r("div"),v(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),no=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Uo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),v(be.$$.fragment),ir=u(),v(ve.$$.fragment),Mn=u(),se=r("h2"),ke=r("a"),Bo=r("span"),v(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),v(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),vt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr=u(),U=r("div"),v(Ct.$$.fragment),Xr=u(),ie=r("p"),ed=a("The "),io=r("a"),td=a("LongT5EncoderModel"),od=a(" forward method, overrides the "),Zo=r("code"),nd=a("__call__"),ad=a(" special method."),sd=u(),v(xe.$$.fragment),rd=u(),v(Le.$$.fragment),Pn=u(),le=r("h2"),ze=r("a"),Qo=r("span"),v(Et.$$.fragment),dd=u(),Xo=r("span"),id=a("FlaxLongT5Model"),Gn=u(),A=r("div"),v(Ot.$$.fragment),ld=u(),B=r("div"),v(Pt.$$.fragment),cd=u(),ce=r("p"),pd=a("The "),en=r("code"),ud=a("FlaxLongT5PreTrainedModel"),hd=a(" forward method, overrides the "),tn=r("code"),md=a("__call__"),gd=a(" special method."),fd=u(),v(qe.$$.fragment),_d=u(),v(Fe.$$.fragment),Td=u(),je=r("div"),v(Gt.$$.fragment),bd=u(),v(Me.$$.fragment),vd=u(),Ce=r("div"),v(St.$$.fragment),kd=u(),v(Ee.$$.fragment),Sn=u(),pe=r("h2"),Oe=r("a"),on=r("span"),v(At.$$.fragment),yd=u(),nn=r("span"),wd=a("FlaxLongT5ForConditionalGeneration"),An=u(),N=r("div"),v(Nt.$$.fragment),$d=u(),H=r("div"),v(It.$$.fragment),xd=u(),ue=r("p"),Ld=a("The "),an=r("code"),zd=a("FlaxLongT5PreTrainedModel"),qd=a(" forward method, overrides the "),sn=r("code"),Fd=a("__call__"),jd=a(" special method."),Md=u(),v(Pe.$$.fragment),Cd=u(),v(Ge.$$.fragment),Ed=u(),Se=r("div"),v(Dt.$$.fragment),Od=u(),v(Ae.$$.fragment),Pd=u(),Ne=r("div"),v(Wt.$$.fragment),Gd=u(),v(Ie.$$.fragment),this.h()},l(t){const f=tl('[data-svelte="svelte-1phssyn"]',document.head);l=d(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),m=d(t,"H1",{class:!0});var Ut=i(m);p=d(Ut,"A",{id:!0,class:!0,href:!0});var rn=i(p);_=d(rn,"SPAN",{});var dn=i(_);k(n.$$.fragment,dn),dn.forEach(o),rn.forEach(o),c=h(Ut),z=d(Ut,"SPAN",{});var ln=i(z);la=s(ln,"LongT5"),ln.forEach(o),Ut.forEach(o),bn=h(t),ee=d(t,"H2",{class:!0});var Bt=i(ee);ge=d(Bt,"A",{id:!0,class:!0,href:!0});var cn=i(ge);_o=d(cn,"SPAN",{});var pn=i(_o);k(Ke.$$.fragment,pn),pn.forEach(o),cn.forEach(o),ca=h(Bt),To=d(Bt,"SPAN",{});var un=i(To);pa=s(un,"Overview"),un.forEach(o),Bt.forEach(o),vn=h(t),fe=d(t,"P",{});var Ht=i(fe);ua=s(Ht,"The LongT5 model was proposed in "),Ze=d(Ht,"A",{href:!0,rel:!0});var hn=i(Ze);ha=s(hn,"LongT5: Efficient Text-To-Text Transformer for Long Sequences"),hn.forEach(o),ma=s(Ht,`
by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
...
The original code can be found `),at=d(lo,"A",{href:!0,rel:!0});var ri=i(at);vs=s(ri,"here"),ri.forEach(o),ks=s(lo,"."),lo.forEach(o),zn=h(t),te=d(t,"H2",{class:!0});var Un=i(te);_e=d(Un,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);k(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),ys=h(Un),No=d(Un,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Un.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var co=i(K);k(rt.$$.fragment,co),$s=h(co),Z=d(co,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Qt=d(De,"A",{href:!0});var ci=i(Qt);Ls=s(ci,"LongT5Model"),ci.forEach(o),zs=s(De," or a "),Xt=d(De,"A",{href:!0});var pi=i(Xt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),Fs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yn.forEach(o),er=h(Y),D=d(Y,"DIV",{class:!0});var We=i(D);k(gt.$$.fragment,We),tr=h(We),ae=d(We,"P",{});var uo=i(ae);or=s(uo,"The "),no=d(uo,"A",{href:!0});var yi=i(no);nr=s(yi,"LongT5Model"),yi.forEach(o),ar=s(uo," forward method, overrides the "),Uo=d(uo,"CODE",{});var wi=i(Uo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(uo," special method."),uo.forEach(o),dr=h(We),k(be.$$.fragment,We),ir=h(We),k(ve.$$.fragment,We),We.forEach(o),Y.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Rn=i(se);ke=d(Rn,"A",{id:!0,class:!0,href:!0});var $i=i(ke);Bo=d($i,"SPAN",{});var xi=i(Bo);k(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Rn),Ho=d(Rn,"SPAN",{});var Li=i(Ho);cr=s(Li,"LongT5ForConditionalGeneration"),Li.forEach(o),Rn.forEach(o),Cn=h(t),M=d(t,"DIV",{class:!0});var R=i(M);k(_t.$$.fragment,R),pr=h(R),Tt=d(R,"P",{});var Jn=i(Tt);ur=s(Jn,"LONGT5 Model with a "),Vo=d(Jn,"CODE",{});var zi=i(Vo);hr=s(zi,"language modeling"),zi.forEach(o),mr=s(Jn," head on top."),Jn.forEach(o),gr=h(R),bt=d(R,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),vt=d(Kn,"A",{href:!0,rel:!0});var qi=i(vt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
