...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L629",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L727",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L1055",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L960",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/distilbert/modeling_distilbert.py#L843",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ph.forEach(t),_g=h(Ht),Je=n(Ht,"DIV",{class:!0});var Vt=r(Je);$(Tr.$$.fragment,Vt),bg=h(Vt),us=n(Vt,"P",{});var gl=r(us);vg=i(gl,"The "),Ui=n(gl,"A",{href:!0});var Yw=r(Ui);kg=i(Yw,"DistilBertForTokenClassification"),Yw.forEach(t),Tg=i(gl," forward method, overrides the "),ad=n(gl,"CODE",{});var Zw=r(ad);$g=i(Zw,"__call__"),Zw.forEach(t),wg=i(gl," special method."),gl.forEach(t),yg=h(Vt),$(fo.$$.fragment,Vt),Fg=h(Vt),$(mo.$$.fragment,Vt),Dg=h(Vt),$(go.$$.fragment,Vt),Vt.forEach(t),Ht.forEach(t),Up=h(s),fs=n(s,"H2",{class:!0});var Ah=r(fs);_o=n(Ah,"A",{id:!0,class:!0,href:!0});var e2=r(_o);id=n(e2,"SPAN",{});var t2=r(id);$($r.$$.fragment,t2),t2.forEach(t),e2.forEach(t),xg=h(Ah),ld=n(Ah,"SPAN",{});var s2=r(ld);Bg=i(s2,"DistilBertForQuestionAnswering"),s2.forEach(t),Ah.forEach(t),Hp=h(s),Ve=n(s,"DIV",{class:!0});var Kt=r(Ve);$(wr.$$.fragment,Kt),Mg=h(Kt),ms=n(Kt,"P",{});var _l=r(ms);Eg=i(_l,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),dd=n(_l,"CODE",{});var o2=r(dd);zg=i(o2,"span start logits"),o2.forEach(t),jg=i(_l," and "),cd=n(_l,"CODE",{});var n2=r(cd);Cg=i(n2,"span end logits"),n2.forEach(t),qg=i(_l,")."),_l.forEach(t),Pg=h(Kt),yr=n(Kt,"P",{});var Oh=r(yr);Ag=i(Oh,"This model inherits from "),Hi=n(Oh,"A",{href:!0});var r2=r(Hi);Og=i(r2,"PreTrainedModel"),r2.forEach(t),Ng=i(Oh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Oh.forEach(t),Lg=h(Kt),Fr=n(Kt,"P",{});var Nh=r(Fr);Sg=i(Nh,"This model is also a PyTorch "),Dr=n(Nh,"A",{href:!0,rel:!0});var a2=r(Dr);Ig=i(a2,"torch.nn.Module"),a2.forEach(t),Wg=i(Nh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh.forEach(t),Qg=h(Kt),Ge=n(Kt,"DIV",{class:!0});var Jt=r(Ge);$(xr.$$.fragment,Jt),Rg=h(Jt),gs=n(Jt,"P",{});var bl=r(gs);Ug=i(bl,"The "),Vi=n(bl,"A",{href:!0});var i2=r(Vi);Hg=i(i2,"DistilBertForQuestionAnswering"),i2.forEach(t),Vg=i(bl," forward method, overrides the "),pd=n(bl,"CODE",{});var l2=r(pd);Kg=i(l2,"__call__"),l2.forEach(t),Jg=i(bl," special method."),bl.forEach(t),Gg=h(Jt),$(bo.$$.fragment,Jt),Xg=h(Jt),$(vo.$$.fragment,Jt),Yg=h(Jt),$(ko.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Vp=h(s),_s=n(s,"H2",{class:!0});var Lh=r(_s);To=n(Lh,"A",{id:!0,class:!0,href:!0});var d2=r(To);hd=n(d2,"SPAN",{});var c2=r(hd);$(Br.$$.fragment,c2),c2.forEach(t),d2.forEach(t),Zg=h(Lh),ud=n(Lh,"SPAN",{});var p2=r(ud);e_=i(p2,"TFDistilBertModel"),p2.forEach(t),Lh.forEach(t),Kp=h(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);$(Mr.$$.fragment,$t),t_=h($t),fd=n($t,"P",{});var h2=r(fd);s_=i(h2,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),h2.forEach(t),o_=h($t),Er=n($t,"P",{});var Sh=r(Er);n_=i(Sh,"This model inherits from "),Ki=n(Sh,"A",{href:!0});var u2=r(Ki);r_=i(u2,"TFPreTrainedModel"),u2.forEach(t),a_=i(Sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zh.forEach(t),Ub=h(Dt),sa=n(Dt,"P",{});var eu=r(sa);Hb=i(eu,"This model is also a "),oa=n(eu,"A",{href:!0,rel:!0});var H2=r(oa);Vb=i(H2,"tf.keras.Model"),H2.forEach(t),Kb=i(eu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),eu.forEach(t),Jb=h(Dt),$(So.$$.fragment,Dt),Gb=h(Dt),Ze=n(Dt,"DIV",{class:!0});var Yt=r(Ze);$(na.$$.fragment,Yt),Xb=h(Yt),Ds=n(Yt,"P",{});var wl=r(Ds);Yb=i(wl,"The "),ol=n(wl,"A",{href:!0});var V2=r(ol);Zb=i(V2,"TFDistilBertForTokenClassification"),V2.forEach(t),ev=i(wl," forward method, overrides the "),zd=n(wl,"CODE",{});var K2=r(zd);tv=i(K2,"__call__"),K2.forEach(t),sv=i(wl," special method."),wl.forEach(t),ov=h(Yt),$(Io.$$.fragment,Yt),nv=h(Yt),$(Wo.$$.fragment,Yt),rv=h(Yt),$(Qo.$$.fragment,Yt),Yt.forEach(t),Dt.forEach(t),oh=h(s),xs=n(s,"H2",{class:!0});var tu=r(xs);Ro=n(tu,"A",{id:!0,class:!0,href:!0});var J2=r(Ro);jd=n(J2,"SPAN",{});var G2=r(jd);$(ra.$$.fragment,G2),G2.forEach(t),J2.forEach(t),av=h(tu),Cd=n(tu,"SPAN",{});var X2=r(Cd);iv=i(X2,"TFDistilBertForQuestionAnswering"),X2.forEach(t),tu.forEach(t),nh=h(s),Ie=n(s,"DIV",{class:!0});var xt=r(Ie);$(aa.$$.fragment,xt),lv=h(xt),Bs=n(xt,"P",{});var yl=r(Bs);dv=i(yl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),gu.forEach(t),jT=h(rt),gc=n(rt,"P",{});var i1=r(gc);CT=i(i1,"Finally, this model supports inherent JAX features such as:"),i1.forEach(t),qT=h(rt),jt=n(rt,"UL",{});var Dn=r(jt);_c=n(Dn,"LI",{});var l1=r(_c);Va=n(l1,"A",{href:!0,rel:!0});var d1=r(Va);PT=i(d1,"Just-In-Time (JIT) compilation"),d1.forEach(t),l1.forEach(t),AT=h(Dn),bc=n(Dn,"LI",{});var c1=r(bc);Ka=n(c1,"A",{href:!0,rel:!0});var p1=r(Ka);OT=i(p1,"Automatic Differentiation"),p1.forEach(t),c1.forEach(t),NT=h(Dn),vc=n(Dn,"LI",{});var h1=r(vc);Ja=n(h1,"A",{href:!0,rel:!0});var u1=r(Ja);LT=i(u1,"Vectorization"),u1.forEach(t),h1.forEach(t),ST=h(Dn),kc=n(Dn,"LI",{});var f1=r(kc);Ga=n(f1,"A",{href:!0,rel:!0});var m1=r(Ga);IT=i(m1,"Parallelization"),m1.forEach(t),f1.forEach(t),Dn.forEach(t),WT=h(rt),vt=n(rt,"DIV",{class:!0});var xn=r(vt);$(Xa.$$.fragment,xn),QT=h(xn),Os=n(xn,"P",{});var Ml=r(Os);RT=i(Ml,"The "),Tc=n(Ml,"CODE",{});var g1=r(Tc);UT=i(g1,"FlaxDistilBertPreTrainedModel"),g1.forEach(t),HT=i(Ml," forward method, overrides the "),$c=n(Ml,"CODE",{});var _1=r($c);VT=i(_1,"__call__"),_1.forEach(t),KT=i(Ml," special method."),Ml.forEach(t),JT=h(xn),$(rn.$$.fragment,xn),GT=h(xn),$(an.$$.fragment,xn),xn.forEach(t),rt.forEach(t),uh=h(s),Ns=n(s,"H2",{class:!0});var _u=r(Ns);ln=n(_u,"A",{id:!0,class:!0,href:!0});var b1=r(ln);wc=n(b1,"SPAN",{});var v1=r(wc);$(Ya.$$.fragment,v1),v1.forEach(t),b1.forEach(t),XT=h(_u),yc=n(_u,"SPAN",{});var k1=r(yc);YT=i(k1,"FlaxDistilBertForTokenClassification"),k1.forEach(t),_u.forEach(t),fh=h(s),Ce=n(s,"DIV",{class:!0});var at=r(Ce);$(Za.$$.fragment,at),ZT=h(at),Fc=n(at,"P",{});var T1=r(Fc);e$=i(T1,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
