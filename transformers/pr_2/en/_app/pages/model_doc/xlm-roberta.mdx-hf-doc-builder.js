...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L742",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L909",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1064",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1180",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1279",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1377",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_2/src/transformers/models/roberta/modeling_roberta.py#L1482",returnDescription:`
<p>A <a
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gw=c(),li=n("p"),Yw=r("This model is also a Flax Linen "),di=n("a"),Zw=r("flax.linen.Module"),e2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t2=c(),Rp=n("p"),o2=r("Finally, this model supports inherent JAX features such as:"),n2=c(),Wt=n("ul"),Lp=n("li"),ci=n("a"),s2=r("Just-In-Time (JIT) compilation"),a2=c(),Ep=n("li"),pi=n("a"),r2=r("Automatic Differentiation"),i2=c(),zp=n("li"),hi=n("a"),l2=r("Vectorization"),d2=c(),qp=n("li"),mi=n("a"),c2=r("Parallelization"),p2=c(),ui=n("p"),h2=r("This class overrides "),kd=n("a"),m2=r("FlaxRobertaForMaskedLM"),u2=r(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),f2=c(),Lt=n("div"),T(fi.$$.fragment),g2=c(),Wo=n("p"),_2=r("The "),Cp=n("code"),b2=r("FlaxRobertaPreTrainedModel"),k2=r(" forward method, overrides the "),jp=n("code"),v2=r("__call__"),T2=r(" special method."),y2=c(),T(ms.$$.fragment),w2=c(),T(us.$$.fragment),Pm=c(),Bo=n("h2"),fs=n("a"),Xp=n("span"),T(gi.$$.fragment),$2=c(),Pp=n("span"),M2=r("FlaxXLMRobertaForSequenceClassification"),Am=c(),Ce=n("div"),T(_i.$$.fragment),F2=c(),Ap=n("p"),x2=r(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),R2=c(),bi=n("p"),L2=r("This model inherits from "),vd=n("a"),E2=r("FlaxPreTrainedModel"),z2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),q2=c(),ki=n("p"),C2=r("This model is also a Flax Linen "),vi=n("a"),j2=r("flax.linen.Module"),X2=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P2=c(),Op=n("p"),A2=r("Finally, this model supports inherent JAX features such as:"),O2=c(),Bt=n("ul"),Np=n("li"),Ti=n("a"),N2=r("Just-In-Time (JIT) compilation"),I2=c(),Ip=n("li"),yi=n("a"),D2=r("Automatic Differentiation"),S2=c(),Dp=n("li"),wi=n("a"),W2=r("Vectorization"),B2=c(),Sp=n("li"),$i=n("a"),U2=r("Parallelization"),Q2=c(),Mi=n("p"),H2=r("This class overrides "),Td=n("a"),V2=r("FlaxRobertaForSequenceClassification"),J2=r(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),K2=c(),Et=n("div"),T(Fi.$$.fragment),G2=c(),Uo=n("p"),Y2=r("The "),Wp=n("code"),Z2=r("FlaxRobertaPreTrainedModel"),e$=r(" forward method, overrides the "),Bp=n("code"),t$=r("__call__"),o$=r(" special method."),n$=c(),T(gs.$$.fragment),s$=c(),T(_s.$$.fragment),Om=c(),Qo=n("h2"),bs=n("a"),Up=n("span"),T(xi.$$.fragment),a$=c(),Qp=n("span"),r$=r("FlaxXLMRobertaForMultipleChoice"),Nm=c(),je=n("div"),T(Ri.$$.fragment),i$=c(),Hp=n("p"),l$=r(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y$=c(),sh=n("p"),Z$=r("Finally, this model supports inherent JAX features such as:"),e1=c(),Qt=n("ul"),ah=n("li"),Wi=n("a"),t1=r("Just-In-Time (JIT) compilation"),o1=c(),rh=n("li"),Bi=n("a"),n1=r("Automatic Differentiation"),s1=c(),ih=n("li"),Ui=n("a"),a1=r("Vectorization"),r1=c(),lh=n("li"),Qi=n("a"),i1=r("Parallelization"),l1=c(),Hi=n("p"),d1=r("This class overrides "),Md=n("a"),c1=r("FlaxRobertaForTokenClassification"),p1=r(`. Please check the superclass for the appropriate
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),Gw=p(Tt),li=s(Tt,"P",{});var tf=a(li);Yw=i(tf,"This model is also a Flax Linen "),di=s(tf,"A",{href:!0,rel:!0});var Z0=a(di);Zw=i(Z0,"flax.linen.Module"),Z0.forEach(t),e2=i(tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),tf.forEach(t),t2=p(Tt),Rp=s(Tt,"P",{});var ex=a(Rp);o2=i(ex,"Finally, this model supports inherent JAX features such as:"),ex.forEach(t),n2=p(Tt),Wt=s(Tt,"UL",{});var js=a(Wt);Lp=s(js,"LI",{});var tx=a(Lp);ci=s(tx,"A",{href:!0,rel:!0});var ox=a(ci);s2=i(ox,"Just-In-Time (JIT) compilation"),ox.forEach(t),tx.forEach(t),a2=p(js),Ep=s(js,"LI",{});var nx=a(Ep);pi=s(nx,"A",{href:!0,rel:!0});var sx=a(pi);r2=i(sx,"Automatic Differentiation"),sx.forEach(t),nx.forEach(t),i2=p(js),zp=s(js,"LI",{});var ax=a(zp);hi=s(ax,"A",{href:!0,rel:!0});var rx=a(hi);l2=i(rx,"Vectorization"),rx.forEach(t),ax.forEach(t),d2=p(js),qp=s(js,"LI",{});var ix=a(qp);mi=s(ix,"A",{href:!0,rel:!0});var lx=a(mi);c2=i(lx,"Parallelization"),lx.forEach(t),ix.forEach(t),js.forEach(t),p2=p(Tt),ui=s(Tt,"P",{});var of=a(ui);h2=i(of,"This class overrides "),kd=s(of,"A",{href:!0});var dx=a(kd);m2=i(dx,"FlaxRobertaForMaskedLM"),dx.forEach(t),u2=i(of,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),of.forEach(t),f2=p(Tt),Lt=s(Tt,"DIV",{class:!0});var Xs=a(Lt);y(fi.$$.fragment,Xs),g2=p(Xs),Wo=s(Xs,"P",{});var Vd=a(Wo);_2=i(Vd,"The "),Cp=s(Vd,"CODE",{});var cx=a(Cp);b2=i(cx,"FlaxRobertaPreTrainedModel"),cx.forEach(t),k2=i(Vd," forward method, overrides the "),jp=s(Vd,"CODE",{});var px=a(jp);v2=i(px,"__call__"),px.forEach(t),T2=i(Vd," special method."),Vd.forEach(t),y2=p(Xs),y(ms.$$.fragment,Xs),w2=p(Xs),y(us.$$.fragment,Xs),Xs.forEach(t),Tt.forEach(t),Pm=p(o),Bo=s(o,"H2",{class:!0});var nf=a(Bo);fs=s(nf,"A",{id:!0,class:!0,href:!0});var hx=a(fs);Xp=s(hx,"SPAN",{});var mx=a(Xp);y(gi.$$.fragment,mx),mx.forEach(t),hx.forEach(t),$2=p(nf),Pp=s(nf,"SPAN",{});var ux=a(Pp);M2=i(ux,"FlaxXLMRobertaForSequenceClassification"),ux.forEach(t),nf.forEach(t),Am=p(o),Ce=s(o,"DIV",{class:!0});var tt=a(Ce);y(_i.$$.fragment,tt),F2=p(tt),Ap=s(tt,"P",{});var fx=a(Ap);x2=i(fx,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),fx.forEach(t),R2=p(tt),bi=s(tt,"P",{});var sf=a(bi);L2=i(sf,"This model inherits from "),vd=s(sf,"A",{href:!0});var gx=a(vd);E2=i(gx,"FlaxPreTrainedModel"),gx.forEach(t),z2=i(sf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),sf.forEach(t),q2=p(tt),ki=s(tt,"P",{});var af=a(ki);C2=i(af,"This model is also a Flax Linen "),vi=s(af,"A",{href:!0,rel:!0});var _x=a(vi);j2=i(_x,"flax.linen.Module"),_x.forEach(t),X2=i(af,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),af.forEach(t),P2=p(tt),Op=s(tt,"P",{});var bx=a(Op);A2=i(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O2=p(tt),Bt=s(tt,"UL",{});var Ps=a(Bt);Np=s(Ps,"LI",{});var kx=a(Np);Ti=s(kx,"A",{href:!0,rel:!0});var vx=a(Ti);N2=i(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I2=p(Ps),Ip=s(Ps,"LI",{});var Tx=a(Ip);yi=s(Tx,"A",{href:!0,rel:!0});var yx=a(yi);D2=i(yx,"Automatic Differentiation"),yx.forEach(t),Tx.forEach(t),S2=p(Ps),Dp=s(Ps,"LI",{});var wx=a(Dp);wi=s(wx,"A",{href:!0,rel:!0});var $x=a(wi);W2=i($x,"Vectorization"),$x.forEach(t),wx.forEach(t),B2=p(Ps),Sp=s(Ps,"LI",{});var Mx=a(Sp);$i=s(Mx,"A",{href:!0,rel:!0});var Fx=a($i);U2=i(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ps.forEach(t),Q2=p(tt),Mi=s(tt,"P",{});var rf=a(Mi);H2=i(rf,"This class overrides "),Td=s(rf,"A",{href:!0});var xx=a(Td);V2=i(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),J2=i(rf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),rf.forEach(t),K2=p(tt),Et=s(tt,"DIV",{class:!0});var As=a(Et);y(Fi.$$.fragment,As),G2=p(As),Uo=s(As,"P",{});var Jd=a(Uo);Y2=i(Jd,"The "),Wp=s(Jd,"CODE",{});var Rx=a(Wp);Z2=i(Rx,"FlaxRobertaPreTrainedModel"),Rx.forEach(t),e$=i(Jd," forward method, overrides the "),Bp=s(Jd,"CODE",{});var Lx=a(Bp);t$=i(Lx,"__call__"),Lx.forEach(t),o$=i(Jd," special method."),Jd.forEach(t),n$=p(As),y(gs.$$.fragment,As),s$=p(As),y(_s.$$.fragment,As),As.forEach(t),tt.forEach(t),Om=p(o),Qo=s(o,"H2",{class:!0});var lf=a(Qo);bs=s(lf,"A",{id:!0,class:!0,href:!0});var Ex=a(bs);Up=s(Ex,"SPAN",{});var zx=a(Up);y(xi.$$.fragment,zx),zx.forEach(t),Ex.forEach(t),a$=p(lf),Qp=s(lf,"SPAN",{});var qx=a(Qp);r$=i(qx,"FlaxXLMRobertaForMultipleChoice"),qx.forEach(t),lf.forEach(t),Nm=p(o),je=s(o,"DIV",{class:!0});var ot=a(je);y(Ri.$$.fragment,ot),i$=p(ot),Hp=s(ot,"P",{});var Cx=a(Hp);l$=i(Cx,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),Y$=p(nt),sh=s(nt,"P",{});var eR=a(sh);Z$=i(eR,"Finally, this model supports inherent JAX features such as:"),eR.forEach(t),e1=p(nt),Qt=s(nt,"UL",{});var Is=a(Qt);ah=s(Is,"LI",{});var tR=a(ah);Wi=s(tR,"A",{href:!0,rel:!0});var oR=a(Wi);t1=i(oR,"Just-In-Time (JIT) compilation"),oR.forEach(t),tR.forEach(t),o1=p(Is),rh=s(Is,"LI",{});var nR=a(rh);Bi=s(nR,"A",{href:!0,rel:!0});var sR=a(Bi);n1=i(sR,"Automatic Differentiation"),sR.forEach(t),nR.forEach(t),s1=p(Is),ih=s(Is,"LI",{});var aR=a(ih);Ui=s(aR,"A",{href:!0,rel:!0});var rR=a(Ui);a1=i(rR,"Vectorization"),rR.forEach(t),aR.forEach(t),r1=p(Is),lh=s(Is,"LI",{});var iR=a(lh);Qi=s(iR,"A",{href:!0,rel:!0});var lR=a(Qi);i1=i(lR,"Parallelization"),lR.forEach(t),iR.forEach(t),Is.forEach(t),l1=p(nt),Hi=s(nt,"P",{});var ff=a(Hi);d1=i(ff,"This class overrides "),Md=s(ff,"A",{href:!0});var dR=a(Md);c1=i(dR,"FlaxRobertaForTokenClassification"),dR.forEach(t),p1=i(ff,`. Please check the superclass for the appropriate
