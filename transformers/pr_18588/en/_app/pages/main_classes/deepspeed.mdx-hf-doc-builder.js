...
with, we combined the two into a single argument.`),bw=u(),Ct=o("p"),X$=a("For some practical usage examples, please, see this "),bo=o("a"),Q$=a("post"),e8=a("."),qw=u(),Xp=o("a"),Ew=u(),Ps=o("h3"),xt=o("a"),Of=o("span"),f(qo.$$.fragment),s8=u(),Af=o("span"),t8=a("Deployment with one GPU"),$w=u(),Rt=o("p"),a8=a("To deploy DeepSpeed with one GPU adjust the "),Qp=o("a"),n8=a("Trainer"),o8=a(" command line arguments as follows:"),kw=u(),f(Eo.$$.fragment),Pw=u(),Ue=o("p"),l8=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Tf=o("code"),r8=a("--num_gpus=1"),p8=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=o("a"),i8=a("documentation"),u8=a(" discusses the launcher options."),zw=u(),ei=o("p"),c8=a("Why would you want to use DeepSpeed with just one GPU?"),Dw=u(),It=o("ol"),Sf=o("li"),h8=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),f8=u(),Cf=o("li"),d8=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),Ow=u(),si=o("p"),m8=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),Aw=u(),f(ko.$$.fragment),Tw=u(),ti=o("p"),_8=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),Sw=u(),Ut=o("p"),v8=a("For a practical usage example of this type of deployment, please, see this "),Po=o("a"),j8=a("post"),w8=a("."),Cw=u(),ai=o("p"),y8=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),xw=u(),ni=o("p"),g8=a("Notes:"),Rw=u(),oi=o("ul"),zs=o("li"),zo=o("p"),b8=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),xf=o("code"),q8=a("CUDA_VISIBLE_DEVICES"),E8=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),$8=u(),f(Do.$$.fragment),k8=u(),Rf=o("p"),P8=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),Iw=u(),li=o("a"),Uw=u(),Ds=o("h3"),Gt=o("a"),If=o("span"),f(Oo.$$.fragment),z8=u(),Uf=o("span"),D8=a("Deployment in Notebooks"),Gw=u(),Mt=o("p"),O8=a("The problem with running notebook cells as a script is that there is no normal "),Gf=o("code"),A8=a("deepspeed"),T8=a(` launcher to rely on, so
under certain setups we have to emulate it.`),Mw=u(),ri=o("p"),S8=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Lw=u(),f(Ao.$$.fragment),Zw=u(),Lt=o("p"),C8=a("Note: "),Mf=o("code"),x8=a("..."),R8=a(" stands for the normal arguments that you\u2019d pass to the functions."),Nw=u(),pi=o("p"),I8=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Hw=u(),ii=o("p"),U8=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Bw=u(),f(To.$$.fragment),Ww=u(),Ge=o("p"),G8=a("If the training script is in a normal file and not in the notebook cells, you can launch "),Lf=o("code"),M8=a("deepspeed"),L8=a(` normally via
shell from a cell. For example, to use `),Zf=o("code"),Z8=a("run_translation.py"),N8=a(" you would launch it with:"),Fw=u(),f(So.$$.fragment),Vw=u(),Zt=o("p"),H8=a("or with "),Nf=o("code"),B8=a("%%bash"),W8=a(" magic, where you can write a multi-line code for the shell program to run:"),Yw=u(),f(Co.$$.fragment),Kw=u(),ui=o("p"),F8=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Jw=u(),Nt=o("p"),V8=a("Note: While "),Hf=o("code"),Y8=a("%%bash"),K8=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Xw=u(),ci=o("a"),Qw=u(),Os=o("h3"),Ht=o("a"),Bf=o("span"),f(xo.$$.fragment),J8=u(),Wf=o("span"),X8=a("Configuration"),ey=u(),Bt=o("p"),Q8=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
...
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),Y0.forEach(t),bw=c(e),Ct=l(e,"P",{});var K0=r(Ct);X$=n(K0,"For some practical usage examples, please, see this "),bo=l(K0,"A",{href:!0,rel:!0});var KG=r(bo);Q$=n(KG,"post"),KG.forEach(t),e8=n(K0,"."),K0.forEach(t),qw=c(e),Xp=l(e,"A",{id:!0}),r(Xp).forEach(t),Ew=c(e),Ps=l(e,"H3",{class:!0});var J0=r(Ps);xt=l(J0,"A",{id:!0,class:!0,href:!0});var JG=r(xt);Of=l(JG,"SPAN",{});var XG=r(Of);d(qo.$$.fragment,XG),XG.forEach(t),JG.forEach(t),s8=c(J0),Af=l(J0,"SPAN",{});var QG=r(Af);t8=n(QG,"Deployment with one GPU"),QG.forEach(t),J0.forEach(t),$w=c(e),Rt=l(e,"P",{});var X0=r(Rt);a8=n(X0,"To deploy DeepSpeed with one GPU adjust the "),Qp=l(X0,"A",{href:!0});var eM=r(Qp);n8=n(eM,"Trainer"),eM.forEach(t),o8=n(X0," command line arguments as follows:"),X0.forEach(t),kw=c(e),d(Eo.$$.fragment,e),Pw=c(e),Ue=l(e,"P",{});var th=r(Ue);l8=n(th,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Tf=l(th,"CODE",{});var sM=r(Tf);r8=n(sM,"--num_gpus=1"),sM.forEach(t),p8=n(th,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=l(th,"A",{href:!0,rel:!0});var tM=r($o);i8=n(tM,"documentation"),tM.forEach(t),u8=n(th," discusses the launcher options."),th.forEach(t),zw=c(e),ei=l(e,"P",{});var aM=r(ei);c8=n(aM,"Why would you want to use DeepSpeed with just one GPU?"),aM.forEach(t),Dw=c(e),It=l(e,"OL",{});var Q0=r(It);Sf=l(Q0,"LI",{});var nM=r(Sf);h8=n(nM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),nM.forEach(t),f8=c(Q0),Cf=l(Q0,"LI",{});var oM=r(Cf);d8=n(oM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),oM.forEach(t),Q0.forEach(t),Ow=c(e),si=l(e,"P",{});var lM=r(si);m8=n(lM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),lM.forEach(t),Aw=c(e),d(ko.$$.fragment,e),Tw=c(e),ti=l(e,"P",{});var rM=r(ti);_8=n(rM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),rM.forEach(t),Sw=c(e),Ut=l(e,"P",{});var eq=r(Ut);v8=n(eq,"For a practical usage example of this type of deployment, please, see this "),Po=l(eq,"A",{href:!0,rel:!0});var pM=r(Po);j8=n(pM,"post"),pM.forEach(t),w8=n(eq,"."),eq.forEach(t),Cw=c(e),ai=l(e,"P",{});var iM=r(ai);y8=n(iM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),iM.forEach(t),xw=c(e),ni=l(e,"P",{});var uM=r(ni);g8=n(uM,"Notes:"),uM.forEach(t),Rw=c(e),oi=l(e,"UL",{});var cM=r(oi);zs=l(cM,"LI",{});var ah=r(zs);zo=l(ah,"P",{});var sq=r(zo);b8=n(sq,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),xf=l(sq,"CODE",{});var hM=r(xf);q8=n(hM,"CUDA_VISIBLE_DEVICES"),hM.forEach(t),E8=n(sq,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),sq.forEach(t),$8=c(ah),d(Do.$$.fragment,ah),k8=c(ah),Rf=l(ah,"P",{});var fM=r(Rf);P8=n(fM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),fM.forEach(t),ah.forEach(t),cM.forEach(t),Iw=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),Uw=c(e),Ds=l(e,"H3",{class:!0});var tq=r(Ds);Gt=l(tq,"A",{id:!0,class:!0,href:!0});var dM=r(Gt);If=l(dM,"SPAN",{});var mM=r(If);d(Oo.$$.fragment,mM),mM.forEach(t),dM.forEach(t),z8=c(tq),Uf=l(tq,"SPAN",{});var _M=r(Uf);D8=n(_M,"Deployment in Notebooks"),_M.forEach(t),tq.forEach(t),Gw=c(e),Mt=l(e,"P",{});var aq=r(Mt);O8=n(aq,"The problem with running notebook cells as a script is that there is no normal "),Gf=l(aq,"CODE",{});var vM=r(Gf);A8=n(vM,"deepspeed"),vM.forEach(t),T8=n(aq,` launcher to rely on, so
under certain setups we have to emulate it.`),aq.forEach(t),Mw=c(e),ri=l(e,"P",{});var jM=r(ri);S8=n(jM,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),jM.forEach(t),Lw=c(e),d(Ao.$$.fragment,e),Zw=c(e),Lt=l(e,"P",{});var nq=r(Lt);C8=n(nq,"Note: "),Mf=l(nq,"CODE",{});var wM=r(Mf);x8=n(wM,"..."),wM.forEach(t),R8=n(nq," stands for the normal arguments that you\u2019d pass to the functions."),nq.forEach(t),Nw=c(e),pi=l(e,"P",{});var yM=r(pi);I8=n(yM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),yM.forEach(t),Hw=c(e),ii=l(e,"P",{});var gM=r(ii);U8=n(gM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),gM.forEach(t),Bw=c(e),d(To.$$.fragment,e),Ww=c(e),Ge=l(e,"P",{});var nh=r(Ge);G8=n(nh,"If the training script is in a normal file and not in the notebook cells, you can launch "),Lf=l(nh,"CODE",{});var bM=r(Lf);M8=n(bM,"deepspeed"),bM.forEach(t),L8=n(nh,` normally via
shell from a cell. For example, to use `),Zf=l(nh,"CODE",{});var qM=r(Zf);Z8=n(qM,"run_translation.py"),qM.forEach(t),N8=n(nh," you would launch it with:"),nh.forEach(t),Fw=c(e),d(So.$$.fragment,e),Vw=c(e),Zt=l(e,"P",{});var oq=r(Zt);H8=n(oq,"or with "),Nf=l(oq,"CODE",{});var EM=r(Nf);B8=n(EM,"%%bash"),EM.forEach(t),W8=n(oq," magic, where you can write a multi-line code for the shell program to run:"),oq.forEach(t),Yw=c(e),d(Co.$$.fragment,e),Kw=c(e),ui=l(e,"P",{});var $M=r(ui);F8=n($M,"In such case you don\u2019t need any of the code presented at the beginning of this section."),$M.forEach(t),Jw=c(e),Nt=l(e,"P",{});var lq=r(Nt);V8=n(lq,"Note: While "),Hf=l(lq,"CODE",{});var kM=r(Hf);Y8=n(kM,"%%bash"),kM.forEach(t),K8=n(lq,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),lq.forEach(t),Xw=c(e),ci=l(e,"A",{id:!0}),r(ci).forEach(t),Qw=c(e),Os=l(e,"H3",{class:!0});var rq=r(Os);Ht=l(rq,"A",{id:!0,class:!0,href:!0});var PM=r(Ht);Bf=l(PM,"SPAN",{});var zM=r(Bf);d(xo.$$.fragment,zM),zM.forEach(t),PM.forEach(t),J8=c(rq),Wf=l(rq,"SPAN",{});var DM=r(Wf);X8=n(DM,"Configuration"),DM.forEach(t),rq.forEach(t),ey=c(e),Bt=l(e,"P",{});var pq=r(Bt);Q8=n(pq,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
