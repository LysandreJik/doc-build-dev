...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/tokenization_roberta.py#L396",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L1171",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),Zk=h(ro),xt=s(ro,"DIV",{class:!0});var oa=a(xt);y(vr.$$.fragment,oa),ev=h(oa),zo=s(oa,"P",{});var Qd=a(zo);tv=i(Qd,"The "),fd=s(Qd,"A",{href:!0});var s8=a(fd);ov=i(s8,"RobertaForMultipleChoice"),s8.forEach(t),nv=i(Qd," forward method, overrides the "),op=s(Qd,"CODE",{});var a8=a(op);sv=i(a8,"__call__"),a8.forEach(t),av=i(Qd," special method."),Qd.forEach(t),rv=h(oa),y(Qn.$$.fragment,oa),iv=h(oa),y(Jn.$$.fragment,oa),oa.forEach(t),ro.forEach(t),lf=h(o),qo=s(o,"H2",{class:!0});var cu=a(qo);Vn=s(cu,"A",{id:!0,class:!0,href:!0});var r8=a(Vn);np=s(r8,"SPAN",{});var i8=a(np);y(Tr.$$.fragment,i8),i8.forEach(t),r8.forEach(t),lv=h(cu),sp=s(cu,"SPAN",{});var l8=a(sp);dv=i(l8,"RobertaForTokenClassification"),l8.forEach(t),cu.forEach(t),df=h(o),at=s(o,"DIV",{class:!0});var io=a(at);y(yr.$$.fragment,io),cv=h(io),ap=s(io,"P",{});var d8=a(ap);pv=i(d8,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),d8.forEach(t),hv=h(io),wr=s(io,"P",{});var pu=a(wr);mv=i(pu,"This model inherits from "),ud=s(pu,"A",{href:!0});var c8=a(ud);fv=i(c8,"PreTrainedModel"),c8.forEach(t),uv=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),gv=h(io),$r=s(io,"P",{});var hu=a($r);_v=i(hu,"This model is also a PyTorch "),Fr=s(hu,"A",{href:!0,rel:!0});var p8=a(Fr);bv=i(p8,"torch.nn.Module"),p8.forEach(t),kv=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),vv=h(io),lt=s(io,"DIV",{class:!0});var lo=a(lt);y(xr.$$.fragment,lo),Tv=h(lo),Co=s(lo,"P",{});var Jd=a(Co);yv=i(Jd,"The "),gd=s(Jd,"A",{href:!0});var h8=a(gd);wv=i(h8,"RobertaForTokenClassification"),h8.forEach(t),$v=i(Jd," forward method, overrides the "),rp=s(Jd,"CODE",{});var m8=a(rp);Fv=i(m8,"__call__"),m8.forEach(t),xv=i(Jd," special method."),Jd.forEach(t),Rv=h(lo),y(Kn.$$.fragment,lo),Mv=h(lo),y(Gn.$$.fragment,lo),Ev=h(lo),y(Xn.$$.fragment,lo),lo.forEach(t),io.forEach(t),cf=h(o),jo=s(o,"H2",{class:!0});var mu=a(jo);Yn=s(mu,"A",{id:!0,class:!0,href:!0});var f8=a(Yn);ip=s(f8,"SPAN",{});var u8=a(ip);y(Rr.$$.fragment,u8),u8.forEach(t),f8.forEach(t),zv=h(mu),lp=s(mu,"SPAN",{});var g8=a(lp);qv=i(g8,"RobertaForQuestionAnswering"),g8.forEach(t),mu.forEach(t),pf=h(o),rt=s(o,"DIV",{class:!0});var co=a(rt);y(Mr.$$.fragment,co),Cv=h(co),Po=s(co,"P",{});var Vd=a(Po);jv=i(Vd,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),dp=s(Vd,"CODE",{});var _8=a(dp);Pv=i(_8,"span start logits"),_8.forEach(t),Lv=i(Vd," and "),cp=s(Vd,"CODE",{});var b8=a(cp);Av=i(b8,"span end logits"),b8.forEach(t),Ov=i(Vd,")."),Vd.forEach(t),Nv=h(co),Er=s(co,"P",{});var fu=a(Er);Iv=i(fu,"This model inherits from "),_d=s(fu,"A",{href:!0});var k8=a(_d);Dv=i(k8,"PreTrainedModel"),k8.forEach(t),Sv=i(fu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Wv=h(co),zr=s(co,"P",{});var uu=a(zr);Bv=i(uu,"This model is also a PyTorch "),qr=s(uu,"A",{href:!0,rel:!0});var v8=a(qr);Uv=i(v8,"torch.nn.Module"),v8.forEach(t),Hv=i(uu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uu.forEach(t),Qv=h(co),dt=s(co,"DIV",{class:!0});var po=a(dt);y(Cr.$$.fragment,po),Jv=h(po),Lo=s(po,"P",{});var Kd=a(Lo);Vv=i(Kd,"The "),bd=s(Kd,"A",{href:!0});var T8=a(bd);Kv=i(T8,"RobertaForQuestionAnswering"),T8.forEach(t),Gv=i(Kd," forward method, overrides the "),pp=s(Kd,"CODE",{});var y8=a(pp);Xv=i(y8,"__call__"),y8.forEach(t),Yv=i(Kd," special method."),Kd.forEach(t),Zv=h(po),y(Zn.$$.fragment,po),eT=h(po),y(es.$$.fragment,po),tT=h(po),y(ts.$$.fragment,po),po.forEach(t),co.forEach(t),hf=h(o),Ao=s(o,"H2",{class:!0});var gu=a(Ao);os=s(gu,"A",{id:!0,class:!0,href:!0});var w8=a(os);hp=s(w8,"SPAN",{});var $8=a(hp);y(jr.$$.fragment,$8),$8.forEach(t),w8.forEach(t),oT=h(gu),mp=s(gu,"SPAN",{});var F8=a(mp);nT=i(F8,"TFRobertaModel"),F8.forEach(t),gu.forEach(t),mf=h(o),Qe=s(o,"DIV",{class:!0});var Ot=a(Qe);y(Pr.$$.fragment,Ot),sT=h(Ot),fp=s(Ot,"P",{});var x8=a(fp);aT=i(x8,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x8.forEach(t),rT=h(Ot),Lr=s(Ot,"P",{});var _u=a(Lr);iT=i(_u,"This model inherits from "),kd=s(_u,"A",{href:!0});var R8=a(kd);lT=i(R8,"TFPreTrainedModel"),R8.forEach(t),dT=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),cT=h(Ot),Ar=s(Ot,"P",{});var bu=a(Ar);pT=i(bu,"This model is also a "),Or=s(bu,"A",{href:!0,rel:!0});var M8=a(Or);hT=i(M8,"tf.keras.Model"),M8.forEach(t),mT=i(bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),fT=h(Ot),y(ns.$$.fragment,Ot),uT=h(Ot),Rt=s(Ot,"DIV",{class:!0});var na=a(Rt);y(Nr.$$.fragment,na),gT=h(na),Oo=s(na,"P",{});var Gd=a(Oo);_T=i(Gd,"The "),vd=s(Gd,"A",{href:!0});var E8=a(vd);bT=i(E8,"TFRobertaModel"),E8.forEach(t),kT=i(Gd," forward method, overrides the "),up=s(Gd,"CODE",{});var z8=a(up);vT=i(z8,"__call__"),z8.forEach(t),TT=i(Gd," special method."),Gd.forEach(t),yT=h(na),y(ss.$$.fragment,na),wT=h(na),y(as.$$.fragment,na),na.forEach(t),Ot.forEach(t),ff=h(o),No=s(o,"H2",{class:!0});var ku=a(No);rs=s(ku,"A",{id:!0,class:!0,href:!0});var q8=a(rs);gp=s(q8,"SPAN",{});var C8=a(gp);y(Ir.$$.fragment,C8),C8.forEach(t),q8.forEach(t),$T=h(ku),_p=s(ku,"SPAN",{});var j8=a(_p);FT=i(j8,"TFRobertaForCausalLM"),j8.forEach(t),ku.forEach(t),uf=h(o),Io=s(o,"DIV",{class:!0});var vu=a(Io);y(Dr.$$.fragment,vu),xT=h(vu),Mt=s(vu,"DIV",{class:!0});var sa=a(Mt);y(Sr.$$.fragment,sa),RT=h(sa),Do=s(sa,"P",{});var Xd=a(Do);MT=i(Xd,"The "),Td=s(Xd,"A",{href:!0});var P8=a(Td);ET=i(P8,"TFRobertaForCausalLM"),P8.forEach(t),zT=i(Xd," forward method, overrides the "),bp=s(Xd,"CODE",{});var L8=a(bp);qT=i(L8,"__call__"),L8.forEach(t),CT=i(Xd," special method."),Xd.forEach(t),jT=h(sa),y(is.$$.fragment,sa),PT=h(sa),y(ls.$$.fragment,sa),sa.forEach(t),vu.forEach(t),gf=h(o),So=s(o,"H2",{class:!0});var Tu=a(So);ds=s(Tu,"A",{id:!0,class:!0,href:!0});var A8=a(ds);kp=s(A8,"SPAN",{});var O8=a(kp);y(Wr.$$.fragment,O8),O8.forEach(t),A8.forEach(t),LT=h(Tu),vp=s(Tu,"SPAN",{});var N8=a(vp);AT=i(N8,"TFRobertaForMaskedLM"),N8.forEach(t),Tu.forEach(t),_f=h(o),Je=s(o,"DIV",{class:!0});var Nt=a(Je);y(Br.$$.fragment,Nt),OT=h(Nt),Ur=s(Nt,"P",{});var yu=a(Ur);NT=i(yu,"RoBERTa Model with a "),Tp=s(yu,"CODE",{});var I8=a(Tp);IT=i(I8,"language modeling"),I8.forEach(t),DT=i(yu," head on top."),yu.forEach(t),ST=h(Nt),Hr=s(Nt,"P",{});var wu=a(Hr);WT=i(wu,"This model inherits from "),yd=s(wu,"A",{href:!0});var D8=a(yd);BT=i(D8,"TFPreTrainedModel"),D8.forEach(t),UT=i(wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu.forEach(t),HT=h(Nt),Qr=s(Nt,"P",{});var $u=a(Qr);QT=i($u,"This model is also a "),Jr=s($u,"A",{href:!0,rel:!0});var S8=a(Jr);JT=i(S8,"tf.keras.Model"),S8.forEach(t),VT=i($u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$u.forEach(t),KT=h(Nt),y(cs.$$.fragment,Nt),GT=h(Nt),ct=s(Nt,"DIV",{class:!0});var ho=a(ct);y(Vr.$$.fragment,ho),XT=h(ho),Wo=s(ho,"P",{});var Yd=a(Wo);YT=i(Yd,"The "),wd=s(Yd,"A",{href:!0});var W8=a(wd);ZT=i(W8,"TFRobertaForMaskedLM"),W8.forEach(t),ey=i(Yd," forward method, overrides the "),yp=s(Yd,"CODE",{});var B8=a(yp);ty=i(B8,"__call__"),B8.forEach(t),oy=i(Yd," special method."),Yd.forEach(t),ny=h(ho),y(ps.$$.fragment,ho),sy=h(ho),y(hs.$$.fragment,ho),ay=h(ho),y(ms.$$.fragment,ho),ho.forEach(t),Nt.forEach(t),bf=h(o),Bo=s(o,"H2",{class:!0});var Fu=a(Bo);fs=s(Fu,"A",{id:!0,class:!0,href:!0});var U8=a(fs);wp=s(U8,"SPAN",{});var H8=a(wp);y(Kr.$$.fragment,H8),H8.forEach(t),U8.forEach(t),ry=h(Fu),$p=s(Fu,"SPAN",{});var Q8=a($p);iy=i(Q8,"TFRobertaForSequenceClassification"),Q8.forEach(t),Fu.forEach(t),kf=h(o),Ve=s(o,"DIV",{class:!0});var It=a(Ve);y(Gr.$$.fragment,It),ly=h(It),Fp=s(It,"P",{});var J8=a(Fp);dy=i(J8,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),J8.forEach(t),cy=h(It),Xr=s(It,"P",{});var xu=a(Xr);py=i(xu,"This model inherits from "),$d=s(xu,"A",{href:!0});var V8=a($d);hy=i(V8,"TFPreTrainedModel"),V8.forEach(t),my=i(xu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xu.forEach(t),fy=h(It),Yr=s(It,"P",{});var Ru=a(Yr);uy=i(Ru,"This model is also a "),Zr=s(Ru,"A",{href:!0,rel:!0});var K8=a(Zr);gy=i(K8,"tf.keras.Model"),K8.forEach(t),_y=i(Ru,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ru.forEach(t),by=h(It),y(us.$$.fragment,It),ky=h(It),pt=s(It,"DIV",{class:!0});var mo=a(pt);y(ei.$$.fragment,mo),vy=h(mo),Uo=s(mo,"P",{});var Zd=a(Uo);Ty=i(Zd,"The "),Fd=s(Zd,"A",{href:!0});var G8=a(Fd);yy=i(G8,"TFRobertaForSequenceClassification"),G8.forEach(t),wy=i(Zd," forward method, overrides the "),xp=s(Zd,"CODE",{});var X8=a(xp);$y=i(X8,"__call__"),X8.forEach(t),Fy=i(Zd," special method."),Zd.forEach(t),xy=h(mo),y(gs.$$.fragment,mo),Ry=h(mo),y(_s.$$.fragment,mo),My=h(mo),y(bs.$$.fragment,mo),mo.forEach(t),It.forEach(t),vf=h(o),Ho=s(o,"H2",{class:!0});var Mu=a(Ho);ks=s(Mu,"A",{id:!0,class:!0,href:!0});var Y8=a(ks);Rp=s(Y8,"SPAN",{});var Z8=a(Rp);y(ti.$$.fragment,Z8),Z8.forEach(t),Y8.forEach(t),Ey=h(Mu),Mp=s(Mu,"SPAN",{});var ex=a(Mp);zy=i(ex,"TFRobertaForMultipleChoice"),ex.forEach(t),Mu.forEach(t),Tf=h(o),Ke=s(o,"DIV",{class:!0});var Dt=a(Ke);y(oi.$$.fragment,Dt),qy=h(Dt),Ep=s(Dt,"P",{});var tx=a(Ep);Cy=i(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
