...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18588/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18588/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L742",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions"
>transformers.modeling_outputs.BaseModelOutputWithPoolingAndCrossAttentions</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18588/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L909",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L1064",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_outputs.MaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L1180",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L1279",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_outputs.MultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L1377",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_roberta.py#L1482",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18588/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/pr_18588/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L914",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPoolingAndCrossAttentions"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L1070",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_tf_outputs.TFMaskedLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L1329",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_tf_outputs.TFSequenceClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L1426",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_tf_outputs.TFMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L1541",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_tf_outputs.TFTokenClassifierOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_tf_roberta.py#L1627",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_tf_outputs.TFQuestionAnsweringModelOutput"
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18588/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/pr_18588/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18588/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
...
Whether or not to return a <a href="/docs/transformers/pr_18588/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSequenceClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18588/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_flax_outputs.FlaxMultipleChoiceModelOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18588/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_flax_outputs.FlaxTokenClassifierOutput"
...
Whether or not to return a <a href="/docs/transformers/pr_18588/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_18588/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18588/en/main_classes/output#transformers.modeling_flax_outputs.FlaxQuestionAnsweringModelOutput"
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pu.forEach(t),kT=p(gt),y(Un.$$.fragment,gt),vT=p(gt),Fr=s(gt,"P",{});var Au=a(Fr);TT=i(Au,"This class overrides "),rd=s(Au,"A",{href:!0});var e8=a(rd);yT=i(e8,"TFRobertaForSequenceClassification"),e8.forEach(t),wT=i(Au,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Au.forEach(t),$T=p(gt),ct=s(gt,"DIV",{class:!0});var no=a(ct);y(xr.$$.fragment,no),MT=p(no),zo=s(no,"P",{});var Dd=a(zo);FT=i(Dd,"The "),id=s(Dd,"A",{href:!0});var t8=a(id);xT=i(t8,"TFRobertaForSequenceClassification"),t8.forEach(t),RT=i(Dd," forward method, overrides the "),tp=s(Dd,"CODE",{});var o8=a(tp);LT=i(o8,"__call__"),o8.forEach(t),ET=i(Dd," special method."),Dd.forEach(t),zT=p(no),y(Qn.$$.fragment,no),qT=p(no),y(Hn.$$.fragment,no),CT=p(no),y(Vn.$$.fragment,no),no.forEach(t),gt.forEach(t),Fm=p(o),qo=s(o,"H2",{class:!0});var Ou=a(qo);Jn=s(Ou,"A",{id:!0,class:!0,href:!0});var n8=a(Jn);op=s(n8,"SPAN",{});var s8=a(op);y(Rr.$$.fragment,s8),s8.forEach(t),n8.forEach(t),jT=p(Ou),np=s(Ou,"SPAN",{});var a8=a(np);XT=i(a8,"TFXLMRobertaForMultipleChoice"),a8.forEach(t),Ou.forEach(t),xm=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Lr.$$.fragment,_t),PT=p(_t),sp=s(_t,"P",{});var r8=a(sp);AT=i(r8,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),r8.forEach(t),OT=p(_t),Er=s(_t,"P",{});var Nu=a(Er);NT=i(Nu,"This model inherits from "),ld=s(Nu,"A",{href:!0});var i8=a(ld);IT=i(i8,"TFPreTrainedModel"),i8.forEach(t),DT=i(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu.forEach(t),ST=p(_t),zr=s(_t,"P",{});var Iu=a(zr);WT=i(Iu,"This model is also a "),qr=s(Iu,"A",{href:!0,rel:!0});var l8=a(qr);BT=i(l8,"tf.keras.Model"),l8.forEach(t),UT=i(Iu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Iu.forEach(t),QT=p(_t),y(Kn.$$.fragment,_t),HT=p(_t),Cr=s(_t,"P",{});var Du=a(Cr);VT=i(Du,"This class overrides "),dd=s(Du,"A",{href:!0});var d8=a(dd);JT=i(d8,"TFRobertaForMultipleChoice"),d8.forEach(t),KT=i(Du,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Du.forEach(t),GT=p(_t),xt=s(_t,"DIV",{class:!0});var zs=a(xt);y(jr.$$.fragment,zs),YT=p(zs),Co=s(zs,"P",{});var Sd=a(Co);ZT=i(Sd,"The "),cd=s(Sd,"A",{href:!0});var c8=a(cd);e1=i(c8,"TFRobertaForMultipleChoice"),c8.forEach(t),t1=i(Sd," forward method, overrides the "),ap=s(Sd,"CODE",{});var p8=a(ap);o1=i(p8,"__call__"),p8.forEach(t),n1=i(Sd," special method."),Sd.forEach(t),s1=p(zs),y(Gn.$$.fragment,zs),a1=p(zs),y(Yn.$$.fragment,zs),zs.forEach(t),_t.forEach(t),Rm=p(o),jo=s(o,"H2",{class:!0});var Su=a(jo);Zn=s(Su,"A",{id:!0,class:!0,href:!0});var h8=a(Zn);rp=s(h8,"SPAN",{});var m8=a(rp);y(Xr.$$.fragment,m8),m8.forEach(t),h8.forEach(t),r1=p(Su),ip=s(Su,"SPAN",{});var u8=a(ip);i1=i(u8,"TFXLMRobertaForTokenClassification"),u8.forEach(t),Su.forEach(t),Lm=p(o),Se=s(o,"DIV",{class:!0});var bt=a(Se);y(Pr.$$.fragment,bt),l1=p(bt),lp=s(bt,"P",{});var f8=a(lp);d1=i(f8,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),f8.forEach(t),c1=p(bt),Ar=s(bt,"P",{});var Wu=a(Ar);p1=i(Wu,"This model inherits from "),pd=s(Wu,"A",{href:!0});var g8=a(pd);h1=i(g8,"TFPreTrainedModel"),g8.forEach(t),m1=i(Wu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wu.forEach(t),u1=p(bt),Or=s(bt,"P",{});var Bu=a(Or);f1=i(Bu,"This model is also a "),Nr=s(Bu,"A",{href:!0,rel:!0});var _8=a(Nr);g1=i(_8,"tf.keras.Model"),_8.forEach(t),_1=i(Bu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bu.forEach(t),b1=p(bt),y(es.$$.fragment,bt),k1=p(bt),Ir=s(bt,"P",{});var Uu=a(Ir);v1=i(Uu,"This class overrides "),hd=s(Uu,"A",{href:!0});var b8=a(hd);T1=i(b8,"TFRobertaForTokenClassification"),b8.forEach(t),y1=i(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),w1=p(bt),pt=s(bt,"DIV",{class:!0});var so=a(pt);y(Dr.$$.fragment,so),$1=p(so),Xo=s(so,"P",{});var Wd=a(Xo);M1=i(Wd,"The "),md=s(Wd,"A",{href:!0});var k8=a(md);F1=i(k8,"TFRobertaForTokenClassification"),k8.forEach(t),x1=i(Wd," forward method, overrides the "),dp=s(Wd,"CODE",{});var v8=a(dp);R1=i(v8,"__call__"),v8.forEach(t),L1=i(Wd," special method."),Wd.forEach(t),E1=p(so),y(ts.$$.fragment,so),z1=p(so),y(os.$$.fragment,so),q1=p(so),y(ns.$$.fragment,so),so.forEach(t),bt.forEach(t),Em=p(o),Po=s(o,"H2",{class:!0});var Qu=a(Po);ss=s(Qu,"A",{id:!0,class:!0,href:!0});var T8=a(ss);cp=s(T8,"SPAN",{});var y8=a(cp);y(Sr.$$.fragment,y8),y8.forEach(t),T8.forEach(t),C1=p(Qu),pp=s(Qu,"SPAN",{});var w8=a(pp);j1=i(w8,"TFXLMRobertaForQuestionAnswering"),w8.forEach(t),Qu.forEach(t),zm=p(o),We=s(o,"DIV",{class:!0});var kt=a(We);y(Wr.$$.fragment,kt),X1=p(kt),Ao=s(kt,"P",{});var Bd=a(Ao);P1=i(Bd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),hp=s(Bd,"CODE",{});var $8=a(hp);A1=i($8,"span start logits"),$8.forEach(t),O1=i(Bd," and "),mp=s(Bd,"CODE",{});var M8=a(mp);N1=i(M8,"span end logits"),M8.forEach(t),I1=i(Bd,")."),Bd.forEach(t),D1=p(kt),Br=s(kt,"P",{});var Hu=a(Br);S1=i(Hu,"This model inherits from "),ud=s(Hu,"A",{href:!0});var F8=a(ud);W1=i(F8,"TFPreTrainedModel"),F8.forEach(t),B1=i(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hu.forEach(t),U1=p(kt),Ur=s(kt,"P",{});var Vu=a(Ur);Q1=i(Vu,"This model is also a "),Qr=s(Vu,"A",{href:!0,rel:!0});var x8=a(Qr);H1=i(x8,"tf.keras.Model"),x8.forEach(t),V1=i(Vu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vu.forEach(t),J1=p(kt),y(as.$$.fragment,kt),K1=p(kt),Hr=s(kt,"P",{});var Ju=a(Hr);G1=i(Ju,"This class overrides "),up=s(Ju,"CODE",{});var R8=a(up);Y1=i(R8,"TFRobertaForQuestionAnsweringSimple"),R8.forEach(t),Z1=i(Ju,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Ju.forEach(t),ey=p(kt),ht=s(kt,"DIV",{class:!0});var ao=a(ht);y(Vr.$$.fragment,ao),ty=p(ao),Oo=s(ao,"P",{});var Ud=a(Oo);oy=i(Ud,"The "),fd=s(Ud,"A",{href:!0});var L8=a(fd);ny=i(L8,"TFRobertaForQuestionAnswering"),L8.forEach(t),sy=i(Ud," forward method, overrides the "),fp=s(Ud,"CODE",{});var E8=a(fp);ay=i(E8,"__call__"),E8.forEach(t),ry=i(Ud," special method."),Ud.forEach(t),iy=p(ao),y(rs.$$.fragment,ao),ly=p(ao),y(is.$$.fragment,ao),dy=p(ao),y(ls.$$.fragment,ao),ao.forEach(t),kt.forEach(t),qm=p(o),No=s(o,"H2",{class:!0});var Ku=a(No);ds=s(Ku,"A",{id:!0,class:!0,href:!0});var z8=a(ds);gp=s(z8,"SPAN",{});var q8=a(gp);y(Jr.$$.fragment,q8),q8.forEach(t),z8.forEach(t),cy=p(Ku),_p=s(Ku,"SPAN",{});var C8=a(_p);py=i(C8,"FlaxXLMRobertaModel"),C8.forEach(t),Ku.forEach(t),Cm=p(o),Be=s(o,"DIV",{class:!0});var vt=a(Be);y(Kr.$$.fragment,vt),hy=p(vt),Gr=s(vt,"P",{});var Gu=a(Gr);my=i(Gu,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gd=s(Gu,"A",{href:!0});var j8=a(gd);uy=i(j8,"FlaxPreTrainedModel"),j8.forEach(t),fy=i(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gu.forEach(t),gy=p(vt),Yr=s(vt,"P",{});var Yu=a(Yr);_y=i(Yu,"This model is also a Flax Linen "),Zr=s(Yu,"A",{href:!0,rel:!0});var X8=a(Zr);by=i(X8,"flax.linen.Module"),X8.forEach(t),ky=i(Yu,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Yu.forEach(t),vy=p(vt),bp=s(vt,"P",{});var P8=a(bp);Ty=i(P8,"Finally, this model supports inherent JAX features such as:"),P8.forEach(t),yy=p(vt),St=s(vt,"UL",{});var qs=a(St);kp=s(qs,"LI",{});var A8=a(kp);ei=s(A8,"A",{href:!0,rel:!0});var O8=a(ei);wy=i(O8,"Just-In-Time (JIT) compilation"),O8.forEach(t),A8.forEach(t),$y=p(qs),vp=s(qs,"LI",{});var N8=a(vp);ti=s(N8,"A",{href:!0,rel:!0});var I8=a(ti);My=i(I8,"Automatic Differentiation"),I8.forEach(t),N8.forEach(t),Fy=p(qs),Tp=s(qs,"LI",{});var D8=a(Tp);oi=s(D8,"A",{href:!0,rel:!0});var S8=a(oi);xy=i(S8,"Vectorization"),S8.forEach(t),D8.forEach(t),Ry=p(qs),yp=s(qs,"LI",{});var W8=a(yp);ni=s(W8,"A",{href:!0,rel:!0});var B8=a(ni);Ly=i(B8,"Parallelization"),B8.forEach(t),W8.forEach(t),qs.forEach(t),Ey=p(vt),si=s(vt,"P",{});var Zu=a(si);zy=i(Zu,"This class overrides "),_d=s(Zu,"A",{href:!0});var U8=a(_d);qy=i(U8,"FlaxRobertaModel"),U8.forEach(t),Cy=i(Zu,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),Zu.forEach(t),jy=p(vt),Rt=s(vt,"DIV",{class:!0});var Cs=a(Rt);y(ai.$$.fragment,Cs),Xy=p(Cs),Io=s(Cs,"P",{});var Qd=a(Io);Py=i(Qd,"The "),wp=s(Qd,"CODE",{});var Q8=a(wp);Ay=i(Q8,"FlaxRobertaPreTrainedModel"),Q8.forEach(t),Oy=i(Qd," forward method, overrides the "),$p=s(Qd,"CODE",{});var H8=a($p);Ny=i(H8,"__call__"),H8.forEach(t),Iy=i(Qd," special method."),Qd.forEach(t),Dy=p(Cs),y(cs.$$.fragment,Cs),Sy=p(Cs),y(ps.$$.fragment,Cs),Cs.forEach(t),vt.forEach(t),jm=p(o),Do=s(o,"H2",{class:!0});var ef=a(Do);hs=s(ef,"A",{id:!0,class:!0,href:!0});var V8=a(hs);Mp=s(V8,"SPAN",{});var J8=a(Mp);y(ri.$$.fragment,J8),J8.forEach(t),V8.forEach(t),Wy=p(ef),Fp=s(ef,"SPAN",{});var K8=a(Fp);By=i(K8,"FlaxXLMRobertaForMaskedLM"),K8.forEach(t),ef.forEach(t),Xm=p(o),Ue=s(o,"DIV",{class:!0});var Tt=a(Ue);y(ii.$$.fragment,Tt),Uy=p(Tt),So=s(Tt,"P",{});var Hd=a(So);Qy=i(Hd,"XLM-RoBERTa Model with a "),xp=s(Hd,"CODE",{});var G8=a(xp);Hy=i(G8,"language modeling"),G8.forEach(t),Vy=i(Hd,` head on top.
This model inherits from `),bd=s(Hd,"A",{href:!0});var Y8=a(bd);Jy=i(Y8,"FlaxPreTrainedModel"),Y8.forEach(t),Ky=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Hd.forEach(t),Gy=p(Tt),li=s(Tt,"P",{});var tf=a(li);Yy=i(tf,"This model is also a Flax Linen "),di=s(tf,"A",{href:!0,rel:!0});var Z8=a(di);Zy=i(Z8,"flax.linen.Module"),Z8.forEach(t),ew=i(tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
