...
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_4/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/pr_4/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L841",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_4/en/model_doc/electra#transformers.ElectraConfig"
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1074",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/model_doc/electra#transformers.models.electra.modeling_electra.ElectraForPreTrainingOutput"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1559",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1188",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L977",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1463",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1275",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_electra.py#L1357",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_4/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/pr_4/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L931",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L1029",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_4/en/model_doc/electra#transformers.models.electra.modeling_tf_electra.TFElectraForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L1159",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L1271",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L1365",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L1482",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_4/src/transformers/models/electra/modeling_tf_electra.py#L1564",returnDescription:`
<p>A <a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fg.forEach(t),gE=p(Qt),y($s.$$.fragment,Qt),_E=p(Qt),jt=s(Qt,"DIV",{class:!0});var ga=a(jt);y(ki.$$.fragment,ga),kE=p(ga),Yo=s(ga,"P",{});var Fc=a(Yo);vE=i(Fc,"The "),ec=s(Fc,"A",{href:!0});var u4=a(ec);TE=i(u4,"TFElectraForMultipleChoice"),u4.forEach(t),bE=i(Fc," forward method, overrides the "),Yp=s(Fc,"CODE",{});var f4=a(Yp);yE=i(f4,"__call__"),f4.forEach(t),EE=i(Fc," special method."),Fc.forEach(t),wE=p(ga),y(Fs.$$.fragment,ga),$E=p(ga),y(xs.$$.fragment,ga),ga.forEach(t),Qt.forEach(t),rf=p(o),Zo=s(o,"H2",{class:!0});var gg=a(Zo);Ms=s(gg,"A",{id:!0,class:!0,href:!0});var g4=a(Ms);Zp=s(g4,"SPAN",{});var _4=a(Zp);y(vi.$$.fragment,_4),_4.forEach(t),g4.forEach(t),FE=p(gg),eh=s(gg,"SPAN",{});var k4=a(eh);xE=i(k4,"TFElectraForTokenClassification"),k4.forEach(t),gg.forEach(t),lf=p(o),Ne=s(o,"DIV",{class:!0});var ft=a(Ne);y(Ti.$$.fragment,ft),ME=p(ft),th=s(ft,"P",{});var v4=a(th);zE=i(v4,"Electra model with a token classification head on top."),v4.forEach(t),CE=p(ft),oh=s(ft,"P",{});var T4=a(oh);jE=i(T4,"Both the discriminator and generator may be loaded into this model."),T4.forEach(t),qE=p(ft),bi=s(ft,"P",{});var _g=a(bi);PE=i(_g,"This model inherits from "),tc=s(_g,"A",{href:!0});var b4=a(tc);AE=i(b4,"TFPreTrainedModel"),b4.forEach(t),OE=i(_g,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_g.forEach(t),LE=p(ft),yi=s(ft,"P",{});var kg=a(yi);NE=i(kg,"This model is also a "),Ei=s(kg,"A",{href:!0,rel:!0});var y4=a(Ei);IE=i(y4,"tf.keras.Model"),y4.forEach(t),DE=i(kg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kg.forEach(t),SE=p(ft),y(zs.$$.fragment,ft),WE=p(ft),ct=s(ft,"DIV",{class:!0});var ko=a(ct);y(wi.$$.fragment,ko),UE=p(ko),en=s(ko,"P",{});var xc=a(en);RE=i(xc,"The "),oc=s(xc,"A",{href:!0});var E4=a(oc);HE=i(E4,"TFElectraForTokenClassification"),E4.forEach(t),QE=i(xc," forward method, overrides the "),nh=s(xc,"CODE",{});var w4=a(nh);VE=i(w4,"__call__"),w4.forEach(t),BE=i(xc," special method."),xc.forEach(t),KE=p(ko),y(Cs.$$.fragment,ko),JE=p(ko),y(js.$$.fragment,ko),GE=p(ko),y(qs.$$.fragment,ko),ko.forEach(t),ft.forEach(t),df=p(o),tn=s(o,"H2",{class:!0});var vg=a(tn);Ps=s(vg,"A",{id:!0,class:!0,href:!0});var $4=a(Ps);sh=s($4,"SPAN",{});var F4=a(sh);y($i.$$.fragment,F4),F4.forEach(t),$4.forEach(t),XE=p(vg),ah=s(vg,"SPAN",{});var x4=a(ah);YE=i(x4,"TFElectraForQuestionAnswering"),x4.forEach(t),vg.forEach(t),cf=p(o),Xe=s(o,"DIV",{class:!0});var Vt=a(Xe);y(Fi.$$.fragment,Vt),ZE=p(Vt),on=s(Vt,"P",{});var Mc=a(on);ew=i(Mc,`Electra Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),rh=s(Mc,"CODE",{});var M4=a(rh);tw=i(M4,"span start logits"),M4.forEach(t),ow=i(Mc," and "),ih=s(Mc,"CODE",{});var z4=a(ih);nw=i(z4,"span end logits"),z4.forEach(t),sw=i(Mc,")."),Mc.forEach(t),aw=p(Vt),xi=s(Vt,"P",{});var Tg=a(xi);rw=i(Tg,"This model inherits from "),nc=s(Tg,"A",{href:!0});var C4=a(nc);iw=i(C4,"TFPreTrainedModel"),C4.forEach(t),lw=i(Tg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tg.forEach(t),dw=p(Vt),Mi=s(Vt,"P",{});var bg=a(Mi);cw=i(bg,"This model is also a "),zi=s(bg,"A",{href:!0,rel:!0});var j4=a(zi);pw=i(j4,"tf.keras.Model"),j4.forEach(t),hw=i(bg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bg.forEach(t),mw=p(Vt),y(As.$$.fragment,Vt),uw=p(Vt),pt=s(Vt,"DIV",{class:!0});var vo=a(pt);y(Ci.$$.fragment,vo),fw=p(vo),nn=s(vo,"P",{});var zc=a(nn);gw=i(zc,"The "),sc=s(zc,"A",{href:!0});var q4=a(sc);_w=i(q4,"TFElectraForQuestionAnswering"),q4.forEach(t),kw=i(zc," forward method, overrides the "),lh=s(zc,"CODE",{});var P4=a(lh);vw=i(P4,"__call__"),P4.forEach(t),Tw=i(zc," special method."),zc.forEach(t),bw=p(vo),y(Os.$$.fragment,vo),yw=p(vo),y(Ls.$$.fragment,vo),Ew=p(vo),y(Ns.$$.fragment,vo),vo.forEach(t),Vt.forEach(t),pf=p(o),sn=s(o,"H2",{class:!0});var yg=a(sn);Is=s(yg,"A",{id:!0,class:!0,href:!0});var A4=a(Is);dh=s(A4,"SPAN",{});var O4=a(dh);y(ji.$$.fragment,O4),O4.forEach(t),A4.forEach(t),ww=p(yg),ch=s(yg,"SPAN",{});var L4=a(ch);$w=i(L4,"FlaxElectraModel"),L4.forEach(t),yg.forEach(t),hf=p(o),Ie=s(o,"DIV",{class:!0});var gt=a(Ie);y(qi.$$.fragment,gt),Fw=p(gt),ph=s(gt,"P",{});var N4=a(ph);xw=i(N4,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),N4.forEach(t),Mw=p(gt),Pi=s(gt,"P",{});var Eg=a(Pi);zw=i(Eg,"This model inherits from "),ac=s(Eg,"A",{href:!0});var I4=a(ac);Cw=i(I4,"FlaxPreTrainedModel"),I4.forEach(t),jw=i(Eg,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wg.forEach(t),Lw=p(gt),hh=s(gt,"P",{});var S4=a(hh);Nw=i(S4,"Finally, this model supports inherent JAX features such as:"),S4.forEach(t),Iw=p(gt),Kt=s(gt,"UL",{});var _a=a(Kt);mh=s(_a,"LI",{});var W4=a(mh);Li=s(W4,"A",{href:!0,rel:!0});var U4=a(Li);Dw=i(U4,"Just-In-Time (JIT) compilation"),U4.forEach(t),W4.forEach(t),Sw=p(_a),uh=s(_a,"LI",{});var R4=a(uh);Ni=s(R4,"A",{href:!0,rel:!0});var H4=a(Ni);Ww=i(H4,"Automatic Differentiation"),H4.forEach(t),R4.forEach(t),Uw=p(_a),fh=s(_a,"LI",{});var Q4=a(fh);Ii=s(Q4,"A",{href:!0,rel:!0});var V4=a(Ii);Rw=i(V4,"Vectorization"),V4.forEach(t),Q4.forEach(t),Hw=p(_a),gh=s(_a,"LI",{});var B4=a(gh);Di=s(B4,"A",{href:!0,rel:!0});var K4=a(Di);Qw=i(K4,"Parallelization"),K4.forEach(t),B4.forEach(t),_a.forEach(t),Vw=p(gt),qt=s(gt,"DIV",{class:!0});var ka=a(qt);y(Si.$$.fragment,ka),Bw=p(ka),an=s(ka,"P",{});var Cc=a(an);Kw=i(Cc,"The "),_h=s(Cc,"CODE",{});var J4=a(_h);Jw=i(J4,"FlaxElectraPreTrainedModel"),J4.forEach(t),Gw=i(Cc," forward method, overrides the "),kh=s(Cc,"CODE",{});var G4=a(kh);Xw=i(G4,"__call__"),G4.forEach(t),Yw=i(Cc," special method."),Cc.forEach(t),Zw=p(ka),y(Ds.$$.fragment,ka),e$=p(ka),y(Ss.$$.fragment,ka),ka.forEach(t),gt.forEach(t),mf=p(o),rn=s(o,"H2",{class:!0});var $g=a(rn);Ws=s($g,"A",{id:!0,class:!0,href:!0});var X4=a(Ws);vh=s(X4,"SPAN",{});var Y4=a(vh);y(Wi.$$.fragment,Y4),Y4.forEach(t),X4.forEach(t),t$=p($g),Th=s($g,"SPAN",{});var Z4=a(Th);o$=i(Z4,"FlaxElectraForPreTraining"),Z4.forEach(t),$g.forEach(t),uf=p(o),Pe=s(o,"DIV",{class:!0});var Ye=a(Pe);y(Ui.$$.fragment,Ye),n$=p(Ye),bh=s(Ye,"P",{});var eM=a(bh);s$=i(eM,"Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),eM.forEach(t),a$=p(Ye),yh=s(Ye,"P",{});var tM=a(yh);r$=i(tM,"It is recommended to load the discriminator checkpoint into that model."),tM.forEach(t),i$=p(Ye),Ri=s(Ye,"P",{});var Fg=a(Ri);l$=i(Fg,"This model inherits from "),rc=s(Fg,"A",{href:!0});var oM=a(rc);d$=i(oM,"FlaxPreTrainedModel"),oM.forEach(t),c$=i(Fg,`. Check the superclass documentation for the generic methods the
...
`),Qi=s(xg,"A",{href:!0,rel:!0});var nM=a(Qi);m$=i(nM,"flax.nn.Module"),nM.forEach(t),u$=i(xg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),f$=p(Ye),Eh=s(Ye,"P",{});var sM=a(Eh);g$=i(sM,"Finally, this model supports inherent JAX features such as:"),sM.forEach(t),_$=p(Ye),Jt=s(Ye,"UL",{});var va=a(Jt);wh=s(va,"LI",{});var aM=a(wh);Vi=s(aM,"A",{href:!0,rel:!0});var rM=a(Vi);k$=i(rM,"Just-In-Time (JIT) compilation"),rM.forEach(t),aM.forEach(t),v$=p(va),$h=s(va,"LI",{});var iM=a($h);Bi=s(iM,"A",{href:!0,rel:!0});var lM=a(Bi);T$=i(lM,"Automatic Differentiation"),lM.forEach(t),iM.forEach(t),b$=p(va),Fh=s(va,"LI",{});var dM=a(Fh);Ki=s(dM,"A",{href:!0,rel:!0});var cM=a(Ki);y$=i(cM,"Vectorization"),cM.forEach(t),dM.forEach(t),E$=p(va),xh=s(va,"LI",{});var pM=a(xh);Ji=s(pM,"A",{href:!0,rel:!0});var hM=a(Ji);w$=i(hM,"Parallelization"),hM.forEach(t),pM.forEach(t),va.forEach(t),$$=p(Ye),Pt=s(Ye,"DIV",{class:!0});var Ta=a(Pt);y(Gi.$$.fragment,Ta),F$=p(Ta),ln=s(Ta,"P",{});var jc=a(ln);x$=i(jc,"The "),Mh=s(jc,"CODE",{});var mM=a(Mh);M$=i(mM,"FlaxElectraPreTrainedModel"),mM.forEach(t),z$=i(jc," forward method, overrides the "),zh=s(jc,"CODE",{});var uM=a(zh);C$=i(uM,"__call__"),uM.forEach(t),j$=i(jc," special method."),jc.forEach(t),q$=p(Ta),y(Us.$$.fragment,Ta),P$=p(Ta),y(Rs.$$.fragment,Ta),Ta.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Hs=s(Mg,"A",{id:!0,class:!0,href:!0});var fM=a(Hs);Ch=s(fM,"SPAN",{});var gM=a(Ch);y(Xi.$$.fragment,gM),gM.forEach(t),fM.forEach(t),A$=p(Mg),jh=s(Mg,"SPAN",{});var _M=a(jh);O$=i(_M,"FlaxElectraForCausalLM"),_M.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),L$=p(_t),qh=s(_t,"P",{});var kM=a(qh);N$=i(kM,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),kM.forEach(t),I$=p(_t),Zi=s(_t,"P",{});var zg=a(Zi);D$=i(zg,"This model inherits from "),ic=s(zg,"A",{href:!0});var vM=a(ic);S$=i(vM,"FlaxPreTrainedModel"),vM.forEach(t),W$=i(zg,`. Check the superclass documentation for the generic methods the
...
`),tl=s(Cg,"A",{href:!0,rel:!0});var TM=a(tl);H$=i(TM,"flax.nn.Module"),TM.forEach(t),Q$=i(Cg,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cg.forEach(t),V$=p(_t),Ph=s(_t,"P",{});var bM=a(Ph);B$=i(bM,"Finally, this model supports inherent JAX features such as:"),bM.forEach(t),K$=p(_t),Gt=s(_t,"UL",{});var ba=a(Gt);Ah=s(ba,"LI",{});var yM=a(Ah);ol=s(yM,"A",{href:!0,rel:!0});var EM=a(ol);J$=i(EM,"Just-In-Time (JIT) compilation"),EM.forEach(t),yM.forEach(t),G$=p(ba),Oh=s(ba,"LI",{});var wM=a(Oh);nl=s(wM,"A",{href:!0,rel:!0});var $M=a(nl);X$=i($M,"Automatic Differentiation"),$M.forEach(t),wM.forEach(t),Y$=p(ba),Lh=s(ba,"LI",{});var FM=a(Lh);sl=s(FM,"A",{href:!0,rel:!0});var xM=a(sl);Z$=i(xM,"Vectorization"),xM.forEach(t),FM.forEach(t),e1=p(ba),Nh=s(ba,"LI",{});var MM=a(Nh);al=s(MM,"A",{href:!0,rel:!0});var zM=a(al);t1=i(zM,"Parallelization"),zM.forEach(t),MM.forEach(t),ba.forEach(t),o1=p(_t),At=s(_t,"DIV",{class:!0});var ya=a(At);y(rl.$$.fragment,ya),n1=p(ya),cn=s(ya,"P",{});var qc=a(cn);s1=i(qc,"The "),Ih=s(qc,"CODE",{});var CM=a(Ih);a1=i(CM,"FlaxElectraPreTrainedModel"),CM.forEach(t),r1=i(qc," forward method, overrides the "),Dh=s(qc,"CODE",{});var jM=a(Dh);i1=i(jM,"__call__"),jM.forEach(t),l1=i(qc," special method."),qc.forEach(t),d1=p(ya),y(Qs.$$.fragment,ya),c1=p(ya),y(Vs.$$.fragment,ya),ya.forEach(t),_t.forEach(t),_f=p(o),pn=s(o,"H2",{class:!0});var jg=a(pn);Bs=s(jg,"A",{id:!0,class:!0,href:!0});var qM=a(Bs);Sh=s(qM,"SPAN",{});var PM=a(Sh);y(il.$$.fragment,PM),PM.forEach(t),qM.forEach(t),p1=p(jg),Wh=s(jg,"SPAN",{});var AM=a(Wh);h1=i(AM,"FlaxElectraForMaskedLM"),AM.forEach(t),jg.forEach(t),kf=p(o),Se=s(o,"DIV",{class:!0});var kt=a(Se);y(ll.$$.fragment,kt),m1=p(kt),dl=s(kt,"P",{});var qg=a(dl);u1=i(qg,"Electra Model with a "),Uh=s(qg,"CODE",{});var OM=a(Uh);f1=i(OM,"language modeling"),OM.forEach(t),g1=i(qg," head on top."),qg.forEach(t),_1=p(kt),cl=s(kt,"P",{});var Pg=a(cl);k1=i(Pg,"This model inherits from "),lc=s(Pg,"A",{href:!0});var LM=a(lc);v1=i(LM,"FlaxPreTrainedModel"),LM.forEach(t),T1=i(Pg,`. Check the superclass documentation for the generic methods the
...
`),hl=s(Ag,"A",{href:!0,rel:!0});var NM=a(hl);E1=i(NM,"flax.nn.Module"),NM.forEach(t),w1=i(Ag,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ag.forEach(t),$1=p(kt),Rh=s(kt,"P",{});var IM=a(Rh);F1=i(IM,"Finally, this model supports inherent JAX features such as:"),IM.forEach(t),x1=p(kt),Xt=s(kt,"UL",{});var Ea=a(Xt);Hh=s(Ea,"LI",{});var DM=a(Hh);ml=s(DM,"A",{href:!0,rel:!0});var SM=a(ml);M1=i(SM,"Just-In-Time (JIT) compilation"),SM.forEach(t),DM.forEach(t),z1=p(Ea),Qh=s(Ea,"LI",{});var WM=a(Qh);ul=s(WM,"A",{href:!0,rel:!0});var UM=a(ul);C1=i(UM,"Automatic Differentiation"),UM.forEach(t),WM.forEach(t),j1=p(Ea),Vh=s(Ea,"LI",{});var RM=a(Vh);fl=s(RM,"A",{href:!0,rel:!0});var HM=a(fl);q1=i(HM,"Vectorization"),HM.forEach(t),RM.forEach(t),P1=p(Ea),Bh=s(Ea,"LI",{});var QM=a(Bh);gl=s(QM,"A",{href:!0,rel:!0});var VM=a(gl);A1=i(VM,"Parallelization"),VM.forEach(t),QM.forEach(t),Ea.forEach(t),O1=p(kt),Ot=s(kt,"DIV",{class:!0});var wa=a(Ot);y(_l.$$.fragment,wa),L1=p(wa),hn=s(wa,"P",{});var Pc=a(hn);N1=i(Pc,"The "),Kh=s(Pc,"CODE",{});var BM=a(Kh);I1=i(BM,"FlaxElectraPreTrainedModel"),BM.forEach(t),D1=i(Pc," forward method, overrides the "),Jh=s(Pc,"CODE",{});var KM=a(Jh);S1=i(KM,"__call__"),KM.forEach(t),W1=i(Pc," special method."),Pc.forEach(t),U1=p(wa),y(Ks.$$.fragment,wa),R1=p(wa),y(Js.$$.fragment,wa),wa.forEach(t),kt.forEach(t),vf=p(o),mn=s(o,"H2",{class:!0});var Og=a(mn);Gs=s(Og,"A",{id:!0,class:!0,href:!0});var JM=a(Gs);Gh=s(JM,"SPAN",{});var GM=a(Gh);y(kl.$$.fragment,GM),GM.forEach(t),JM.forEach(t),H1=p(Og),Xh=s(Og,"SPAN",{});var XM=a(Xh);Q1=i(XM,"FlaxElectraForSequenceClassification"),XM.forEach(t),Og.forEach(t),Tf=p(o),We=s(o,"DIV",{class:!0});var vt=a(We);y(vl.$$.fragment,vt),V1=p(vt),Yh=s(vt,"P",{});var YM=a(Yh);B1=i(YM,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),YM.forEach(t),K1=p(vt),Tl=s(vt,"P",{});var Lg=a(Tl);J1=i(Lg,"This model inherits from "),dc=s(Lg,"A",{href:!0});var ZM=a(dc);G1=i(ZM,"FlaxPreTrainedModel"),ZM.forEach(t),X1=i(Lg,`. Check the superclass documentation for the generic methods the
