...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vr_18462/src/transformers/tokenization_utils_base.py#L2436",returnDescription:`
<p>A <a
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18462/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L506",returnDescription:`
<p>The
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18462/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L450",returnDescription:`
<p>The decoded
...
sequences.`),Ro=c(),q=n("div"),E(Z.$$.fragment),Oo=c(),be=n("p"),Uo=s("Convert a list of lists of token ids into a list of strings by calling decode."),Bo=c(),_=n("div"),E(G.$$.fragment),Mo=c(),Te=n("p"),Ho=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
...
should make use of a dictionary and language model.`),ft.forEach(t),g.forEach(t),Ee=l(e),C=r(e,"P",{});var Ue=a(C);vo=i(Ue,"Relevant checkpoints can be found under "),O=r(Ue,"A",{href:!0,rel:!0});var _t=a(O);ko=i(_t,"https://huggingface.co/models?other=phoneme-recognition"),_t.forEach(t),bo=i(Ue,"."),Ue.forEach(t),$e=l(e),U=r(e,"P",{});var Jo=a(U);To=i(Jo,"This model was contributed by "),B=r(Jo,"A",{href:!0,rel:!0});var gt=a(B);wo=i(gt,"patrickvonplaten"),gt.forEach(t),Jo.forEach(t),Le=l(e),x=r(e,"P",{});var Be=a(x);yo=i(Be,"The original code can be found "),M=r(Be,"A",{href:!0,rel:!0});var vt=a(M);zo=i(vt,"here"),vt.forEach(t),Co=i(Be,"."),Be.forEach(t),Ie=l(e),P=r(e,"P",{});var Me=a(P);xo=i(Me,"Wav2Vec2Phoneme\u2019s architecture is based on the Wav2Vec2 model, so one can refer to "),fe=r(Me,"CODE",{});var kt=a(fe);Po=i(kt,"Wav2Vec2"),kt.forEach(t),Wo=i(Me,"\u2019s documentation page except for the tokenizer."),Me.forEach(t),Fe=l(e),T=r(e,"H2",{class:!0});var He=a(T);W=r(He,"A",{id:!0,class:!0,href:!0});var bt=a(W);_e=r(bt,"SPAN",{});var Tt=a(_e);$(H.$$.fragment,Tt),Tt.forEach(t),bt.forEach(t),Vo=l(He),ge=r(He,"SPAN",{});var wt=a(ge);qo=i(wt,"Wav2Vec2PhonemeCTCTokenizer"),wt.forEach(t),He.forEach(t),Ne=l(e),m=r(e,"DIV",{class:!0});var f=a(m);$(X.$$.fragment,f),Eo=l(f),ve=r(f,"P",{});var yt=a(ve);$o=i(yt,"Constructs a Wav2Vec2PhonemeCTC tokenizer."),yt.forEach(t),Lo=l(f),j=r(f,"P",{});var Xe=a(j);Io=i(Xe,"This tokenizer inherits from "),ne=r(Xe,"A",{href:!0});var zt=a(ne);Fo=i(zt,"PreTrainedTokenizer"),zt.forEach(t),No=i(Xe,` which contains some of the main methods. Users should refer to
