import{S as Fp,i as Cp,s as Pp,e as s,k as c,w as y,t as n,M as Ap,c as r,d as o,m as u,a as i,x as b,h as a,b as l,N as jp,G as e,g,y as L,q as k,o as w,B as x,v as Ip,L as ln}from"../../chunks/vendor-hf-doc-builder.js";import{T as ws}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as dn}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as rn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Np(q){let p,T,_,f,v;return f=new dn({props:{code:`from transformers import LayoutLMv3Model, LayoutLMv3Config
...
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var h=i(p);T=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(h,"CODE",{});var P=i(_);f=a(P,"Module"),P.forEach(o),v=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18646/src/transformers/models/layoutlmv3/feature_extraction_layoutlmv3.py#L147",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18646/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a> with the following fields:</p>
<ul>
<li><strong>pixel_values</strong> \u2014 Pixel values to be fed to a model, of shape (batch_size, num_channels, height,
width).</li>
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/pr_18646/en/model_doc/layoutlmv3#transformers.LayoutLMv3FeatureExtractor"
...
<p><a
  href="/docs/transformers/pr_18646/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a></p>
`}}),Ce=new rn({props:{anchor:"transformers.LayoutLMv3FeatureExtractor.__call__.example",$$slots:{default:[Sp]},$$scope:{ctx:q}}}),To=new oe({}),Mo=new C({props:{name:"class transformers.LayoutLMv3Tokenizer",anchor:"transformers.LayoutLMv3Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = True"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vr_18646/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L547"}}),qo=new C({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv3Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_18646/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L428"}}),Eo=new oe({}),Fo=new C({props:{name:"class transformers.LayoutLMv3TokenizerFast",anchor:"transformers.LayoutLMv3TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = True"},{name:"trim_offsets",val:" = True"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/pr_18646/en/model_doc/layoutlmv3#transformers.LayoutLMv3Tokenizer">LayoutLMv3Tokenizer</a>. See <a href="/docs/transformers/pr_18646/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/pr_18646/en/main_classes/output#transformers.modeling_outputs.BaseModelOutput"
>transformers.modeling_outputs.BaseModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/pr_18646/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config"
...
`}}),De=new ws({props:{$$slots:{default:[Dp]},$$scope:{ctx:q}}}),Oe=new rn({props:{anchor:"transformers.LayoutLMv3Model.forward.example",$$slots:{default:[Op]},$$scope:{ctx:q}}}),Vo=new oe({}),Ho=new C({props:{name:"class transformers.LayoutLMv3ForSequenceClassification",anchor:"transformers.LayoutLMv3ForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18646/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config">LayoutLMv3Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p>A <a
  href="/docs/transformers/pr_18646/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_18646/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1058",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18646/en/main_classes/output#transformers.modeling_outputs.TokenClassifierOutput"
...
`}}),Qe=new ws({props:{$$slots:{default:[Bp]},$$scope:{ctx:q}}}),Ve=new rn({props:{anchor:"transformers.LayoutLMv3ForTokenClassification.forward.example",$$slots:{default:[Up]},$$scope:{ctx:q}}}),lt=new oe({}),dt=new C({props:{name:"class transformers.LayoutLMv3ForQuestionAnswering",anchor:"transformers.LayoutLMv3ForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3ForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18646/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config">LayoutLMv3Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/pr_18646/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18646/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1156"}}),mt=new C({props:{name:"forward",anchor:"transformers.LayoutLMv3ForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"bbox",val:" = None"},{name:"pixel_values",val:" = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv3ForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/pr_18646/en/model_doc/layoutlmv3#transformers.LayoutLMv3Tokenizer">LayoutLMv3Tokenizer</a>. See <a href="/docs/transformers/pr_18646/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/pr_18646/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18646/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1169",returnDescription:`
<p>A <a
  href="/docs/transformers/pr_18646/en/main_classes/output#transformers.modeling_outputs.QuestionAnsweringModelOutput"
...
`}}),Ge=new ws({props:{$$slots:{default:[Qp]},$$scope:{ctx:q}}}),Xe=new rn({props:{anchor:"transformers.LayoutLMv3ForQuestionAnswering.forward.example",$$slots:{default:[Vp]},$$scope:{ctx:q}}}),{c(){p=s("meta"),T=c(),_=s("h1"),f=s("a"),v=s("span"),y(d.$$.fragment),h=c(),P=s("span"),xs=n("LayoutLMv3"),Ta=c(),le=s("h2"),Te=s("a"),cn=s("span"),y(lo.$$.fragment),Ts=c(),un=s("span"),Ms=n("Overview"),Ma=c(),Q=s("p"),$s=n("The LayoutLMv3 model was proposed in "),co=s("a"),zs=n("LayoutLMv3: Pre-training for Document AI with Unified Text and Image Masking"),qs=n(` by Yupan Huang, Tengchao Lv, Lei Cui, Yutong Lu, Furu Wei.
...
documentation from `),Ft=s("a"),Fr=n("PretrainedConfig"),Cr=n(" for more information."),Pr=c(),y(Ee.$$.fragment),Ia=c(),me=s("h2"),Fe=s("a"),gn=s("span"),y(Lo.$$.fragment),Ar=c(),_n=s("span"),jr=n("LayoutLMv3FeatureExtractor"),Na=c(),D=s("div"),y(ko.$$.fragment),Ir=c(),vn=s("p"),Nr=n(`Constructs a LayoutLMv3 feature extractor. This can be used to resize + normalize document images, as well as to
...
classification).`),ci=c(),$o=s("p"),ui=n("This tokenizer inherits from "),Pt=s("a"),pi=n("PreTrainedTokenizer"),mi=n(` which contains most of the main methods. Users should refer to
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),ss.forEach(o),Wr=u(Ke),ne=r(Ke,"DIV",{class:!0});var Zt=i(ne);b(xo.$$.fragment,Zt),Br=u(Zt),bn=r(Zt,"P",{});var tu=i(bn);Ur=a(tu,"Main method to prepare for the model one or several image(s)."),tu.forEach(o),Qr=u(Zt),b(Ce.$$.fragment,Zt),Zt.forEach(o),Ke.forEach(o),Sa=u(t),he=r(t,"H2",{class:!0});var rs=i(he);Pe=r(rs,"A",{id:!0,class:!0,href:!0});var nu=i(Pe);Ln=r(nu,"SPAN",{});var au=i(Ln);b(To.$$.fragment,au),au.forEach(o),nu.forEach(o),Vr=u(rs),kn=r(rs,"SPAN",{});var su=i(kn);Hr=a(su,"LayoutLMv3Tokenizer"),su.forEach(o),rs.forEach(o),Da=u(t),A=r(t,"DIV",{class:!0});var J=i(A);b(Mo.$$.fragment,J),Gr=u(J),F=r(J,"P",{});var j=i(F);Xr=a(j,"Construct a LayoutLMv3 tokenizer. Based on "),wn=r(j,"CODE",{});var ru=i(wn);Yr=a(ru,"RoBERTatokenizer"),ru.forEach(o),Jr=a(j,` (Byte Pair Encoding or BPE).
`),Ct=r(j,"A",{href:!0});var iu=i(Ct);Kr=a(iu,"LayoutLMv3Tokenizer"),iu.forEach(o),Zr=a(j,` can be used to turn words, word-level bounding boxes and optional word labels to
...
classification).`),j.forEach(o),ci=u(J),$o=r(J,"P",{});var is=i($o);ui=a(is,"This tokenizer inherits from "),Pt=r(is,"A",{href:!0});var mu=i(Pt);pi=a(mu,"PreTrainedTokenizer"),mu.forEach(o),mi=a(is,` which contains most of the main methods. Users should refer to
...
sequences with word-level normalized bounding boxes and optional labels.`),fu.forEach(o),ls.forEach(o),bi=u(J),It=r(J,"DIV",{class:!0});var gu=i(It);b(qo.$$.fragment,gu),gu.forEach(o),J.forEach(o),Oa=u(t),fe=r(t,"H2",{class:!0});var ds=i(fe);je=r(ds,"A",{id:!0,class:!0,href:!0});var _u=i(je);En=r(_u,"SPAN",{});var vu=i(En);b(Eo.$$.fragment,vu),vu.forEach(o),_u.forEach(o),Li=u(ds),Fn=r(ds,"SPAN",{});var yu=i(Fn);ki=a(yu,"LayoutLMv3TokenizerFast"),yu.forEach(o),ds.forEach(o),Ra=u(t),O=r(t,"DIV",{class:!0});var Ze=i(O);b(Fo.$$.fragment,Ze),wi=u(Ze),Co=r(Ze,"P",{});var cs=i(Co);xi=a(cs,"Construct a \u201Cfast\u201D LayoutLMv3 tokenizer (backed by HuggingFace\u2019s "),Cn=r(cs,"EM",{});var bu=i(Cn);Ti=a(bu,"tokenizers"),bu.forEach(o),Mi=a(cs," library). Based on BPE."),cs.forEach(o),$i=u(Ze),Po=r(Ze,"P",{});var us=i(Po);zi=a(us,"This tokenizer inherits from "),Nt=r(us,"A",{href:!0});var Lu=i(Nt);qi=a(Lu,"PreTrainedTokenizerFast"),Lu.forEach(o),Ei=a(us,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),us.forEach(o),Fi=u(Ze),Ie=r(Ze,"DIV",{class:!0});var ps=i(Ie);b(Ao.$$.fragment,ps),Ci=u(ps),Pn=r(ps,"P",{});var ku=i(Pn);Pi=a(ku,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),tt=r(ie,"A",{href:!0,rel:!0});var gp=i(tt);Fd=a(gp,"SROIE"),gp.forEach(o),Cd=a(ie,", "),nt=r(ie,"A",{href:!0,rel:!0});var _p=i(nt);Pd=a(_p,"CORD"),_p.forEach(o),Ad=a(ie,` and
