import{S as oi,i as ai,s as si,e as s,k as c,w as C,t as o,M as ni,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ii,G as e,g as p,y as k,q as $,o as O,B as y,v as li,L as ri}from"../../chunks/vendor-hf-doc-builder.js";import{T as ei}from"../../chunks/Tip-hf-doc-builder.js";import{D as te}from"../../chunks/Docstring-hf-doc-builder.js";import{C as As}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ti}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function di(S){let f,R,u,g,T;return g=new As({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("p"),R=o("Example:"),u=c(),C(g.$$.fragment)},l(m){f=n(m,"P",{});var _=i(f);R=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){p(m,f,_),e(f,R),p(m,u,_),k(g,m,_),T=!0},p:ri,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){O(g.$$.fragment,m),T=!1},d(m){m&&r(f),m&&r(u),y(g,m)}}}function pi(S){let f,R,u,g,T,m,_,D,j,b,z,L,Pt,ke,Kr,Mt,Qr,mr,W,eo,$e,to,ro,Oe,oo,ao,pr,ot,so,fr,at,jt,no,ur,re,Is,gr,oe,io,st,lo,co,_r,ae,ho,zt,mo,po,vr,B,fo,ye,uo,go,Ee,_o,vo,Tr,nt,To,br,H,Re,bo,xe,Co,wo,ko,I,$o,Pe,Oo,yo,Me,Eo,Ro,je,xo,Po,Mo,ze,jo,it,zo,Fo,Cr,Z,se,Ft,Fe,Lo,Lt,Do,wr,G,qo,Dt,Ao,Io,lt,Vo,No,kr,v,So,qt,Wo,Bo,At,Ho,Go,It,Xo,Uo,Vt,Zo,Jo,dt,Yo,Ko,Nt,Qo,ea,St,ta,ra,Wt,oa,aa,Bt,sa,na,$r,ct,Ht,ia,Or,Le,yr,ne,la,De,da,ca,Er,J,ie,Gt,qe,ha,Xt,ma,Rr,q,Ae,pa,Y,fa,ht,ua,ga,Ie,_a,va,Ta,K,ba,mt,Ca,wa,pt,ka,$a,Oa,le,xr,Q,de,Ut,Ve,ya,Zt,Ea,Pr,E,Ne,Ra,Jt,xa,Pa,P,ft,Ma,ja,Yt,za,Fa,Kt,La,Da,Qt,qa,Aa,er,Ia,Va,Se,tr,Na,Sa,Wa,ut,Ba,Ha,Ga,ce,We,Xa,V,Ua,rr,Za,Ja,or,Ya,Ka,ar,Qa,es,ts,X,Be,rs,sr,os,as,he,ss,U,He,ns,Ge,is,gt,ls,ds,cs,me,hs,pe,Xe,ms,Ue,ps,_t,fs,us,gs,fe,Ze,_s,Je,vs,vt,Ts,bs,Mr,ee,ue,nr,Ye,Cs,ir,ws,jr,A,Ke,ks,N,$s,Tt,Os,ys,lr,Es,Rs,bt,xs,Ps,Ms,Qe,js,et,zs,Fs,Ls,ge,tt,Ds,_e,zr;return m=new xt({}),ke=new xt({}),Fe=new xt({}),Le=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
<a href="/docs/transformers/pr_18361/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/pr_18361/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vr_18361/src/transformers/processing_utils.py#L94"}}),me=new ei({props:{$$slots:{default:[hi]},$$scope:{ctx:S}}}),Xe=new te({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18361/src/transformers/models/trocr/processing_trocr.py#L83"}}),Ze=new te({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18361/src/transformers/models/trocr/processing_trocr.py#L90"}}),Ye=new xt({}),Ke=new te({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/pr_18361/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vr_18361/src/transformers/models/trocr/modeling_trocr.py#L782"}}),tt=new te({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/pr_18361/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRConfig"
...
tasks.`),ur=c(),re=s("img"),gr=c(),oe=s("small"),io=o("TrOCR architecture. Taken from the "),st=s("a"),lo=o("original paper"),co=o("."),_r=c(),ae=s("p"),ho=o("Please refer to the "),zt=s("code"),mo=o("VisionEncoderDecoder"),po=o(" class on how to use this model."),vr=c(),B=s("p"),fo=o("This model was contributed by "),ye=s("a"),uo=o("nielsr"),go=o(`. The original code can be found
`),Ee=s("a"),_o=o("here"),vo=o("."),Tr=c(),nt=s("p"),To=o("Tips:"),br=c(),H=s("ul"),Re=s("li"),bo=o("The quickest way to get started with TrOCR is by checking the "),xe=s("a"),Co=o(`tutorial
...
on both printed (e.g. the `),Pe=s("a"),Oo=o("SROIE dataset"),yo=o(" and handwritten (e.g. the "),Me=s("a"),Eo=o(`IAM
...
into a single instance to both extract the input features and decode the predicted token ids.`),$r=c(),ct=s("ul"),Ht=s("li"),ia=o("Step-by-step Optical Character Recognition (OCR)"),Or=c(),C(Le.$$.fragment),yr=c(),ne=s("p"),la=o("See the "),De=s("a"),da=o("model hub"),ca=o(" to look for TrOCR checkpoints."),Er=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ha=c(),Xt=s("span"),ma=o("TrOCRConfig"),Rr=c(),q=s("div"),C(Ae.$$.fragment),pa=c(),Y=s("p"),fa=o("This is the configuration class to store the configuration of a "),ht=s("a"),ua=o("TrOCRForCausalLM"),ga=o(`. It is used to instantiate an
...
on both printed (e.g. the `),Pe=n(ve,"A",{href:!0,rel:!0});var en=i(Pe);Oo=a(en,"SROIE dataset"),en.forEach(r),yo=a(ve," and handwritten (e.g. the "),Me=n(ve,"A",{href:!0,rel:!0});var tn=i(Me);Eo=a(tn,`IAM
...
`),ar=n(be,"CODE",{});var Sn=i(ar);Qa=a(Sn,"__call__"),Sn.forEach(r),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(r),Wr.forEach(r),ts=h(M),X=n(M,"DIV",{class:!0});var Et=i(X);w(Be.$$.fragment,Et),rs=h(Et),sr=n(Et,"P",{});var Wn=i(sr);os=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(r),as=h(Et),w(he.$$.fragment,Et),Et.forEach(r),ss=h(M),U=n(M,"DIV",{class:!0});var Rt=i(U);w(He.$$.fragment,Rt),ns=h(Rt),Ge=n(Rt,"P",{});var Br=i(Ge);is=a(Br,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr.forEach(r),Ls=h(Ce),ge=n(Ce,"DIV",{class:!0});var Yr=i(ge);w(tt.$$.fragment,Yr),Ds=h(Yr),w(_e.$$.fragment,Yr),Yr.forEach(r),Ce.forEach(r),this.h()},h(){l(f,"name","hf:doc:metadata"),l(f,"content",JSON.stringify(fi)),l(g,"id","trocr"),l(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(g,"href","#trocr"),l(u,"class","relative group"),l(L,"id","overview"),l(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(L,"href","#overview"),l(z,"class","relative group"),l($e,"href","https://arxiv.org/abs/2109.10282"),l($e,"rel","nofollow"),l(Oe,"href","https://en.wikipedia.org/wiki/Optical_character_recognition"),l(Oe,"rel","nofollow"),ii(re.src,Is="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/trocr_architecture.jpg")||l(re,"src",Is),l(re,"alt","drawing"),l(re,"width","600"),l(st,"href","https://arxiv.org/abs/2109.10282"),l(ye,"href","https://huggingface.co/nielsr"),l(ye,"rel","nofollow"),l(Ee,"href","https://github.com/microsoft/unilm/tree/6f60612e7cc86a2a1ae85c47231507a587ab4e01/trocr"),l(Ee,"rel","nofollow"),l(xe,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/TrOCR"),l(xe,"rel","nofollow"),l(Pe,"href","https://paperswithcode.com/dataset/sroie"),l(Pe,"rel","nofollow"),l(Me,"href","https://fki.tic.heia-fr.ch/databases/iam-handwriting-database%3E"),l(Me,"rel","nofollow"),l(je,"href","https://huggingface.co/models?other=trocr%3E"),l(je,"rel","nofollow"),l(it,"href","vision-encoder-decoder"),l(se,"id","inference"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#inference"),l(Z,"class","relative group"),l(lt,"href","/docs/transformers/pr_18361/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),l(dt,"href","/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRProcessor"),l(De,"href","https://huggingface.co/models?filter=trocr"),l(De,"rel","nofollow"),l(ie,"id","transformers.TrOCRConfig"),l(ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ie,"href","#transformers.TrOCRConfig"),l(J,"class","relative group"),l(ht,"href","/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRForCausalLM"),l(Ie,"href","https://huggingface.co/microsoft/trocr-base-handwritten"),l(Ie,"rel","nofollow"),l(mt,"href","/docs/transformers/pr_18361/en/main_classes/configuration#transformers.PretrainedConfig"),l(pt,"href","/docs/transformers/pr_18361/en/main_classes/configuration#transformers.PretrainedConfig"),l(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"id","transformers.TrOCRProcessor"),l(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(de,"href","#transformers.TrOCRProcessor"),l(Q,"class","relative group"),l(ft,"href","/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRProcessor"),l(Se,"href","/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRProcessor.__call__"),l(ut,"href","/docs/transformers/pr_18361/en/model_doc/trocr#transformers.TrOCRProcessor.decode"),l(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(gt,"href","/docs/transformers/pr_18361/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),l(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_t,"href","/docs/transformers/pr_18361/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.batch_decode"),l(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(vt,"href","/docs/transformers/pr_18361/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.decode"),l(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ue,"id","transformers.TrOCRForCausalLM"),l(ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ue,"href","#transformers.TrOCRForCausalLM"),l(ee,"class","relative group"),l(Tt,"href","/docs/transformers/pr_18361/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),l(bt,"href","/docs/transformers/pr_18361/en/main_classes/model#transformers.PreTrainedModel"),l(et,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(et,"rel","nofollow"),l(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,d){e(document.head,f),p(t,R,d),p(t,u,d),e(u,g),e(g,T),k(m,T,null),e(u,_),e(u,D),e(D,j),p(t,b,d),p(t,z,d),e(z,L),e(L,Pt),k(ke,Pt,null),e(z,Kr),e(z,Mt),e(Mt,Qr),p(t,mr,d),p(t,W,d),e(W,eo),e(W,$e),e($e,to),e(W,ro),e(W,Oe),e(Oe,oo),e(W,ao),p(t,pr,d),p(t,ot,d),e(ot,so),p(t,fr,d),p(t,at,d),e(at,jt),e(jt,no),p(t,ur,d),p(t,re,d),p(t,gr,d),p(t,oe,d),e(oe,io),e(oe,st),e(st,lo),e(oe,co),p(t,_r,d),p(t,ae,d),e(ae,ho),e(ae,zt),e(zt,mo),e(ae,po),p(t,vr,d),p(t,B,d),e(B,fo),e(B,ye),e(ye,uo),e(B,go),e(B,Ee),e(Ee,_o),e(B,vo),p(t,Tr,d),p(t,nt,d),e(nt,To),p(t,br,d),p(t,H,d),e(H,Re),e(Re,bo),e(Re,xe),e(xe,Co),e(Re,wo),e(H,ko),e(H,I),e(I,$o),e(I,Pe),e(Pe,Oo),e(I,yo),e(I,Me),e(Me,Eo),e(I,Ro),e(I,je),e(je,xo),e(I,Po),e(H,Mo),e(H,ze),e(ze,jo),e(ze,it),e(it,zo),e(ze,Fo),p(t,Cr,d),p(t,Z,d),e(Z,se),e(se,Ft),k(Fe,Ft,null),e(Z,Lo),e(Z,Lt),e(Lt,Do),p(t,wr,d),p(t,G,d),e(G,qo),e(G,Dt),e(Dt,Ao),e(G,Io),e(G,lt),e(lt,Vo),e(G,No),p(t,kr,d),p(t,v,d),e(v,So),e(v,qt),e(qt,Wo),e(v,Bo),e(v,At),e(At,Ho),e(v,Go),e(v,It),e(It,Xo),e(v,Uo),e(v,Vt),e(Vt,Zo),e(v,Jo),e(v,dt),e(dt,Yo),e(v,Ko),e(v,Nt),e(Nt,Qo),e(v,ea),e(v,St),e(St,ta),e(v,ra),e(v,Wt),e(Wt,oa),e(v,aa),e(v,Bt),e(Bt,sa),e(v,na),p(t,$r,d),p(t,ct,d),e(ct,Ht),e(Ht,ia),p(t,Or,d),k(Le,t,d),p(t,yr,d),p(t,ne,d),e(ne,la),e(ne,De),e(De,da),e(ne,ca),p(t,Er,d),p(t,J,d),e(J,ie),e(ie,Gt),k(qe,Gt,null),e(J,ha),e(J,Xt),e(Xt,ma),p(t,Rr,d),p(t,q,d),k(Ae,q,null),e(q,pa),e(q,Y),e(Y,fa),e(Y,ht),e(ht,ua),e(Y,ga),e(Y,Ie),e(Ie,_a),e(Y,va),e(q,Ta),e(q,K),e(K,ba),e(K,mt),e(mt,Ca),e(K,wa),e(K,pt),e(pt,ka),e(K,$a),e(q,Oa),k(le,q,null),p(t,xr,d),p(t,Q,d),e(Q,de),e(de,Ut),k(Ve,Ut,null),e(Q,ya),e(Q,Zt),e(Zt,Ea),p(t,Pr,d),p(t,E,d),k(Ne,E,null),e(E,Ra),e(E,Jt),e(Jt,xa),e(E,Pa),e(E,P),e(P,ft),e(ft,Ma),e(P,ja),e(P,Yt),e(Yt,za),e(P,Fa),e(P,Kt),e(Kt,La),e(P,Da),e(P,Qt),e(Qt,qa),e(P,Aa),e(P,er),e(er,Ia),e(P,Va),e(P,Se),e(Se,tr),e(tr,Na),e(Se,Sa),e(P,Wa),e(P,ut),e(ut,Ba),e(P,Ha),e(E,Ga),e(E,ce),k(We,ce,null),e(ce,Xa),e(ce,V),e(V,Ua),e(V,rr),e(rr,Za),e(V,Ja),e(V,or),e(or,Ya),e(V,Ka),e(V,ar),e(ar,Qa),e(V,es),e(E,ts),e(E,X),k(Be,X,null),e(X,rs),e(X,sr),e(sr,os),e(X,as),k(he,X,null),e(E,ss),e(E,U),k(He,U,null),e(U,ns),e(U,Ge),e(Ge,is),e(Ge,gt),e(gt,ls),e(Ge,ds),e(U,cs),k(me,U,null),e(E,hs),e(E,pe),k(Xe,pe,null),e(pe,ms),e(pe,Ue),e(Ue,ps),e(Ue,_t),e(_t,fs),e(Ue,us),e(E,gs),e(E,fe),k(Ze,fe,null),e(fe,_s),e(fe,Je),e(Je,vs),e(Je,vt),e(vt,Ts),e(Je,bs),p(t,Mr,d),p(t,ee,d),e(ee,ue),e(ue,nr),k(Ye,nr,null),e(ee,Cs),e(ee,ir),e(ir,ws),p(t,jr,d),p(t,A,d),k(Ke,A,null),e(A,ks),e(A,N),e(N,$s),e(N,Tt),e(Tt,Os),e(N,ys),e(N,lr),e(lr,Es),e(N,Rs),e(N,bt),e(bt,xs),e(N,Ps),e(A,Ms),e(A,Qe),e(Qe,js),e(Qe,et),e(et,zs),e(Qe,Fs),e(A,Ls),e(A,ge),k(tt,ge,null),e(ge,Ds),k(_e,ge,null),zr=!0},p(t,[d]){const rt={};d&2&&(rt.$$scope={dirty:d,ctx:t}),le.$set(rt);const dr={};d&2&&(dr.$$scope={dirty:d,ctx:t}),he.$set(dr);const cr={};d&2&&(cr.$$scope={dirty:d,ctx:t}),me.$set(cr);const hr={};d&2&&(hr.$$scope={dirty:d,ctx:t}),_e.$set(hr)},i(t){zr||($(m.$$.fragment,t),$(ke.$$.fragment,t),$(Fe.$$.fragment,t),$(Le.$$.fragment,t),$(qe.$$.fragment,t),$(Ae.$$.fragment,t),$(le.$$.fragment,t),$(Ve.$$.fragment,t),$(Ne.$$.fragment,t),$(We.$$.fragment,t),$(Be.$$.fragment,t),$(he.$$.fragment,t),$(He.$$.fragment,t),$(me.$$.fragment,t),$(Xe.$$.fragment,t),$(Ze.$$.fragment,t),$(Ye.$$.fragment,t),$(Ke.$$.fragment,t),$(tt.$$.fragment,t),$(_e.$$.fragment,t),zr=!0)},o(t){O(m.$$.fragment,t),O(ke.$$.fragment,t),O(Fe.$$.fragment,t),O(Le.$$.fragment,t),O(qe.$$.fragment,t),O(Ae.$$.fragment,t),O(le.$$.fragment,t),O(Ve.$$.fragment,t),O(Ne.$$.fragment,t),O(We.$$.fragment,t),O(Be.$$.fragment,t),O(he.$$.fragment,t),O(He.$$.fragment,t),O(me.$$.fragment,t),O(Xe.$$.fragment,t),O(Ze.$$.fragment,t),O(Ye.$$.fragment,t),O(Ke.$$.fragment,t),O(tt.$$.fragment,t),O(_e.$$.fragment,t),zr=!1},d(t){r(f),t&&r(R),t&&r(u),y(m),t&&r(b),t&&r(z),y(ke),t&&r(mr),t&&r(W),t&&r(pr),t&&r(ot),t&&r(fr),t&&r(at),t&&r(ur),t&&r(re),t&&r(gr),t&&r(oe),t&&r(_r),t&&r(ae),t&&r(vr),t&&r(B),t&&r(Tr),t&&r(nt),t&&r(br),t&&r(H),t&&r(Cr),t&&r(Z),y(Fe),t&&r(wr),t&&r(G),t&&r(kr),t&&r(v),t&&r($r),t&&r(ct),t&&r(Or),y(Le,t),t&&r(yr),t&&r(ne),t&&r(Er),t&&r(J),y(qe),t&&r(Rr),t&&r(q),y(Ae),y(le),t&&r(xr),t&&r(Q),y(Ve),t&&r(Pr),t&&r(E),y(Ne),y(We),y(Be),y(he),y(He),y(me),y(Xe),y(Ze),t&&r(Mr),t&&r(ee),y(Ye),t&&r(jr),t&&r(A),y(Ke),y(tt),y(_e)}}}const fi={local:"trocr",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.TrOCRConfig",title:"TrOCRConfig"},{local:"transformers.TrOCRProcessor",title:"TrOCRProcessor"},{local:"transformers.TrOCRForCausalLM",title:"TrOCRForCausalLM"}],title:"TrOCR"};function ui(S){return li(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class wi extends oi{constructor(f){super();ai(this,f,ui,pi,si,{})}}export{wi as default,fi as metadata};
