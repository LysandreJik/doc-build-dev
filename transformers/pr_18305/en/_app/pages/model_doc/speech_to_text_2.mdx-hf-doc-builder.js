...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(f){m=n(f,"P",{});var S=c(m);E=s(S,"Example:"),S.forEach(o),u=d(f),v(_.$$.fragment,f)},m(f,S){h(f,m,S),e(m,E),h(f,u,S),T(_,f,S),w=!0},p:Bc,i(f){w||(x(_.$$.fragment,f),w=!0)},o(f){k(_.$$.fragment,f),w=!1},d(f){f&&o(m),f&&o(u),b(_,f)}}}function oi(B){let m,E,u,_,w,f,S,D,q,$,F,M,Zt,Ee,yr,eo,Er,qo,J,zr,_t,Pr,jr,ze,Cr,qr,Fo,z,Fr,to,Mr,Ar,oo,Lr,Dr,gt,Wr,Ir,vt,Vr,Nr,Tt,Or,Rr,ro,Ur,Hr,Mo,ne,Br,Pe,Jr,Gr,Ao,ce,Yr,je,Kr,Qr,Lo,xt,Xr,Do,G,Ce,Zr,qe,es,ts,os,Fe,rs,kt,ss,as,ns,Me,cs,Ae,is,ls,Wo,Z,ie,so,Le,ds,ao,ps,Io,Y,hs,bt,fs,ms,St,us,_s,Vo,j,gs,wt,vs,Ts,$t,xs,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,No,Pt,no,zs,Oo,De,Ro,jt,We,co,Ps,js,io,Cs,Uo,Ie,Ho,le,qs,Ve,Fs,Ms,Bo,ee,de,lo,Ne,As,po,Ls,Jo,W,Oe,Ds,te,Ws,Ct,Is,Vs,Re,Ns,Os,Rs,oe,Us,qt,Hs,Bs,Ft,Js,Gs,Ys,pe,Go,re,he,ho,Ue,Ks,fo,Qs,Yo,P,He,Xs,mo,Zs,ea,Be,ta,Mt,oa,ra,sa,fe,Je,aa,uo,na,ca,K,Ge,ia,_o,la,da,Ye,pa,go,ha,fa,ma,At,Ke,Ko,se,me,vo,Qe,ua,To,_a,Qo,y,Xe,ga,xo,va,Ta,A,Lt,xa,ka,Dt,ba,Sa,Wt,wa,$a,Ze,ko,ya,Ea,za,It,Pa,ja,Ca,ue,et,qa,R,Fa,bo,Ma,Aa,So,La,Da,tt,wo,Wa,Ia,Va,Na,Q,ot,Oa,$o,Ra,Ua,_e,Ha,X,rt,Ba,st,Ja,Vt,Ga,Ya,Ka,ge,Qa,ve,at,Xa,nt,Za,Nt,en,tn,on,Te,ct,rn,it,sn,Ot,an,nn,Xo,ae,xe,yo,lt,cn,Eo,ln,Zo,I,dt,dn,U,pn,Rt,hn,fn,zo,mn,un,Ut,_n,gn,vn,pt,Tn,ht,xn,kn,bn,ke,ft,Sn,be,er;return f=new ut({}),Ee=new ut({}),Le=new ut({}),De=new $r({props:{code:`import torch
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/pr_18305/en/model_doc/speech_to_text#transformers.Speech2TextModel">Speech2TextModel</a>`,name:"vocab_size"},{anchor:"transformers.Speech2Text2Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/vr_18305/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L31"}}),pe=new Hc({props:{anchor:"transformers.Speech2Text2Config.example",$$slots:{default:[Xc]},$$scope:{ctx:B}}}),Ue=new ut({}),He=new V({props:{name:"class transformers.Speech2Text2Tokenizer",anchor:"transformers.Speech2Text2Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"do_lower_case",val:" = False"},{name:"merges_file",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18305/src/transformers/tokenization_utils_base.py#L3349",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vr_18305/src/transformers/tokenization_utils_base.py#L3382",returnDescription:`
<p>The decoded sentence.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Ke=new V({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vr_18305/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L241"}}),Qe=new ut({}),Xe=new V({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/pr_18305/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer">Speech2Text2Tokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vr_18305/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L24"}}),et=new V({props:{name:"__call__",anchor:"transformers.Speech2Text2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vr_18305/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L46"}}),ot=new V({props:{name:"from_pretrained",anchor:"transformers.Speech2Text2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/pr_18305/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/pr_18305/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
model.`),Mo=l(),ne=a("p"),Br=r("This model was contributed by "),Pe=a("a"),Jr=r("Patrick von Platen"),Gr=r("."),Ao=l(),ce=a("p"),Yr=r("The original code can be found "),je=a("a"),Kr=r("here"),Qr=r("."),Lo=l(),xt=a("p"),Xr=r("Tips:"),Do=l(),G=a("ul"),Ce=a("li"),Zr=r(`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
the `),qe=a("a"),es=r("official models"),ts=r(" ."),os=l(),Fe=a("li"),rs=r("Speech2Text2 is always used within the "),kt=a("a"),ss=r("SpeechEncoderDecoder"),as=r(" framework."),ns=l(),Me=a("li"),cs=r("Speech2Text2\u2019s tokenizer is based on "),Ae=a("a"),is=r("fastBPE"),ls=r("."),Wo=l(),Z=a("h2"),ie=a("a"),so=a("span"),g(Le.$$.fragment),ds=l(),ao=a("span"),ps=r("Inference"),Io=l(),Y=a("p"),hs=r("Speech2Text2\u2019s "),bt=a("a"),fs=r("SpeechEncoderDecoderModel"),ms=r(` model accepts raw waveform input values from speech and
...
documentation from `),Ft=a("a"),Js=r("PretrainedConfig"),Gs=r(" for more information."),Ys=l(),g(pe.$$.fragment),Go=l(),re=a("h2"),he=a("a"),ho=a("span"),g(Ue.$$.fragment),Ks=l(),fo=a("span"),Qs=r("Speech2TextTokenizer"),Yo=l(),P=a("div"),g(He.$$.fragment),Xs=l(),mo=a("p"),Zs=r("Constructs a Speech2Text2Tokenizer."),ea=l(),Be=a("p"),ta=r("This tokenizer inherits from "),Mt=a("a"),oa=r("PreTrainedTokenizer"),ra=r(` which contains some of the main methods. Users should refer to
...
methods for more information.`),we.forEach(o),_r.forEach(o),Na=d(C),Q=n(C,"DIV",{class:!0});var Qt=c(Q);v(ot.$$.fragment,Qt),Oa=d(Qt),$o=n(Qt,"P",{});var Fc=c($o);Ra=s(Fc,"Instantiate a processor associated with a pretrained model."),Fc.forEach(o),Ua=d(Qt),v(_e.$$.fragment,Qt),Qt.forEach(o),Ha=d(C),X=n(C,"DIV",{class:!0});var Xt=c(X);v(rt.$$.fragment,Xt),Ba=d(Xt),st=n(Xt,"P",{});var gr=c(st);Ja=s(gr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Vt=n(gr,"A",{href:!0});var Mc=c(Vt);Ga=s(Mc,"from_pretrained()"),Mc.forEach(o),Ya=s(gr," method."),gr.forEach(o),Ka=d(Xt),v(ge.$$.fragment,Xt),Xt.forEach(o),Qa=d(C),ve=n(C,"DIV",{class:!0});var vr=c(ve);v(at.$$.fragment,vr),Xa=d(vr),nt=n(vr,"P",{});var Tr=c(nt);Za=s(Tr,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Nt=n(Tr,"A",{href:!0});var Ac=c(Nt);en=s(Ac,"batch_decode()"),Ac.forEach(o),tn=s(Tr,`. Please
