...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Vt=new Z({}),Ut=new I({props:{name:"class transformers.MvpModel",anchor:"transformers.MvpModel",parameters:[{name:"config",val:": MvpConfig"}],parametersDescription:[{anchor:"transformers.MvpModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/pr_3/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mvp/modeling_mvp.py#L1331",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mvp/modeling_mvp.py#L1471",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/pr_3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vr_3/src/transformers/models/mvp/modeling_mvp.py#L1893",returnDescription:`
<p>A <a
