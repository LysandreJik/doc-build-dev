import{S as ka,i as $a,s as Ea,e as r,k as d,w as z,t as o,M as Pa,c as l,d as a,m as h,a as s,x as S,h as n,b as p,G as t,g as c,y as C,L as Da,q as O,o as G,B as I,v as xa}from"../../chunks/vendor-hf-doc-builder.js";import{I as Jt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{C as ve}from"../../chunks/CodeBlock-hf-doc-builder.js";function Aa(Rt){let g,ke,v,E,ee,L,Fe,te,Ke,$e,P,Qe,ae,Ve,We,Ee,m,Xe,oe,Ze,et,ne,tt,at,re,ot,nt,Pe,N,De,D,rt,R,lt,st,xe,B,Ae,k,x,le,H,it,se,ct,Te,f,dt,ie,ht,pt,ce,ut,mt,je,F,ft,ze,u,wt,de,yt,_t,he,bt,gt,pe,vt,kt,ue,$t,Et,Se,$,A,me,U,Pt,fe,Dt,Ce,w,xt,we,At,Tt,q,ye,jt,zt,Oe,y,St,_e,Ct,Ot,be,Gt,It,Ge,M,Ie,_,Lt,ge,Nt,Bt,K,Ht,Ut,Le,Y,Ne,T,qt,Q,Mt,Yt,Be,J,He;return L=new Jt({}),N=new ve({props:{code:`import torch.nn as nn
...
at specific points and these must also occur at roughly the same time before moving on.`),ze=d(),u=r("p"),wt=o("The most direct example is when you update all of the parameters in a model through "),de=r("code"),yt=o(".backward()"),_t=o(`. All instances of the model
...
gradient accumulation, you accumulate `),he=r("code"),bt=o("n"),gt=o(" losses and skip "),pe=r("code"),vt=o(".backward()"),kt=o(" until "),ue=r("code"),$t=o("n"),Et=o(` batches have been reached. This
...
that is added to your model after converting it to DDP.`),Oe=d(),y=r("p"),St=o("Under this context manager, PyTorch will skip synchronizing the gradients when "),_e=r("code"),Ct=o(".backward()"),Ot=o(" is called, and the first call to "),be=r("code"),Gt=o(".backward()"),It=o(` outside this
context manager will trigger the synchronization. See an example below:`),Ge=d(),z(M.$$.fragment),Ie=d(),_=r("p"),Lt=o(`In \u{1F917} Accelerate to make this an API that can be called no matter the training device (though it may not do anything if you are not in a distributed system!),
...
at specific points and these must also occur at roughly the same time before moving on.`),la.forEach(a),ze=h(e),u=l(e,"P",{});var b=s(u);wt=n(b,"The most direct example is when you update all of the parameters in a model through "),de=l(b,"CODE",{});var sa=s(de);yt=n(sa,".backward()"),sa.forEach(a),_t=n(b,`. All instances of the model
need to have updated their gradients, collated, and updated again before moving onto the next batch of data. But when performing
gradient accumulation, you accumulate `),he=l(b,"CODE",{});var ia=s(he);bt=n(ia,"n"),ia.forEach(a),gt=n(b," losses and skip "),pe=l(b,"CODE",{});var ca=s(pe);vt=n(ca,".backward()"),ca.forEach(a),kt=n(b," until "),ue=l(b,"CODE",{});var da=s(ue);$t=n(da,"n"),da.forEach(a),Et=n(b,` batches have been reached. This
can cause a significant slowdown since all the processes need to communicate with them more times than needed. How
can you avoid this overhead?`),b.forEach(a),Se=h(e),$=l(e,"H2",{class:!0});var Je=s($);A=l(Je,"A",{id:!0,class:!0,href:!0});var ha=s(A);me=l(ha,"SPAN",{});var pa=s(me);S(U.$$.fragment,pa),pa.forEach(a),ha.forEach(a),Pt=h(Je),fe=l(Je,"SPAN",{});var ua=s(fe);Dt=n(ua,"Solving the slowdown problem"),ua.forEach(a),Je.forEach(a),Ce=h(e),w=l(e,"P",{});var W=s(w);xt=n(W,"Since you are skipping these batches, their gradients do not need to be synchronized until the point where "),we=l(W,"CODE",{});var ma=s(we);At=n(ma,".backward()"),ma.forEach(a),Tt=n(W,` is actually called.
...
that is added to your model after converting it to DDP.`),W.forEach(a),Oe=h(e),y=l(e,"P",{});var X=s(y);St=n(X,"Under this context manager, PyTorch will skip synchronizing the gradients when "),_e=l(X,"CODE",{});var ya=s(_e);Ct=n(ya,".backward()"),ya.forEach(a),Ot=n(X," is called, and the first call to "),be=l(X,"CODE",{});var _a=s(be);Gt=n(_a,".backward()"),_a.forEach(a),It=n(X,` outside this
context manager will trigger the synchronization. See an example below:`),X.forEach(a),Ge=h(e),S(M.$$.fragment,e),Ie=h(e),_=l(e,"P",{});var Z=s(_);Lt=n(Z,`In \u{1F917} Accelerate to make this an API that can be called no matter the training device (though it may not do anything if you are not in a distributed system!),
`),ge=l(Z,"CODE",{});var ba=s(ge);Nt=n(ba,"ddp_model.no_sync"),ba.forEach(a),Bt=n(Z," gets replaced with "),K=l(Z,"A",{href:!0});var ga=s(K);Ht=n(ga,"no_sync()"),ga.forEach(a),Ut=n(Z," and operates the same way:"),Z.forEach(a),Le=h(e),S(Y.$$.fragment,e),Ne=h(e),T=l(e,"P",{});var Re=s(T);qt=n(Re,"As you may expect, the "),Q=l(Re,"A",{href:!0});var va=s(Q);Mt=n(va,"accumulate()"),va.forEach(a),Yt=n(Re,` function wraps around this conditional check by keeping track of the current batch number, leaving you with the final
gradient accumulation API:`),Re.forEach(a),Be=h(e),S(J.$$.fragment,e),this.h()},h(){p(g,"name","hf:doc:metadata"),p(g,"content",JSON.stringify(Ta)),p(E,"id","gradient-synchronization"),p(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(E,"href","#gradient-synchronization"),p(v,"class","relative group"),p(R,"href","/docs/accelerate/pr_607/en/package_reference/accelerator#accelerate.Accelerator.prepare"),p(x,"id","the-slowdown-in-gradient-accumulation"),p(x,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(x,"href","#the-slowdown-in-gradient-accumulation"),p(k,"class","relative group"),p(A,"id","solving-the-slowdown-problem"),p(A,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(A,"href","#solving-the-slowdown-problem"),p($,"class","relative group"),p(q,"href","https://pytorch.org/docs/stable/generated/torch.nn.parallel.DistributedDataParallel.html#torch.nn.parallel.DistributedDataParallel.no_sync"),p(q,"rel","nofollow"),p(K,"href","/docs/accelerate/pr_607/en/package_reference/accelerator#accelerate.Accelerator.no_sync"),p(Q,"href","/docs/accelerate/pr_607/en/package_reference/accelerator#accelerate.Accelerator.accumulate")},m(e,i){t(document.head,g),c(e,ke,i),c(e,v,i),t(v,E),t(E,ee),C(L,ee,null),t(v,Fe),t(v,te),t(te,Ke),c(e,$e,i),c(e,P,i),t(P,Qe),t(P,ae),t(ae,Ve),t(P,We),c(e,Ee,i),c(e,m,i),t(m,Xe),t(m,oe),t(oe,Ze),t(m,et),t(m,ne),t(ne,tt),t(m,at),t(m,re),t(re,ot),t(m,nt),c(e,Pe,i),C(N,e,i),c(e,De,i),c(e,D,i),t(D,rt),t(D,R),t(R,lt),t(D,st),c(e,xe,i),C(B,e,i),c(e,Ae,i),c(e,k,i),t(k,x),t(x,le),C(H,le,null),t(k,it),t(k,se),t(se,ct),c(e,Te,i),c(e,f,i),t(f,dt),t(f,ie),t(ie,ht),t(f,pt),t(f,ce),t(ce,ut),t(f,mt),c(e,je,i),c(e,F,i),t(F,ft),c(e,ze,i),c(e,u,i),t(u,wt),t(u,de),t(de,yt),t(u,_t),t(u,he),t(he,bt),t(u,gt),t(u,pe),t(pe,vt),t(u,kt),t(u,ue),t(ue,$t),t(u,Et),c(e,Se,i),c(e,$,i),t($,A),t(A,me),C(U,me,null),t($,Pt),t($,fe),t(fe,Dt),c(e,Ce,i),c(e,w,i),t(w,xt),t(w,we),t(we,At),t(w,Tt),t(w,q),t(q,ye),t(ye,jt),t(w,zt),c(e,Oe,i),c(e,y,i),t(y,St),t(y,_e),t(_e,Ct),t(y,Ot),t(y,be),t(be,Gt),t(y,It),c(e,Ge,i),C(M,e,i),c(e,Ie,i),c(e,_,i),t(_,Lt),t(_,ge),t(ge,Nt),t(_,Bt),t(_,K),t(K,Ht),t(_,Ut),c(e,Le,i),C(Y,e,i),c(e,Ne,i),c(e,T,i),t(T,qt),t(T,Q),t(Q,Mt),t(T,Yt),c(e,Be,i),C(J,e,i),He=!0},p:Da,i(e){He||(O(L.$$.fragment,e),O(N.$$.fragment,e),O(B.$$.fragment,e),O(H.$$.fragment,e),O(U.$$.fragment,e),O(M.$$.fragment,e),O(Y.$$.fragment,e),O(J.$$.fragment,e),He=!0)},o(e){G(L.$$.fragment,e),G(N.$$.fragment,e),G(B.$$.fragment,e),G(H.$$.fragment,e),G(U.$$.fragment,e),G(M.$$.fragment,e),G(Y.$$.fragment,e),G(J.$$.fragment,e),He=!1},d(e){a(g),e&&a(ke),e&&a(v),I(L),e&&a($e),e&&a(P),e&&a(Ee),e&&a(m),e&&a(Pe),I(N,e),e&&a(De),e&&a(D),e&&a(xe),I(B,e),e&&a(Ae),e&&a(k),I(H),e&&a(Te),e&&a(f),e&&a(je),e&&a(F),e&&a(ze),e&&a(u),e&&a(Se),e&&a($),I(U),e&&a(Ce),e&&a(w),e&&a(Oe),e&&a(y),e&&a(Ge),I(M,e),e&&a(Ie),e&&a(_),e&&a(Le),I(Y,e),e&&a(Ne),e&&a(T),e&&a(Be),I(J,e)}}}const Ta={local:"gradient-synchronization",sections:[{local:"the-slowdown-in-gradient-accumulation",title:"The slowdown in gradient accumulation"},{local:"solving-the-slowdown-problem",title:"Solving the slowdown problem"}],title:"Gradient Synchronization"};function ja(Rt){return xa(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Oa extends ka{constructor(g){super();$a(this,g,ja,Aa,Ea,{})}}export{Oa as default,Ta as metadata};
